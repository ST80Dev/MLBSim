...
- **Fase 1 — Turno interattivo: COMPLETATA (nucleo).**
  ...
  - Tattiche **complete**: in attacco Swing / Bunt di sacrificio / **Squeeze**
    (bunt suicida col corridore in 3ª) / Rubata / **Hit-and-run** / **Pinch-hit**
    (panchina); in difesa cambio lanciatore manuale / base intenzionale /
  ...
  - **AI tattica della CPU (small-ball)**: nel gioco interattivo la CPU può
    rubare / buntare / hit-and-run secondo doti e situazione (`cpuOffenseTurn`).
