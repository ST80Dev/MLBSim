...
export function ActionBar({
  ...
  // di turno) le azioni di giocatori/squadra = sostituzioni; a DESTRA le azioni di
  // gioco del turno = tattiche (bunt/rubate/posizionamenti…). Così i pulsanti non
  // si accumulano tutti da un lato e la barra resta bilanciata attorno al primario.
  const bar = waiting ? (
