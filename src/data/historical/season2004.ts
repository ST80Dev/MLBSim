...
export const SEASON_2004: HistTeam[] = [
  // BAL (BAL 2004)
  {
    ...
    batters: [
      ...
      { id: 'palmera01', name: 'Rafael Palmeiro', pos: '1B', bats: 'L', age: 39, pa: 651, h: 144, double: 27, triple: 1, hr: 31, bb: 88, so: 72, hbp: 6, sb: 2, cs: 0, sec: 'LF', fld: 72 },
      { id: 'roberbr01', name: 'Brian Roberts', pos: '2B', bats: 'S', age: 26, pa: 734, h: 174, double: 43, triple: 3, hr: 5, bb: 70, so: 92, hbp: 1, sb: 31, cs: 11, sec: 'SS', fld: 62 },
      ...
      { id: 'tejadmi01', name: 'Miguel Tejada', pos: 'SS', bats: 'R', age: 30, pa: 725, h: 197, double: 39, triple: 1, hr: 32, bb: 49, so: 73, hbp: 9, sb: 7, cs: 1, sec: '2B', fld: 81 },
      ...
      { id: 'gibboja01', name: 'Jay Gibbons', pos: 'RF', bats: 'L', age: 27, pa: 380, h: 90, double: 19, triple: 1, hr: 13, bb: 29, so: 54, hbp: 1, sb: 0, cs: 1, sec: '1B', fld: 65, arm: 75 },
    ...
    bench: [
      ...
      { id: 'hairsje02', name: 'Jerry Hairston', pos: 'RF', bats: 'R', age: 28, pa: 334, h: 82, double: 18, triple: 2, hr: 3, bb: 28, so: 32, hbp: 7, sb: 15, cs: 7, sec: 'CF', fld: 79, arm: 70 },
      ...
      { id: 'macharo01', name: 'Robert Machado', pos: 'C', bats: 'R', age: 31, pa: 77, h: 15, double: 3, triple: 0, hr: 1, bb: 6, so: 16, hbp: 0, sb: 0, cs: 0, sec: '1B', fld: 70, arm: 90 },
    ],
    reserveBatters: [
  ...
  // BOS (BOS 2004)
  {
    ...
    batters: [
      ...
      { id: 'millake01', name: 'Kevin Millar', pos: '1B', bats: 'R', age: 32, pa: 588, h: 149, double: 35, triple: 0, hr: 20, bb: 56, so: 95, hbp: 11, sb: 2, cs: 2, sec: 'LF', fld: 75 },
      { id: 'bellhma01', name: 'Mark Bellhorn', pos: '2B', bats: 'S', age: 29, pa: 620, h: 132, double: 32, triple: 3, hr: 17, bb: 91, so: 172, hbp: 6, sb: 7, cs: 4, sec: '3B', fld: 61 },
      { id: 'muellbi02', name: 'Bill Mueller', pos: '3B', bats: 'S', age: 33, pa: 460, h: 119, double: 29, triple: 3, hr: 12, bb: 49, so: 56, hbp: 4, sb: 1, cs: 2, sec: '2B', fld: 63 },
      { id: 'reesepo01', name: 'Pokey Reese', pos: 'SS', bats: 'R', age: 31, pa: 268, h: 56, double: 9, triple: 1, hr: 3, bb: 19, so: 57, hbp: 1, sb: 7, cs: 1, sec: '2B', fld: 80 },
      { id: 'ramirma02', name: 'Manny Ramirez', pos: 'LF', bats: 'R', age: 32, pa: 663, h: 180, double: 40, triple: 0, hr: 40, bb: 88, so: 111, hbp: 7, sb: 2, cs: 2, sec: 'RF', fld: 58, arm: 65 },
    ...
    bench: [
      ...
      { id: 'mirabdo01', name: 'Doug Mirabelli', pos: 'C', bats: 'R', age: 33, pa: 182, h: 43, double: 12, triple: 0, hr: 8, bb: 16, so: 41, hbp: 2, sb: 0, cs: 0, sec: '1B', fld: 60, arm: 58 },
      { id: 'mccarda01', name: 'Dave McCarty', pos: '1B', bats: 'R', age: 34, pa: 168, h: 39, double: 8, triple: 1, hr: 4, bb: 13, so: 41, hbp: 2, sb: 1, cs: 0, sec: 'LF', fld: 75 },
      { id: 'nixontr01', name: 'Trot Nixon', pos: 'RF', bats: 'L', age: 30, pa: 167, h: 43, double: 9, triple: 1, hr: 8, bb: 19, so: 29, hbp: 1, sb: 1, cs: 0, sec: 'CF', fld: 62, arm: 63 },
  ...
  // NYY (NYA 2004)
  {
    ...
    batters: [
      ...
      { id: 'giambja01', name: 'Jason Giambi', pos: '1B', bats: 'L', age: 33, pa: 322, h: 65, double: 12, triple: 0, hr: 17, bb: 54, so: 61, hbp: 9, sb: 1, cs: 1, sec: 'LF', fld: 55 },
      ...
      { id: 'rodrial01', name: 'Alex Rodriguez', pos: '3B', bats: 'R', age: 28, pa: 698, h: 175, double: 26, triple: 3, hr: 43, bb: 82, so: 126, hbp: 11, sb: 21, cs: 4, sec: 'SS', fld: 61 },
      ...
      { id: 'willibe02', name: 'Bernie Williams', pos: 'CF', bats: 'S', age: 35, pa: 651, h: 155, double: 29, triple: 1, hr: 20, bb: 85, so: 89, hbp: 3, sb: 4, cs: 3, fld: 64, arm: 64 },
      { id: 'sheffga01', name: 'Gary Sheffield', pos: 'RF', bats: 'R', age: 35, pa: 684, h: 177, double: 33, triple: 1, hr: 36, bb: 89, so: 71, hbp: 10, sb: 11, cs: 5, sec: 'LF', fld: 71, arm: 73 },
    ...
    bench: [
      { id: 'loftoke01', name: 'Kenny Lofton', pos: 'CF', bats: 'L', age: 37, pa: 313, h: 78, double: 14, triple: 5, hr: 5, bb: 29, so: 29, hbp: 1, sb: 12, cs: 4, sec: 'RF', fld: 79, arm: 71 },
      ...
      { id: 'crosbbu01', name: 'Bubba Crosby', pos: 'RF', bats: 'L', age: 27, pa: 58, h: 8, double: 2, triple: 0, hr: 2, bb: 2, so: 13, hbp: 1, sb: 2, cs: 0, sec: 'LF', fld: 70, arm: 58, rk: true },
    ],
    pitchers: [
  ...
  // TBR (TBA 2004)
  {
    ...
    batters: [
      ...
      { id: 'lugoju01', name: 'Julio Lugo', pos: 'SS', bats: 'R', age: 28, pa: 655, h: 159, double: 32, triple: 4, hr: 11, bb: 53, so: 113, hbp: 5, sb: 18, cs: 5, sec: '2B', fld: 75 },
      { id: 'crawfca02', name: 'Carl Crawford', pos: 'LF', bats: 'L', age: 22, pa: 672, h: 181, double: 23, triple: 15, hr: 8, bb: 31, so: 91, hbp: 1, sb: 55, cs: 13, sec: 'CF', fld: 88, arm: 66 },
      { id: 'baldero01', name: 'Rocco Baldelli', pos: 'CF', bats: 'R', age: 22, pa: 565, h: 148, double: 27, triple: 5, hr: 13, bb: 28, so: 96, hbp: 7, sb: 19, cs: 6, sec: 'LF', fld: 84, arm: 77 },
      ...
      { id: 'blumge01', name: 'Geoff Blum', pos: 'DH', bats: 'S', age: 31, pa: 369, h: 83, double: 18, triple: 1, hr: 8, bb: 24, so: 52, hbp: 1, sb: 1, cs: 1, sec: '3B', fld: 66 },
    ],
    bench: [
      { id: 'fickro01', name: 'Robert Fick', pos: 'DH', bats: 'L', age: 30, pa: 253, h: 56, double: 11, triple: 1, hr: 6, bb: 22, so: 32, hbp: 2, sb: 0, cs: 0, sec: '1B' },
      { id: 'cantujo01', name: 'Jorge Cantu', pos: '2B', bats: 'R', age: 22, pa: 185, h: 52, double: 20, triple: 1, hr: 2, bb: 9, so: 44, hbp: 2, sb: 0, cs: 0, sec: '3B', fld: 51, rk: true },
      { id: 'uptonbj01', name: 'B. J. Upton', pos: 'SS', bats: 'R', age: 19, pa: 177, h: 41, double: 8, triple: 2, hr: 4, bb: 15, so: 46, hbp: 1, sb: 4, cs: 1, sec: '3B', fld: 53, rk: true },
  ...
  // TOR (TOR 2004)
  {
    ...
    batters: [
      ...
      { id: 'delgaca01', name: 'Carlos Delgado', pos: '1B', bats: 'L', age: 32, pa: 551, h: 127, double: 28, triple: 1, hr: 32, bb: 79, so: 111, hbp: 13, sb: 0, cs: 0, sec: 'LF', fld: 75 },
      { id: 'hudsoor01', name: 'Orlando Hudson', pos: '2B', bats: 'S', age: 26, pa: 551, h: 133, double: 28, triple: 7, hr: 11, bb: 46, so: 94, hbp: 5, sb: 6, cs: 3, sec: 'SS', fld: 86 },
      { id: 'hinsker01', name: 'Eric Hinske', pos: '3B', bats: 'L', age: 26, pa: 634, h: 141, double: 35, triple: 3, hr: 16, bb: 63, so: 119, hbp: 3, sb: 13, cs: 5, sec: '1B', fld: 63 },
      ...
      { id: 'johnsre02', name: 'Reed Johnson', pos: 'LF', bats: 'R', age: 27, pa: 582, h: 148, double: 26, triple: 2, hr: 11, bb: 27, so: 94, hbp: 17, sb: 6, cs: 3, sec: 'RF', fld: 78, arm: 74 },
      { id: 'wellsve01', name: 'Vernon Wells', pos: 'CF', bats: 'R', age: 25, pa: 590, h: 157, double: 36, triple: 3, hr: 24, bb: 40, so: 75, hbp: 3, sb: 7, cs: 2, sec: 'RF', fld: 75, arm: 67 },
      { id: 'riosal01', name: 'Alex Rios', pos: 'RF', bats: 'R', age: 23, pa: 460, h: 122, double: 24, triple: 7, hr: 1, bb: 31, so: 84, hbp: 2, sb: 15, cs: 3, sec: 'LF', fld: 73, arm: 76, rk: true },
    ...
    bench: [
      { id: 'menecfr01', name: 'Frank Menechino', pos: '2B', bats: 'R', age: 33, pa: 311, h: 67, double: 11, triple: 3, hr: 8, bb: 40, so: 52, hbp: 5, sb: 0, cs: 1, sec: '3B', fld: 67 },
      ...
      { id: 'bergda01', name: 'Dave Berg', pos: 'LF', bats: 'R', age: 33, pa: 162, h: 39, double: 6, triple: 1, hr: 3, bb: 8, so: 27, hbp: 1, sb: 0, cs: 1, sec: '1B', fld: 55, arm: 66 },
    ],
    reserveBatters: [
      { id: 'grossga01', name: 'Gabe Gross', pos: 'LF', bats: 'L', age: 24, pa: 148, h: 27, double: 4, triple: 0, hr: 3, bb: 19, so: 31, hbp: 0, sb: 2, cs: 2, sec: 'RF', fld: 85, arm: 90, rk: true },
      { id: 'clarkho02', name: 'Howie Clark', pos: '1B', bats: 'L', age: 30, pa: 133, h: 31, double: 6, triple: 0, hr: 2, bb: 10, so: 14, hbp: 1, sb: 0, cs: 0, sec: 'LF' },
      { id: 'adamsru01', name: 'Russ Adams', pos: 'SS', bats: 'L', age: 23, pa: 78, h: 22, double: 2, triple: 1, hr: 4, bb: 5, so: 5, hbp: 1, sb: 1, cs: 0, sec: '2B', fld: 56, rk: true },
  ...
  // CWS (CHA 2004)
  {
    ...
    batters: [
      ...
      { id: 'konerpa01', name: 'Paul Konerko', pos: '1B', bats: 'R', age: 28, pa: 643, h: 154, double: 24, triple: 0, hr: 34, bb: 61, so: 89, hbp: 6, sb: 1, cs: 0, sec: '3B', fld: 70 },
      ...
      { id: 'credejo01', name: 'Joe Crede', pos: '3B', bats: 'R', age: 26, pa: 543, h: 125, double: 27, triple: 1, hr: 20, bb: 32, so: 78, hbp: 8, sb: 1, cs: 2, sec: '1B', fld: 63 },
      { id: 'valenjo03', name: 'Jose Valentin', pos: 'SS', bats: 'S', age: 34, pa: 504, h: 103, double: 22, triple: 3, hr: 27, bb: 44, so: 118, hbp: 3, sb: 7, cs: 4, sec: '3B', fld: 79 },
      ...
      { id: 'harriwi01', name: 'Willie Harris', pos: 'DH', bats: 'L', age: 26, pa: 471, h: 103, double: 14, triple: 2, hr: 2, bb: 45, so: 78, hbp: 1, sb: 22, cs: 6, sec: '1B', fld: 75 },
    ],
    bench: [
      ...
      { id: 'ordonma01', name: 'Magglio Ordonez', pos: 'RF', bats: 'R', age: 30, pa: 222, h: 62, double: 14, triple: 1, hr: 10, bb: 18, so: 24, hbp: 2, sb: 2, cs: 2, sec: 'CF', fld: 80, arm: 62 },
    ],
    reserveBatters: [
  ...
  // CLE (CLE 2004)
  {
    ...
    batters: [
      ...
      { id: 'crispco01', name: 'Coco Crisp', pos: 'CF', bats: 'S', age: 24, pa: 538, h: 140, double: 23, triple: 4, hr: 11, bb: 33, so: 67, hbp: 0, sb: 19, cs: 12, sec: 'LF', fld: 63, arm: 67 },
    ...
    bench: [
      { id: 'merlolo01', name: 'Lou Merloni', pos: '1B', bats: 'R', age: 33, pa: 214, h: 51, double: 11, triple: 1, hr: 3, bb: 19, so: 40, hbp: 3, sb: 1, cs: 2, sec: '3B', fld: 66 },
      { id: 'escobal01', name: 'Alex Escobar', pos: 'CF', bats: 'R', age: 25, pa: 179, h: 36, double: 7, triple: 1, hr: 3, bb: 20, so: 46, hbp: 1, sb: 1, cs: 1, sec: 'RF', fld: 72, arm: 90 },
      { id: 'sizemgr01', name: 'Grady Sizemore', pos: 'CF', bats: 'L', age: 21, pa: 159, h: 34, double: 6, triple: 2, hr: 4, bb: 14, so: 34, hbp: 5, sb: 2, cs: 0, sec: 'LF', fld: 76, arm: 59, rk: true },
  ...
  // DET (DET 2004)
  {
    ...
    batters: [
      ...
      { id: 'penaca01', name: 'Carlos Pena', pos: '1B', bats: 'L', age: 26, pa: 561, h: 119, double: 22, triple: 5, hr: 24, bb: 63, so: 141, hbp: 4, sb: 6, cs: 3, sec: '3B', fld: 70 },
      ...
      { id: 'ingebr01', name: 'Brandon Inge', pos: '3B', bats: 'R', age: 27, pa: 458, h: 103, double: 17, triple: 6, hr: 12, bb: 31, so: 89, hbp: 5, sb: 4, cs: 4, sec: '1B', fld: 76 },
      { id: 'guillca01', name: 'Carlos Guillen', pos: 'SS', bats: 'S', age: 28, pa: 583, h: 153, double: 32, triple: 8, hr: 15, bb: 56, so: 88, hbp: 2, sb: 9, cs: 5, sec: '3B', fld: 81 },
      { id: 'whitero02', name: 'Rondell White', pos: 'LF', bats: 'R', age: 32, pa: 498, h: 123, double: 21, triple: 2, hr: 19, bb: 33, so: 77, hbp: 8, sb: 1, cs: 3, sec: 'CF', fld: 66, arm: 64 },
      { id: 'sanchal03', name: 'Alex Sanchez', pos: 'CF', bats: 'L', age: 27, pa: 352, h: 99, double: 11, triple: 4, hr: 1, bb: 13, so: 47, hbp: 1, sb: 26, cs: 13, sec: 'LF', fld: 57, arm: 65 },
      ...
      { id: 'monrocr01', name: 'Craig Monroe', pos: 'DH', bats: 'R', age: 27, pa: 481, h: 121, double: 24, triple: 2, hr: 20, bb: 28, so: 85, hbp: 2, sb: 3, cs: 4, sec: 'LF', fld: 75, arm: 67 },
    ],
    bench: [
      ...
      { id: 'thamema01', name: 'Marcus Thames', pos: 'LF', bats: 'R', age: 27, pa: 184, h: 40, double: 10, triple: 0, hr: 8, bb: 16, so: 42, hbp: 3, sb: 0, cs: 1, sec: 'RF', fld: 84, arm: 74, rk: true },
      { id: 'smithja05', name: 'Jason Smith', pos: '2B', bats: 'L', age: 26, pa: 169, h: 36, double: 6, triple: 4, hr: 5, bb: 8, so: 39, hbp: 1, sb: 2, cs: 2, sec: 'SS', fld: 81, rk: true },
      { id: 'loganno01', name: 'Nook Logan', pos: 'CF', bats: 'S', age: 24, pa: 152, h: 37, double: 5, triple: 2, hr: 0, bb: 13, so: 24, hbp: 0, sb: 8, cs: 2, sec: 'LF', fld: 84, arm: 74, rk: true },
    ],
    reserveBatters: [
      { id: 'vinafe01', name: 'Fernando Vina', pos: '2B', bats: 'L', age: 35, pa: 131, h: 30, double: 6, triple: 1, hr: 1, bb: 7, so: 9, hbp: 4, sb: 2, cs: 2, sec: 'SS', fld: 81 },
  ...
  // KCR (KCA 2004)
  {
    ...
    batters: [
      ...
      { id: 'harveke01', name: 'Ken Harvey', pos: '1B', bats: 'R', age: 26, pa: 494, h: 127, double: 23, triple: 1, hr: 13, bb: 28, so: 89, hbp: 7, sb: 1, cs: 2, sec: '3B', fld: 73 },
      { id: 'graffto01', name: 'Tony Graffanino', pos: '2B', bats: 'R', age: 32, pa: 314, h: 73, double: 13, triple: 2, hr: 5, bb: 27, so: 40, hbp: 3, sb: 9, cs: 1, sec: '3B', fld: 89 },
      ...
      { id: 'dejesda01', name: 'David DeJesus', pos: 'CF', bats: 'L', age: 24, pa: 413, h: 104, double: 15, triple: 4, hr: 7, bb: 33, so: 53, hbp: 10, sb: 8, cs: 11, sec: 'LF', fld: 78, arm: 66, rk: true },
      { id: 'nunezab02', name: 'Abraham Nunez', pos: 'RF', bats: 'S', age: 27, pa: 322, h: 61, double: 10, triple: 1, hr: 6, bb: 33, so: 69, hbp: 0, sb: 1, cs: 3, sec: 'LF', fld: 83, arm: 65, rk: true },
    ...
    bench: [
      ...
      { id: 'relafde01', name: 'Desi Relaford', pos: '3B', bats: 'S', age: 30, pa: 430, h: 92, double: 17, triple: 2, hr: 6, bb: 33, so: 56, hbp: 6, sb: 10, cs: 4, sec: 'SS', fld: 72 },
      ...
      { id: 'gotayru01', name: 'Ruben Gotay', pos: '2B', bats: 'S', age: 21, pa: 166, h: 41, double: 7, triple: 3, hr: 1, bb: 9, so: 36, hbp: 2, sb: 0, cs: 1, sec: 'SS', fld: 56, rk: true },
      { id: 'guielaa01', name: 'Aaron Guiel', pos: 'LF', bats: 'L', age: 31, pa: 157, h: 32, double: 9, triple: 0, hr: 5, bb: 13, so: 32, hbp: 4, sb: 1, cs: 2, sec: 'RF', fld: 80, arm: 77 },
    ],
    reserveBatters: [
      ...
      { id: 'gonzaju03', name: 'Juan Gonzalez', pos: 'RF', bats: 'R', age: 34, pa: 138, h: 37, double: 7, triple: 1, hr: 7, bb: 7, so: 25, hbp: 1, sb: 0, cs: 0, sec: 'LF', fld: 61, arm: 79 },
      { id: 'mateoru01', name: 'Ruben Mateo', pos: 'RF', bats: 'R', age: 26, pa: 137, h: 29, double: 5, triple: 1, hr: 2, bb: 8, so: 29, hbp: 2, sb: 0, cs: 0, sec: 'CF', fld: 74, arm: 87 },
      ...
      { id: 'stinnke01', name: 'Kelly Stinnett', pos: 'C', bats: 'R', age: 34, pa: 69, h: 15, double: 3, triple: 0, hr: 2, bb: 5, so: 17, hbp: 1, sb: 0, cs: 0, fld: 63, arm: 70 },
    ],
    pitchers: [
      ...
      { id: 'gobblji01', name: 'Jimmy Gobble', role: 'SP', throws: 'L', age: 22, g: 25, gs: 24, outs: 444, h: 157, hr: 24, bb: 43, so: 56, hbp: 5, er: 85, w: 9, l: 8, sv: 0, fld: 55 },
  ...
  // MIN (MIN 2004)
  {
    ...
    batters: [
      ...
      { id: 'cuddymi01', name: 'Michael Cuddyer', pos: '2B', bats: 'R', age: 25, pa: 382, h: 88, double: 19, triple: 2, hr: 12, bb: 36, so: 74, hbp: 3, sb: 5, cs: 4, sec: '3B', fld: 60 },
      ...
      { id: 'fordle01', name: 'Lew Ford', pos: 'LF', bats: 'R', age: 27, pa: 658, h: 172, double: 33, triple: 4, hr: 16, bb: 67, so: 75, hbp: 13, sb: 20, cs: 2, sec: 'CF', fld: 77, arm: 70, rk: true },
      ...
      { id: 'jonesja04', name: 'Jacque Jones', pos: 'RF', bats: 'L', age: 29, pa: 608, h: 156, double: 29, triple: 1, hr: 22, bb: 34, so: 118, hbp: 7, sb: 12, cs: 7, sec: 'LF', fld: 80, arm: 64 },
      { id: 'stewash01', name: 'Shannon Stewart', pos: 'DH', bats: 'R', age: 30, pa: 430, h: 116, double: 24, triple: 2, hr: 9, bb: 40, so: 43, hbp: 3, sb: 5, cs: 3, sec: 'LF', fld: 54, arm: 64 },
    ],
    bench: [
      ...
      { id: 'morneju01', name: 'Justin Morneau', pos: '1B', bats: 'L', age: 23, pa: 312, h: 74, double: 16, triple: 0, hr: 17, bb: 27, so: 59, hbp: 2, sb: 0, cs: 0, sec: '3B', fld: 72, rk: true },
  ...
  // HOU (HOU 2004)
  {
    ...
    batters: [
      ...
      { id: 'bagweje01', name: 'Jeff Bagwell', pos: '1B', bats: 'R', age: 36, pa: 679, h: 157, double: 29, triple: 2, hr: 31, bb: 93, so: 125, hbp: 8, sb: 8, cs: 4, fld: 72 },
      ...
      { id: 'ensbemo01', name: 'Morgan Ensberg', pos: '3B', bats: 'R', age: 28, pa: 456, h: 113, double: 18, triple: 2, hr: 16, bb: 42, so: 54, hbp: 3, sb: 6, cs: 3, sec: '1B', fld: 61 },
      ...
      { id: 'biggicr01', name: 'Craig Biggio', pos: 'LF', bats: 'R', age: 38, pa: 700, h: 169, double: 44, triple: 1, hr: 20, bb: 47, so: 104, hbp: 19, sb: 9, cs: 3, sec: 'CF', fld: 63, arm: 64 },
      ...
      { id: 'berkmla01', name: 'Lance Berkman', pos: 'RF', bats: 'S', age: 28, pa: 687, h: 168, double: 38, triple: 4, hr: 31, bb: 119, so: 108, hbp: 9, sb: 8, cs: 5, sec: 'LF', fld: 57, arm: 71 },
      { id: 'lambmi01', name: 'Mike Lamb', pos: 'DH', bats: 'L', age: 28, pa: 312, h: 77, double: 12, triple: 2, hr: 12, bb: 29, so: 57, hbp: 1, sb: 1, cs: 1, sec: '3B', fld: 72 },
    ],
    bench: [
  ...
  // LAA (ANA 2004)
  {
    ...
    batters: [
      ...
      { id: 'erstada01', name: 'Darin Erstad', pos: '1B', bats: 'L', age: 30, pa: 543, h: 141, double: 24, triple: 2, hr: 7, bb: 33, so: 70, hbp: 4, sb: 17, cs: 2, sec: 'LF', fld: 70 },
      { id: 'kennead01', name: 'Adam Kennedy', pos: '2B', bats: 'L', age: 28, pa: 533, h: 133, double: 21, triple: 4, hr: 11, bb: 40, so: 86, hbp: 11, sb: 18, cs: 6, sec: 'SS', fld: 63 },
      { id: 'figgich01', name: 'Chone Figgins', pos: '3B', bats: 'S', age: 26, pa: 638, h: 170, double: 22, triple: 15, hr: 4, bb: 48, so: 94, hbp: 0, sb: 34, cs: 14, sec: '2B', fld: 57 },
      { id: 'eckstda01', name: 'David Eckstein', pos: 'SS', bats: 'R', age: 29, pa: 637, h: 153, double: 24, triple: 2, hr: 3, bb: 42, so: 49, hbp: 17, sb: 18, cs: 7, sec: '2B', fld: 60 },
      ...
      { id: 'guerrvl01', name: 'Vladimir Guerrero', pos: 'RF', bats: 'R', age: 29, pa: 680, h: 200, double: 36, triple: 3, hr: 38, bb: 68, so: 73, hbp: 8, sb: 19, cs: 7, sec: 'LF', fld: 74, arm: 75 },
      { id: 'davanje02', name: 'Jeff DaVanon', pos: 'DH', bats: 'S', age: 30, pa: 337, h: 80, double: 13, triple: 3, hr: 9, bb: 42, so: 53, hbp: 0, sb: 17, cs: 4, sec: 'RF', fld: 67, arm: 66 },
    ],
    bench: [
      ...
      { id: 'quinlro01', name: 'Robb Quinlan', pos: '3B', bats: 'R', age: 27, pa: 177, h: 53, double: 12, triple: 1, hr: 4, bb: 13, so: 27, hbp: 1, sb: 3, cs: 2, sec: '1B', fld: 60, rk: true },
      { id: 'kotchca01', name: 'Casey Kotchman', pos: '1B', bats: 'L', age: 21, pa: 128, h: 26, double: 6, triple: 0, hr: 0, bb: 7, so: 11, hbp: 4, sb: 3, cs: 0, sec: '3B', fld: 58, rk: true },
    ],
    reserveBatters: [
      ...
      { id: 'amezaal01', name: 'Alfredo Amezaga', pos: 'SS', bats: 'S', age: 26, pa: 105, h: 18, double: 3, triple: 1, hr: 2, bb: 5, so: 22, hbp: 2, sb: 3, cs: 2, sec: '3B', fld: 85 },
  ...
  // OAK (OAK 2004)
  {
    ...
    batters: [
      ...
      { id: 'hattesc01', name: 'Scott Hatteberg', pos: '1B', bats: 'L', age: 34, pa: 638, h: 151, double: 31, triple: 1, hr: 14, bb: 71, so: 52, hbp: 7, sb: 0, cs: 0, fld: 67 },
      ...
      { id: 'chaveer01', name: 'Eric Chavez', pos: '3B', bats: 'L', age: 26, pa: 577, h: 138, double: 26, triple: 2, hr: 28, bb: 74, so: 93, hbp: 2, sb: 7, cs: 3, sec: '1B', fld: 85 },
      { id: 'crosbbo01', name: 'Bobby Crosby', pos: 'SS', bats: 'R', age: 24, pa: 623, h: 128, double: 33, triple: 1, hr: 22, bb: 58, so: 142, hbp: 10, sb: 7, cs: 3, sec: '2B', fld: 81, rk: true },
      ...
      { id: 'dyeje01', name: 'Jermaine Dye', pos: 'RF', bats: 'R', age: 30, pa: 590, h: 130, double: 26, triple: 3, hr: 21, bb: 52, so: 120, hbp: 6, sb: 3, cs: 1, sec: 'LF', fld: 68, arm: 62 },
    ...
    bench: [
      { id: 'mclemma01', name: 'Mark McLemore', pos: '2B', bats: 'S', age: 39, pa: 295, h: 62, double: 13, triple: 1, hr: 3, bb: 38, so: 45, hbp: 1, sb: 4, cs: 4, sec: '3B', fld: 82 },
      ...
      { id: 'karroer01', name: 'Eric Karros', pos: '1B', bats: 'R', age: 36, pa: 111, h: 27, double: 5, triple: 0, hr: 3, bb: 8, so: 15, hbp: 0, sb: 1, cs: 0, fld: 76 },
  ...
  // SEA (SEA 2004)
  {
    ...
    batters: [
      ...
      { id: 'olerujo01', name: 'John Olerud', pos: '1B', bats: 'L', age: 35, pa: 500, h: 114, double: 25, triple: 0, hr: 10, bb: 65, so: 56, hbp: 6, sb: 0, cs: 0, fld: 75 },
      { id: 'boonebr01', name: 'Bret Boone', pos: '2B', bats: 'R', age: 35, pa: 658, h: 159, double: 31, triple: 2, hr: 27, bb: 58, so: 123, hbp: 5, sb: 12, cs: 4, fld: 55 },
      ...
      { id: 'winnra01', name: 'Randy Winn', pos: 'CF', bats: 'S', age: 30, pa: 703, h: 184, double: 37, triple: 6, hr: 13, bb: 51, so: 106, hbp: 8, sb: 23, cs: 7, sec: 'LF', fld: 79, arm: 66 },
      { id: 'suzukic01', name: 'Ichiro Suzuki', pos: 'RF', bats: 'L', age: 30, pa: 762, h: 242, double: 27, triple: 7, hr: 10, bb: 49, so: 66, hbp: 5, sb: 35, cs: 11, sec: 'LF', fld: 83, arm: 72 },
    ...
    bench: [
      { id: 'cabrejo02', name: 'Jolbert Cabrera', pos: '3B', bats: 'R', age: 31, pa: 391, h: 96, double: 24, triple: 2, hr: 6, bb: 17, so: 67, hbp: 9, sb: 8, cs: 3, sec: '2B', fld: 85 },
      ...
      { id: 'lopezjo01', name: 'Jose Lopez', pos: 'SS', bats: 'R', age: 20, pa: 218, h: 48, double: 13, triple: 0, hr: 5, bb: 8, so: 31, hbp: 1, sb: 0, cs: 1, sec: '2B', fld: 56, rk: true },
      { id: 'bloomwi01', name: 'Willie Bloomquist', pos: '3B', bats: 'R', age: 26, pa: 201, h: 47, double: 9, triple: 1, hr: 1, bb: 14, so: 42, hbp: 0, sb: 9, cs: 2, sec: 'SS', fld: 59 },
      { id: 'jacobbu02', name: 'Bucky Jacobsen', pos: '1B', bats: 'R', age: 28, pa: 176, h: 44, double: 9, triple: 0, hr: 9, bb: 14, so: 47, hbp: 1, sb: 0, cs: 0, sec: '3B', fld: 57, rk: true },
    ],
    reserveBatters: [
      ...
      { id: 'bocachi01', name: 'Hiram Bocachica', pos: 'CF', bats: 'R', age: 28, pa: 107, h: 21, double: 5, triple: 0, hr: 3, bb: 9, so: 27, hbp: 1, sb: 4, cs: 3, sec: 'LF', fld: 66, arm: 59 },
  ...
  // TEX (TEX 2004)
  {
    ...
    batters: [
      ...
      { id: 'teixema01', name: 'Mark Teixeira', pos: '1B', bats: 'S', age: 24, pa: 625, h: 150, double: 33, triple: 3, hr: 34, bb: 60, so: 121, hbp: 12, sb: 3, cs: 1, sec: '3B', fld: 70 },
      ...
      { id: 'blaloha01', name: 'Hank Blalock', pos: '3B', bats: 'L', age: 23, pa: 713, h: 179, double: 38, triple: 3, hr: 32, bb: 67, so: 138, hbp: 4, sb: 2, cs: 2, sec: '1B', fld: 65 },
      { id: 'youngmi02', name: 'Michael Young', pos: 'SS', bats: 'R', age: 27, pa: 739, h: 208, double: 33, triple: 9, hr: 18, bb: 42, so: 101, hbp: 1, sb: 12, cs: 3, sec: '2B', fld: 65 },
      { id: 'delluda01', name: 'David Dellucci', pos: 'LF', bats: 'L', age: 30, pa: 387, h: 79, double: 15, triple: 2, hr: 13, bb: 43, so: 88, hbp: 5, sb: 11, cs: 3, sec: 'RF', fld: 76, arm: 58 },
      { id: 'nixla01', name: 'Laynce Nix', pos: 'CF', bats: 'L', age: 23, pa: 400, h: 93, double: 20, triple: 3, hr: 15, bb: 22, so: 112, hbp: 2, sb: 2, cs: 1, sec: 'RF', fld: 64, arm: 67 },
      { id: 'matthga02', name: 'Gary Matthews', pos: 'RF', bats: 'S', age: 29, pa: 317, h: 74, double: 18, triple: 1, hr: 7, bb: 30, so: 60, hbp: 1, sb: 7, cs: 3, sec: 'CF', fld: 86, arm: 76 },
    ...
    bench: [
      ...
      { id: 'jordabr01', name: 'Brian Jordan', pos: 'RF', bats: 'R', age: 37, pa: 233, h: 55, double: 11, triple: 1, hr: 6, bb: 17, so: 34, hbp: 2, sb: 1, cs: 1, sec: 'LF', fld: 79, arm: 62 },
  ...
  // ATL (ATL 2004)
  {
    ...
    batters: [
      ...
      { id: 'francju01', name: 'Julio Franco', pos: '1B', bats: 'R', age: 45, pa: 361, h: 96, double: 17, triple: 3, hr: 6, bb: 37, so: 69, hbp: 1, sb: 3, cs: 2, fld: 75 },
      { id: 'gilesma01', name: 'Marcus Giles', pos: '2B', bats: 'R', age: 26, pa: 434, h: 116, double: 27, triple: 2, hr: 11, bb: 39, so: 63, hbp: 8, sb: 12, cs: 3, sec: 'SS', fld: 76 },
      ...
      { id: 'furcara01', name: 'Rafael Furcal', pos: 'SS', bats: 'S', age: 26, pa: 632, h: 161, double: 27, triple: 7, hr: 12, bb: 52, so: 75, hbp: 2, sb: 26, cs: 6, sec: '2B', fld: 76 },
      { id: 'thomach01', name: 'Charles Thomas', pos: 'LF', bats: 'L', age: 25, pa: 267, h: 68, double: 8, triple: 4, hr: 7, bb: 21, so: 45, hbp: 9, sb: 3, cs: 1, sec: 'RF', fld: 80, arm: 82, rk: true },
      { id: 'jonesan01', name: 'Andruw Jones', pos: 'CF', bats: 'R', age: 27, pa: 646, h: 153, double: 32, triple: 3, hr: 32, bb: 66, so: 136, hbp: 5, sb: 6, cs: 4, sec: 'RF', fld: 75, arm: 72 },
      ...
      { id: 'larocad01', name: 'Adam LaRoche', pos: 'DH', bats: 'L', age: 24, pa: 356, h: 90, double: 27, triple: 1, hr: 13, bb: 27, so: 78, hbp: 1, sb: 0, cs: 0, sec: '1B', fld: 65, rk: true },
    ],
    bench: [
      { id: 'derosma01', name: 'Mark DeRosa', pos: '3B', bats: 'R', age: 29, pa: 345, h: 80, double: 16, triple: 0, hr: 5, bb: 21, so: 53, hbp: 4, sb: 1, cs: 2, sec: 'SS', fld: 60 },
      { id: 'greenni01', name: 'Nick Green', pos: '2B', bats: 'R', age: 25, pa: 290, h: 72, double: 15, triple: 3, hr: 3, bb: 12, so: 63, hbp: 4, sb: 1, cs: 2, sec: 'SS', fld: 75, rk: true },
      { id: 'marreel01', name: 'Eli Marrero', pos: 'LF', bats: 'R', age: 30, pa: 280, h: 72, double: 15, triple: 1, hr: 10, bb: 23, so: 48, hbp: 1, sb: 5, cs: 1, sec: 'RF', fld: 74, arm: 79 },
  ...
  // MIA (FLO 2004)
  {
    ...
    batters: [
      ...
      { id: 'choihe01', name: 'Hee-Seop Choi', pos: '1B', bats: 'L', age: 25, pa: 416, h: 82, double: 23, triple: 1, hr: 15, bb: 63, so: 103, hbp: 5, sb: 1, cs: 0, sec: '3B', fld: 62 },
      ...
      { id: 'coninje01', name: 'Jeff Conine', pos: 'LF', bats: 'R', age: 38, pa: 579, h: 146, double: 33, triple: 2, hr: 16, bb: 44, so: 72, hbp: 3, sb: 5, cs: 2, sec: '1B', fld: 80, arm: 72 },
      { id: 'pierrju01', name: 'Juan Pierre', pos: 'CF', bats: 'L', age: 26, pa: 748, h: 212, double: 24, triple: 9, hr: 2, bb: 47, so: 39, hbp: 7, sb: 53, cs: 21, sec: 'LF', fld: 62, arm: 63 },
      { id: 'cabremi01', name: 'Miguel Cabrera', pos: 'RF', bats: 'R', age: 21, pa: 685, h: 174, double: 34, triple: 2, hr: 31, bb: 63, so: 153, hbp: 5, sb: 4, cs: 2, sec: 'LF', fld: 56, arm: 73 },
      { id: 'easleda01', name: 'Damion Easley', pos: 'DH', bats: 'R', age: 34, pa: 257, h: 51, double: 15, triple: 1, hr: 7, bb: 20, so: 36, hbp: 7, sb: 2, cs: 1, sec: '3B', fld: 57 },
    ],
    bench: [
      ...
      { id: 'treanma01', name: 'Matt Treanor', pos: 'C', bats: 'R', age: 28, pa: 61, h: 13, double: 2, triple: 0, hr: 0, bb: 4, so: 13, hbp: 2, sb: 0, cs: 0, sec: '1B', fld: 67, arm: 63, rk: true },
    ],
    reserveBatters: [
  ...
  // NYM (NYN 2004)
  {
    ...
    batters: [
      ...
      { id: 'piazzmi01', name: 'Mike Piazza', pos: '1B', bats: 'R', age: 35, pa: 528, h: 125, double: 22, triple: 0, hr: 23, bb: 65, so: 78, hbp: 2, sb: 0, cs: 1, fld: 58 },
      ...
      { id: 'matsuka01', name: 'Kazuo Matsui', pos: 'SS', bats: 'S', age: 28, pa: 509, h: 125, double: 32, triple: 2, hr: 7, bb: 40, so: 97, hbp: 2, sb: 14, cs: 3, sec: '2B', fld: 73, rk: true },
      { id: 'floydcl01', name: 'Cliff Floyd', pos: 'LF', bats: 'L', age: 31, pa: 457, h: 108, double: 28, triple: 1, hr: 19, bb: 52, so: 88, hbp: 8, sb: 9, cs: 3, sec: '1B', fld: 65, arm: 69 },
      { id: 'camermi01', name: 'Mike Cameron', pos: 'CF', bats: 'R', age: 31, pa: 562, h: 117, double: 28, triple: 3, hr: 24, bb: 62, so: 139, hbp: 6, sb: 21, cs: 6, sec: 'RF', fld: 74, arm: 68 },
      ...
      { id: 'spencsh01', name: 'Shane Spencer', pos: 'DH', bats: 'R', age: 32, pa: 204, h: 47, double: 9, triple: 1, hr: 5, bb: 18, so: 40, hbp: 2, sb: 2, cs: 0, sec: 'LF', fld: 85, arm: 68 },
    ],
    bench: [
      { id: 'zeileto01', name: 'Todd Zeile', pos: '1B', bats: 'R', age: 38, pa: 396, h: 84, double: 15, triple: 1, hr: 11, bb: 43, so: 73, hbp: 2, sb: 0, cs: 0, sec: '3B', fld: 69 },
      { id: 'valener01', name: 'Eric Valent', pos: 'LF', bats: 'L', age: 27, pa: 300, h: 71, double: 14, triple: 2, hr: 12, bb: 26, so: 61, hbp: 1, sb: 0, cs: 1, sec: '1B', fld: 67, arm: 64, rk: true },
    ...
    reserveBatters: [
      ...
      { id: 'mcewijo01', name: 'Joe McEwing', pos: '2B', bats: 'R', age: 31, pa: 154, h: 33, double: 5, triple: 0, hr: 1, bb: 10, so: 31, hbp: 1, sb: 3, cs: 1, sec: 'SS', fld: 85 },
      { id: 'delgawi01', name: 'Wilson Delgado', pos: 'SS', bats: 'S', age: 31, pa: 147, h: 35, double: 4, triple: 1, hr: 2, bb: 13, so: 26, hbp: 0, sb: 1, cs: 0, sec: '2B', fld: 73 },
      { id: 'willige02', name: 'Gerald Williams', pos: 'LF', bats: 'R', age: 37, pa: 138, h: 27, double: 7, triple: 2, hr: 3, bb: 8, so: 25, hbp: 0, sb: 4, cs: 1, sec: 'CF', fld: 64, arm: 79 },
  ...
  // PHI (PHI 2004)
  {
    ...
    batters: [
      ...
      { id: 'polanpl01', name: 'Placido Polanco', pos: '2B', bats: 'R', age: 28, pa: 555, h: 147, double: 26, triple: 1, hr: 15, bb: 31, so: 39, hbp: 10, sb: 9, cs: 3, sec: '3B', fld: 82 },
      { id: 'bellda01', name: 'David Bell', pos: '3B', bats: 'R', age: 31, pa: 603, h: 140, double: 30, triple: 1, hr: 16, bb: 59, so: 74, hbp: 7, sb: 1, cs: 1, sec: '2B', fld: 74 },
      { id: 'rolliji01', name: 'Jimmy Rollins', pos: 'SS', bats: 'S', age: 25, pa: 725, h: 180, double: 42, triple: 10, hr: 12, bb: 57, so: 93, hbp: 2, sb: 27, cs: 11, sec: '2B', fld: 63 },
      ...
      { id: 'byrdma01', name: 'Marlon Byrd', pos: 'CF', bats: 'R', age: 26, pa: 378, h: 91, double: 16, triple: 2, hr: 5, bb: 26, so: 66, hbp: 6, sb: 5, cs: 2, sec: 'LF', fld: 64, arm: 68 },
    ...
    bench: [
      { id: 'utleych01', name: 'Chase Utley', pos: '2B', bats: 'L', age: 25, pa: 287, h: 68, double: 13, triple: 2, hr: 11, bb: 17, so: 40, hbp: 4, sb: 4, cs: 1, sec: 'SS', fld: 67 },
      { id: 'ledeeri01', name: 'Ricky Ledee', pos: 'CF', bats: 'L', age: 30, pa: 205, h: 42, double: 10, triple: 1, hr: 8, bb: 26, so: 44, hbp: 1, sb: 1, cs: 0, sec: 'LF', fld: 65, arm: 78 },
      ...
      { id: 'glanvdo01', name: 'Doug Glanville', pos: 'CF', bats: 'R', age: 33, pa: 175, h: 39, double: 3, triple: 1, hr: 3, bb: 8, so: 21, hbp: 0, sb: 6, cs: 0, sec: 'LF', fld: 84, arm: 59 },
  ...
  // WSH (MON 2004)
  {
    ...
    batters: [
      ...
      { id: 'wilkebr01', name: 'Brad Wilkerson', pos: '1B', bats: 'L', age: 27, pa: 688, h: 150, double: 38, triple: 4, hr: 27, bb: 103, so: 165, hbp: 4, sb: 13, cs: 8, sec: 'LF', fld: 77 },
      { id: 'vidrojo01', name: 'Jose Vidro', pos: '2B', bats: 'S', age: 29, pa: 467, h: 124, double: 27, triple: 0, hr: 13, bb: 49, so: 43, hbp: 2, sb: 2, cs: 1, sec: '3B', fld: 63 },
    ...
    bench: [
      { id: 'gonzaal01', name: 'Alex Gonzalez', pos: 'SS', bats: 'R', age: 31, pa: 304, h: 64, double: 18, triple: 1, hr: 9, bb: 21, so: 65, hbp: 2, sb: 2, cs: 2, sec: '2B', fld: 67 },
      { id: 'johnsni01', name: 'Nick Johnson', pos: '1B', bats: 'L', age: 25, pa: 295, h: 64, double: 14, triple: 0, hr: 9, bb: 42, so: 53, hbp: 5, sb: 4, cs: 2, sec: '3B', fld: 70 },
      ...
      { id: 'izturma01', name: 'Maicer Izturis', pos: 'SS', bats: 'S', age: 23, pa: 121, h: 22, double: 5, triple: 2, hr: 1, bb: 10, so: 20, hbp: 2, sb: 4, cs: 0, sec: '2B', fld: 75, rk: true },
    ],
    reserveBatters: [
      { id: 'calloro01', name: 'Ron Calloway', pos: 'RF', bats: 'L', age: 27, pa: 91, h: 18, double: 4, triple: 0, hr: 2, bb: 5, so: 20, hbp: 0, sb: 2, cs: 0, sec: 'LF', fld: 64, arm: 58 },
  ...
  // CHC (CHN 2004)
  {
    ...
    batters: [
      ...
      { id: 'leede02', name: 'Derrek Lee', pos: '1B', bats: 'R', age: 28, pa: 688, h: 162, double: 36, triple: 2, hr: 32, bb: 81, so: 138, hbp: 8, sb: 17, cs: 7, sec: '3B', fld: 77 },
      { id: 'walketo04', name: 'Todd Walker', pos: '2B', bats: 'L', age: 31, pa: 424, h: 107, double: 23, triple: 3, hr: 11, bb: 36, so: 45, hbp: 2, sb: 1, cs: 2, sec: '3B', fld: 55 },
      { id: 'ramirar01', name: 'Aramis Ramirez', pos: '3B', bats: 'R', age: 26, pa: 606, h: 158, double: 30, triple: 1, hr: 29, bb: 42, so: 78, hbp: 6, sb: 1, cs: 2, sec: '1B', fld: 57 },
      { id: 'garcino01', name: 'Nomar Garciaparra', pos: 'SS', bats: 'R', age: 30, pa: 354, h: 99, double: 21, triple: 4, hr: 12, bb: 21, so: 30, hbp: 5, sb: 6, cs: 2, sec: '2B', fld: 58 },
      { id: 'aloumo01', name: 'Moises Alou', pos: 'LF', bats: 'R', age: 37, pa: 675, h: 172, double: 35, triple: 2, hr: 31, bb: 66, so: 77, hbp: 2, sb: 4, cs: 0, sec: 'RF', fld: 58, arm: 68 },
      { id: 'patteco01', name: 'Corey Patterson', pos: 'CF', bats: 'L', age: 24, pa: 687, h: 173, double: 33, triple: 8, hr: 23, bb: 37, so: 162, hbp: 5, sb: 30, cs: 8, sec: 'LF', fld: 59, arm: 69 },
    ...
    reserveBatters: [
      { id: 'ordonre01', name: 'Rey Ordonez', pos: 'SS', bats: 'R', age: 33, pa: 67, h: 16, double: 4, triple: 0, hr: 1, bb: 2, so: 8, hbp: 0, sb: 0, cs: 0, sec: '2B', fld: 60 },
    ],
    pitchers: [
      { id: 'maddugr01', name: 'Greg Maddux', role: 'SP', throws: 'R', age: 38, g: 33, gs: 33, outs: 638, h: 217, hr: 28, bb: 35, so: 137, hbp: 8, er: 89, w: 16, l: 11, sv: 0, fld: 88 },
  ...
  // CIN (CIN 2004)
  {
    ...
    batters: [
      ...
      { id: 'caseyse01', name: 'Sean Casey', pos: '1B', bats: 'L', age: 29, pa: 633, h: 174, double: 34, triple: 2, hr: 18, bb: 49, so: 47, hbp: 7, sb: 3, cs: 0, sec: '3B', fld: 62 },
      ...
      { id: 'freelry01', name: 'Ryan Freel', pos: '3B', bats: 'R', age: 28, pa: 592, h: 142, double: 21, triple: 7, hr: 5, bb: 62, so: 82, hbp: 13, sb: 37, cs: 11, sec: '2B', fld: 90 },
      ...
      { id: 'dunnad01', name: 'Adam Dunn', pos: 'LF', bats: 'L', age: 24, pa: 681, h: 140, double: 29, triple: 1, hr: 41, bb: 112, so: 188, hbp: 8, sb: 10, cs: 3, sec: '1B', fld: 61, arm: 73 },
      { id: 'griffke02', name: 'Ken Griffey', pos: 'CF', bats: 'L', age: 34, pa: 348, h: 75, double: 18, triple: 0, hr: 19, bb: 44, so: 68, hbp: 4, sb: 1, cs: 0, fld: 66, arm: 70 },
      ...
      { id: 'cruzja01', name: 'Jacob Cruz', pos: 'DH', bats: 'L', age: 31, pa: 167, h: 34, double: 7, triple: 0, hr: 3, bb: 17, so: 41, hbp: 4, sb: 1, cs: 0, sec: 'RF', fld: 68, arm: 67 },
    ],
    bench: [
      { id: 'penawi01', name: 'Wily Mo Pena', pos: 'RF', bats: 'R', age: 22, pa: 364, h: 83, double: 10, triple: 1, hr: 22, bb: 22, so: 109, hbp: 6, sb: 5, cs: 2, sec: 'CF', fld: 85, arm: 71 },
      ...
      { id: 'larsobr01', name: 'Brandon Larson', pos: '3B', bats: 'R', age: 28, pa: 135, h: 22, double: 4, triple: 0, hr: 3, bb: 15, so: 36, hbp: 1, sb: 2, cs: 1, sec: '1B', fld: 59 },
    ],
    reserveBatters: [
      { id: 'hummeti01', name: 'Tim Hummel', pos: '3B', bats: 'R', age: 25, pa: 125, h: 24, double: 5, triple: 0, hr: 2, bb: 9, so: 17, hbp: 1, sb: 1, cs: 0, sec: '1B', fld: 78, rk: true },
      { id: 'braggda01', name: 'Darren Bragg', pos: 'CF', bats: 'L', age: 34, pa: 112, h: 23, double: 4, triple: 1, hr: 2, bb: 10, so: 26, hbp: 1, sb: 1, cs: 0, sec: 'RF', fld: 85, arm: 77 },
      { id: 'machaan01', name: 'Anderson Machado', pos: 'SS', bats: 'S', age: 23, pa: 66, h: 15, double: 5, triple: 1, hr: 0, bb: 10, so: 26, hbp: 0, sb: 3, cs: 1, sec: '2B', fld: 44, rk: true },
  ...
  // MIL (MIL 2004)
  {
    ...
    batters: [
      ...
      { id: 'overbly01', name: 'Lyle Overbay', pos: '1B', bats: 'L', age: 27, pa: 668, h: 170, double: 51, triple: 1, hr: 14, bb: 80, so: 134, hbp: 3, sb: 2, cs: 1, sec: '3B', fld: 71 },
      { id: 'ginteke01', name: 'Keith Ginter', pos: '2B', bats: 'R', age: 28, pa: 437, h: 99, double: 21, triple: 2, hr: 17, bb: 39, so: 95, hbp: 10, sb: 5, cs: 1, sec: '3B', fld: 50 },
      { id: 'helmswe01', name: 'Wes Helms', pos: '3B', bats: 'R', age: 28, pa: 306, h: 71, double: 13, triple: 0, hr: 9, bb: 23, so: 69, hbp: 5, sb: 0, cs: 1, sec: '1B', fld: 56 },
      { id: 'counscr01', name: 'Craig Counsell', pos: 'SS', bats: 'L', age: 33, pa: 545, h: 117, double: 18, triple: 4, hr: 3, bb: 59, so: 73, hbp: 4, sb: 15, cs: 5, sec: '2B', fld: 65 },
      { id: 'jenkige01', name: 'Geoff Jenkins', pos: 'LF', bats: 'L', age: 29, pa: 681, h: 166, double: 37, triple: 5, hr: 29, bb: 55, so: 150, hbp: 11, sb: 2, cs: 1, sec: 'RF', fld: 67, arm: 72 },
      ...
      { id: 'clarkbr02', name: 'Brady Clark', pos: 'RF', bats: 'R', age: 31, pa: 419, h: 99, double: 20, triple: 1, hr: 7, bb: 42, so: 48, hbp: 9, sb: 15, cs: 6, sec: 'LF', fld: 86, arm: 67 },
      { id: 'grievbe01', name: 'Ben Grieve', pos: 'DH', bats: 'L', age: 28, pa: 294, h: 62, double: 15, triple: 0, hr: 8, bb: 40, so: 66, hbp: 4, sb: 1, cs: 0, sec: 'RF', fld: 61, arm: 58 },
    ],
    bench: [
      { id: 'hallbi03', name: 'Bill Hall', pos: '2B', bats: 'R', age: 24, pa: 415, h: 94, double: 21, triple: 4, hr: 10, bb: 20, so: 111, hbp: 1, sb: 10, cs: 6, sec: 'SS', fld: 51 },
      ...
      { id: 'branyru01', name: 'Russell Branyan', pos: '3B', bats: 'L', age: 28, pa: 182, h: 36, double: 9, triple: 1, hr: 10, bb: 22, so: 65, hbp: 1, sb: 1, cs: 0, sec: '1B', fld: 84 },
    ...
    pitchers: [
      ...
      { id: 'santovi01', name: 'Victor Santos', role: 'SP', throws: 'R', age: 27, g: 31, gs: 28, outs: 462, h: 170, hr: 19, bb: 63, so: 112, hbp: 6, er: 91, w: 11, l: 12, sv: 0, fld: 54 },
  ...
  // PIT (PIT 2004)
  {
    ...
    batters: [
      ...
      { id: 'wardda01', name: 'Daryle Ward', pos: '1B', bats: 'L', age: 29, pa: 321, h: 73, double: 16, triple: 1, hr: 11, bb: 20, so: 49, hbp: 2, sb: 0, cs: 1, sec: 'LF', fld: 64 },
      ...
      { id: 'wilsoja02', name: 'Jack Wilson', pos: 'SS', bats: 'R', age: 26, pa: 693, h: 182, double: 33, triple: 8, hr: 10, bb: 33, so: 77, hbp: 4, sb: 7, cs: 4, sec: '2B', fld: 80 },
    ...
    bench: [
      { id: 'mackoro01', name: 'Rob Mackowiak', pos: 'RF', bats: 'L', age: 28, pa: 555, h: 123, double: 21, triple: 6, hr: 18, bb: 49, so: 127, hbp: 7, sb: 13, cs: 3, sec: 'CF', fld: 58, arm: 78 },
      { id: 'hillbo01', name: 'Bobby Hill', pos: '2B', bats: 'S', age: 26, pa: 267, h: 61, double: 7, triple: 2, hr: 3, bb: 21, so: 42, hbp: 10, sb: 2, cs: 3, sec: '3B', fld: 86 },
      { id: 'nunezab01', name: 'Abraham Nunez', pos: '2B', bats: 'S', age: 28, pa: 195, h: 42, double: 7, triple: 2, hr: 2, bb: 14, so: 32, hbp: 1, sb: 3, cs: 2, sec: 'SS', fld: 92 },
  ...
  // STL (SLN 2004)
  {
    ...
    batters: [
      ...
      { id: 'pujolal01', name: 'Albert Pujols', pos: '1B', bats: 'R', age: 24, pa: 692, h: 201, double: 50, triple: 2, hr: 43, bb: 81, so: 60, hbp: 8, sb: 5, cs: 4, sec: 'LF', fld: 73 },
      ...
      { id: 'rolensc01', name: 'Scott Rolen', pos: '3B', bats: 'R', age: 29, pa: 593, h: 149, double: 35, triple: 3, hr: 30, bb: 71, so: 92, hbp: 11, sb: 7, cs: 3, sec: '1B', fld: 84 },
      ...
      { id: 'edmonji01', name: 'Jim Edmonds', pos: 'CF', bats: 'L', age: 34, pa: 612, h: 149, double: 37, triple: 3, hr: 41, bb: 96, so: 148, hbp: 5, sb: 5, cs: 3, sec: 'LF', fld: 63, arm: 75 },
      { id: 'sandere02', name: 'Reggie Sanders', pos: 'RF', bats: 'R', age: 36, pa: 487, h: 118, double: 25, triple: 4, hr: 24, bb: 36, so: 112, hbp: 5, sb: 18, cs: 5, sec: 'LF', fld: 63, arm: 68 },
      { id: 'walkela01', name: 'Larry Walker', pos: 'DH', bats: 'L', age: 37, pa: 316, h: 78, double: 17, triple: 4, hr: 13, bb: 49, so: 50, hbp: 6, sb: 5, cs: 2, sec: 'RF', fld: 65, arm: 71 },
    ],
    bench: [
      { id: 'mabryjo01', name: 'John Mabry', pos: 'LF', bats: 'L', age: 33, pa: 275, h: 67, double: 12, triple: 0, hr: 12, bb: 26, so: 58, hbp: 2, sb: 0, cs: 1, sec: '1B', fld: 66, arm: 58 },
      ...
      { id: 'cedenro01', name: 'Roger Cedeno', pos: 'RF', bats: 'S', age: 29, pa: 223, h: 54, double: 9, triple: 2, hr: 3, bb: 17, so: 38, hbp: 0, sb: 7, cs: 2, sec: 'LF', fld: 52, arm: 67 },
      ...
      { id: 'lunahe01', name: 'Hector Luna', pos: 'SS', bats: 'R', age: 24, pa: 192, h: 43, double: 7, triple: 2, hr: 3, bb: 13, so: 37, hbp: 2, sb: 6, cs: 3, sec: '2B', fld: 90, rk: true },
    ],
    reserveBatters: [
  ...
  // ARI (ARI 2004)
  {
    ...
    batters: [
      ...
      { id: 'hillesh02', name: 'Shea Hillenbrand', pos: '1B', bats: 'R', age: 28, pa: 604, h: 167, double: 37, triple: 3, hr: 17, bb: 24, so: 64, hbp: 10, sb: 2, cs: 0, sec: '3B', fld: 62 },
      { id: 'hairssc01', name: 'Scott Hairston', pos: '2B', bats: 'R', age: 24, pa: 364, h: 84, double: 15, triple: 6, hr: 13, bb: 21, so: 88, hbp: 1, sb: 3, cs: 3, sec: 'SS', fld: 63, rk: true },
      { id: 'tracych01', name: 'Chad Tracy', pos: '3B', bats: 'L', age: 24, pa: 532, h: 137, double: 29, triple: 3, hr: 8, bb: 45, so: 60, hbp: 0, sb: 2, cs: 3, sec: '1B', fld: 80, rk: true },
      { id: 'cintral01', name: 'Alex Cintron', pos: 'SS', bats: 'S', age: 25, pa: 613, h: 157, double: 32, triple: 7, hr: 8, bb: 34, so: 54, hbp: 2, sb: 3, cs: 3, sec: '2B', fld: 65 },
      { id: 'gonzalu01', name: 'Luis Gonzalez', pos: 'LF', bats: 'L', age: 36, pa: 451, h: 107, double: 26, triple: 4, hr: 18, bb: 66, so: 52, hbp: 2, sb: 3, cs: 2, fld: 57, arm: 62 },
      { id: 'finlest01', name: 'Steve Finley', pos: 'CF', bats: 'L', age: 39, pa: 706, h: 174, double: 29, triple: 5, hr: 32, bb: 66, so: 93, hbp: 3, sb: 13, cs: 8, sec: 'RF', fld: 64, arm: 66 },
      ...
      { id: 'mccraqu01', name: 'Quinton McCracken', pos: 'DH', bats: 'S', age: 33, pa: 195, h: 47, double: 9, triple: 2, hr: 1, bb: 15, so: 29, hbp: 0, sb: 3, cs: 3, sec: 'LF', fld: 57, arm: 74 },
    ],
    bench: [
      { id: 'terrelu01', name: 'Luis Terrero', pos: 'CF', bats: 'R', age: 24, pa: 255, h: 56, double: 14, triple: 0, hr: 4, bb: 20, so: 78, hbp: 6, sb: 10, cs: 2, sec: 'LF', fld: 45, arm: 76, rk: true },
      { id: 'alomaro01', name: 'Roberto Alomar', pos: '2B', bats: 'S', age: 36, pa: 190, h: 44, double: 8, triple: 1, hr: 3, bb: 17, so: 26, hbp: 1, sb: 3, cs: 1, fld: 59 },
      ...
      { id: 'katama01', name: 'Matt Kata', pos: '2B', bats: 'S', age: 26, pa: 177, h: 40, double: 9, triple: 2, hr: 3, bb: 13, so: 29, hbp: 0, sb: 3, cs: 1, sec: '3B', fld: 77 },
    ...
    reserveBatters: [
      { id: 'devordo01', name: 'Doug DeVore', pos: 'LF', bats: 'L', age: 26, pa: 114, h: 24, double: 3, triple: 2, hr: 3, bb: 7, so: 31, hbp: 0, sb: 1, cs: 1, sec: 'RF', fld: 83, arm: 76, rk: true },
      ...
      { id: 'sexsori01', name: 'Richie Sexson', pos: '1B', bats: 'R', age: 29, pa: 104, h: 24, double: 5, triple: 0, hr: 6, bb: 13, so: 22, hbp: 1, sb: 0, cs: 0, sec: 'LF', fld: 87 },
  ...
  // COL (COL 2004)
  {
    ...
    batters: [
      ...
      { id: 'milesaa01', name: 'Aaron Miles', pos: '2B', bats: 'S', age: 27, pa: 566, h: 153, double: 17, triple: 3, hr: 6, bb: 29, so: 52, hbp: 2, sb: 12, cs: 7, sec: 'SS', fld: 79, rk: true },
      { id: 'castivi02', name: 'Vinny Castilla', pos: '3B', bats: 'R', age: 36, pa: 648, h: 159, double: 37, triple: 3, hr: 28, bb: 40, so: 102, hbp: 5, sb: 1, cs: 1, sec: 'SS', fld: 86 },
      { id: 'claytro01', name: 'Royce Clayton', pos: 'SS', bats: 'R', age: 34, pa: 652, h: 150, double: 29, triple: 3, hr: 10, bb: 50, so: 119, hbp: 4, sb: 9, cs: 4, fld: 75 },
      { id: 'hollima01', name: 'Matt Holliday', pos: 'LF', bats: 'R', age: 24, pa: 439, h: 116, double: 31, triple: 3, hr: 14, bb: 31, so: 86, hbp: 6, sb: 3, cs: 3, sec: 'RF', fld: 60, arm: 66, rk: true },
      { id: 'burnije01', name: 'Jeromy Burnitz', pos: 'CF', bats: 'L', age: 35, pa: 606, h: 141, double: 27, triple: 2, hr: 34, bb: 54, so: 131, hbp: 6, sb: 6, cs: 6, sec: 'RF', fld: 63, arm: 71 },
      ...
      { id: 'gonzalu02', name: 'Luis Gonzalez', pos: 'DH', bats: 'R', age: 25, pa: 351, h: 94, double: 17, triple: 2, hr: 12, bb: 15, so: 67, hbp: 4, sb: 1, cs: 5, sec: 'LF', fld: 85, rk: true },
    ],
    bench: [
      { id: 'wilsopr01', name: 'Preston Wilson', pos: 'CF', bats: 'R', age: 29, pa: 222, h: 53, double: 12, triple: 0, hr: 10, bb: 19, so: 49, hbp: 2, sb: 5, cs: 2, sec: 'LF', fld: 60, arm: 71 },
      { id: 'sweenma01', name: 'Mark Sweeney', pos: 'RF', bats: 'L', age: 34, pa: 215, h: 47, double: 13, triple: 1, hr: 7, bb: 27, so: 52, hbp: 1, sb: 1, cs: 0, sec: '1B', fld: 83, arm: 87 },
      ...
      { id: 'pelloki01', name: 'Kit Pellow', pos: 'RF', bats: 'R', age: 30, pa: 133, h: 31, double: 6, triple: 1, hr: 2, bb: 9, so: 41, hbp: 4, sb: 1, cs: 0, sec: '1B', fld: 53, arm: 75, rk: true },
    ...
    reserveBatters: [
      ...
      { id: 'piedrjo01', name: 'Jorge Piedra', pos: 'CF', bats: 'L', age: 25, pa: 98, h: 27, double: 8, triple: 0, hr: 3, bb: 5, so: 19, hbp: 1, sb: 0, cs: 1, sec: 'LF', fld: 60, arm: 68, rk: true },
  ...
  // LAD (LAN 2004)
  {
    ...
    batters: [
      ...
      { id: 'greensh01', name: 'Shawn Green', pos: '1B', bats: 'L', age: 31, pa: 671, h: 161, double: 35, triple: 1, hr: 27, bb: 73, so: 112, hbp: 7, sb: 6, cs: 2, sec: 'LF', fld: 67 },
      { id: 'coraal01', name: 'Alex Cora', pos: '2B', bats: 'L', age: 28, pa: 484, h: 111, double: 16, triple: 4, hr: 8, bb: 35, so: 49, hbp: 14, sb: 4, cs: 3, sec: 'SS', fld: 71 },
      { id: 'beltrad01', name: 'Adrian Beltre', pos: '3B', bats: 'R', age: 25, pa: 657, h: 175, double: 31, triple: 2, hr: 36, bb: 46, so: 97, hbp: 3, sb: 6, cs: 3, sec: '1B', fld: 82 },
      ...
      { id: 'roberda07', name: 'Dave Roberts', pos: 'LF', bats: 'L', age: 32, pa: 371, h: 83, double: 10, triple: 6, hr: 3, bb: 37, so: 41, hbp: 4, sb: 36, cs: 7, sec: 'CF', fld: 74, arm: 66 },
    ...
    bench: [
      { id: 'hernajo01', name: 'Jose Hernandez', pos: '2B', bats: 'R', age: 34, pa: 238, h: 55, double: 9, triple: 1, hr: 9, bb: 22, so: 71, hbp: 1, sb: 2, cs: 1, sec: 'SS', fld: 70 },
      ...
      { id: 'graboja01', name: 'Jason Grabowski', pos: 'LF', bats: 'L', age: 28, pa: 192, h: 37, double: 7, triple: 0, hr: 7, bb: 20, so: 51, hbp: 0, sb: 0, cs: 0, sec: 'RF', fld: 60, arm: 58, rk: true },
      ...
      { id: 'venturo01', name: 'Robin Ventura', pos: '1B', bats: 'L', age: 36, pa: 175, h: 37, double: 5, triple: 0, hr: 6, bb: 24, so: 32, hbp: 0, sb: 0, cs: 0, sec: '3B', fld: 76 },
    ],
    reserveBatters: [
  ...
  // SDP (SDN 2004)
  {
    ...
    batters: [
      ...
      { id: 'nevinph01', name: 'Phil Nevin', pos: '1B', bats: 'R', age: 33, pa: 623, h: 158, double: 28, triple: 1, hr: 26, bb: 62, so: 119, hbp: 4, sb: 2, cs: 0, sec: '3B', fld: 66 },
      ...
      { id: 'greenkh01', name: 'Khalil Greene', pos: 'SS', bats: 'R', age: 24, pa: 554, h: 130, double: 31, triple: 4, hr: 15, bb: 51, so: 98, hbp: 8, sb: 4, cs: 2, sec: '2B', fld: 64, rk: true },
      { id: 'kleskry01', name: 'Ryan Klesko', pos: 'LF', bats: 'L', age: 33, pa: 480, h: 114, double: 27, triple: 1, hr: 16, bb: 68, so: 72, hbp: 2, sb: 3, cs: 3, sec: '1B', fld: 63, arm: 63 },
      { id: 'paytoja01', name: 'Jay Payton', pos: 'CF', bats: 'R', age: 31, pa: 511, h: 131, double: 21, triple: 4, hr: 15, bb: 37, so: 58, hbp: 5, sb: 4, cs: 2, sec: 'LF', fld: 84, arm: 77 },
      ...
      { id: 'longte01', name: 'Terrence Long', pos: 'DH', bats: 'L', age: 28, pa: 313, h: 76, double: 16, triple: 2, hr: 6, bb: 20, so: 46, hbp: 1, sb: 2, cs: 2, sec: 'LF', fld: 79, arm: 65 },
    ],
    bench: [
      ...
      { id: 'vazqura01', name: 'Ramon Vazquez', pos: 'SS', bats: 'L', age: 27, pa: 132, h: 30, double: 5, triple: 1, hr: 1, bb: 13, so: 23, hbp: 0, sb: 2, cs: 1, sec: '2B', fld: 56 },
      { id: 'robinke02', name: 'Kerry Robinson', pos: 'LF', bats: 'L', age: 30, pa: 101, h: 25, double: 3, triple: 1, hr: 0, bb: 5, so: 11, hbp: 1, sb: 6, cs: 2, sec: 'RF', fld: 89, arm: 69 },
      { id: 'nadyxa01', name: 'Xavier Nady', pos: 'LF', bats: 'R', age: 25, pa: 84, h: 20, double: 4, triple: 0, hr: 2, bb: 5, so: 15, hbp: 1, sb: 1, cs: 0, sec: 'RF', fld: 47, arm: 71 },
      { id: 'cirilje01', name: 'Jeff Cirillo', pos: '3B', bats: 'R', age: 34, pa: 81, h: 16, double: 3, triple: 0, hr: 1, bb: 6, so: 10, hbp: 1, sb: 1, cs: 0, sec: '1B' },
    ],
    reserveBatters: [
      { id: 'guzmafr01', name: 'Freddy Guzman', pos: 'CF', bats: 'S', age: 23, pa: 80, h: 16, double: 3, triple: 0, hr: 0, bb: 3, so: 13, hbp: 1, sb: 5, cs: 2, sec: 'LF', fld: 83, arm: 84, rk: true },
  ...
  // SFG (SFN 2004)
  {
    ...
    batters: [
      ...
      { id: 'durhara01', name: 'Ray Durham', pos: '2B', bats: 'S', age: 32, pa: 542, h: 134, double: 30, triple: 7, hr: 14, bb: 58, so: 73, hbp: 5, sb: 12, cs: 6, sec: 'SS', fld: 68 },
      ...
      { id: 'bondsba01', name: 'Barry Bonds', pos: 'LF', bats: 'L', age: 39, pa: 617, h: 142, double: 27, triple: 2, hr: 47, bb: 206, so: 50, hbp: 10, sb: 7, cs: 1, sec: 'CF', fld: 64, arm: 77 },
      ...
      { id: 'tuckemi01', name: 'Michael Tucker', pos: 'RF', bats: 'L', age: 33, pa: 547, h: 121, double: 23, triple: 6, hr: 14, bb: 61, so: 107, hbp: 2, sb: 10, cs: 6, sec: 'LF', fld: 76, arm: 61 },
    ...
    bench: [
      ...
      { id: 'hammoje01', name: 'Jeffrey Hammonds', pos: 'RF', bats: 'R', age: 33, pa: 113, h: 24, double: 6, triple: 0, hr: 3, bb: 13, so: 20, hbp: 1, sb: 1, cs: 0, sec: 'CF', fld: 80, arm: 82 },
    ...
    pitchers: [
      ...
      { id: 'rueteki01', name: 'Kirk Rueter', role: 'SP', throws: 'L', age: 33, g: 33, gs: 33, outs: 571, h: 220, hr: 20, bb: 63, so: 59, hbp: 1, er: 94, w: 9, l: 12, sv: 0, fld: 88 },
