...
export const SEASON_2006: HistTeam[] = [
  // BAL (BAL 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'loewead01', name: 'Adam Loewen', role: 'SP', throws: 'L', age: 22, g: 22, gs: 19, outs: 337, h: 111, hr: 8, bb: 62, so: 98, hbp: 8, er: 67, w: 6, l: 6, sv: 0, fld: 81, rk: true },
      { id: 'raych01', name: 'Chris Ray', role: 'CL', throws: 'R', age: 24, g: 61, gs: 0, outs: 198, h: 47, hr: 9, bb: 27, so: 56, hbp: 1, er: 20, w: 4, l: 4, sv: 33, fld: 68, rk: true },
      { id: 'hawkila01', name: 'LaTroy Hawkins', role: 'RP', throws: 'R', age: 33, g: 60, gs: 0, outs: 181, h: 67, hr: 6, bb: 18, so: 39, hbp: 0, er: 27, w: 3, l: 2, sv: 0, fld: 66 },
      { id: 'willito02', name: 'Todd Williams', role: 'RP', throws: 'R', age: 35, g: 62, gs: 0, outs: 171, h: 67, hr: 6, bb: 20, so: 27, hbp: 3, er: 26, w: 2, l: 4, sv: 1, fld: 82 },
      { id: 'brittch01', name: 'Chris Britton', role: 'RP', throws: 'R', age: 23, g: 52, gs: 0, outs: 161, h: 46, hr: 4, bb: 17, so: 41, hbp: 0, er: 20, w: 0, l: 2, sv: 1, fld: 74, rk: true },
      { id: 'rlealse01', name: 'Sendy Rleal', role: 'RP', throws: 'R', age: 26, g: 42, gs: 0, outs: 140, h: 48, hr: 10, bb: 23, so: 19, hbp: 0, er: 23, w: 1, l: 1, sv: 0, fld: 67, rk: true },
      { id: 'birkiku01', name: 'Kurt Birkins', role: 'RP', throws: 'L', age: 25, g: 35, gs: 0, outs: 93, h: 25, hr: 4, bb: 16, so: 27, hbp: 3, er: 17, w: 5, l: 2, sv: 0, fld: 68, rk: true },
    ],
    reservePitchers: [
      { id: 'chenbr01', name: 'Bruce Chen', role: 'SP', throws: 'L', age: 29, g: 40, gs: 12, outs: 296, h: 117, hr: 22, bb: 35, so: 72, hbp: 3, er: 58, w: 0, l: 7, sv: 0, fld: 70 },
      { id: 'ortizru01', name: 'Russ Ortiz', role: 'SP', throws: 'R', age: 32, g: 26, gs: 11, outs: 189, h: 79, hr: 12, bb: 38, so: 39, hbp: 2, er: 47, w: 0, l: 8, sv: 0, fld: 67 },
      { id: 'halamjo01', name: 'John Halama', role: 'RP', throws: 'L', age: 34, g: 17, gs: 1, outs: 88, h: 37, hr: 4, bb: 9, so: 15, hbp: 2, er: 18, w: 3, l: 1, sv: 0, fld: 79 },
      { id: 'broweji01', name: 'Jim Brower', role: 'RP', throws: 'R', age: 33, g: 18, gs: 0, outs: 60, h: 28, hr: 3, bb: 12, so: 18, hbp: 2, er: 16, w: 0, l: 1, sv: 0, fld: 66 },
      { id: 'manonju01', name: 'Julio Manon', role: 'RP', throws: 'R', age: 33, g: 22, gs: 0, outs: 60, h: 23, hr: 5, bb: 16, so: 22, hbp: 2, er: 12, w: 0, l: 1, sv: 0, fld: 87, rk: true },
    ],
  },
  // BOS (BOS 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'lestejo01', name: 'Jon Lester', role: 'SP', throws: 'L', age: 22, g: 15, gs: 15, outs: 244, h: 91, hr: 7, bb: 43, so: 60, hbp: 5, er: 43, w: 7, l: 2, sv: 0, fld: 75, rk: true },
      { id: 'wellsda01', name: 'David Wells', role: 'SP', throws: 'L', age: 43, g: 13, gs: 13, outs: 226, h: 91, hr: 10, bb: 10, so: 42, hbp: 2, er: 37, w: 3, l: 5, sv: 0, fld: 68 },
      { id: 'papeljo01', name: 'Jonathan Papelbon', role: 'CL', throws: 'R', age: 25, g: 59, gs: 0, outs: 205, h: 44, hr: 4, bb: 17, so: 70, hbp: 2, er: 10, w: 4, l: 2, sv: 35, fld: 70, rk: true },
      { id: 'tavarju01', name: 'Julian Tavarez', role: 'RP', throws: 'R', age: 33, g: 58, gs: 6, outs: 296, h: 107, hr: 9, bb: 39, so: 63, hbp: 8, er: 44, w: 5, l: 4, sv: 1, fld: 64 },
      { id: 'timlimi01', name: 'Mike Timlin', role: 'RP', throws: 'R', age: 40, g: 68, gs: 0, outs: 192, h: 73, hr: 5, bb: 16, so: 40, hbp: 2, er: 26, w: 6, l: 6, sv: 9, fld: 71 },
      { id: 'delcama01', name: 'Manny Delcarmen', role: 'RP', throws: 'R', age: 24, g: 50, gs: 0, outs: 160, h: 66, hr: 2, bb: 19, so: 46, hbp: 2, er: 29, w: 2, l: 0, sv: 0, fld: 91, rk: true },
      { id: 'seaneru01', name: 'Rudy Seanez', role: 'RP', throws: 'R', age: 37, g: 49, gs: 0, outs: 159, h: 53, hr: 6, bb: 27, so: 65, hbp: 1, er: 24, w: 3, l: 3, sv: 0, fld: 74 },
      { id: 'foulkke01', name: 'Keith Foulke', role: 'RP', throws: 'R', age: 33, g: 44, gs: 0, outs: 149, h: 49, hr: 8, bb: 11, so: 39, hbp: 3, er: 23, w: 3, l: 1, sv: 0, fld: 65 },
    ],
    reservePitchers: [
      { id: 'clemema01', name: 'Matt Clement', role: 'SP', throws: 'R', age: 31, g: 12, gs: 12, outs: 196, h: 71, hr: 8, bb: 30, so: 56, hbp: 6, er: 38, w: 5, l: 5, sv: 0, fld: 68 },
      { id: 'snydeky01', name: 'Kyle Snyder', role: 'SP', throws: 'R', age: 28, g: 17, gs: 11, outs: 181, h: 88, hr: 10, bb: 19, so: 50, hbp: 2, er: 44, w: 4, l: 5, sv: 0, fld: 56 },
      { id: 'coreybr01', name: 'Bryan Corey', role: 'RP', throws: 'R', age: 32, g: 32, gs: 0, outs: 117, h: 35, hr: 1, bb: 15, so: 28, hbp: 2, er: 16, w: 2, l: 1, sv: 0, fld: 62, rk: true },
      { id: 'dinarle01', name: 'Lenny DiNardo', role: 'RP', throws: 'L', age: 26, g: 13, gs: 6, outs: 117, h: 57, hr: 5, bb: 19, so: 24, hbp: 1, er: 28, w: 1, l: 2, sv: 0, fld: 63, rk: true },
      { id: 'hansecr01', name: 'Craig Hansen', role: 'RP', throws: 'R', age: 22, g: 38, gs: 0, outs: 114, h: 47, hr: 5, bb: 15, so: 30, hbp: 4, er: 28, w: 2, l: 2, sv: 0, fld: 73, rk: true },
    ],
  },
  // NYY (NYA 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'chacosh01', name: 'Shawn Chacon', role: 'SP', throws: 'R', age: 28, g: 26, gs: 20, outs: 327, h: 116, hr: 18, bb: 60, so: 64, hbp: 10, er: 64, w: 7, l: 6, sv: 0, fld: 67 },
      { id: 'riverma01', name: 'Mariano Rivera', role: 'CL', throws: 'R', age: 36, g: 63, gs: 0, outs: 225, h: 57, hr: 3, bb: 15, so: 64, hbp: 5, er: 14, w: 5, l: 5, sv: 34, fld: 62 },
      { id: 'proctsc01', name: 'Scott Proctor', role: 'RP', throws: 'R', age: 29, g: 83, gs: 0, outs: 307, h: 92, hr: 15, bb: 35, so: 86, hbp: 2, er: 46, w: 6, l: 4, sv: 1, fld: 76 },
      { id: 'villoro01', name: 'Ron Villone', role: 'RP', throws: 'L', age: 36, g: 70, gs: 0, outs: 241, h: 74, hr: 8, bb: 48, so: 74, hbp: 6, er: 41, w: 3, l: 3, sv: 0, fld: 79 },
      { id: 'farnsky01', name: 'Kyle Farnsworth', role: 'RP', throws: 'R', age: 30, g: 72, gs: 0, outs: 198, h: 57, hr: 7, bb: 28, so: 79, hbp: 2, er: 27, w: 3, l: 6, sv: 6, fld: 76 },
      { id: 'karstje01', name: 'Jeff Karstens', role: 'RP', throws: 'R', age: 23, g: 8, gs: 6, outs: 128, h: 40, hr: 6, bb: 11, so: 16, hbp: 1, er: 18, w: 2, l: 1, sv: 0, fld: 81, rk: true },
      { id: 'myersmi01', name: 'Mike Myers', role: 'RP', throws: 'L', age: 37, g: 62, gs: 0, outs: 92, h: 28, hr: 3, bb: 12, so: 21, hbp: 2, er: 12, w: 1, l: 2, sv: 0, fld: 63 },
    ],
    reservePitchers: [
      { id: 'smallaa01', name: 'Aaron Small', role: 'RP', throws: 'R', age: 34, g: 11, gs: 3, outs: 83, h: 35, hr: 5, bb: 11, so: 14, hbp: 2, er: 18, w: 0, l: 3, sv: 0, fld: 62 },
      { id: 'brunebr01', name: 'Brian Bruney', role: 'RP', throws: 'R', age: 24, g: 19, gs: 0, outs: 62, h: 18, hr: 2, bb: 15, so: 22, hbp: 1, er: 10, w: 1, l: 1, sv: 0, fld: 71 },
      { id: 'smithma04', name: 'Matt Smith', role: 'RP', throws: 'L', age: 27, g: 26, gs: 0, outs: 62, h: 7, hr: 0, bb: 12, so: 21, hbp: 0, er: 2, w: 0, l: 1, sv: 0, fld: 72, rk: true },
      { id: 'rasneda01', name: 'Darrell Rasner', role: 'RP', throws: 'R', age: 25, g: 6, gs: 3, outs: 61, h: 17, hr: 2, bb: 5, so: 11, hbp: 2, er: 10, w: 3, l: 1, sv: 0, fld: 76, rk: true },
      { id: 'beamtj01', name: 'T. J. Beam', role: 'RP', throws: 'R', age: 25, g: 20, gs: 0, outs: 54, h: 26, hr: 5, bb: 6, so: 12, hbp: 2, er: 17, w: 2, l: 0, sv: 0, fld: 84, rk: true },
    ],
  },
  // TBR (TBA 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'fossuca01', name: 'Casey Fossum', role: 'SP', throws: 'L', age: 28, g: 25, gs: 25, outs: 390, h: 140, hr: 19, bb: 57, so: 97, hbp: 12, er: 78, w: 6, l: 6, sv: 0, fld: 69 },
      { id: 'shielja02', name: 'James Shields', role: 'SP', throws: 'R', age: 24, g: 21, gs: 21, outs: 374, h: 141, hr: 18, bb: 38, so: 104, hbp: 5, er: 67, w: 6, l: 8, sv: 0, fld: 64, rk: true },
      { id: 'walkety01', name: 'Tyler Walker', role: 'CL', throws: 'R', age: 30, g: 26, gs: 0, outs: 76, h: 28, hr: 3, bb: 11, so: 20, hbp: 1, er: 14, w: 1, l: 4, sv: 10, fld: 72 },
      { id: 'lugoru01', name: 'Ruddy Lugo', role: 'RP', throws: 'R', age: 26, g: 64, gs: 0, outs: 255, h: 75, hr: 4, bb: 37, so: 48, hbp: 5, er: 36, w: 2, l: 4, sv: 0, fld: 64, rk: true },
      { id: 'campsh01', name: 'Shawn Camp', role: 'RP', throws: 'R', age: 30, g: 75, gs: 0, outs: 225, h: 94, hr: 9, bb: 19, so: 51, hbp: 7, er: 41, w: 7, l: 4, sv: 4, fld: 78 },
      { id: 'meadobr01', name: 'Brian Meadows', role: 'RP', throws: 'R', age: 30, g: 53, gs: 0, outs: 209, h: 84, hr: 11, bb: 17, so: 39, hbp: 0, er: 37, w: 3, l: 6, sv: 8, fld: 69 },
      { id: 'hammeja01', name: 'Jason Hammel', role: 'RP', throws: 'R', age: 23, g: 9, gs: 9, outs: 132, h: 61, hr: 7, bb: 21, so: 32, hbp: 1, er: 38, w: 0, l: 6, sv: 0, fld: 66, rk: true },
      { id: 'howeljp01', name: 'J. P. Howell', role: 'RP', throws: 'L', age: 23, g: 8, gs: 8, outs: 127, h: 47, hr: 5, bb: 19, so: 32, hbp: 3, er: 27, w: 1, l: 3, sv: 0, fld: 66 },
    ],
    reservePitchers: [
      { id: 'mccluse01', name: 'Seth McClung', role: 'SP', throws: 'R', age: 25, g: 39, gs: 15, outs: 309, h: 114, hr: 16, bb: 65, so: 72, hbp: 5, er: 75, w: 6, l: 12, sv: 6, fld: 77 },
      { id: 'corcoti02', name: 'Tim Corcoran', role: 'SP', throws: 'R', age: 28, g: 21, gs: 16, outs: 271, h: 90, hr: 9, bb: 48, so: 58, hbp: 4, er: 47, w: 5, l: 9, sv: 0, fld: 75, rk: true },
      { id: 'waechdo01', name: 'Doug Waechter', role: 'SP', throws: 'R', age: 25, g: 11, gs: 10, outs: 159, h: 66, hr: 10, bb: 17, so: 29, hbp: 3, er: 36, w: 1, l: 4, sv: 0, fld: 55 },
      { id: 'harpetr01', name: 'Travis Harper', role: 'RP', throws: 'R', age: 30, g: 30, gs: 0, outs: 126, h: 54, hr: 7, bb: 14, so: 30, hbp: 2, er: 27, w: 2, l: 0, sv: 0, fld: 62 },
      { id: 'harvich01', name: 'Chad Harville', role: 'RP', throws: 'R', age: 29, g: 32, gs: 0, outs: 123, h: 42, hr: 6, bb: 22, so: 32, hbp: 2, er: 24, w: 0, l: 2, sv: 1, fld: 76 },
    ],
  },
  // TOR (TOR 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'janssca01', name: 'Casey Janssen', role: 'SP', throws: 'R', age: 24, g: 19, gs: 17, outs: 282, h: 103, hr: 12, bb: 21, so: 44, hbp: 7, er: 53, w: 6, l: 10, sv: 0, fld: 79, rk: true },
      { id: 'chacigu01', name: 'Gustavo Chacin', role: 'SP', throws: 'L', age: 25, g: 17, gs: 17, outs: 262, h: 92, hr: 13, bb: 33, so: 51, hbp: 5, er: 42, w: 9, l: 4, sv: 0, fld: 76 },
      { id: 'ryanbj01', name: 'B. J. Ryan', role: 'CL', throws: 'L', age: 30, g: 65, gs: 0, outs: 217, h: 47, hr: 3, bb: 23, so: 91, hbp: 1, er: 15, w: 2, l: 2, sv: 38, fld: 73 },
      { id: 'downssc01', name: 'Scott Downs', role: 'RP', throws: 'L', age: 30, g: 59, gs: 5, outs: 231, h: 76, hr: 9, bb: 29, so: 59, hbp: 3, er: 36, w: 6, l: 2, sv: 1, fld: 69 },
      { id: 'tallebr01', name: 'Brian Tallet', role: 'RP', throws: 'L', age: 28, g: 44, gs: 1, outs: 163, h: 46, hr: 6, bb: 31, so: 36, hbp: 3, er: 24, w: 3, l: 0, sv: 0, fld: 71, rk: true },
      { id: 'schoesc01', name: 'Scott Schoeneweis', role: 'RP', throws: 'L', age: 32, g: 71, gs: 0, outs: 155, h: 51, hr: 4, bb: 23, so: 32, hbp: 2, er: 26, w: 4, l: 2, sv: 4, fld: 62 },
      { id: 'speieju01', name: 'Justin Speier', role: 'RP', throws: 'R', age: 32, g: 58, gs: 0, outs: 154, h: 44, hr: 6, bb: 18, so: 49, hbp: 2, er: 18, w: 2, l: 0, sv: 0, fld: 75 },
      { id: 'frasoja01', name: 'Jason Frasor', role: 'RP', throws: 'R', age: 28, g: 51, gs: 0, outs: 150, h: 46, hr: 6, bb: 19, so: 45, hbp: 2, er: 21, w: 3, l: 2, sv: 0, fld: 67 },
    ],
    reservePitchers: [
      { id: 'marcush01', name: 'Shaun Marcum', role: 'SP', throws: 'R', age: 24, g: 21, gs: 14, outs: 235, h: 86, hr: 13, bb: 38, so: 64, hbp: 4, er: 41, w: 3, l: 4, sv: 0, fld: 67, rk: true },
      { id: 'towerjo01', name: 'Josh Towers', role: 'SP', throws: 'R', age: 29, g: 15, gs: 12, outs: 186, h: 84, hr: 11, bb: 13, so: 35, hbp: 3, er: 38, w: 2, l: 10, sv: 0, fld: 64 },
      { id: 'chulkvi01', name: 'Vinnie Chulk', role: 'RP', throws: 'R', age: 27, g: 48, gs: 0, outs: 139, h: 46, hr: 6, bb: 19, so: 35, hbp: 2, er: 24, w: 1, l: 3, sv: 0, fld: 64 },
      { id: 'leagubr01', name: 'Brandon League', role: 'RP', throws: 'R', age: 23, g: 33, gs: 0, outs: 128, h: 37, hr: 5, bb: 13, so: 24, hbp: 3, er: 17, w: 1, l: 2, sv: 1, fld: 64, rk: true },
      { id: 'taubety01', name: 'Ty Taubenheim', role: 'RP', throws: 'R', age: 23, g: 12, gs: 7, outs: 105, h: 40, hr: 5, bb: 18, so: 26, hbp: 4, er: 19, w: 1, l: 5, sv: 0, fld: 81, rk: true },
    ],
  },
  // CWS (CHA 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'jenksbo01', name: 'Bobby Jenks', role: 'CL', throws: 'R', age: 25, g: 67, gs: 0, outs: 209, h: 65, hr: 5, bb: 30, so: 83, hbp: 2, er: 29, w: 3, l: 4, sv: 41, fld: 68, rk: true },
      { id: 'mccarbr01', name: 'Brandon McCarthy', role: 'RP', throws: 'R', age: 22, g: 53, gs: 2, outs: 254, h: 78, hr: 17, bb: 29, so: 67, hbp: 1, er: 42, w: 4, l: 7, sv: 0, fld: 79 },
      { id: 'cottsne01', name: 'Neal Cotts', role: 'RP', throws: 'L', age: 26, g: 70, gs: 0, outs: 162, h: 54, hr: 8, bb: 26, so: 49, hbp: 3, er: 26, w: 1, l: 2, sv: 1, fld: 78 },
      { id: 'thornma01', name: 'Matt Thornton', role: 'RP', throws: 'L', age: 29, g: 63, gs: 0, outs: 162, h: 46, hr: 7, bb: 29, so: 49, hbp: 1, er: 24, w: 5, l: 3, sv: 2, fld: 68 },
      { id: 'riskeda01', name: 'David Riske', role: 'RP', throws: 'R', age: 29, g: 41, gs: 0, outs: 132, h: 38, hr: 7, bb: 16, so: 33, hbp: 2, er: 18, w: 1, l: 2, sv: 0, fld: 61 },
      { id: 'politcl01', name: 'Cliff Politte', role: 'RP', throws: 'R', age: 32, g: 30, gs: 0, outs: 90, h: 35, hr: 6, bb: 14, so: 26, hbp: 1, er: 18, w: 2, l: 2, sv: 0, fld: 66 },
    ],
    reservePitchers: [
      { id: 'macdomi01', name: 'Mike MacDougal', role: 'RP', throws: 'R', age: 29, g: 29, gs: 0, outs: 87, h: 24, hr: 2, bb: 8, so: 25, hbp: 1, er: 8, w: 1, l: 1, sv: 1, fld: 71 },
      { id: 'haegech01', name: 'Charlie Haeger', role: 'RP', throws: 'R', age: 22, g: 7, gs: 1, outs: 55, h: 12, hr: 0, bb: 13, so: 19, hbp: 0, er: 7, w: 1, l: 1, sv: 1, fld: 50, rk: true },
      { id: 'loganbo02', name: 'Boone Logan', role: 'RP', throws: 'L', age: 21, g: 21, gs: 0, outs: 52, h: 21, hr: 2, bb: 15, so: 15, hbp: 3, er: 16, w: 0, l: 0, sv: 1, fld: 73, rk: true },
      { id: 'monteag01', name: 'Agustin Montero', role: 'RP', throws: 'R', age: 28, g: 11, gs: 0, outs: 42, h: 15, hr: 3, bb: 2, so: 7, hbp: 0, er: 8, w: 1, l: 0, sv: 0, fld: 67, rk: true },
    ],
  },
  // CLE (CLE 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'johnsja02', name: 'Jason Johnson', role: 'SP', throws: 'R', age: 32, g: 24, gs: 20, outs: 345, h: 146, hr: 14, bb: 33, so: 59, hbp: 4, er: 70, w: 3, l: 12, sv: 0, fld: 62 },
      { id: 'wickmbo01', name: 'Bob Wickman', role: 'CL', throws: 'R', age: 37, g: 57, gs: 0, outs: 162, h: 52, hr: 5, bb: 15, so: 40, hbp: 1, er: 16, w: 1, l: 6, sv: 33, fld: 79 },
      { id: 'carmofa01', name: 'Roberto Hernandez', role: 'RP', throws: 'R', age: 25, g: 38, gs: 7, outs: 224, h: 88, hr: 9, bb: 31, so: 58, hbp: 7, er: 45, w: 1, l: 10, sv: 0, fld: 64, rk: true },
      { id: 'cabrefe01', name: 'Fernando Cabrera', role: 'RP', throws: 'R', age: 24, g: 51, gs: 0, outs: 182, h: 52, hr: 9, bb: 30, so: 69, hbp: 1, er: 29, w: 3, l: 3, sv: 0, fld: 79, rk: true },
      { id: 'betanra01', name: 'Rafael Betancourt', role: 'RP', throws: 'R', age: 31, g: 50, gs: 0, outs: 170, h: 52, hr: 6, bb: 13, so: 55, hbp: 0, er: 22, w: 3, l: 4, sv: 3, fld: 71 },
      { id: 'motagu01', name: 'Guillermo Mota', role: 'RP', throws: 'R', age: 32, g: 52, gs: 0, outs: 167, h: 52, hr: 7, bb: 24, so: 48, hbp: 1, er: 26, w: 4, l: 3, sv: 0, fld: 77 },
      { id: 'davisja02', name: 'Jason Davis', role: 'RP', throws: 'R', age: 26, g: 39, gs: 0, outs: 166, h: 65, hr: 4, bb: 20, so: 37, hbp: 3, er: 27, w: 3, l: 2, sv: 1, fld: 72 },
    ],
    reservePitchers: [
      { id: 'sowerje01', name: 'Jeremy Sowers', role: 'SP', throws: 'L', age: 23, g: 14, gs: 14, outs: 265, h: 85, hr: 10, bb: 20, so: 35, hbp: 2, er: 35, w: 7, l: 4, sv: 0, fld: 91, rk: true },
      { id: 'sikorbr01', name: 'Brian Sikorski', role: 'RP', throws: 'R', age: 31, g: 30, gs: 0, outs: 102, h: 36, hr: 8, bb: 7, so: 38, hbp: 1, er: 19, w: 3, l: 2, sv: 0, fld: 73, rk: true },
      { id: 'sauersc01', name: 'Scott Sauerbeck', role: 'RP', throws: 'L', age: 34, g: 46, gs: 0, outs: 76, h: 24, hr: 3, bb: 15, so: 21, hbp: 5, er: 13, w: 0, l: 1, sv: 0, fld: 64 },
      { id: 'guthrje01', name: 'Jeremy Guthrie', role: 'RP', throws: 'R', age: 27, g: 9, gs: 1, outs: 58, h: 24, hr: 3, bb: 13, so: 13, hbp: 2, er: 14, w: 0, l: 0, sv: 0, fld: 68, rk: true },
      { id: 'mujiced01', name: 'Edward Mujica', role: 'RP', throws: 'R', age: 22, g: 10, gs: 0, outs: 55, h: 25, hr: 1, bb: 0, so: 12, hbp: 1, er: 6, w: 0, l: 1, sv: 0, fld: 64, rk: true },
    ],
  },
  // DET (DET 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'minerza01', name: 'Zach Miner', role: 'SP', throws: 'R', age: 24, g: 27, gs: 16, outs: 279, h: 100, hr: 11, bb: 32, so: 59, hbp: 0, er: 50, w: 7, l: 6, sv: 0, fld: 59, rk: true },
      { id: 'jonesto02', name: 'Todd Jones', role: 'CL', throws: 'R', age: 38, g: 62, gs: 0, outs: 192, h: 64, hr: 4, bb: 14, so: 41, hbp: 3, er: 24, w: 2, l: 6, sv: 37, fld: 68 },
      { id: 'zumayjo01', name: 'Joel Zumaya', role: 'RP', throws: 'R', age: 21, g: 62, gs: 0, outs: 250, h: 56, hr: 6, bb: 42, so: 97, hbp: 2, er: 18, w: 6, l: 3, sv: 1, fld: 79, rk: true },
      { id: 'rodnefe01', name: 'Fernando Rodney', role: 'RP', throws: 'R', age: 29, g: 63, gs: 0, outs: 215, h: 55, hr: 7, bb: 32, so: 66, hbp: 7, er: 26, w: 7, l: 4, sv: 7, fld: 62 },
      { id: 'grillja01', name: 'Jason Grilli', role: 'RP', throws: 'R', age: 29, g: 51, gs: 0, outs: 186, h: 62, hr: 7, bb: 25, so: 30, hbp: 4, er: 32, w: 2, l: 3, sv: 0, fld: 75 },
      { id: 'ledezwi01', name: 'Wil Ledezma', role: 'RP', throws: 'L', age: 25, g: 24, gs: 7, outs: 181, h: 63, hr: 7, bb: 24, so: 36, hbp: 2, er: 31, w: 3, l: 3, sv: 0, fld: 70 },
      { id: 'marotmi01', name: 'Mike Maroth', role: 'RP', throws: 'L', age: 28, g: 13, gs: 9, outs: 161, h: 62, hr: 8, bb: 14, so: 28, hbp: 2, er: 27, w: 5, l: 2, sv: 0, fld: 75 },
    ],
    reservePitchers: [
      { id: 'walkeja01', name: 'Jamie Walker', role: 'RP', throws: 'L', age: 34, g: 56, gs: 0, outs: 144, h: 47, hr: 6, bb: 10, so: 34, hbp: 1, er: 17, w: 0, l: 1, sv: 0, fld: 78 },
      { id: 'colonro01', name: 'Roman Colon', role: 'RP', throws: 'R', age: 26, g: 20, gs: 1, outs: 116, h: 46, hr: 7, bb: 13, so: 26, hbp: 0, er: 22, w: 2, l: 0, sv: 1, fld: 79 },
      { id: 'spurlch01', name: 'Chris Spurling', role: 'RP', throws: 'R', age: 29, g: 16, gs: 0, outs: 64, h: 21, hr: 3, bb: 8, so: 8, hbp: 0, er: 10, w: 0, l: 0, sv: 0, fld: 54 },
      { id: 'seaybo01', name: 'Bobby Seay', role: 'RP', throws: 'L', age: 28, g: 14, gs: 0, outs: 46, h: 16, hr: 2, bb: 8, so: 12, hbp: 2, er: 10, w: 0, l: 0, sv: 0, fld: 53 },
      { id: 'tatajo01', name: 'Jordan Tata', role: 'RP', throws: 'R', age: 24, g: 8, gs: 0, outs: 44, h: 14, hr: 1, bb: 7, so: 6, hbp: 0, er: 10, w: 0, l: 0, sv: 0, fld: 76, rk: true },
    ],
  },
  // KCR (KCA 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'perezod01', name: 'Odalis Perez', role: 'SP', throws: 'L', age: 28, g: 32, gs: 20, outs: 379, h: 151, hr: 18, bb: 32, so: 87, hbp: 2, er: 74, w: 6, l: 8, sv: 0, fld: 67 },
      { id: 'elartsc01', name: 'Scott Elarton', role: 'SP', throws: 'R', age: 30, g: 20, gs: 20, outs: 344, h: 121, hr: 24, bb: 42, so: 62, hbp: 5, er: 67, w: 4, l: 9, sv: 0, fld: 71 },
      { id: 'hernaru03', name: 'Runelvys Hernandez', role: 'SP', throws: 'R', age: 28, g: 21, gs: 21, outs: 329, h: 135, hr: 18, bb: 49, so: 57, hbp: 6, er: 75, w: 6, l: 10, sv: 0, fld: 74 },
      { id: 'hudsolu01', name: 'Luke Hudson', role: 'SP', throws: 'R', age: 29, g: 26, gs: 15, outs: 306, h: 102, hr: 10, bb: 46, so: 65, hbp: 7, er: 59, w: 7, l: 6, sv: 0, fld: 69 },
      { id: 'burgoam01', name: 'Ambiorix Burgos', role: 'CL', throws: 'R', age: 22, g: 68, gs: 1, outs: 220, h: 79, hr: 13, bb: 37, so: 74, hbp: 6, er: 41, w: 4, l: 5, sv: 18, fld: 53 },
      { id: 'affelje01', name: 'Jeremy Affeldt', role: 'RP', throws: 'L', age: 27, g: 54, gs: 9, outs: 292, h: 105, hr: 11, bb: 53, so: 56, hbp: 2, er: 62, w: 8, l: 8, sv: 1, fld: 62 },
      { id: 'gobblji01', name: 'Jimmy Gobble', role: 'RP', throws: 'L', age: 24, g: 60, gs: 6, outs: 252, h: 94, hr: 13, bb: 31, so: 60, hbp: 1, er: 49, w: 4, l: 6, sv: 2, fld: 70 },
      { id: 'welleto01', name: 'Todd Wellemeyer', role: 'RP', throws: 'R', age: 27, g: 46, gs: 0, outs: 235, h: 71, hr: 8, bb: 51, so: 61, hbp: 3, er: 40, w: 1, l: 4, sv: 1, fld: 77 },
      { id: 'desseel01', name: 'Elmer Dessens', role: 'RP', throws: 'R', age: 35, g: 62, gs: 0, outs: 231, h: 84, hr: 8, bb: 22, so: 50, hbp: 1, er: 37, w: 5, l: 8, sv: 2, fld: 56 },
      { id: 'peraljo01', name: 'Joel Peralta', role: 'RP', throws: 'R', age: 30, g: 64, gs: 0, outs: 221, h: 71, hr: 11, bb: 20, so: 59, hbp: 2, er: 35, w: 1, l: 3, sv: 1, fld: 56, rk: true },
    ],
    reservePitchers: [
      { id: 'delarjo01', name: 'Jorge De La Rosa', role: 'SP', throws: 'L', age: 25, g: 28, gs: 13, outs: 237, h: 83, hr: 10, bb: 57, so: 65, hbp: 2, er: 52, w: 5, l: 6, sv: 0, fld: 67 },
      { id: 'woodmi01', name: 'Mike Wood', role: 'RP', throws: 'R', age: 26, g: 23, gs: 7, outs: 194, h: 80, hr: 10, bb: 25, so: 33, hbp: 5, er: 38, w: 3, l: 3, sv: 0, fld: 63 },
      { id: 'siscoan01', name: 'Andy Sisco', role: 'RP', throws: 'L', age: 23, g: 65, gs: 0, outs: 175, h: 62, hr: 7, bb: 38, so: 57, hbp: 1, er: 35, w: 1, l: 3, sv: 1, fld: 65 },
      { id: 'duckwbr01', name: 'Brandon Duckworth', role: 'RP', throws: 'R', age: 30, g: 10, gs: 8, outs: 137, h: 63, hr: 6, bb: 22, so: 27, hbp: 3, er: 36, w: 1, l: 5, sv: 0, fld: 78 },
      { id: 'nelsojo01', name: 'Joe Nelson', role: 'RP', throws: 'R', age: 31, g: 43, gs: 0, outs: 134, h: 37, hr: 5, bb: 24, so: 44, hbp: 2, er: 23, w: 1, l: 1, sv: 9, fld: 72, rk: true },
    ],
  },
  // MIN (MIN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'lohseky01', name: 'Kyle Lohse', role: 'SP', throws: 'R', age: 27, g: 34, gs: 19, outs: 380, h: 152, hr: 16, bb: 40, so: 78, hbp: 6, er: 72, w: 5, l: 10, sv: 0, fld: 73 },
      { id: 'liriafr01', name: 'Francisco Liriano', role: 'SP', throws: 'L', age: 22, g: 28, gs: 16, outs: 363, h: 90, hr: 10, bb: 32, so: 146, hbp: 1, er: 34, w: 12, l: 3, sv: 1, fld: 74, rk: true },
      { id: 'nathajo01', name: 'Joe Nathan', role: 'CL', throws: 'R', age: 31, g: 64, gs: 0, outs: 205, h: 41, hr: 4, bb: 18, so: 90, hbp: 1, er: 15, w: 7, l: 0, sv: 36, fld: 68 },
      { id: 'crainje01', name: 'Jesse Crain', role: 'RP', throws: 'R', age: 24, g: 68, gs: 0, outs: 230, h: 70, hr: 6, bb: 23, so: 45, hbp: 3, er: 27, w: 4, l: 5, sv: 1, fld: 80 },
      { id: 'rincoju01', name: 'Juan Rincon', role: 'RP', throws: 'R', age: 27, g: 75, gs: 0, outs: 223, h: 67, hr: 2, bb: 27, so: 78, hbp: 3, er: 23, w: 3, l: 1, sv: 1, fld: 72 },
      { id: 'guerrma02', name: 'Matt Guerrier', role: 'RP', throws: 'R', age: 27, g: 39, gs: 1, outs: 209, h: 75, hr: 8, bb: 22, so: 40, hbp: 1, er: 27, w: 1, l: 0, sv: 1, fld: 67 },
      { id: 'eyrewi01', name: 'Willie Eyre', role: 'RP', throws: 'R', age: 27, g: 42, gs: 0, outs: 178, h: 75, hr: 8, bb: 22, so: 26, hbp: 6, er: 35, w: 1, l: 0, sv: 0, fld: 73, rk: true },
      { id: 'reyesde01', name: 'Dennys Reyes', role: 'RP', throws: 'L', age: 29, g: 66, gs: 0, outs: 152, h: 44, hr: 4, bb: 21, so: 40, hbp: 1, er: 16, w: 5, l: 0, sv: 0, fld: 73 },
    ],
    reservePitchers: [
      { id: 'bonsebo01', name: 'Boof Bonser', role: 'SP', throws: 'R', age: 24, g: 18, gs: 18, outs: 301, h: 104, hr: 18, bb: 24, so: 84, hbp: 1, er: 47, w: 7, l: 6, sv: 0, fld: 63, rk: true },
      { id: 'bakersc02', name: 'Scott Baker', role: 'SP', throws: 'R', age: 24, g: 16, gs: 16, outs: 250, h: 105, hr: 15, bb: 18, so: 60, hbp: 2, er: 52, w: 5, l: 8, sv: 0, fld: 61 },
      { id: 'garzama01', name: 'Matt Garza', role: 'RP', throws: 'R', age: 22, g: 10, gs: 9, outs: 150, h: 62, hr: 6, bb: 23, so: 38, hbp: 0, er: 32, w: 3, l: 6, sv: 0, fld: 76, rk: true },
      { id: 'neshepa01', name: 'Pat Neshek', role: 'RP', throws: 'R', age: 25, g: 32, gs: 0, outs: 111, h: 23, hr: 6, bb: 6, so: 53, hbp: 0, er: 9, w: 4, l: 2, sv: 0, fld: 90, rk: true },
    ],
  },
  // HOU (HOU 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'clemero02', name: 'Roger Clemens', role: 'SP', throws: 'R', age: 43, g: 19, gs: 19, outs: 340, h: 86, hr: 7, bb: 34, so: 104, hbp: 3, er: 29, w: 7, l: 6, sv: 0, fld: 72 },
      { id: 'buchhta01', name: 'Taylor Buchholz', role: 'SP', throws: 'R', age: 24, g: 22, gs: 19, outs: 339, h: 107, hr: 21, bb: 34, so: 77, hbp: 3, er: 74, w: 6, l: 10, sv: 0, fld: 75, rk: true },
      { id: 'lidgebr01', name: 'Brad Lidge', role: 'CL', throws: 'R', age: 29, g: 78, gs: 0, outs: 225, h: 65, hr: 8, bb: 31, so: 115, hbp: 5, er: 32, w: 1, l: 5, sv: 32, fld: 76 },
      { id: 'quallch01', name: 'Chad Qualls', role: 'RP', throws: 'R', age: 27, g: 81, gs: 0, outs: 266, h: 78, hr: 9, bb: 27, so: 60, hbp: 7, er: 35, w: 7, l: 3, sv: 0, fld: 61 },
      { id: 'wheelda01', name: 'Dan Wheeler', role: 'RP', throws: 'R', age: 28, g: 75, gs: 0, outs: 214, h: 60, hr: 7, bb: 22, so: 67, hbp: 2, er: 21, w: 3, l: 5, sv: 9, fld: 62 },
      { id: 'borkoda01', name: 'Dave Borkowski', role: 'RP', throws: 'R', age: 29, g: 40, gs: 0, outs: 213, h: 72, hr: 8, bb: 22, so: 53, hbp: 1, er: 37, w: 3, l: 2, sv: 0, fld: 82 },
      { id: 'sprinru01', name: 'Russ Springer', role: 'RP', throws: 'R', age: 37, g: 72, gs: 0, outs: 179, h: 47, hr: 9, bb: 18, so: 48, hbp: 4, er: 25, w: 1, l: 1, sv: 0, fld: 62 },
      { id: 'milletr02', name: 'Trever Miller', role: 'RP', throws: 'L', age: 33, g: 70, gs: 0, outs: 152, h: 44, hr: 5, bb: 19, so: 47, hbp: 5, er: 18, w: 2, l: 3, sv: 1, fld: 67 },
    ],
    reservePitchers: [
      { id: 'nievefe01', name: 'Fernando Nieve', role: 'SP', throws: 'R', age: 23, g: 40, gs: 11, outs: 289, h: 87, hr: 18, bb: 41, so: 70, hbp: 2, er: 45, w: 3, l: 3, sv: 0, fld: 75, rk: true },
      { id: 'hirshja01', name: 'Jason Hirsh', role: 'RP', throws: 'R', age: 24, g: 9, gs: 9, outs: 134, h: 48, hr: 11, bb: 22, so: 29, hbp: 3, er: 30, w: 3, l: 4, sv: 0, fld: 63, rk: true },
      { id: 'backebr01', name: 'Brandon Backe', role: 'RP', throws: 'R', age: 28, g: 8, gs: 8, outs: 129, h: 44, hr: 5, bb: 19, so: 26, hbp: 2, er: 21, w: 3, l: 2, sv: 0, fld: 64 },
      { id: 'sampsch01', name: 'Chris Sampson', role: 'RP', throws: 'R', age: 28, g: 12, gs: 3, outs: 102, h: 25, hr: 3, bb: 5, so: 15, hbp: 1, er: 8, w: 2, l: 1, sv: 0, fld: 60, rk: true },
      { id: 'gallomi01', name: 'Mike Gallo', role: 'RP', throws: 'L', age: 29, g: 23, gs: 0, outs: 49, h: 22, hr: 3, bb: 8, so: 10, hbp: 2, er: 9, w: 1, l: 2, sv: 0, fld: 69 },
    ],
  },
  // LAA (LAA 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'weaveje02', name: 'Jered Weaver', role: 'SP', throws: 'R', age: 23, g: 19, gs: 19, outs: 369, h: 94, hr: 15, bb: 33, so: 105, hbp: 3, er: 35, w: 11, l: 2, sv: 0, fld: 69, rk: true },
      { id: 'rodrifr03', name: 'Francisco Rodriguez', role: 'CL', throws: 'R', age: 24, g: 69, gs: 0, outs: 219, h: 50, hr: 6, bb: 30, so: 100, hbp: 1, er: 17, w: 2, l: 3, sv: 47, fld: 66 },
      { id: 'carrahe01', name: 'Hector Carrasco', role: 'RP', throws: 'R', age: 36, g: 56, gs: 3, outs: 301, h: 84, hr: 9, bb: 33, so: 77, hbp: 6, er: 33, w: 7, l: 3, sv: 1, fld: 59 },
      { id: 'shielsc01', name: 'Scot Shields', role: 'RP', throws: 'R', age: 30, g: 74, gs: 0, outs: 263, h: 69, hr: 6, bb: 29, so: 87, hbp: 2, er: 28, w: 7, l: 7, sv: 2, fld: 80 },
      { id: 'greggke01', name: 'Kevin Gregg', role: 'RP', throws: 'R', age: 28, g: 32, gs: 3, outs: 235, h: 84, hr: 9, bb: 26, so: 69, hbp: 3, er: 38, w: 3, l: 4, sv: 0, fld: 83 },
      { id: 'donnebr01', name: 'Brendan Donnelly', role: 'RP', throws: 'R', age: 34, g: 62, gs: 0, outs: 192, h: 59, hr: 8, bb: 25, so: 57, hbp: 3, er: 27, w: 6, l: 0, sv: 0, fld: 64 },
      { id: 'romerjc01', name: 'J. C. Romero', role: 'RP', throws: 'L', age: 30, g: 65, gs: 0, outs: 145, h: 49, hr: 4, bb: 30, so: 38, hbp: 3, er: 27, w: 1, l: 2, sv: 0, fld: 68 },
    ],
    reservePitchers: [
      { id: 'saundjo01', name: 'Joe Saunders', role: 'SP', throws: 'L', age: 25, g: 13, gs: 13, outs: 212, h: 71, hr: 7, bb: 29, so: 49, hbp: 1, er: 39, w: 7, l: 3, sv: 0, fld: 75, rk: true },
      { id: 'colonba01', name: 'Bartolo Colon', role: 'SP', throws: 'R', age: 33, g: 10, gs: 10, outs: 169, h: 62, hr: 9, bb: 14, so: 41, hbp: 1, er: 28, w: 1, l: 5, sv: 0, fld: 65 },
      { id: 'yanes01', name: 'Esteban Yan', role: 'RP', throws: 'R', age: 31, g: 27, gs: 0, outs: 112, h: 36, hr: 5, bb: 17, so: 26, hbp: 1, er: 19, w: 1, l: 0, sv: 1, fld: 76 },
      { id: 'moseldu01', name: 'Dustin Moseley', role: 'RP', throws: 'R', age: 24, g: 3, gs: 2, outs: 33, h: 22, hr: 3, bb: 2, so: 3, hbp: 0, er: 11, w: 1, l: 0, sv: 0, fld: 66, rk: true },
      { id: 'bootcch01', name: 'Chris Bootcheck', role: 'RP', throws: 'R', age: 27, g: 7, gs: 0, outs: 31, h: 15, hr: 2, bb: 6, so: 6, hbp: 0, er: 9, w: 0, l: 1, sv: 0, fld: 78, rk: true },
    ],
  },
  // OAK (OAK 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'saarlki01', name: 'Kirk Saarloos', role: 'SP', throws: 'R', age: 27, g: 35, gs: 16, outs: 364, h: 143, hr: 15, bb: 49, so: 48, hbp: 6, er: 62, w: 7, l: 7, sv: 2, fld: 72 },
      { id: 'streehu01', name: 'Huston Street', role: 'CL', throws: 'R', age: 22, g: 69, gs: 0, outs: 212, h: 58, hr: 3, bb: 18, so: 67, hbp: 2, er: 21, w: 4, l: 4, sv: 37, fld: 55 },
      { id: 'halsebr01', name: 'Brad Halsey', role: 'RP', throws: 'L', age: 25, g: 52, gs: 7, outs: 283, h: 113, hr: 12, bb: 35, so: 53, hbp: 5, er: 51, w: 5, l: 4, sv: 0, fld: 68 },
      { id: 'gaudich01', name: 'Chad Gaudin', role: 'RP', throws: 'R', age: 23, g: 55, gs: 0, outs: 192, h: 64, hr: 6, bb: 36, so: 38, hbp: 2, er: 30, w: 4, l: 2, sv: 2, fld: 72 },
      { id: 'calerki01', name: 'Kiko Calero', role: 'RP', throws: 'R', age: 31, g: 70, gs: 0, outs: 174, h: 48, hr: 5, bb: 21, so: 63, hbp: 1, er: 22, w: 3, l: 2, sv: 2, fld: 67 },
      { id: 'duchsju01', name: 'Justin Duchscherer', role: 'RP', throws: 'R', age: 28, g: 53, gs: 0, outs: 167, h: 48, hr: 5, bb: 12, so: 49, hbp: 2, er: 17, w: 2, l: 1, sv: 9, fld: 63 },
      { id: 'harderi01', name: 'Rich Harden', role: 'RP', throws: 'R', age: 24, g: 9, gs: 9, outs: 140, h: 36, hr: 4, bb: 20, so: 45, hbp: 1, er: 18, w: 4, l: 0, sv: 0, fld: 84 },
    ],
    reservePitchers: [
      { id: 'kennejo04', name: 'Joe Kennedy', role: 'RP', throws: 'L', age: 27, g: 39, gs: 0, outs: 105, h: 38, hr: 3, bb: 14, so: 23, hbp: 1, er: 17, w: 4, l: 1, sv: 1, fld: 76 },
      { id: 'florero01', name: 'Ron Flores', role: 'RP', throws: 'L', age: 26, g: 25, gs: 0, outs: 89, h: 28, hr: 3, bb: 8, so: 20, hbp: 0, er: 10, w: 1, l: 2, sv: 1, fld: 72, rk: true },
      { id: 'witasja01', name: 'Jay Witasick', role: 'RP', throws: 'R', age: 33, g: 20, gs: 0, outs: 68, h: 23, hr: 2, bb: 14, so: 27, hbp: 2, er: 11, w: 1, l: 0, sv: 0, fld: 63 },
      { id: 'windsja01', name: 'Jason Windsor', role: 'RP', throws: 'R', age: 23, g: 4, gs: 3, outs: 41, h: 21, hr: 2, bb: 5, so: 6, hbp: 0, er: 10, w: 0, l: 1, sv: 0, fld: 62, rk: true },
      { id: 'keislra01', name: 'Randy Keisler', role: 'RP', throws: 'L', age: 30, g: 11, gs: 0, outs: 30, h: 12, hr: 2, bb: 4, so: 7, hbp: 0, er: 6, w: 0, l: 0, sv: 0, fld: 75 },
    ],
  },
  // SEA (SEA 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'putzjj01', name: 'J. J. Putz', role: 'CL', throws: 'R', age: 29, g: 72, gs: 0, outs: 235, h: 64, hr: 7, bb: 19, so: 80, hbp: 3, er: 25, w: 4, l: 1, sv: 36, fld: 62 },
      { id: 'woodsja01', name: 'Jake Woods', role: 'RP', throws: 'L', age: 24, g: 37, gs: 8, outs: 315, h: 115, hr: 14, bb: 50, so: 68, hbp: 3, er: 50, w: 7, l: 4, sv: 1, fld: 64, rk: true },
      { id: 'soriara01', name: 'Rafael Soriano', role: 'RP', throws: 'R', age: 26, g: 53, gs: 0, outs: 180, h: 46, hr: 5, bb: 20, so: 65, hbp: 2, er: 16, w: 1, l: 2, sv: 2, fld: 71 },
      { id: 'mateoju01', name: 'Julio Mateo', role: 'RP', throws: 'R', age: 28, g: 48, gs: 0, outs: 161, h: 57, hr: 8, bb: 17, so: 34, hbp: 4, er: 24, w: 9, l: 4, sv: 0, fld: 83 },
      { id: 'sherrge01', name: 'George Sherrill', role: 'RP', throws: 'L', age: 29, g: 72, gs: 0, outs: 120, h: 31, hr: 2, bb: 23, so: 42, hbp: 1, er: 20, w: 2, l: 4, sv: 1, fld: 61, rk: true },
      { id: 'guarded01', name: 'Eddie Guardado', role: 'RP', throws: 'L', age: 35, g: 43, gs: 0, outs: 111, h: 39, hr: 8, bb: 12, so: 38, hbp: 1, er: 14, w: 1, l: 3, sv: 13, fld: 71 },
    ],
    reservePitchers: [
      { id: 'frutoem01', name: 'Emiliano Fruto', role: 'RP', throws: 'R', age: 22, g: 23, gs: 0, outs: 108, h: 34, hr: 4, bb: 24, so: 34, hbp: 2, er: 22, w: 2, l: 2, sv: 1, fld: 80, rk: true },
      { id: 'baekch01', name: 'Cha-Seung Baek', role: 'RP', throws: 'R', age: 26, g: 6, gs: 6, outs: 103, h: 28, hr: 6, bb: 13, so: 22, hbp: 2, er: 15, w: 4, l: 1, sv: 0, fld: 63, rk: true },
      { id: 'greense01', name: 'Sean Green', role: 'RP', throws: 'R', age: 27, g: 24, gs: 0, outs: 96, h: 34, hr: 2, bb: 13, so: 15, hbp: 2, er: 16, w: 0, l: 0, sv: 0, fld: 69, rk: true },
      { id: 'lowema01', name: 'Mark Lowe', role: 'RP', throws: 'R', age: 23, g: 15, gs: 0, outs: 56, h: 12, hr: 1, bb: 9, so: 20, hbp: 2, er: 4, w: 1, l: 0, sv: 0, fld: 73, rk: true },
      { id: 'feierry01', name: 'Ryan Feierabend', role: 'RP', throws: 'L', age: 20, g: 4, gs: 2, outs: 51, h: 15, hr: 3, bb: 7, so: 11, hbp: 0, er: 7, w: 0, l: 1, sv: 0, fld: 67, rk: true },
    ],
  },
  // TEX (TEX 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'koronjo01', name: 'John Koronka', role: 'SP', throws: 'L', age: 25, g: 23, gs: 23, outs: 375, h: 145, hr: 17, bb: 48, so: 62, hbp: 5, er: 81, w: 7, l: 7, sv: 0, fld: 78, rk: true },
      { id: 'loeka01', name: 'Kameron Loe', role: 'SP', throws: 'R', age: 24, g: 15, gs: 15, outs: 235, h: 94, hr: 8, bb: 25, so: 37, hbp: 2, er: 43, w: 3, l: 6, sv: 0, fld: 88 },
      { id: 'tejedro01', name: 'Rob Tejeda', role: 'SP', throws: 'R', age: 24, g: 14, gs: 14, outs: 221, h: 73, hr: 8, bb: 38, so: 50, hbp: 5, er: 33, w: 5, l: 5, sv: 0, fld: 73 },
      { id: 'otsukak01', name: 'Akinori Otsuka', role: 'CL', throws: 'R', age: 34, g: 63, gs: 0, outs: 179, h: 49, hr: 3, bb: 19, so: 53, hbp: 1, er: 16, w: 2, l: 4, sv: 32, fld: 66 },
      { id: 'benoijo01', name: 'Joaquin Benoit', role: 'RP', throws: 'R', age: 28, g: 56, gs: 0, outs: 239, h: 71, hr: 8, bb: 34, so: 78, hbp: 3, er: 41, w: 1, l: 1, sv: 0, fld: 74 },
      { id: 'cordefr01', name: 'Francisco Cordero', role: 'RP', throws: 'R', age: 31, g: 77, gs: 0, outs: 226, h: 67, hr: 6, bb: 33, so: 85, hbp: 3, er: 28, w: 10, l: 5, sv: 22, fld: 54 },
      { id: 'bauerri01', name: 'Rick Bauer', role: 'RP', throws: 'R', age: 29, g: 58, gs: 1, outs: 213, h: 73, hr: 5, bb: 26, so: 38, hbp: 4, er: 32, w: 3, l: 1, sv: 2, fld: 75 },
      { id: 'mahayro01', name: 'Ron Mahay', role: 'RP', throws: 'L', age: 35, g: 62, gs: 0, outs: 171, h: 57, hr: 8, bb: 26, so: 51, hbp: 0, er: 27, w: 1, l: 3, sv: 0, fld: 85 },
      { id: 'wilsocj01', name: 'C. J. Wilson', role: 'RP', throws: 'L', age: 25, g: 44, gs: 0, outs: 133, h: 46, hr: 6, bb: 17, so: 35, hbp: 4, er: 25, w: 2, l: 4, sv: 1, fld: 69, rk: true },
    ],
    reservePitchers: [
      { id: 'rheinjo01', name: 'John Rheinecker', role: 'SP', throws: 'L', age: 27, g: 21, gs: 13, outs: 212, h: 104, hr: 6, bb: 19, so: 28, hbp: 3, er: 46, w: 4, l: 6, sv: 0, fld: 89, rk: true },
      { id: 'eatonad01', name: 'Adam Eaton', role: 'SP', throws: 'R', age: 28, g: 13, gs: 13, outs: 195, h: 74, hr: 9, bb: 22, so: 50, hbp: 3, er: 35, w: 7, l: 4, sv: 0, fld: 52 },
      { id: 'feldmsc01', name: 'Scott Feldman', role: 'RP', throws: 'R', age: 23, g: 36, gs: 0, outs: 124, h: 42, hr: 3, bb: 10, so: 29, hbp: 3, er: 16, w: 0, l: 2, sv: 0, fld: 63, rk: true },
      { id: 'littlwe01', name: 'Wes Littleton', role: 'RP', throws: 'R', age: 23, g: 33, gs: 0, outs: 109, h: 23, hr: 2, bb: 13, so: 17, hbp: 2, er: 7, w: 2, l: 1, sv: 1, fld: 75, rk: true },
      { id: 'volqued01', name: 'Edinson Volquez', role: 'RP', throws: 'R', age: 22, g: 8, gs: 8, outs: 100, h: 53, hr: 7, bb: 18, so: 17, hbp: 2, er: 31, w: 1, l: 6, sv: 0, fld: 54, rk: true },
    ],
  },
  // ATL (ATL 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'jamesch03', name: 'Chuck James', role: 'SP', throws: 'L', age: 24, g: 25, gs: 18, outs: 357, h: 101, hr: 19, bb: 48, so: 91, hbp: 6, er: 49, w: 11, l: 4, sv: 0, fld: 75, rk: true },
      { id: 'sosajo02', name: 'Jorge Sosa', role: 'SP', throws: 'R', age: 28, g: 45, gs: 13, outs: 354, h: 125, hr: 22, bb: 50, so: 81, hbp: 1, er: 58, w: 3, l: 11, sv: 4, fld: 88 },
      { id: 'thomsjo01', name: 'John Thomson', role: 'SP', throws: 'R', age: 32, g: 18, gs: 15, outs: 241, h: 92, hr: 8, bb: 26, so: 51, hbp: 2, er: 40, w: 2, l: 7, sv: 0, fld: 76 },
      { id: 'reitsch01', name: 'Chris Reitsma', role: 'CL', throws: 'R', age: 28, g: 27, gs: 0, outs: 84, h: 39, hr: 4, bb: 7, so: 18, hbp: 1, er: 18, w: 1, l: 2, sv: 8, fld: 74 },
      { id: 'villaos01', name: 'Oscar Villarreal', role: 'RP', throws: 'R', age: 24, g: 58, gs: 4, outs: 277, h: 93, hr: 13, bb: 28, so: 55, hbp: 5, er: 40, w: 9, l: 1, sv: 0, fld: 70 },
      { id: 'cormila01', name: 'Lance Cormier', role: 'RP', throws: 'R', age: 25, g: 29, gs: 9, outs: 221, h: 88, hr: 9, bb: 40, so: 48, hbp: 3, er: 44, w: 4, l: 5, sv: 0, fld: 68 },
      { id: 'rayke01', name: 'Ken Ray', role: 'RP', throws: 'R', age: 31, g: 69, gs: 0, outs: 203, h: 66, hr: 9, bb: 38, so: 50, hbp: 0, er: 34, w: 1, l: 1, sv: 5, fld: 75, rk: true },
      { id: 'mcbrima01', name: 'Macay McBride', role: 'RP', throws: 'L', age: 23, g: 71, gs: 0, outs: 170, h: 55, hr: 2, bb: 31, so: 52, hbp: 1, er: 25, w: 4, l: 1, sv: 1, fld: 80, rk: true },
      { id: 'paronch01', name: 'Chad Paronto', role: 'RP', throws: 'R', age: 30, g: 65, gs: 0, outs: 170, h: 53, hr: 5, bb: 19, so: 41, hbp: 3, er: 20, w: 2, l: 3, sv: 0, fld: 74 },
    ],
    reservePitchers: [
      { id: 'ramirho01', name: 'Horacio Ramirez', role: 'SP', throws: 'L', age: 26, g: 14, gs: 14, outs: 229, h: 83, hr: 10, bb: 29, so: 34, hbp: 2, er: 38, w: 5, l: 5, sv: 0, fld: 87 },
      { id: 'davieky01', name: 'Kyle Davies', role: 'SP', throws: 'R', age: 22, g: 14, gs: 14, outs: 190, h: 83, hr: 10, bb: 35, so: 49, hbp: 2, er: 49, w: 3, l: 7, sv: 0, fld: 67 },
      { id: 'yatesty01', name: 'Tyler Yates', role: 'RP', throws: 'R', age: 28, g: 56, gs: 0, outs: 150, h: 46, hr: 6, bb: 29, so: 43, hbp: 1, er: 25, w: 2, l: 5, sv: 1, fld: 60, rk: true },
      { id: 'barryke01', name: 'Kevin Barry', role: 'RP', throws: 'R', age: 27, g: 19, gs: 1, outs: 77, h: 24, hr: 2, bb: 14, so: 19, hbp: 1, er: 16, w: 1, l: 1, sv: 0, fld: 80, rk: true },
      { id: 'remlimi01', name: 'Mike Remlinger', role: 'RP', throws: 'L', age: 40, g: 36, gs: 0, outs: 67, h: 26, hr: 3, bb: 10, so: 20, hbp: 1, er: 13, w: 2, l: 4, sv: 2, fld: 76 },
    ],
  },
  // MIA (FLO 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'moehlbr01', name: 'Brian Moehler', role: 'SP', throws: 'R', age: 34, g: 29, gs: 21, outs: 366, h: 161, hr: 16, bb: 36, so: 66, hbp: 5, er: 77, w: 7, l: 11, sv: 0, fld: 58 },
      { id: 'borowjo01', name: 'Joe Borowski', role: 'CL', throws: 'R', age: 35, g: 72, gs: 0, outs: 209, h: 64, hr: 9, bb: 30, so: 57, hbp: 1, er: 33, w: 3, l: 3, sv: 36, fld: 59 },
      { id: 'hergema01', name: 'Matt Herges', role: 'RP', throws: 'R', age: 36, g: 66, gs: 0, outs: 213, h: 94, hr: 7, bb: 27, so: 35, hbp: 3, er: 39, w: 2, l: 3, sv: 0, fld: 69 },
      { id: 'messera01', name: 'Randy Messenger', role: 'RP', throws: 'R', age: 24, g: 59, gs: 0, outs: 181, h: 68, hr: 8, bb: 31, so: 45, hbp: 1, er: 37, w: 2, l: 7, sv: 0, fld: 73, rk: true },
      { id: 'vargaja01', name: 'Jason Vargas', role: 'RP', throws: 'L', age: 23, g: 12, gs: 5, outs: 129, h: 48, hr: 6, bb: 25, so: 32, hbp: 3, er: 28, w: 1, l: 2, sv: 0, fld: 75 },
      { id: 'mitrese01', name: 'Sergio Mitre', role: 'RP', throws: 'R', age: 25, g: 15, gs: 7, outs: 123, h: 46, hr: 7, bb: 18, so: 29, hbp: 4, er: 27, w: 1, l: 5, sv: 0, fld: 63 },
      { id: 'tanketa01', name: 'Taylor Tankersley', role: 'RP', throws: 'L', age: 23, g: 49, gs: 0, outs: 123, h: 33, hr: 4, bb: 26, so: 46, hbp: 1, er: 13, w: 2, l: 1, sv: 3, fld: 79, rk: true },
    ],
    reservePitchers: [
      { id: 'sanchan01', name: 'Anibal Sanchez', role: 'SP', throws: 'R', age: 22, g: 18, gs: 17, outs: 343, h: 90, hr: 9, bb: 46, so: 72, hbp: 4, er: 36, w: 10, l: 3, sv: 0, fld: 69, rk: true },
      { id: 'kensilo01', name: 'Logan Kensing', role: 'RP', throws: 'R', age: 23, g: 37, gs: 0, outs: 113, h: 34, hr: 7, bb: 19, so: 39, hbp: 3, er: 23, w: 1, l: 3, sv: 1, fld: 69, rk: true },
      { id: 'pintore01', name: 'Renyel Pinto', role: 'RP', throws: 'L', age: 23, g: 27, gs: 0, outs: 89, h: 20, hr: 3, bb: 27, so: 36, hbp: 1, er: 10, w: 0, l: 0, sv: 1, fld: 81, rk: true },
      { id: 'petityu01', name: 'Yusmeiro Petit', role: 'RP', throws: 'R', age: 21, g: 15, gs: 1, outs: 79, h: 46, hr: 7, bb: 9, so: 20, hbp: 0, er: 28, w: 1, l: 1, sv: 0, fld: 66, rk: true },
      { id: 'resopch01', name: 'Chris Resop', role: 'RP', throws: 'R', age: 23, g: 22, gs: 0, outs: 64, h: 27, hr: 1, bb: 15, so: 13, hbp: 1, er: 12, w: 1, l: 2, sv: 0, fld: 71, rk: true },
    ],
  },
  // NYM (NYN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'martipe02', name: 'Pedro Martinez', role: 'SP', throws: 'R', age: 34, g: 23, gs: 23, outs: 398, h: 108, hr: 16, bb: 35, so: 136, hbp: 7, er: 55, w: 9, l: 8, sv: 0, fld: 77 },
      { id: 'mainejo01', name: 'John Maine', role: 'SP', throws: 'R', age: 25, g: 16, gs: 15, outs: 270, h: 72, hr: 15, bb: 37, so: 65, hbp: 2, er: 42, w: 6, l: 5, sv: 0, fld: 64, rk: true },
      { id: 'wagnebi02', name: 'Billy Wagner', role: 'CL', throws: 'L', age: 34, g: 70, gs: 0, outs: 217, h: 53, hr: 7, bb: 19, so: 92, hbp: 4, er: 17, w: 3, l: 2, sv: 40, fld: 79 },
      { id: 'heilmaa01', name: 'Aaron Heilman', role: 'RP', throws: 'R', age: 27, g: 74, gs: 0, outs: 261, h: 72, hr: 5, bb: 29, so: 78, hbp: 4, er: 34, w: 4, l: 5, sv: 0, fld: 64 },
      { id: 'oliveda02', name: 'Darren Oliver', role: 'RP', throws: 'L', age: 35, g: 45, gs: 0, outs: 243, h: 75, hr: 13, bb: 21, so: 57, hbp: 3, er: 36, w: 4, l: 1, sv: 0, fld: 59 },
      { id: 'bradfch01', name: 'Chad Bradford', role: 'RP', throws: 'R', age: 31, g: 70, gs: 0, outs: 186, h: 59, hr: 2, bb: 15, so: 39, hbp: 2, er: 23, w: 4, l: 2, sv: 2, fld: 82 },
      { id: 'felicpe01', name: 'Pedro Feliciano', role: 'RP', throws: 'L', age: 29, g: 64, gs: 0, outs: 181, h: 55, hr: 4, bb: 22, so: 53, hbp: 3, er: 16, w: 7, l: 2, sv: 0, fld: 47 },
      { id: 'sanchdu01', name: 'Duaner Sanchez', role: 'RP', throws: 'R', age: 26, g: 49, gs: 0, outs: 166, h: 48, hr: 5, bb: 23, so: 42, hbp: 3, er: 19, w: 5, l: 1, sv: 0, fld: 75 },
    ],
    reservePitchers: [
      { id: 'soleral01', name: 'Alay Soler', role: 'RP', throws: 'R', age: 26, g: 8, gs: 8, outs: 135, h: 50, hr: 7, bb: 21, so: 23, hbp: 1, er: 30, w: 2, l: 3, sv: 0, fld: 67, rk: true },
      { id: 'bannibr01', name: 'Brian Bannister', role: 'RP', throws: 'R', age: 25, g: 8, gs: 6, outs: 114, h: 34, hr: 4, bb: 22, so: 19, hbp: 2, er: 18, w: 2, l: 1, sv: 0, fld: 66, rk: true },
      { id: 'bellhe01', name: 'Heath Bell', role: 'RP', throws: 'R', age: 28, g: 22, gs: 0, outs: 111, h: 48, hr: 5, bb: 11, so: 36, hbp: 0, er: 22, w: 0, l: 0, sv: 0, fld: 64 },
      { id: 'pelfrmi01', name: 'Mike Pelfrey', role: 'RP', throws: 'R', age: 22, g: 4, gs: 4, outs: 64, h: 25, hr: 1, bb: 12, so: 13, hbp: 3, er: 13, w: 2, l: 1, sv: 0, fld: 77, rk: true },
      { id: 'zambrvi01', name: 'Victor Zambrano', role: 'RP', throws: 'R', age: 30, g: 5, gs: 5, outs: 64, h: 21, hr: 2, bb: 12, so: 16, hbp: 2, er: 11, w: 1, l: 2, sv: 0, fld: 73 },
    ],
  },
  // PHI (PHI 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'hamelco01', name: 'Cole Hamels', role: 'SP', throws: 'L', age: 22, g: 23, gs: 23, outs: 397, h: 117, hr: 19, bb: 48, so: 145, hbp: 3, er: 60, w: 9, l: 8, sv: 0, fld: 78, rk: true },
      { id: 'gordoto01', name: 'Tom Gordon', role: 'CL', throws: 'R', age: 38, g: 59, gs: 0, outs: 178, h: 48, hr: 7, bb: 21, so: 63, hbp: 1, er: 19, w: 3, l: 4, sv: 34, fld: 60 },
      { id: 'gearyge01', name: 'Geoff Geary', role: 'RP', throws: 'R', age: 29, g: 81, gs: 0, outs: 274, h: 99, hr: 8, bb: 25, so: 62, hbp: 5, er: 35, w: 7, l: 1, sv: 1, fld: 79 },
      { id: 'frankry01', name: 'Ryan Franklin', role: 'RP', throws: 'R', age: 33, g: 66, gs: 0, outs: 232, h: 88, hr: 12, bb: 27, so: 41, hbp: 3, er: 43, w: 6, l: 7, sv: 0, fld: 60 },
      { id: 'fultzaa01', name: 'Aaron Fultz', role: 'RP', throws: 'L', age: 32, g: 66, gs: 1, outs: 214, h: 70, hr: 7, bb: 28, so: 60, hbp: 3, er: 31, w: 3, l: 1, sv: 0, fld: 54 },
      { id: 'whiteri01', name: 'Rick White', role: 'RP', throws: 'R', age: 37, g: 64, gs: 0, outs: 194, h: 73, hr: 7, bb: 22, so: 37, hbp: 3, er: 33, w: 4, l: 1, sv: 1, fld: 74 },
      { id: 'cormirh01', name: 'Rheal Cormier', role: 'RP', throws: 'L', age: 39, g: 64, gs: 0, outs: 144, h: 49, hr: 6, bb: 16, so: 26, hbp: 3, er: 20, w: 2, l: 3, sv: 0, fld: 64 },
    ],
    reservePitchers: [
      { id: 'wolfra02', name: 'Randy Wolf', role: 'SP', throws: 'L', age: 29, g: 12, gs: 12, outs: 170, h: 64, hr: 11, bb: 24, so: 43, hbp: 3, er: 31, w: 4, l: 0, sv: 0, fld: 69 },
      { id: 'floydga01', name: 'Gavin Floyd', role: 'SP', throws: 'R', age: 23, g: 11, gs: 11, outs: 163, h: 66, hr: 12, bb: 32, so: 36, hbp: 5, er: 45, w: 4, l: 3, sv: 0, fld: 83 },
      { id: 'rhodear01', name: 'Arthur Rhodes', role: 'RP', throws: 'L', age: 36, g: 55, gs: 0, outs: 137, h: 46, hr: 3, bb: 25, so: 48, hbp: 1, er: 22, w: 0, l: 5, sv: 4, fld: 76 },
      { id: 'mathisc01', name: 'Scott Mathieson', role: 'RP', throws: 'R', age: 22, g: 9, gs: 8, outs: 112, h: 48, hr: 8, bb: 16, so: 28, hbp: 1, er: 31, w: 1, l: 4, sv: 0, fld: 72, rk: true },
      { id: 'castrfa01', name: 'Fabio Castro', role: 'RP', throws: 'L', age: 21, g: 20, gs: 0, outs: 95, h: 18, hr: 1, bb: 13, so: 18, hbp: 2, er: 8, w: 0, l: 1, sv: 1, fld: 68, rk: true },
    ],
  },
  // WSH (WAS 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'oconnmi01', name: 'Mike O\'Connor', role: 'SP', throws: 'L', age: 25, g: 21, gs: 20, outs: 315, h: 96, hr: 15, bb: 45, so: 59, hbp: 7, er: 56, w: 3, l: 8, sv: 0, fld: 66, rk: true },
      { id: 'astacpe01', name: 'Pedro Astacio', role: 'SP', throws: 'R', age: 37, g: 17, gs: 17, outs: 271, h: 105, hr: 13, bb: 30, so: 50, hbp: 1, er: 56, w: 5, l: 5, sv: 0, fld: 54 },
      { id: 'cordech01', name: 'Chad Cordero', role: 'CL', throws: 'R', age: 24, g: 68, gs: 0, outs: 220, h: 58, hr: 11, bb: 23, so: 67, hbp: 2, er: 22, w: 7, l: 4, sv: 29, fld: 81 },
      { id: 'rauchjo01', name: 'Jon Rauch', role: 'RP', throws: 'R', age: 27, g: 85, gs: 0, outs: 274, h: 78, hr: 12, bb: 35, so: 82, hbp: 2, er: 34, w: 4, l: 5, sv: 2, fld: 83 },
      { id: 'majewga01', name: 'Gary Majewski', role: 'RP', throws: 'R', age: 26, g: 65, gs: 0, outs: 211, h: 75, hr: 4, bb: 29, so: 43, hbp: 5, er: 31, w: 4, l: 4, sv: 0, fld: 64 },
      { id: 'stantmi02', name: 'Mike Stanton', role: 'RP', throws: 'L', age: 39, g: 82, gs: 0, outs: 203, h: 70, hr: 3, bb: 27, so: 48, hbp: 1, er: 30, w: 7, l: 7, sv: 8, fld: 60 },
      { id: 'bergmja01', name: 'Jason Bergmann', role: 'RP', throws: 'R', age: 24, g: 29, gs: 6, outs: 194, h: 76, hr: 11, bb: 29, so: 57, hbp: 6, er: 44, w: 0, l: 2, sv: 0, fld: 70, rk: true },
      { id: 'riversa01', name: 'Saul Rivera', role: 'RP', throws: 'R', age: 28, g: 54, gs: 0, outs: 181, h: 59, hr: 4, bb: 32, so: 41, hbp: 4, er: 23, w: 3, l: 0, sv: 1, fld: 65, rk: true },
    ],
    reservePitchers: [
      { id: 'trabebi01', name: 'Billy Traber', role: 'RP', throws: 'L', age: 26, g: 15, gs: 8, outs: 130, h: 53, hr: 5, bb: 14, so: 25, hbp: 8, er: 31, w: 4, l: 3, sv: 0, fld: 56 },
      { id: 'pattejo02', name: 'John Patterson', role: 'RP', throws: 'R', age: 28, g: 8, gs: 8, outs: 122, h: 36, hr: 4, bb: 13, so: 38, hbp: 2, er: 16, w: 1, l: 2, sv: 0, fld: 78 },
      { id: 'dayza01', name: 'Zach Day', role: 'RP', throws: 'R', age: 28, g: 8, gs: 8, outs: 120, h: 49, hr: 5, bb: 21, so: 20, hbp: 2, er: 26, w: 2, l: 5, sv: 0, fld: 72 },
      { id: 'hillsh01', name: 'Shawn Hill', role: 'RP', throws: 'R', age: 25, g: 6, gs: 6, outs: 110, h: 44, hr: 2, bb: 13, so: 18, hbp: 3, er: 22, w: 1, l: 3, sv: 0, fld: 61, rk: true },
      { id: 'wagnery01', name: 'Ryan Wagner', role: 'RP', throws: 'R', age: 23, g: 26, gs: 0, outs: 92, h: 37, hr: 3, bb: 14, so: 23, hbp: 2, er: 18, w: 3, l: 3, sv: 0, fld: 78 },
    ],
  },
  // CHC (CHN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'marshse01', name: 'Sean Marshall', role: 'SP', throws: 'L', age: 23, g: 24, gs: 24, outs: 377, h: 132, hr: 20, bb: 59, so: 77, hbp: 7, er: 78, w: 6, l: 9, sv: 0, fld: 78, rk: true },
      { id: 'hillri01', name: 'Rich Hill', role: 'SP', throws: 'L', age: 26, g: 17, gs: 16, outs: 298, h: 84, hr: 15, bb: 43, so: 88, hbp: 2, er: 53, w: 6, l: 7, sv: 0, fld: 53, rk: true },
      { id: 'marmoca01', name: 'Carlos Marmol', role: 'SP', throws: 'R', age: 23, g: 19, gs: 13, outs: 231, h: 71, hr: 14, bb: 59, so: 59, hbp: 5, er: 52, w: 5, l: 7, sv: 0, fld: 83, rk: true },
      { id: 'dempsry01', name: 'Ryan Dempster', role: 'CL', throws: 'R', age: 29, g: 74, gs: 0, outs: 225, h: 73, hr: 4, bb: 38, so: 70, hbp: 3, er: 34, w: 1, l: 9, sv: 24, fld: 69 },
      { id: 'howrybo01', name: 'Bob Howry', role: 'RP', throws: 'R', age: 32, g: 84, gs: 0, outs: 230, h: 65, hr: 7, bb: 18, so: 65, hbp: 2, er: 25, w: 4, l: 5, sv: 5, fld: 48 },
      { id: 'novoaro01', name: 'Roberto Novoa', role: 'RP', throws: 'R', age: 26, g: 66, gs: 0, outs: 228, h: 78, hr: 13, bb: 34, so: 60, hbp: 4, er: 37, w: 2, l: 1, sv: 0, fld: 71 },
      { id: 'ruschgl01', name: 'Glendon Rusch', role: 'RP', throws: 'L', age: 31, g: 25, gs: 9, outs: 199, h: 83, hr: 11, bb: 27, so: 55, hbp: 1, er: 41, w: 3, l: 8, sv: 0, fld: 70 },
      { id: 'ohmanwi01', name: 'Will Ohman', role: 'RP', throws: 'L', age: 28, g: 78, gs: 0, outs: 196, h: 50, hr: 7, bb: 35, so: 72, hbp: 5, er: 27, w: 1, l: 1, sv: 0, fld: 70 },
      { id: 'eyresc01', name: 'Scott Eyre', role: 'RP', throws: 'L', age: 34, g: 74, gs: 0, outs: 184, h: 55, hr: 8, bb: 29, so: 68, hbp: 1, er: 23, w: 1, l: 3, sv: 0, fld: 60 },
    ],
    reservePitchers: [
      { id: 'guzmaan01', name: 'Angel Guzman', role: 'SP', throws: 'R', age: 24, g: 15, gs: 10, outs: 168, h: 68, hr: 9, bb: 37, so: 60, hbp: 6, er: 46, w: 0, l: 6, sv: 0, fld: 83, rk: true },
      { id: 'aardsda01', name: 'David Aardsma', role: 'RP', throws: 'R', age: 24, g: 45, gs: 0, outs: 159, h: 44, hr: 9, bb: 29, so: 46, hbp: 2, er: 24, w: 3, l: 0, sv: 0, fld: 69, rk: true },
      { id: 'mateoju02', name: 'Juan Mateo', role: 'SP', throws: 'R', age: 23, g: 11, gs: 10, outs: 137, h: 51, hr: 6, bb: 23, so: 35, hbp: 3, er: 27, w: 1, l: 3, sv: 0, fld: 51, rk: true },
      { id: 'priorma01', name: 'Mark Prior', role: 'RP', throws: 'R', age: 25, g: 9, gs: 9, outs: 131, h: 44, hr: 8, bb: 21, so: 52, hbp: 3, er: 24, w: 1, l: 6, sv: 0, fld: 68 },
      { id: 'wuertmi01', name: 'Michael Wuertz', role: 'RP', throws: 'R', age: 27, g: 41, gs: 0, outs: 122, h: 33, hr: 4, bb: 19, so: 45, hbp: 0, er: 15, w: 3, l: 1, sv: 0, fld: 59 },
    ],
  },
  // CIN (CIN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'ramirel01', name: 'Elizardo Ramirez', role: 'SP', throws: 'R', age: 23, g: 21, gs: 19, outs: 312, h: 125, hr: 15, bb: 31, so: 65, hbp: 8, er: 65, w: 4, l: 9, sv: 0, fld: 76, rk: true },
      { id: 'clausbr01', name: 'Brandon Claussen', role: 'SP', throws: 'L', age: 27, g: 14, gs: 14, outs: 231, h: 89, hr: 12, bb: 29, so: 57, hbp: 4, er: 45, w: 3, l: 8, sv: 0, fld: 59 },
      { id: 'weathda01', name: 'David Weathers', role: 'CL', throws: 'R', age: 36, g: 67, gs: 0, outs: 221, h: 65, hr: 10, bb: 31, so: 53, hbp: 2, er: 31, w: 4, l: 4, sv: 12, fld: 84 },
      { id: 'coffeto01', name: 'Todd Coffey', role: 'RP', throws: 'R', age: 25, g: 81, gs: 0, outs: 234, h: 92, hr: 7, bb: 23, so: 51, hbp: 3, er: 33, w: 6, l: 7, sv: 8, fld: 61 },
      { id: 'braybi01', name: 'Bill Bray', role: 'RP', throws: 'L', age: 23, g: 48, gs: 0, outs: 152, h: 57, hr: 5, bb: 18, so: 39, hbp: 1, er: 23, w: 3, l: 2, sv: 2, fld: 92, rk: true },
      { id: 'belisma01', name: 'Matt Belisle', role: 'RP', throws: 'R', age: 26, g: 30, gs: 2, outs: 120, h: 46, hr: 5, bb: 15, so: 27, hbp: 3, er: 18, w: 2, l: 0, sv: 0, fld: 50 },
      { id: 'michach01', name: 'Chris Michalak', role: 'RP', throws: 'L', age: 35, g: 8, gs: 6, outs: 105, h: 42, hr: 6, bb: 16, so: 10, hbp: 3, er: 19, w: 2, l: 4, sv: 0, fld: 74 },
      { id: 'hammoch01', name: 'Chris Hammond', role: 'RP', throws: 'L', age: 40, g: 29, gs: 0, outs: 86, h: 31, hr: 4, bb: 6, so: 20, hbp: 1, er: 15, w: 1, l: 1, sv: 0, fld: 55 },
    ],
    reservePitchers: [
      { id: 'willida07', name: 'David Williams', role: 'SP', throws: 'L', age: 27, g: 14, gs: 13, outs: 207, h: 80, hr: 12, bb: 26, so: 42, hbp: 5, er: 42, w: 5, l: 4, sv: 0, fld: 65 },
      { id: 'maysjo01', name: 'Joe Mays', role: 'SP', throws: 'R', age: 30, g: 13, gs: 10, outs: 152, h: 75, hr: 9, bb: 19, so: 22, hbp: 1, er: 40, w: 0, l: 5, sv: 0, fld: 60 },
      { id: 'merckke01', name: 'Kent Mercker', role: 'RP', throws: 'L', age: 38, g: 37, gs: 0, outs: 85, h: 27, hr: 4, bb: 11, so: 21, hbp: 1, er: 11, w: 1, l: 1, sv: 1, fld: 65 },
      { id: 'burnsmi01', name: 'Mike Burns', role: 'RP', throws: 'R', age: 27, g: 18, gs: 0, outs: 63, h: 32, hr: 3, bb: 5, so: 16, hbp: 3, er: 16, w: 0, l: 0, sv: 0, fld: 76, rk: true },
      { id: 'standja01', name: 'Jason Standridge', role: 'RP', throws: 'R', age: 27, g: 21, gs: 0, outs: 56, h: 21, hr: 2, bb: 11, so: 14, hbp: 1, er: 10, w: 1, l: 1, sv: 0, fld: 62 },
    ],
  },
  // MIL (MIL 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'sheetbe01', name: 'Ben Sheets', role: 'SP', throws: 'R', age: 27, g: 17, gs: 17, outs: 318, h: 99, hr: 11, bb: 14, so: 110, hbp: 2, er: 40, w: 6, l: 7, sv: 0, fld: 67 },
      { id: 'ohkato01', name: 'Tomo Ohka', role: 'SP', throws: 'R', age: 30, g: 18, gs: 18, outs: 291, h: 102, hr: 12, bb: 31, so: 51, hbp: 3, er: 46, w: 4, l: 5, sv: 0, fld: 66 },
      { id: 'turnbde01', name: 'Derrick Turnbow', role: 'CL', throws: 'R', age: 28, g: 64, gs: 0, outs: 169, h: 52, hr: 7, bb: 33, so: 65, hbp: 3, er: 30, w: 4, l: 9, sv: 24, fld: 62 },
      { id: 'capeljo01', name: 'Jose Capellan', role: 'RP', throws: 'R', age: 25, g: 61, gs: 0, outs: 215, h: 68, hr: 10, bb: 30, so: 58, hbp: 3, er: 35, w: 4, l: 2, sv: 0, fld: 86, rk: true },
      { id: 'gonzaje01', name: 'Geremi Gonzalez', role: 'RP', throws: 'R', age: 31, g: 24, gs: 4, outs: 168, h: 71, hr: 9, bb: 21, so: 36, hbp: 2, er: 38, w: 4, l: 2, sv: 0, fld: 70 },
      { id: 'villaca01', name: 'Carlos Villanueva', role: 'RP', throws: 'R', age: 22, g: 10, gs: 6, outs: 161, h: 43, hr: 8, bb: 11, so: 39, hbp: 4, er: 22, w: 2, l: 2, sv: 0, fld: 72, rk: true },
      { id: 'kolbda01', name: 'Danny Kolb', role: 'RP', throws: 'R', age: 31, g: 53, gs: 0, outs: 145, h: 55, hr: 4, bb: 20, so: 27, hbp: 1, er: 26, w: 2, l: 2, sv: 1, fld: 67 },
      { id: 'wisema01', name: 'Matt Wise', role: 'RP', throws: 'R', age: 30, g: 40, gs: 0, outs: 133, h: 38, hr: 5, bb: 16, so: 34, hbp: 2, er: 19, w: 5, l: 6, sv: 0, fld: 69 },
    ],
    reservePitchers: [
      { id: 'jacksza01', name: 'Zach Jackson', role: 'RP', throws: 'L', age: 23, g: 8, gs: 7, outs: 115, h: 48, hr: 6, bb: 14, so: 22, hbp: 4, er: 23, w: 2, l: 2, sv: 0, fld: 69, rk: true },
      { id: 'shousbr01', name: 'Brian Shouse', role: 'RP', throws: 'L', age: 37, g: 65, gs: 0, outs: 115, h: 40, hr: 4, bb: 16, so: 26, hbp: 4, er: 19, w: 1, l: 3, sv: 2, fld: 61 },
      { id: 'helliri01', name: 'Rick Helling', role: 'RP', throws: 'R', age: 35, g: 20, gs: 2, outs: 105, h: 26, hr: 4, bb: 14, so: 31, hbp: 1, er: 13, w: 0, l: 2, sv: 0, fld: 86 },
      { id: 'evelada01', name: 'Dana Eveland', role: 'RP', throws: 'L', age: 22, g: 9, gs: 5, outs: 83, h: 38, hr: 3, bb: 16, so: 28, hbp: 3, er: 23, w: 0, l: 3, sv: 0, fld: 61, rk: true },
      { id: 'lehrju01', name: 'Justin Lehr', role: 'RP', throws: 'R', age: 28, g: 16, gs: 0, outs: 47, h: 19, hr: 2, bb: 8, so: 11, hbp: 1, er: 11, w: 2, l: 1, sv: 0, fld: 74 },
    ],
  },
  // PIT (PIT 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'santovi01', name: 'Victor Santos', role: 'SP', throws: 'R', age: 29, g: 25, gs: 19, outs: 346, h: 139, hr: 16, bb: 46, so: 81, hbp: 4, er: 67, w: 5, l: 9, sv: 0, fld: 61 },
      { id: 'perezol01', name: 'Oliver Perez', role: 'SP', throws: 'L', age: 24, g: 22, gs: 22, outs: 338, h: 116, hr: 20, bb: 67, so: 117, hbp: 6, er: 70, w: 3, l: 13, sv: 0, fld: 60 },
      { id: 'gonzami02', name: 'Mike Gonzalez', role: 'CL', throws: 'L', age: 28, g: 54, gs: 0, outs: 162, h: 41, hr: 2, bb: 29, so: 65, hbp: 2, er: 14, w: 3, l: 4, sv: 24, fld: 79 },
      { id: 'torresa01', name: 'Salomon Torres', role: 'RP', throws: 'R', age: 34, g: 94, gs: 0, outs: 280, h: 91, hr: 7, bb: 36, so: 67, hbp: 6, er: 32, w: 3, l: 6, sv: 12, fld: 72 },
      { id: 'cappsma01', name: 'Matt Capps', role: 'RP', throws: 'R', age: 22, g: 85, gs: 0, outs: 242, h: 81, hr: 12, bb: 12, so: 56, hbp: 4, er: 34, w: 9, l: 1, sv: 1, fld: 69, rk: true },
      { id: 'grabojo02', name: 'John Grabow', role: 'RP', throws: 'L', age: 27, g: 72, gs: 0, outs: 209, h: 69, hr: 8, bb: 31, so: 64, hbp: 2, er: 34, w: 4, l: 2, sv: 0, fld: 72 },
      { id: 'hernaro01', name: 'Roberto Hernandez', role: 'RP', throws: 'R', age: 41, g: 68, gs: 0, outs: 191, h: 60, hr: 6, bb: 30, so: 52, hbp: 1, er: 23, w: 0, l: 3, sv: 2, fld: 69 },
      { id: 'marteda01', name: 'Damaso Marte', role: 'RP', throws: 'L', age: 31, g: 75, gs: 0, outs: 175, h: 51, hr: 6, bb: 33, so: 62, hbp: 4, er: 24, w: 1, l: 7, sv: 0, fld: 63 },
    ],
    reservePitchers: [
      { id: 'gorzeto01', name: 'Tom Gorzelanny', role: 'SP', throws: 'L', age: 23, g: 11, gs: 11, outs: 185, h: 53, hr: 3, bb: 31, so: 39, hbp: 4, er: 29, w: 2, l: 5, sv: 0, fld: 69, rk: true },
      { id: 'wellski01', name: 'Kip Wells', role: 'RP', throws: 'R', age: 29, g: 9, gs: 9, outs: 133, h: 52, hr: 5, bb: 24, so: 32, hbp: 3, er: 27, w: 2, l: 5, sv: 0, fld: 77 },
      { id: 'vogelry01', name: 'Ryan Vogelsong', role: 'RP', throws: 'R', age: 28, g: 20, gs: 0, outs: 114, h: 42, hr: 4, bb: 18, so: 26, hbp: 4, er: 24, w: 0, l: 0, sv: 0, fld: 82 },
      { id: 'youmash01', name: 'Shane Youman', role: 'RP', throws: 'L', age: 26, g: 5, gs: 3, outs: 65, h: 15, hr: 1, bb: 10, so: 5, hbp: 0, er: 7, w: 0, l: 2, sv: 0, fld: 73, rk: true },
      { id: 'mcleama01', name: 'Marty McLeary', role: 'RP', throws: 'R', age: 31, g: 5, gs: 2, outs: 53, h: 18, hr: 2, bb: 6, so: 9, hbp: 0, er: 6, w: 2, l: 0, sv: 0, fld: 67, rk: true },
    ],
  },
  // STL (SLN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'muldema01', name: 'Mark Mulder', role: 'SP', throws: 'L', age: 28, g: 17, gs: 17, outs: 280, h: 109, hr: 13, bb: 35, so: 55, hbp: 5, er: 54, w: 6, l: 7, sv: 0, fld: 74 },
      { id: 'reyesan01', name: 'Anthony Reyes', role: 'SP', throws: 'R', age: 24, g: 17, gs: 17, outs: 256, h: 81, hr: 17, bb: 34, so: 74, hbp: 6, er: 47, w: 5, l: 8, sv: 0, fld: 86, rk: true },
      { id: 'isrinja01', name: 'Jason Isringhausen', role: 'CL', throws: 'R', age: 33, g: 59, gs: 0, outs: 175, h: 47, hr: 7, bb: 32, so: 54, hbp: 2, er: 20, w: 4, l: 8, sv: 33, fld: 71 },
      { id: 'hancojo01', name: 'Josh Hancock', role: 'RP', throws: 'R', age: 28, g: 62, gs: 0, outs: 231, h: 72, hr: 11, bb: 23, so: 46, hbp: 1, er: 35, w: 3, l: 3, sv: 1, fld: 76 },
      { id: 'wainwad01', name: 'Adam Wainwright', role: 'RP', throws: 'R', age: 24, g: 61, gs: 0, outs: 225, h: 64, hr: 7, bb: 22, so: 71, hbp: 4, er: 27, w: 2, l: 1, sv: 3, fld: 72, rk: true },
      { id: 'loopebr01', name: 'Braden Looper', role: 'RP', throws: 'R', age: 31, g: 69, gs: 0, outs: 220, h: 76, hr: 5, bb: 21, so: 41, hbp: 3, er: 28, w: 9, l: 3, sv: 0, fld: 72 },
      { id: 'thompbr01', name: 'Brad Thompson', role: 'RP', throws: 'R', age: 24, g: 43, gs: 1, outs: 170, h: 55, hr: 5, bb: 19, so: 32, hbp: 5, er: 21, w: 1, l: 2, sv: 0, fld: 59 },
      { id: 'florera01', name: 'Randy Flores', role: 'RP', throws: 'L', age: 30, g: 65, gs: 0, outs: 125, h: 46, hr: 5, bb: 19, so: 42, hbp: 2, er: 22, w: 1, l: 1, sv: 0, fld: 60 },
    ],
    reservePitchers: [
      { id: 'ponsosi01', name: 'Sidney Ponson', role: 'SP', throws: 'R', age: 29, g: 19, gs: 16, outs: 255, h: 111, hr: 10, bb: 32, so: 46, hbp: 3, er: 57, w: 4, l: 5, sv: 0, fld: 67 },
      { id: 'johnsty01', name: 'Tyler Johnson', role: 'RP', throws: 'L', age: 25, g: 56, gs: 0, outs: 109, h: 33, hr: 5, bb: 24, so: 38, hbp: 4, er: 19, w: 2, l: 4, sv: 0, fld: 56, rk: true },
      { id: 'kinnejo01', name: 'Josh Kinney', role: 'RP', throws: 'R', age: 27, g: 21, gs: 0, outs: 75, h: 17, hr: 3, bb: 8, so: 22, hbp: 1, er: 9, w: 0, l: 0, sv: 0, fld: 56, rk: true },
    ],
  },
  // ARI (ARI 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'gonzaen01', name: 'Enrique Gonzalez', role: 'SP', throws: 'R', age: 23, g: 22, gs: 18, outs: 319, h: 114, hr: 14, bb: 34, so: 66, hbp: 4, er: 67, w: 3, l: 7, sv: 0, fld: 83, rk: true },
      { id: 'cruzju02', name: 'Juan Cruz', role: 'SP', throws: 'R', age: 27, g: 31, gs: 15, outs: 284, h: 83, hr: 8, bb: 48, so: 89, hbp: 10, er: 46, w: 5, l: 6, sv: 0, fld: 63 },
      { id: 'valvejo01', name: 'Jose Valverde', role: 'CL', throws: 'R', age: 28, g: 44, gs: 0, outs: 148, h: 46, hr: 6, bb: 20, so: 65, hbp: 2, er: 24, w: 2, l: 3, sv: 18, fld: 81 },
      { id: 'meddebr01', name: 'Brandon Medders', role: 'RP', throws: 'R', age: 26, g: 60, gs: 0, outs: 215, h: 72, hr: 5, bb: 28, so: 54, hbp: 2, er: 26, w: 5, l: 3, sv: 0, fld: 74, rk: true },
      { id: 'lyonbr01', name: 'Brandon Lyon', role: 'RP', throws: 'R', age: 26, g: 68, gs: 0, outs: 208, h: 74, hr: 8, bb: 22, so: 43, hbp: 1, er: 33, w: 2, l: 4, sv: 0, fld: 65 },
      { id: 'juliojo01', name: 'Jorge Julio', role: 'RP', throws: 'R', age: 27, g: 62, gs: 0, outs: 198, h: 58, hr: 11, bb: 31, so: 72, hbp: 2, er: 35, w: 2, l: 4, sv: 16, fld: 74 },
      { id: 'vizcalu01', name: 'Luis Vizcaino', role: 'RP', throws: 'R', age: 31, g: 70, gs: 0, outs: 196, h: 57, hr: 8, bb: 27, so: 58, hbp: 3, er: 26, w: 4, l: 6, sv: 0, fld: 54 },
      { id: 'aquingr01', name: 'Greg Aquino', role: 'RP', throws: 'R', age: 28, g: 42, gs: 0, outs: 145, h: 54, hr: 8, bb: 24, so: 49, hbp: 4, er: 27, w: 2, l: 0, sv: 0, fld: 74 },
    ],
    reservePitchers: [
      { id: 'gonzaed01', name: 'Edgar Gonzalez', role: 'RP', throws: 'R', age: 23, g: 11, gs: 5, outs: 128, h: 49, hr: 9, bb: 11, so: 27, hbp: 3, er: 27, w: 3, l: 4, sv: 0, fld: 60 },
      { id: 'penato03', name: 'Tony Pena', role: 'RP', throws: 'R', age: 24, g: 25, gs: 0, outs: 92, h: 36, hr: 6, bb: 8, so: 21, hbp: 0, er: 19, w: 3, l: 4, sv: 1, fld: 82, rk: true },
      { id: 'grimsja01', name: 'Jason Grimsley', role: 'RP', throws: 'R', age: 38, g: 19, gs: 0, outs: 83, h: 28, hr: 4, bb: 11, so: 13, hbp: 0, er: 14, w: 1, l: 2, sv: 0, fld: 60 },
      { id: 'choatra01', name: 'Randy Choate', role: 'RP', throws: 'L', age: 30, g: 30, gs: 0, outs: 48, h: 18, hr: 0, bb: 7, so: 13, hbp: 2, er: 9, w: 0, l: 1, sv: 0, fld: 83 },
      { id: 'daiglca01', name: 'Casey Daigle', role: 'RP', throws: 'R', age: 25, g: 10, gs: 0, outs: 37, h: 15, hr: 2, bb: 6, so: 5, hbp: 0, er: 8, w: 0, l: 0, sv: 0, fld: 79, rk: true },
    ],
  },
  // COL (COL 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'fuentbr01', name: 'Brian Fuentes', role: 'CL', throws: 'L', age: 30, g: 66, gs: 0, outs: 196, h: 52, hr: 7, bb: 27, so: 74, hbp: 7, er: 25, w: 3, l: 4, sv: 30, fld: 82 },
      { id: 'mesajo01', name: 'Jose Mesa', role: 'RP', throws: 'R', age: 40, g: 79, gs: 0, outs: 217, h: 76, hr: 9, bb: 33, so: 41, hbp: 4, er: 32, w: 1, l: 5, sv: 1, fld: 64 },
      { id: 'ramirra02', name: 'Ramon Ramirez', role: 'RP', throws: 'R', age: 24, g: 61, gs: 0, outs: 203, h: 58, hr: 5, bb: 27, so: 61, hbp: 1, er: 26, w: 4, l: 3, sv: 0, fld: 80, rk: true },
      { id: 'martito02', name: 'Tom Martin', role: 'RP', throws: 'L', age: 36, g: 68, gs: 0, outs: 181, h: 64, hr: 5, bb: 25, so: 43, hbp: 4, er: 34, w: 2, l: 0, sv: 0, fld: 73 },
      { id: 'dohmasc01', name: 'Scott Dohmann', role: 'RP', throws: 'R', age: 28, g: 48, gs: 0, outs: 145, h: 57, hr: 9, bb: 31, so: 50, hbp: 2, er: 35, w: 2, l: 4, sv: 1, fld: 91 },
      { id: 'kingra01', name: 'Ray King', role: 'RP', throws: 'L', age: 32, g: 67, gs: 0, outs: 134, h: 51, hr: 5, bb: 19, so: 26, hbp: 3, er: 19, w: 1, l: 4, sv: 1, fld: 65 },
    ],
    reservePitchers: [
      { id: 'corpama01', name: 'Manny Corpas', role: 'RP', throws: 'R', age: 23, g: 35, gs: 0, outs: 97, h: 36, hr: 3, bb: 8, so: 27, hbp: 2, er: 13, w: 1, l: 2, sv: 0, fld: 74, rk: true },
      { id: 'corteda01', name: 'David Cortes', role: 'RP', throws: 'R', age: 32, g: 30, gs: 0, outs: 88, h: 32, hr: 4, bb: 6, so: 18, hbp: 1, er: 14, w: 3, l: 1, sv: 0, fld: 72 },
      { id: 'kimsu01', name: 'Sun-Woo Kim', role: 'RP', throws: 'R', age: 28, g: 8, gs: 1, outs: 41, h: 19, hr: 2, bb: 6, so: 10, hbp: 1, er: 10, w: 0, l: 1, sv: 0, fld: 66 },
      { id: 'hampsju01', name: 'Justin Hampson', role: 'RP', throws: 'L', age: 26, g: 5, gs: 1, outs: 36, h: 19, hr: 3, bb: 5, so: 9, hbp: 1, er: 10, w: 1, l: 0, sv: 0, fld: 81, rk: true },
    ],
  },
  // LAD (LAN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'tomkobr01', name: 'Brett Tomko', role: 'SP', throws: 'R', age: 33, g: 44, gs: 15, outs: 337, h: 120, hr: 14, bb: 33, so: 69, hbp: 2, er: 56, w: 8, l: 7, sv: 0, fld: 74 },
      { id: 'seleaa01', name: 'Aaron Sele', role: 'SP', throws: 'R', age: 36, g: 28, gs: 15, outs: 310, h: 122, hr: 13, bb: 33, so: 49, hbp: 3, er: 56, w: 8, l: 6, sv: 0, fld: 70 },
      { id: 'billich01', name: 'Chad Billingsley', role: 'SP', throws: 'R', age: 21, g: 18, gs: 16, outs: 270, h: 92, hr: 7, bb: 58, so: 59, hbp: 3, er: 38, w: 7, l: 4, sv: 0, fld: 54, rk: true },
      { id: 'saitota01', name: 'Takashi Saito', role: 'CL', throws: 'R', age: 36, g: 72, gs: 0, outs: 235, h: 48, hr: 3, bb: 23, so: 107, hbp: 2, er: 18, w: 6, l: 2, sv: 24, fld: 80, rk: true },
      { id: 'broxtjo01', name: 'Jonathan Broxton', role: 'RP', throws: 'R', age: 22, g: 68, gs: 0, outs: 229, h: 61, hr: 6, bb: 36, so: 98, hbp: 1, er: 25, w: 4, l: 1, sv: 3, fld: 68, rk: true },
      { id: 'beimejo01', name: 'Joe Beimel', role: 'RP', throws: 'L', age: 29, g: 62, gs: 0, outs: 210, h: 73, hr: 7, bb: 22, so: 29, hbp: 0, er: 25, w: 2, l: 1, sv: 2, fld: 70 },
      { id: 'baezda01', name: 'Danys Baez', role: 'RP', throws: 'R', age: 28, g: 57, gs: 0, outs: 179, h: 57, hr: 4, bb: 21, so: 41, hbp: 5, er: 25, w: 5, l: 6, sv: 9, fld: 74 },
      { id: 'kuoho01', name: 'Hung-Chih Kuo', role: 'RP', throws: 'L', age: 24, g: 28, gs: 5, outs: 179, h: 54, hr: 3, bb: 34, so: 73, hbp: 1, er: 29, w: 1, l: 5, sv: 0, fld: 70, rk: true },
      { id: 'hamulti01', name: 'Tim Hamulack', role: 'RP', throws: 'L', age: 29, g: 33, gs: 0, outs: 102, h: 38, hr: 8, bb: 21, so: 33, hbp: 2, er: 26, w: 0, l: 3, sv: 0, fld: 75, rk: true },
    ],
    reservePitchers: [
      { id: 'carragi01', name: 'Giovanni Carrara', role: 'RP', throws: 'R', age: 38, g: 25, gs: 0, outs: 83, h: 24, hr: 3, bb: 11, so: 22, hbp: 2, er: 11, w: 0, l: 1, sv: 1, fld: 66 },
      { id: 'osorifr01', name: 'Franquelis Osoria', role: 'RP', throws: 'R', age: 24, g: 12, gs: 0, outs: 53, h: 23, hr: 3, bb: 7, so: 12, hbp: 2, er: 12, w: 0, l: 2, sv: 0, fld: 74, rk: true },
      { id: 'stulter01', name: 'Eric Stults', role: 'RP', throws: 'L', age: 26, g: 6, gs: 2, outs: 53, h: 17, hr: 4, bb: 7, so: 5, hbp: 0, er: 11, w: 1, l: 0, sv: 0, fld: 84, rk: true },
      { id: 'cartela02', name: 'Lance Carter', role: 'RP', throws: 'R', age: 31, g: 10, gs: 0, outs: 35, h: 15, hr: 2, bb: 5, so: 6, hbp: 0, er: 7, w: 0, l: 1, sv: 0, fld: 69 },
    ],
  },
  // SDP (SDN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'hoffmtr01', name: 'Trevor Hoffman', role: 'CL', throws: 'R', age: 38, g: 65, gs: 0, outs: 189, h: 50, hr: 5, bb: 12, so: 54, hbp: 1, er: 17, w: 0, l: 2, sv: 46, fld: 85 },
      { id: 'linebsc01', name: 'Scott Linebrink', role: 'RP', throws: 'R', age: 29, g: 73, gs: 0, outs: 227, h: 64, hr: 7, bb: 23, so: 72, hbp: 1, er: 24, w: 7, l: 4, sv: 2, fld: 73 },
      { id: 'sweenbr01', name: 'Brian Sweeney', role: 'RP', throws: 'R', age: 32, g: 37, gs: 0, outs: 169, h: 55, hr: 6, bb: 15, so: 24, hbp: 1, er: 21, w: 2, l: 0, sv: 2, fld: 82, rk: true },
      { id: 'adkinjo01', name: 'Jon Adkins', role: 'RP', throws: 'R', age: 28, g: 55, gs: 0, outs: 163, h: 59, hr: 5, bb: 19, so: 30, hbp: 2, er: 26, w: 2, l: 1, sv: 0, fld: 74 },
      { id: 'embreal01', name: 'Alan Embree', role: 'RP', throws: 'L', age: 36, g: 73, gs: 0, outs: 157, h: 53, hr: 6, bb: 14, so: 45, hbp: 1, er: 28, w: 4, l: 3, sv: 0, fld: 79 },
      { id: 'meredcl01', name: 'Cla Meredith', role: 'RP', throws: 'R', age: 23, g: 45, gs: 0, outs: 152, h: 32, hr: 3, bb: 8, so: 35, hbp: 3, er: 10, w: 5, l: 1, sv: 0, fld: 58, rk: true },
    ],
    reservePitchers: [
      { id: 'thompmi03', name: 'Mike Thompson', role: 'SP', throws: 'R', age: 25, g: 19, gs: 16, outs: 276, h: 103, hr: 13, bb: 30, so: 35, hbp: 7, er: 51, w: 4, l: 5, sv: 0, fld: 59, rk: true },
      { id: 'cassisc01', name: 'Scott Cassidy', role: 'RP', throws: 'R', age: 30, g: 42, gs: 0, outs: 128, h: 42, hr: 8, bb: 17, so: 47, hbp: 1, er: 16, w: 6, l: 4, sv: 0, fld: 69 },
      { id: 'brocado01', name: 'Doug Brocail', role: 'RP', throws: 'R', age: 39, g: 25, gs: 0, outs: 85, h: 29, hr: 1, bb: 10, so: 21, hbp: 1, er: 15, w: 2, l: 2, sv: 0, fld: 62 },
      { id: 'brazede01', name: 'Dewon Brazelton', role: 'RP', throws: 'R', age: 26, g: 9, gs: 2, outs: 54, h: 22, hr: 3, bb: 12, so: 10, hbp: 1, er: 15, w: 0, l: 2, sv: 0, fld: 61 },
    ],
  },
  // SFG (SFN 2006)
  {
    ...
    pitchers: [
      ...
      { id: 'benitar01', name: 'Armando Benitez', role: 'CL', throws: 'R', age: 33, g: 41, gs: 0, outs: 115, h: 34, hr: 6, bb: 19, so: 33, hbp: 0, er: 14, w: 4, l: 2, sv: 17, fld: 61 },
      { id: 'correke01', name: 'Kevin Correia', role: 'RP', throws: 'R', age: 25, g: 48, gs: 0, outs: 209, h: 66, hr: 8, bb: 27, so: 53, hbp: 4, er: 31, w: 2, l: 0, sv: 0, fld: 76 },
      { id: 'accarje01', name: 'Jeremy Accardo', role: 'RP', throws: 'R', age: 24, g: 65, gs: 0, outs: 207, h: 73, hr: 7, bb: 20, so: 51, hbp: 1, er: 39, w: 2, l: 4, sv: 3, fld: 68, rk: true },
      { id: 'klinest02', name: 'Steve Kline', role: 'RP', throws: 'L', age: 33, g: 72, gs: 0, outs: 155, h: 51, hr: 5, bb: 25, so: 33, hbp: 1, er: 21, w: 4, l: 3, sv: 1, fld: 66 },
      { id: 'sanchjo01', name: 'Jonathan Sanchez', role: 'RP', throws: 'L', age: 23, g: 27, gs: 4, outs: 120, h: 39, hr: 2, bb: 23, so: 33, hbp: 4, er: 22, w: 3, l: 1, sv: 0, fld: 86, rk: true },
      { id: 'wilsobr01', name: 'Brian Wilson', role: 'RP', throws: 'R', age: 24, g: 31, gs: 0, outs: 90, h: 32, hr: 1, bb: 21, so: 23, hbp: 1, er: 18, w: 2, l: 3, sv: 1, fld: 78, rk: true },
    ],
    reservePitchers: [
      { id: 'hennebr01', name: 'Brad Hennessey', role: 'SP', throws: 'R', age: 26, g: 34, gs: 12, outs: 298, h: 99, hr: 12, bb: 42, so: 48, hbp: 7, er: 49, w: 5, l: 6, sv: 1, fld: 77 },
      { id: 'muntesc01', name: 'Scott Munter', role: 'RP', throws: 'R', age: 26, g: 27, gs: 0, outs: 68, h: 29, hr: 1, bb: 13, so: 7, hbp: 1, er: 15, w: 0, l: 1, sv: 0, fld: 64, rk: true },
      { id: 'worreti01', name: 'Tim Worrell', role: 'RP', throws: 'R', age: 38, g: 23, gs: 0, outs: 61, h: 25, hr: 5, bb: 6, so: 16, hbp: 1, er: 12, w: 3, l: 2, sv: 6, fld: 75 },
      { id: 'taschja01', name: 'Jack Taschner', role: 'RP', throws: 'L', age: 28, g: 24, gs: 0, outs: 58, h: 25, hr: 2, bb: 9, so: 17, hbp: 1, er: 13, w: 0, l: 1, sv: 0, fld: 80, rk: true },
      { id: 'fasseje01', name: 'Jeff Fassero', role: 'RP', throws: 'L', age: 43, g: 10, gs: 1, outs: 45, h: 19, hr: 2, bb: 6, so: 10, hbp: 0, er: 9, w: 1, l: 1, sv: 0, fld: 62 },
    ],
  },
];
