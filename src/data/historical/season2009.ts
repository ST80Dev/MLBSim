...
export const SEASON_2009: HistTeam[] = [
  // BAL (BAL 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'bergebr02', name: 'Brad Bergesen', role: 'SP', throws: 'R', age: 23, g: 19, gs: 19, outs: 370, h: 126, hr: 11, bb: 32, so: 65, hbp: 5, er: 47, w: 7, l: 5, sv: 0, fld: 62, rk: true },
      { id: 'berkeja01', name: 'Jason Berken', role: 'SP', throws: 'R', age: 25, g: 24, gs: 24, outs: 359, h: 164, hr: 19, bb: 44, so: 66, hbp: 6, er: 87, w: 6, l: 12, sv: 0, fld: 57, rk: true },
      { id: 'hendrma01', name: 'Mark Hendrickson', role: 'SP', throws: 'L', age: 35, g: 53, gs: 11, outs: 315, h: 117, hr: 14, bb: 33, so: 65, hbp: 3, er: 57, w: 6, l: 5, sv: 1, fld: 65 },
      { id: 'hernada01', name: 'David Hernandez', role: 'SP', throws: 'R', age: 24, g: 20, gs: 19, outs: 304, h: 118, hr: 27, bb: 46, so: 68, hbp: 1, er: 61, w: 4, l: 10, sv: 0, fld: 66, rk: true },
      { id: 'sherrge01', name: 'George Sherrill', role: 'CL', throws: 'L', age: 32, g: 72, gs: 0, outs: 207, h: 53, hr: 5, bb: 29, so: 67, hbp: 2, er: 20, w: 1, l: 1, sv: 21, fld: 61 },
      { id: 'bassbr01', name: 'Brian Bass', role: 'RP', throws: 'R', age: 27, g: 48, gs: 0, outs: 259, h: 104, hr: 12, bb: 39, so: 51, hbp: 5, er: 48, w: 5, l: 3, sv: 0, fld: 68 },
      { id: 'baezda01', name: 'Danys Baez', role: 'RP', throws: 'R', age: 31, g: 59, gs: 0, outs: 215, h: 60, hr: 8, bb: 25, so: 39, hbp: 6, er: 35, w: 4, l: 6, sv: 0, fld: 74 },
      { id: 'johnsji04', name: 'Jim Johnson', role: 'RP', throws: 'R', age: 26, g: 64, gs: 0, outs: 210, h: 67, hr: 5, bb: 26, so: 46, hbp: 3, er: 27, w: 4, l: 6, sv: 10, fld: 91 },
      { id: 'alberma01', name: 'Matt Albers', role: 'RP', throws: 'R', age: 26, g: 56, gs: 0, outs: 201, h: 76, hr: 6, bb: 34, so: 45, hbp: 3, er: 39, w: 3, l: 6, sv: 0, fld: 69 },
      { id: 'eatonad01', name: 'Adam Eaton', role: 'RP', throws: 'R', age: 31, g: 12, gs: 8, outs: 147, h: 63, hr: 9, bb: 23, so: 30, hbp: 2, er: 37, w: 3, l: 5, sv: 0, fld: 52 },
    ],
    reservePitchers: [
      { id: 'ueharko01', name: 'Koji Uehara', role: 'SP', throws: 'R', age: 34, g: 12, gs: 12, outs: 200, h: 71, hr: 7, bb: 12, so: 48, hbp: 0, er: 30, w: 2, l: 4, sv: 0, fld: 71, rk: true },
      { id: 'tillmch01', name: 'Chris Tillman', role: 'SP', throws: 'R', age: 21, g: 12, gs: 12, outs: 195, h: 77, hr: 15, bb: 24, so: 39, hbp: 2, er: 39, w: 2, l: 5, sv: 0, fld: 65, rk: true },
      { id: 'hillri01', name: 'Rich Hill', role: 'SP', throws: 'L', age: 29, g: 14, gs: 13, outs: 173, h: 61, hr: 8, bb: 33, so: 53, hbp: 3, er: 38, w: 3, l: 3, sv: 0, fld: 53 },
      { id: 'matusbr01', name: 'Brian Matusz', role: 'RP', throws: 'L', age: 22, g: 8, gs: 8, outs: 134, h: 52, hr: 6, bb: 14, so: 38, hbp: 0, er: 23, w: 5, l: 2, sv: 0, fld: 67, rk: true },
      { id: 'raych01', name: 'Chris Ray', role: 'RP', throws: 'R', age: 27, g: 46, gs: 0, outs: 130, h: 59, hr: 8, bb: 23, so: 42, hbp: 1, er: 33, w: 0, l: 4, sv: 0, fld: 68 },
    ],
  },
  // BOS (BOS 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'wakefti01', name: 'Tim Wakefield', role: 'SP', throws: 'R', age: 42, g: 21, gs: 21, outs: 389, h: 129, hr: 15, bb: 47, so: 80, hbp: 9, er: 66, w: 11, l: 5, sv: 0, fld: 64 },
      { id: 'masteju01', name: 'Justin Masterson', role: 'SP', throws: 'R', age: 24, g: 42, gs: 16, outs: 388, h: 121, hr: 13, bb: 60, so: 115, hbp: 9, er: 60, w: 4, l: 10, sv: 0, fld: 65 },
      { id: 'papeljo01', name: 'Jonathan Papelbon', role: 'CL', throws: 'R', age: 28, g: 66, gs: 0, outs: 204, h: 54, hr: 5, bb: 18, so: 82, hbp: 3, er: 16, w: 1, l: 1, sv: 38, fld: 70 },
      { id: 'ramirra02', name: 'Ramon Ramirez', role: 'RP', throws: 'R', age: 27, g: 70, gs: 0, outs: 209, h: 61, hr: 5, bb: 31, so: 59, hbp: 2, er: 24, w: 7, l: 4, sv: 0, fld: 80 },
      { id: 'okajihi01', name: 'Hideki Okajima', role: 'RP', throws: 'L', age: 33, g: 68, gs: 0, outs: 183, h: 52, hr: 7, bb: 21, so: 57, hbp: 1, er: 20, w: 6, l: 0, sv: 0, fld: 77 },
      { id: 'delcama01', name: 'Manny Delcarmen', role: 'RP', throws: 'R', age: 27, g: 64, gs: 0, outs: 179, h: 57, hr: 5, bb: 30, so: 54, hbp: 3, er: 26, w: 5, l: 2, sv: 0, fld: 91 },
      { id: 'saitota01', name: 'Takashi Saito', role: 'RP', throws: 'R', age: 39, g: 56, gs: 0, outs: 167, h: 47, hr: 4, bb: 21, so: 63, hbp: 4, er: 14, w: 3, l: 3, sv: 2, fld: 80 },
      { id: 'bardda01', name: 'Daniel Bard', role: 'RP', throws: 'R', age: 24, g: 49, gs: 0, outs: 148, h: 41, hr: 5, bb: 22, so: 63, hbp: 3, er: 20, w: 2, l: 2, sv: 1, fld: 62, rk: true },
    ],
    reservePitchers: [
      { id: 'buchhcl01', name: 'Clay Buchholz', role: 'SP', throws: 'R', age: 24, g: 16, gs: 16, outs: 276, h: 94, hr: 12, bb: 40, so: 74, hbp: 2, er: 49, w: 7, l: 4, sv: 0, fld: 88 },
      { id: 'smoltjo01', name: 'John Smoltz', role: 'SP', throws: 'R', age: 42, g: 15, gs: 15, outs: 234, h: 87, hr: 9, bb: 19, so: 80, hbp: 2, er: 41, w: 3, l: 8, sv: 0, fld: 69 },
      { id: 'matsuda01', name: 'Daisuke Matsuzaka', role: 'SP', throws: 'R', age: 28, g: 12, gs: 12, outs: 178, h: 62, hr: 7, bb: 32, so: 60, hbp: 3, er: 29, w: 4, l: 6, sv: 0, fld: 66 },
      { id: 'byrdpa01', name: 'Paul Byrd', role: 'RP', throws: 'R', age: 38, g: 7, gs: 6, outs: 102, h: 43, hr: 6, bb: 7, so: 16, hbp: 1, er: 19, w: 1, l: 3, sv: 0, fld: 77 },
      { id: 'tazawju01', name: 'Junichi Tazawa', role: 'RP', throws: 'R', age: 23, g: 6, gs: 4, outs: 76, h: 43, hr: 4, bb: 9, so: 13, hbp: 3, er: 21, w: 2, l: 3, sv: 0, fld: 77, rk: true },
    ],
  },
  // NYY (NYA 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'riverma01', name: 'Mariano Rivera', role: 'CL', throws: 'R', age: 39, g: 66, gs: 0, outs: 199, h: 48, hr: 5, bb: 10, so: 72, hbp: 2, er: 14, w: 3, l: 3, sv: 44, fld: 62 },
      { id: 'hugheph01', name: 'Phil Hughes', role: 'RP', throws: 'R', age: 23, g: 51, gs: 7, outs: 258, h: 74, hr: 8, bb: 30, so: 82, hbp: 4, er: 36, w: 8, l: 3, sv: 3, fld: 75 },
      { id: 'aceveal01', name: 'Alfredo Aceves', role: 'RP', throws: 'R', age: 26, g: 43, gs: 1, outs: 252, h: 69, hr: 10, bb: 18, so: 64, hbp: 4, er: 31, w: 10, l: 1, sv: 1, fld: 75, rk: true },
      { id: 'cokeph01', name: 'Phil Coke', role: 'RP', throws: 'L', age: 26, g: 72, gs: 0, outs: 180, h: 43, hr: 9, bb: 19, so: 51, hbp: 1, er: 27, w: 4, l: 3, sv: 2, fld: 56, rk: true },
      { id: 'mitrese01', name: 'Sergio Mitre', role: 'RP', throws: 'R', age: 28, g: 12, gs: 9, outs: 155, h: 68, hr: 7, bb: 14, so: 30, hbp: 3, er: 33, w: 3, l: 3, sv: 0, fld: 63 },
      { id: 'verasjo01', name: 'Jose Veras', role: 'RP', throws: 'R', age: 28, g: 47, gs: 0, outs: 151, h: 43, hr: 7, bb: 27, so: 46, hbp: 4, er: 26, w: 4, l: 3, sv: 0, fld: 75 },
    ],
    reservePitchers: [
      { id: 'roberda08', name: 'David Robertson', role: 'RP', throws: 'R', age: 24, g: 45, gs: 0, outs: 131, h: 38, hr: 4, bb: 22, so: 59, hbp: 1, er: 19, w: 2, l: 1, sv: 1, fld: 65, rk: true },
      { id: 'wangch01', name: 'Chien-Ming Wang', role: 'RP', throws: 'R', age: 29, g: 12, gs: 9, outs: 126, h: 53, hr: 3, bb: 17, so: 27, hbp: 2, er: 28, w: 1, l: 6, sv: 0, fld: 85 },
      { id: 'brunebr01', name: 'Brian Bruney', role: 'RP', throws: 'R', age: 27, g: 44, gs: 0, outs: 117, h: 32, hr: 5, bb: 23, so: 36, hbp: 1, er: 15, w: 5, l: 0, sv: 0, fld: 71 },
      { id: 'albaljo01', name: 'Jonathan Albaladejo', role: 'RP', throws: 'R', age: 26, g: 32, gs: 0, outs: 103, h: 39, hr: 5, bb: 15, so: 25, hbp: 2, er: 18, w: 5, l: 1, sv: 0, fld: 77, rk: true },
      { id: 'ramired01', name: 'Edwar Ramirez', role: 'RP', throws: 'R', age: 28, g: 20, gs: 0, outs: 66, h: 23, hr: 5, bb: 14, so: 27, hbp: 1, er: 13, w: 0, l: 0, sv: 0, fld: 59 },
    ],
  },
  // TBR (TBA 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'priceda01', name: 'David Price', role: 'SP', throws: 'L', age: 23, g: 23, gs: 23, outs: 385, h: 117, hr: 17, bb: 53, so: 103, hbp: 4, er: 61, w: 10, l: 7, sv: 0, fld: 78, rk: true },
      { id: 'howeljp01', name: 'J. P. Howell', role: 'CL', throws: 'L', age: 26, g: 69, gs: 0, outs: 200, h: 51, hr: 6, bb: 30, so: 72, hbp: 3, er: 23, w: 7, l: 5, sv: 17, fld: 66 },
      { id: 'cormila01', name: 'Lance Cormier', role: 'RP', throws: 'R', age: 28, g: 53, gs: 0, outs: 232, h: 78, hr: 7, bb: 29, so: 40, hbp: 1, er: 33, w: 3, l: 3, sv: 2, fld: 68 },
      { id: 'balfogr01', name: 'Grant Balfour', role: 'RP', throws: 'R', age: 31, g: 73, gs: 0, outs: 202, h: 53, hr: 5, bb: 34, so: 81, hbp: 1, er: 30, w: 5, l: 4, sv: 4, fld: 69 },
      { id: 'wheelda01', name: 'Dan Wheeler', role: 'RP', throws: 'R', age: 31, g: 69, gs: 0, outs: 173, h: 42, hr: 9, bb: 14, so: 47, hbp: 0, er: 22, w: 4, l: 5, sv: 2, fld: 62 },
      { id: 'nelsojo01', name: 'Joe Nelson', role: 'RP', throws: 'R', age: 34, g: 42, gs: 0, outs: 121, h: 33, hr: 6, bb: 23, so: 41, hbp: 1, er: 14, w: 3, l: 0, sv: 3, fld: 72 },
      { id: 'choatra01', name: 'Randy Choate', role: 'RP', throws: 'L', age: 33, g: 61, gs: 0, outs: 109, h: 29, hr: 4, bb: 11, so: 28, hbp: 0, er: 14, w: 1, l: 0, sv: 5, fld: 83 },
    ],
    reservePitchers: [
      { id: 'sonnaan01', name: 'Andy Sonnanstine', role: 'SP', throws: 'R', age: 26, g: 22, gs: 18, outs: 299, h: 124, hr: 15, bb: 26, so: 67, hbp: 3, er: 64, w: 6, l: 9, sv: 0, fld: 86 },
      { id: 'daviswa01', name: 'Wade Davis', role: 'RP', throws: 'R', age: 23, g: 6, gs: 6, outs: 109, h: 33, hr: 2, bb: 13, so: 36, hbp: 0, er: 15, w: 2, l: 2, sv: 0, fld: 68, rk: true },
      { id: 'shousbr01', name: 'Brian Shouse', role: 'RP', throws: 'L', age: 40, g: 45, gs: 0, outs: 84, h: 29, hr: 3, bb: 8, so: 18, hbp: 1, er: 11, w: 1, l: 1, sv: 0, fld: 61 },
      { id: 'thayeda01', name: 'Dale Thayer', role: 'RP', throws: 'R', age: 28, g: 11, gs: 0, outs: 41, h: 18, hr: 3, bb: 1, so: 8, hbp: 0, er: 7, w: 0, l: 0, sv: 1, fld: 68, rk: true },
      { id: 'percitr01', name: 'Troy Percival', role: 'RP', throws: 'R', age: 39, g: 14, gs: 0, outs: 34, h: 10, hr: 2, bb: 6, so: 10, hbp: 0, er: 6, w: 0, l: 1, sv: 6, fld: 76 },
    ],
  },
  // TOR (TOR 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'cecilbr01', name: 'Brett Cecil', role: 'SP', throws: 'L', age: 22, g: 18, gs: 17, outs: 280, h: 116, hr: 17, bb: 38, so: 69, hbp: 5, er: 55, w: 7, l: 4, sv: 0, fld: 53, rk: true },
      { id: 'frasoja01', name: 'Jason Frasor', role: 'CL', throws: 'R', age: 31, g: 61, gs: 0, outs: 173, h: 42, hr: 4, bb: 23, so: 53, hbp: 2, er: 21, w: 7, l: 3, sv: 11, fld: 67 },
      { id: 'campsh01', name: 'Shawn Camp', role: 'RP', throws: 'R', age: 33, g: 59, gs: 0, outs: 239, h: 79, hr: 7, bb: 28, so: 59, hbp: 4, er: 35, w: 2, l: 6, sv: 1, fld: 78 },
      { id: 'leagubr01', name: 'Brandon League', role: 'RP', throws: 'R', age: 26, g: 67, gs: 0, outs: 224, h: 71, hr: 7, bb: 24, so: 69, hbp: 7, er: 34, w: 3, l: 6, sv: 0, fld: 64 },
      { id: 'carlsje01', name: 'Jesse Carlson', role: 'RP', throws: 'L', age: 28, g: 73, gs: 0, outs: 203, h: 61, hr: 7, bb: 23, so: 56, hbp: 3, er: 29, w: 1, l: 6, sv: 0, fld: 74 },
      { id: 'purceda01', name: 'David Purcey', role: 'RP', throws: 'L', age: 27, g: 9, gs: 9, outs: 144, h: 53, hr: 6, bb: 27, so: 42, hbp: 2, er: 32, w: 1, l: 3, sv: 0, fld: 65 },
      { id: 'downssc01', name: 'Scott Downs', role: 'RP', throws: 'L', age: 33, g: 48, gs: 0, outs: 140, h: 41, hr: 3, bb: 16, so: 42, hbp: 2, er: 13, w: 1, l: 3, sv: 9, fld: 69 },
    ],
    reservePitchers: [
      { id: 'rzepcma01', name: 'Marc Rzepczynski', role: 'SP', throws: 'L', age: 23, g: 11, gs: 11, outs: 184, h: 51, hr: 7, bb: 30, so: 60, hbp: 1, er: 25, w: 2, l: 4, sv: 0, fld: 70, rk: true },
      { id: 'janssca01', name: 'Casey Janssen', role: 'RP', throws: 'R', age: 27, g: 21, gs: 5, outs: 120, h: 53, hr: 4, bb: 14, so: 24, hbp: 2, er: 21, w: 2, l: 4, sv: 1, fld: 79 },
      { id: 'roenijo01', name: 'Josh Roenicke', role: 'RP', throws: 'R', age: 26, g: 24, gs: 0, outs: 93, h: 33, hr: 2, bb: 16, so: 34, hbp: 2, er: 18, w: 0, l: 0, sv: 0, fld: 75, rk: true },
      { id: 'accarje01', name: 'Jeremy Accardo', role: 'RP', throws: 'R', age: 27, g: 26, gs: 0, outs: 74, h: 23, hr: 2, bb: 13, so: 19, hbp: 2, er: 9, w: 0, l: 0, sv: 1, fld: 68 },
      { id: 'rayro01', name: 'Robert Ray', role: 'RP', throws: 'R', age: 25, g: 4, gs: 4, outs: 73, h: 23, hr: 4, bb: 6, so: 13, hbp: 2, er: 12, w: 1, l: 2, sv: 0, fld: 67, rk: true },
    ],
  },
  // CWS (CHA 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'contrjo01', name: 'Jose Contreras', role: 'SP', throws: 'R', age: 37, g: 28, gs: 23, outs: 395, h: 146, hr: 13, bb: 47, so: 91, hbp: 6, er: 73, w: 6, l: 13, sv: 0, fld: 73 },
      { id: 'jenksbo01', name: 'Bobby Jenks', role: 'CL', throws: 'R', age: 28, g: 52, gs: 0, outs: 160, h: 48, hr: 6, bb: 15, so: 44, hbp: 1, er: 19, w: 3, l: 4, sv: 29, fld: 68 },
      { id: 'carradj01', name: 'D. J. Carrasco', role: 'RP', throws: 'R', age: 32, g: 49, gs: 1, outs: 280, h: 97, hr: 5, bb: 30, so: 65, hbp: 4, er: 40, w: 5, l: 1, sv: 0, fld: 67 },
      { id: 'thornma01', name: 'Matt Thornton', role: 'RP', throws: 'L', age: 32, g: 70, gs: 0, outs: 217, h: 58, hr: 5, bb: 22, so: 83, hbp: 2, er: 24, w: 6, l: 3, sv: 4, fld: 68 },
      { id: 'penato03', name: 'Tony Pena', role: 'RP', throws: 'R', age: 27, g: 72, gs: 0, outs: 210, h: 76, hr: 6, bb: 20, so: 54, hbp: 3, er: 31, w: 6, l: 5, sv: 2, fld: 82 },
      { id: 'doteloc01', name: 'Octavio Dotel', role: 'RP', throws: 'R', age: 35, g: 62, gs: 0, outs: 187, h: 53, hr: 9, bb: 32, so: 81, hbp: 3, er: 25, w: 3, l: 3, sv: 0, fld: 85 },
      { id: 'garcifr02', name: 'Freddy Garcia', role: 'RP', throws: 'R', age: 32, g: 9, gs: 9, outs: 168, h: 56, hr: 6, bb: 14, so: 39, hbp: 1, er: 28, w: 3, l: 4, sv: 0, fld: 55 },
    ],
    reservePitchers: [
      { id: 'colonba01', name: 'Bartolo Colon', role: 'SP', throws: 'R', age: 36, g: 12, gs: 12, outs: 187, h: 72, hr: 11, bb: 19, so: 41, hbp: 3, er: 32, w: 3, l: 6, sv: 0, fld: 65 },
      { id: 'linebsc01', name: 'Scott Linebrink', role: 'RP', throws: 'R', age: 32, g: 57, gs: 0, outs: 168, h: 64, hr: 10, bb: 20, so: 53, hbp: 2, er: 28, w: 3, l: 7, sv: 2, fld: 73 },
      { id: 'broadla01', name: 'Lance Broadway', role: 'RP', throws: 'R', age: 25, g: 16, gs: 0, outs: 92, h: 38, hr: 2, bb: 14, so: 19, hbp: 0, er: 20, w: 0, l: 1, sv: 0, fld: 69, rk: true },
      { id: 'torreca01', name: 'Carlos Torres', role: 'RP', throws: 'R', age: 26, g: 8, gs: 5, outs: 85, h: 30, hr: 5, bb: 17, so: 22, hbp: 2, er: 19, w: 1, l: 2, sv: 0, fld: 70, rk: true },
      { id: 'hudsoda01', name: 'Daniel Hudson', role: 'RP', throws: 'R', age: 22, g: 6, gs: 2, outs: 56, h: 16, hr: 3, bb: 9, so: 14, hbp: 1, er: 7, w: 1, l: 1, sv: 0, fld: 65, rk: true },
    ],
  },
  // CLE (CLE 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'huffda01', name: 'David Huff', role: 'SP', throws: 'L', age: 24, g: 23, gs: 23, outs: 385, h: 159, hr: 16, bb: 41, so: 65, hbp: 1, er: 80, w: 11, l: 8, sv: 0, fld: 65, rk: true },
      { id: 'carmofa01', name: 'Roberto Hernandez', role: 'SP', throws: 'R', age: 28, g: 24, gs: 24, outs: 376, h: 142, hr: 12, bb: 64, so: 77, hbp: 8, er: 76, w: 5, l: 12, sv: 0, fld: 64 },
      { id: 'sowerje01', name: 'Jeremy Sowers', role: 'SP', throws: 'L', age: 26, g: 23, gs: 22, outs: 370, h: 139, hr: 14, bb: 46, so: 55, hbp: 3, er: 75, w: 6, l: 11, sv: 0, fld: 91 },
      { id: 'woodke02', name: 'Kerry Wood', role: 'CL', throws: 'R', age: 32, g: 58, gs: 0, outs: 165, h: 47, hr: 5, bb: 23, so: 67, hbp: 4, er: 24, w: 3, l: 3, sv: 20, fld: 70 },
      { id: 'ohkato01', name: 'Tomo Ohka', role: 'RP', throws: 'R', age: 33, g: 18, gs: 6, outs: 213, h: 78, hr: 17, bb: 21, so: 30, hbp: 3, er: 46, w: 1, l: 5, sv: 0, fld: 66 },
      { id: 'lewisje01', name: 'Jensen Lewis', role: 'RP', throws: 'R', age: 25, g: 47, gs: 0, outs: 199, h: 64, hr: 10, bb: 28, so: 59, hbp: 3, er: 30, w: 2, l: 4, sv: 1, fld: 72 },
      { id: 'perezch01', name: 'Chris Perez', role: 'RP', throws: 'R', age: 23, g: 61, gs: 0, outs: 171, h: 43, hr: 8, bb: 28, so: 64, hbp: 4, er: 25, w: 1, l: 2, sv: 2, fld: 64, rk: true },
      { id: 'betanra01', name: 'Rafael Betancourt', role: 'RP', throws: 'R', age: 34, g: 61, gs: 0, outs: 168, h: 47, hr: 5, bb: 17, so: 56, hbp: 0, er: 20, w: 4, l: 3, sv: 2, fld: 71 },
      { id: 'perezra01', name: 'Rafael Perez', role: 'RP', throws: 'L', age: 27, g: 54, gs: 0, outs: 144, h: 56, hr: 5, bb: 20, so: 49, hbp: 1, er: 28, w: 4, l: 3, sv: 0, fld: 80 },
    ],
    reservePitchers: [
      { id: 'laffeaa01', name: 'Aaron Laffey', role: 'SP', throws: 'L', age: 24, g: 25, gs: 19, outs: 365, h: 139, hr: 10, bb: 50, so: 59, hbp: 6, er: 60, w: 7, l: 9, sv: 1, fld: 83 },
      { id: 'sippto01', name: 'Tony Sipp', role: 'RP', throws: 'L', age: 25, g: 46, gs: 0, outs: 120, h: 27, hr: 5, bb: 25, so: 48, hbp: 0, er: 13, w: 2, l: 0, sv: 0, fld: 65, rk: true },
      { id: 'reyesan01', name: 'Anthony Reyes', role: 'RP', throws: 'R', age: 27, g: 8, gs: 8, outs: 115, h: 40, hr: 5, bb: 18, so: 24, hbp: 2, er: 23, w: 1, l: 1, sv: 0, fld: 86 },
      { id: 'hergema01', name: 'Matt Herges', role: 'RP', throws: 'R', age: 39, g: 30, gs: 0, outs: 104, h: 35, hr: 3, bb: 10, so: 24, hbp: 1, er: 15, w: 3, l: 1, sv: 0, fld: 69 },
      { id: 'smithjo05', name: 'Joe Smith', role: 'RP', throws: 'R', age: 25, g: 37, gs: 0, outs: 102, h: 29, hr: 3, bb: 15, so: 29, hbp: 2, er: 13, w: 0, l: 0, sv: 0, fld: 58 },
    ],
  },
  // DET (DET 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'rodnefe01', name: 'Fernando Rodney', role: 'CL', throws: 'R', age: 32, g: 73, gs: 0, outs: 227, h: 68, hr: 7, bb: 43, so: 70, hbp: 3, er: 38, w: 2, l: 5, sv: 37, fld: 62 },
      { id: 'minerza01', name: 'Zach Miner', role: 'RP', throws: 'R', age: 27, g: 51, gs: 5, outs: 277, h: 99, hr: 9, bb: 41, so: 57, hbp: 3, er: 43, w: 7, l: 5, sv: 1, fld: 59 },
      { id: 'lyonbr01', name: 'Brandon Lyon', role: 'RP', throws: 'R', age: 29, g: 65, gs: 0, outs: 236, h: 69, hr: 7, bb: 25, so: 53, hbp: 1, er: 28, w: 6, l: 5, sv: 3, fld: 65 },
      { id: 'perryry01', name: 'Ryan Perry', role: 'RP', throws: 'R', age: 22, g: 53, gs: 0, outs: 185, h: 56, hr: 7, bb: 38, so: 60, hbp: 1, er: 26, w: 0, l: 1, sv: 0, fld: 64, rk: true },
      { id: 'roberna01', name: 'Nate Robertson', role: 'RP', throws: 'L', age: 31, g: 28, gs: 6, outs: 149, h: 63, hr: 7, bb: 21, so: 34, hbp: 1, er: 33, w: 2, l: 3, sv: 0, fld: 51 },
      { id: 'seaybo01', name: 'Bobby Seay', role: 'RP', throws: 'L', age: 31, g: 67, gs: 0, outs: 146, h: 47, hr: 3, bb: 18, so: 42, hbp: 2, er: 22, w: 6, l: 3, sv: 0, fld: 53 },
    ],
    reservePitchers: [
      { id: 'bonined01', name: 'Eddie Bonine', role: 'RP', throws: 'R', age: 28, g: 10, gs: 4, outs: 103, h: 42, hr: 6, bb: 10, so: 16, hbp: 2, er: 18, w: 1, l: 1, sv: 0, fld: 56, rk: true },
      { id: 'willido03', name: 'Dontrelle Willis', role: 'RP', throws: 'L', age: 27, g: 7, gs: 7, outs: 101, h: 38, hr: 5, bb: 24, so: 23, hbp: 2, er: 25, w: 1, l: 4, sv: 0, fld: 61 },
      { id: 'nifu01', name: 'Fu-Te Ni', role: 'RP', throws: 'L', age: 26, g: 36, gs: 0, outs: 93, h: 20, hr: 3, bb: 11, so: 21, hbp: 1, er: 9, w: 0, l: 0, sv: 0, fld: 70, rk: true },
      { id: 'zumayjo01', name: 'Joel Zumaya', role: 'RP', throws: 'R', age: 24, g: 29, gs: 0, outs: 93, h: 31, hr: 4, bb: 23, so: 29, hbp: 1, er: 15, w: 3, l: 3, sv: 1, fld: 79 },
      { id: 'figaral01', name: 'Alfredo Figaro', role: 'RP', throws: 'R', age: 24, g: 5, gs: 3, outs: 51, h: 23, hr: 3, bb: 10, so: 16, hbp: 1, er: 12, w: 2, l: 2, sv: 0, fld: 57, rk: true },
    ],
  },
  // KCR (KCA 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'mechegi01', name: 'Gil Meche', role: 'SP', throws: 'R', age: 30, g: 23, gs: 23, outs: 387, h: 138, hr: 15, bb: 50, so: 106, hbp: 2, er: 65, w: 6, l: 10, sv: 0, fld: 71 },
      { id: 'davieky01', name: 'Kyle Davies', role: 'SP', throws: 'R', age: 25, g: 22, gs: 22, outs: 369, h: 129, hr: 16, bb: 60, so: 84, hbp: 4, er: 69, w: 8, l: 9, sv: 0, fld: 67 },
      { id: 'soriajo01', name: 'Joakim Soria', role: 'CL', throws: 'R', age: 25, g: 47, gs: 0, outs: 159, h: 39, hr: 4, bb: 16, so: 62, hbp: 3, er: 12, w: 3, l: 2, sv: 30, fld: 65 },
      { id: 'wrighja01', name: 'Jamey Wright', role: 'RP', throws: 'R', age: 34, g: 65, gs: 0, outs: 237, h: 78, hr: 7, bb: 40, so: 55, hbp: 7, er: 39, w: 3, l: 5, sv: 0, fld: 85 },
      { id: 'tejedro01', name: 'Rob Tejeda', role: 'RP', throws: 'R', age: 27, g: 35, gs: 6, outs: 221, h: 52, hr: 7, bb: 46, so: 74, hbp: 3, er: 35, w: 4, l: 2, sv: 0, fld: 73 },
      { id: 'chenbr01', name: 'Bruce Chen', role: 'RP', throws: 'L', age: 32, g: 17, gs: 9, outs: 187, h: 74, hr: 12, bb: 26, so: 45, hbp: 4, er: 40, w: 1, l: 6, sv: 0, fld: 70 },
      { id: 'ponsosi01', name: 'Sidney Ponson', role: 'RP', throws: 'R', age: 32, g: 14, gs: 9, outs: 176, h: 77, hr: 7, bb: 23, so: 29, hbp: 3, er: 40, w: 1, l: 7, sv: 0, fld: 67 },
      { id: 'colonro01', name: 'Roman Colon', role: 'RP', throws: 'R', age: 29, g: 43, gs: 0, outs: 151, h: 50, hr: 7, bb: 22, so: 29, hbp: 2, er: 27, w: 2, l: 3, sv: 0, fld: 79 },
    ],
    reservePitchers: [
      { id: 'cruzju02', name: 'Juan Cruz', role: 'RP', throws: 'R', age: 30, g: 46, gs: 0, outs: 151, h: 41, hr: 6, bb: 30, so: 56, hbp: 2, er: 24, w: 3, l: 4, sv: 2, fld: 63 },
      { id: 'mahayro01', name: 'Ron Mahay', role: 'RP', throws: 'L', age: 38, g: 57, gs: 0, outs: 151, h: 55, hr: 7, bb: 24, so: 42, hbp: 2, er: 21, w: 2, l: 1, sv: 0, fld: 85 },
      { id: 'farnsky01', name: 'Kyle Farnsworth', role: 'RP', throws: 'R', age: 33, g: 41, gs: 0, outs: 112, h: 42, hr: 6, bb: 14, so: 38, hbp: 1, er: 19, w: 1, l: 5, sv: 0, fld: 76 },
      { id: 'balejo01', name: 'John Bale', role: 'RP', throws: 'L', age: 35, g: 43, gs: 0, outs: 85, h: 34, hr: 2, bb: 14, so: 24, hbp: 1, er: 16, w: 0, l: 1, sv: 1, fld: 69 },
      { id: 'ramirho01', name: 'Horacio Ramirez', role: 'RP', throws: 'L', age: 29, g: 19, gs: 1, outs: 68, h: 29, hr: 2, bb: 9, so: 10, hbp: 1, er: 15, w: 0, l: 2, sv: 0, fld: 87 },
    ],
  },
  // MIN (MIN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'perkigl01', name: 'Glen Perkins', role: 'SP', throws: 'L', age: 26, g: 18, gs: 17, outs: 289, h: 117, hr: 14, bb: 25, so: 47, hbp: 2, er: 54, w: 6, l: 7, sv: 0, fld: 66 },
      { id: 'sloweke01', name: 'Kevin Slowey', role: 'SP', throws: 'R', age: 25, g: 16, gs: 16, outs: 272, h: 106, hr: 15, bb: 15, so: 74, hbp: 3, er: 46, w: 10, l: 3, sv: 0, fld: 78 },
      { id: 'nathajo01', name: 'Joe Nathan', role: 'CL', throws: 'R', age: 34, g: 70, gs: 0, outs: 206, h: 44, hr: 6, bb: 20, so: 82, hbp: 2, er: 14, w: 2, l: 2, sv: 47, fld: 68 },
      { id: 'duensbr01', name: 'Brian Duensing', role: 'RP', throws: 'L', age: 26, g: 24, gs: 9, outs: 252, h: 84, hr: 7, bb: 31, so: 53, hbp: 3, er: 34, w: 5, l: 2, sv: 0, fld: 64, rk: true },
      { id: 'guerrma02', name: 'Matt Guerrier', role: 'RP', throws: 'R', age: 30, g: 79, gs: 0, outs: 229, h: 64, hr: 10, bb: 22, so: 51, hbp: 3, er: 26, w: 5, l: 1, sv: 1, fld: 67 },
      { id: 'dickera01', name: 'R. A. Dickey', role: 'RP', throws: 'R', age: 34, g: 35, gs: 1, outs: 193, h: 73, hr: 8, bb: 30, so: 38, hbp: 2, er: 36, w: 1, l: 1, sv: 0, fld: 75 },
      { id: 'mijarjo01', name: 'Jose Mijares', role: 'RP', throws: 'L', age: 24, g: 71, gs: 0, outs: 185, h: 48, hr: 6, bb: 21, so: 54, hbp: 2, er: 15, w: 2, l: 2, sv: 0, fld: 75, rk: true },
      { id: 'keppebo01', name: 'Bobby Keppel', role: 'RP', throws: 'R', age: 27, g: 37, gs: 0, outs: 162, h: 63, hr: 4, bb: 21, so: 31, hbp: 5, er: 30, w: 1, l: 1, sv: 0, fld: 76, rk: true },
    ],
    reservePitchers: [
      { id: 'swarzan01', name: 'Anthony Swarzak', role: 'SP', throws: 'R', age: 23, g: 12, gs: 12, outs: 177, h: 76, hr: 12, bb: 20, so: 34, hbp: 2, er: 41, w: 3, l: 7, sv: 0, fld: 61, rk: true },
      { id: 'crainje01', name: 'Jesse Crain', role: 'RP', throws: 'R', age: 27, g: 56, gs: 0, outs: 155, h: 51, hr: 4, bb: 24, so: 42, hbp: 3, er: 25, w: 7, l: 4, sv: 0, fld: 80 },
      { id: 'ayalalu01', name: 'Luis Ayala', role: 'RP', throws: 'R', age: 31, g: 38, gs: 0, outs: 120, h: 48, hr: 5, bb: 13, so: 28, hbp: 3, er: 24, w: 1, l: 5, sv: 0, fld: 78 },
      { id: 'manshje01', name: 'Jeff Manship', role: 'RP', throws: 'R', age: 24, g: 11, gs: 5, outs: 95, h: 39, hr: 4, bb: 15, so: 21, hbp: 1, er: 20, w: 1, l: 1, sv: 0, fld: 70, rk: true },
      { id: 'hennse01', name: 'Sean Henn', role: 'RP', throws: 'L', age: 28, g: 20, gs: 0, outs: 43, h: 16, hr: 2, bb: 12, so: 13, hbp: 1, er: 12, w: 0, l: 3, sv: 0, fld: 76 },
    ],
  },
  // HOU (HOU 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'hamptmi01', name: 'Mike Hampton', role: 'SP', throws: 'L', age: 36, g: 21, gs: 21, outs: 336, h: 126, hr: 14, bb: 45, so: 68, hbp: 2, er: 65, w: 7, l: 10, sv: 0, fld: 64 },
      { id: 'paulife01', name: 'Felipe Paulino', role: 'SP', throws: 'R', age: 25, g: 23, gs: 17, outs: 293, h: 126, hr: 20, bb: 37, so: 91, hbp: 4, er: 69, w: 3, l: 11, sv: 0, fld: 78, rk: true },
      { id: 'valvejo01', name: 'Jose Valverde', role: 'CL', throws: 'R', age: 31, g: 52, gs: 0, outs: 162, h: 42, hr: 6, bb: 20, so: 60, hbp: 2, er: 17, w: 4, l: 2, sv: 25, fld: 81 },
      { id: 'fulchje01', name: 'Jeff Fulchino', role: 'RP', throws: 'R', age: 29, g: 61, gs: 0, outs: 246, h: 74, hr: 7, bb: 28, so: 69, hbp: 3, er: 35, w: 6, l: 4, sv: 0, fld: 58, rk: true },
      { id: 'hawkila01', name: 'LaTroy Hawkins', role: 'RP', throws: 'R', age: 36, g: 65, gs: 0, outs: 190, h: 58, hr: 6, bb: 19, so: 45, hbp: 1, er: 21, w: 1, l: 4, sv: 11, fld: 66 },
      { id: 'byrdati01', name: 'Tim Byrdak', role: 'RP', throws: 'L', age: 35, g: 76, gs: 0, outs: 184, h: 44, hr: 9, bb: 34, so: 56, hbp: 2, er: 23, w: 1, l: 2, sv: 0, fld: 81 },
      { id: 'sampsch01', name: 'Chris Sampson', role: 'RP', throws: 'R', age: 31, g: 49, gs: 0, outs: 166, h: 63, hr: 5, bb: 15, so: 30, hbp: 1, er: 29, w: 4, l: 2, sv: 3, fld: 60 },
      { id: 'ariasal02', name: 'Alberto Arias', role: 'RP', throws: 'R', age: 25, g: 42, gs: 0, outs: 137, h: 49, hr: 1, bb: 20, so: 35, hbp: 5, er: 18, w: 2, l: 1, sv: 0, fld: 65, rk: true },
    ],
    reservePitchers: [
      { id: 'ortizru01', name: 'Russ Ortiz', role: 'SP', throws: 'R', age: 35, g: 23, gs: 13, outs: 257, h: 96, hr: 8, bb: 46, so: 62, hbp: 5, er: 53, w: 3, l: 6, sv: 0, fld: 67 },
      { id: 'norribu01', name: 'Bud Norris', role: 'SP', throws: 'R', age: 24, g: 11, gs: 10, outs: 167, h: 59, hr: 9, bb: 25, so: 54, hbp: 3, er: 28, w: 6, l: 3, sv: 0, fld: 58, rk: true },
      { id: 'wrighwe01', name: 'Wesley Wright', role: 'RP', throws: 'L', age: 24, g: 49, gs: 0, outs: 134, h: 46, hr: 8, bb: 27, so: 48, hbp: 1, er: 27, w: 3, l: 4, sv: 0, fld: 77 },
      { id: 'bazaryo01', name: 'Yorman Bazardo', role: 'RP', throws: 'R', age: 24, g: 10, gs: 6, outs: 96, h: 37, hr: 2, bb: 21, so: 18, hbp: 2, er: 27, w: 1, l: 3, sv: 0, fld: 72, rk: true },
      { id: 'gervasa01', name: 'Sammy Gervacio', role: 'RP', throws: 'R', age: 24, g: 29, gs: 0, outs: 63, h: 16, hr: 1, bb: 8, so: 25, hbp: 1, er: 5, w: 1, l: 1, sv: 0, fld: 73, rk: true },
    ],
  },
  // LAA (LAA 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'palmema01', name: 'Matt Palmer', role: 'SP', throws: 'R', age: 30, g: 40, gs: 13, outs: 364, h: 107, hr: 12, bb: 58, so: 65, hbp: 5, er: 56, w: 11, l: 2, sv: 0, fld: 52, rk: true },
      { id: 'fuentbr01', name: 'Brian Fuentes', role: 'CL', throws: 'L', age: 33, g: 65, gs: 0, outs: 165, h: 49, hr: 5, bb: 23, so: 58, hbp: 4, er: 21, w: 1, l: 5, sv: 48, fld: 82 },
      { id: 'oliveda02', name: 'Darren Oliver', role: 'RP', throws: 'L', age: 38, g: 63, gs: 1, outs: 219, h: 64, hr: 5, bb: 21, so: 58, hbp: 4, er: 24, w: 5, l: 1, sv: 0, fld: 59 },
      { id: 'bulgeja01', name: 'Jason Bulger', role: 'RP', throws: 'R', age: 30, g: 64, gs: 0, outs: 197, h: 48, hr: 7, bb: 31, so: 69, hbp: 2, er: 29, w: 6, l: 1, sv: 1, fld: 73, rk: true },
      { id: 'louxsh01', name: 'Shane Loux', role: 'RP', throws: 'R', age: 29, g: 18, gs: 6, outs: 175, h: 82, hr: 4, bb: 18, so: 19, hbp: 5, er: 36, w: 2, l: 3, sv: 0, fld: 87 },
      { id: 'jepseke01', name: 'Kevin Jepsen', role: 'RP', throws: 'R', age: 24, g: 54, gs: 0, outs: 164, h: 62, hr: 2, bb: 20, so: 48, hbp: 0, er: 30, w: 6, l: 4, sv: 1, fld: 65, rk: true },
      { id: 'arredjo01', name: 'Jose Arredondo', role: 'RP', throws: 'R', age: 25, g: 43, gs: 0, outs: 135, h: 42, hr: 4, bb: 21, so: 46, hbp: 0, er: 21, w: 2, l: 3, sv: 0, fld: 75 },
    ],
    reservePitchers: [
      { id: 'osullse01', name: 'Sean O\'Sullivan', role: 'SP', throws: 'R', age: 21, g: 12, gs: 10, outs: 155, h: 60, hr: 12, bb: 16, so: 29, hbp: 1, er: 34, w: 4, l: 2, sv: 0, fld: 79, rk: true },
      { id: 'speieju01', name: 'Justin Speier', role: 'RP', throws: 'R', age: 35, g: 41, gs: 0, outs: 120, h: 41, hr: 8, bb: 15, so: 37, hbp: 4, er: 22, w: 4, l: 2, sv: 0, fld: 75 },
      { id: 'rodrira01', name: 'Rafael Rodriguez', role: 'RP', throws: 'R', age: 24, g: 18, gs: 0, outs: 92, h: 47, hr: 4, bb: 9, so: 10, hbp: 1, er: 19, w: 0, l: 1, sv: 0, fld: 56, rk: true },
      { id: 'belltr01', name: 'Trevor Bell', role: 'RP', throws: 'R', age: 22, g: 8, gs: 4, outs: 61, h: 40, hr: 3, bb: 11, so: 14, hbp: 0, er: 22, w: 1, l: 2, sv: 0, fld: 62, rk: true },
      { id: 'thompri03', name: 'Rich Thompson', role: 'RP', throws: 'R', age: 24, g: 13, gs: 0, outs: 58, h: 27, hr: 6, bb: 8, so: 20, hbp: 1, er: 14, w: 0, l: 0, sv: 0, fld: 78, rk: true },
    ],
  },
  // OAK (OAK 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'gonzagi01', name: 'Gio Gonzalez', role: 'SP', throws: 'L', age: 23, g: 20, gs: 17, outs: 296, h: 109, hr: 16, bb: 59, so: 107, hbp: 2, er: 67, w: 6, l: 7, sv: 0, fld: 73, rk: true },
      { id: 'mazzavi01', name: 'Vin Mazzaro', role: 'SP', throws: 'R', age: 22, g: 17, gs: 17, outs: 274, h: 120, hr: 12, bb: 39, so: 59, hbp: 4, er: 54, w: 4, l: 9, sv: 0, fld: 59, rk: true },
      { id: 'bailean01', name: 'Andrew Bailey', role: 'CL', throws: 'R', age: 25, g: 68, gs: 0, outs: 250, h: 49, hr: 5, bb: 24, so: 91, hbp: 0, er: 17, w: 6, l: 3, sv: 26, fld: 59, rk: true },
      { id: 'wuertmi01', name: 'Michael Wuertz', role: 'RP', throws: 'R', age: 30, g: 74, gs: 0, outs: 236, h: 58, hr: 6, bb: 27, so: 84, hbp: 0, er: 25, w: 6, l: 1, sv: 4, fld: 59 },
      { id: 'zieglbr01', name: 'Brad Ziegler', role: 'RP', throws: 'R', age: 29, g: 69, gs: 0, outs: 220, h: 75, hr: 2, bb: 28, so: 49, hbp: 1, er: 20, w: 2, l: 4, sv: 7, fld: 73 },
      { id: 'breslcr01', name: 'Craig Breslow', role: 'RP', throws: 'L', age: 28, g: 77, gs: 0, outs: 209, h: 49, hr: 6, bb: 29, so: 56, hbp: 2, er: 23, w: 8, l: 7, sv: 0, fld: 71 },
      { id: 'gonzaed01', name: 'Edgar Gonzalez', role: 'RP', throws: 'R', age: 26, g: 26, gs: 6, outs: 196, h: 76, hr: 8, bb: 26, so: 41, hbp: 5, er: 41, w: 0, l: 4, sv: 0, fld: 60 },
      { id: 'tomkobr01', name: 'Brett Tomko', role: 'RP', throws: 'R', age: 36, g: 21, gs: 6, outs: 172, h: 57, hr: 9, bb: 15, so: 37, hbp: 1, er: 31, w: 5, l: 3, sv: 0, fld: 74 },
    ],
    reservePitchers: [
      { id: 'outmajo01', name: 'Josh Outman', role: 'SP', throws: 'L', age: 24, g: 14, gs: 12, outs: 202, h: 59, hr: 8, bb: 24, so: 51, hbp: 1, er: 27, w: 4, l: 1, sv: 0, fld: 72, rk: true },
      { id: 'sprinru01', name: 'Russ Springer', role: 'RP', throws: 'R', age: 40, g: 74, gs: 0, outs: 171, h: 57, hr: 7, bb: 19, so: 58, hbp: 1, er: 21, w: 1, l: 4, sv: 1, fld: 62 },
      { id: 'garcija01', name: 'Santiago Casilla', role: 'RP', throws: 'R', age: 28, g: 46, gs: 0, outs: 145, h: 58, hr: 6, bb: 23, so: 41, hbp: 3, er: 28, w: 1, l: 2, sv: 0, fld: 73 },
      { id: 'evelada01', name: 'Dana Eveland', role: 'RP', throws: 'L', age: 25, g: 13, gs: 9, outs: 132, h: 57, hr: 3, bb: 24, so: 31, hbp: 2, er: 28, w: 2, l: 4, sv: 0, fld: 61 },
      { id: 'mortecl01', name: 'Clayton Mortensen', role: 'RP', throws: 'R', age: 24, g: 7, gs: 6, outs: 92, h: 42, hr: 6, bb: 13, so: 13, hbp: 3, er: 26, w: 2, l: 4, sv: 0, fld: 77, rk: true },
    ],
  },
  // SEA (SEA 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'rowlary01', name: 'Ryan Rowland-Smith', role: 'SP', throws: 'L', age: 26, g: 15, gs: 15, outs: 289, h: 88, hr: 10, bb: 32, so: 59, hbp: 3, er: 38, w: 5, l: 4, sv: 0, fld: 84 },
      { id: 'vargaja01', name: 'Jason Vargas', role: 'SP', throws: 'L', age: 26, g: 23, gs: 14, outs: 275, h: 100, hr: 17, bb: 24, so: 53, hbp: 3, er: 52, w: 3, l: 6, sv: 0, fld: 75 },
      { id: 'bedarer01', name: 'Erik Bedard', role: 'SP', throws: 'L', age: 30, g: 15, gs: 15, outs: 249, h: 67, hr: 9, bb: 33, so: 89, hbp: 4, er: 29, w: 5, l: 3, sv: 0, fld: 69 },
      { id: 'aardsda01', name: 'David Aardsma', role: 'CL', throws: 'R', age: 27, g: 73, gs: 0, outs: 214, h: 56, hr: 5, bb: 37, so: 73, hbp: 2, er: 28, w: 3, l: 6, sv: 38, fld: 69 },
      { id: 'jakubch01', name: 'Chris Jakubauskas', role: 'RP', throws: 'R', age: 30, g: 35, gs: 8, outs: 279, h: 91, hr: 15, bb: 27, so: 47, hbp: 2, er: 55, w: 6, l: 7, sv: 0, fld: 82, rk: true },
      { id: 'lowema01', name: 'Mark Lowe', role: 'RP', throws: 'R', age: 26, g: 75, gs: 0, outs: 240, h: 77, hr: 7, bb: 33, so: 66, hbp: 2, er: 34, w: 2, l: 7, sv: 3, fld: 73 },
      { id: 'batismi01', name: 'Miguel Batista', role: 'RP', throws: 'R', age: 38, g: 56, gs: 0, outs: 214, h: 79, hr: 9, bb: 40, so: 48, hbp: 3, er: 39, w: 7, l: 4, sv: 1, fld: 76 },
      { id: 'whitese02', name: 'Sean White', role: 'RP', throws: 'R', age: 28, g: 52, gs: 0, outs: 193, h: 51, hr: 3, bb: 22, so: 27, hbp: 4, er: 23, w: 3, l: 2, sv: 1, fld: 73, rk: true },
      { id: 'kellesh01', name: 'Shawn Kelley', role: 'RP', throws: 'R', age: 25, g: 41, gs: 0, outs: 138, h: 45, hr: 9, bb: 9, so: 41, hbp: 3, er: 23, w: 5, l: 4, sv: 0, fld: 71, rk: true },
    ],
    reservePitchers: [
      { id: 'olsonga01', name: 'Garrett Olson', role: 'SP', throws: 'L', age: 25, g: 31, gs: 11, outs: 241, h: 88, hr: 14, bb: 36, so: 48, hbp: 4, er: 53, w: 3, l: 5, sv: 0, fld: 68 },
      { id: 'morrobr01', name: 'Brandon Morrow', role: 'SP', throws: 'R', age: 24, g: 26, gs: 10, outs: 209, h: 60, hr: 9, bb: 45, so: 72, hbp: 0, er: 32, w: 2, l: 4, sv: 6, fld: 70 },
      { id: 'frenclu01', name: 'Luke French', role: 'SP', throws: 'L', age: 23, g: 15, gs: 12, outs: 202, h: 87, hr: 11, bb: 28, so: 42, hbp: 2, er: 39, w: 4, l: 5, sv: 0, fld: 66, rk: true },
      { id: 'fistedo01', name: 'Doug Fister', role: 'SP', throws: 'R', age: 25, g: 11, gs: 10, outs: 183, h: 63, hr: 11, bb: 15, so: 36, hbp: 2, er: 28, w: 3, l: 4, sv: 0, fld: 67, rk: true },
      { id: 'silvaca01', name: 'Carlos Silva', role: 'RP', throws: 'R', age: 30, g: 8, gs: 6, outs: 91, h: 42, hr: 4, bb: 7, so: 14, hbp: 1, er: 21, w: 1, l: 3, sv: 0, fld: 55 },
    ],
  },
  // TEX (TEX 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'hunteto02', name: 'Tommy Hunter', role: 'SP', throws: 'R', age: 22, g: 19, gs: 19, outs: 336, h: 119, hr: 14, bb: 32, so: 65, hbp: 2, er: 59, w: 9, l: 6, sv: 0, fld: 66, rk: true },
      { id: 'francfr01', name: 'Frank Francisco', role: 'CL', throws: 'R', age: 29, g: 51, gs: 0, outs: 148, h: 39, hr: 5, bb: 19, so: 56, hbp: 1, er: 20, w: 2, l: 3, sv: 25, fld: 72 },
      { id: 'wilsocj01', name: 'C. J. Wilson', role: 'RP', throws: 'L', age: 28, g: 74, gs: 0, outs: 221, h: 66, hr: 6, bb: 35, so: 76, hbp: 5, er: 29, w: 5, l: 6, sv: 14, fld: 69 },
      { id: 'jennija01', name: 'Jason Jennings', role: 'RP', throws: 'R', age: 30, g: 44, gs: 0, outs: 183, h: 70, hr: 10, bb: 28, so: 41, hbp: 2, er: 37, w: 2, l: 4, sv: 1, fld: 54 },
      { id: 'odayda01', name: 'Darren O\'Day', role: 'RP', throws: 'R', age: 26, g: 68, gs: 0, outs: 176, h: 48, hr: 3, bb: 18, so: 49, hbp: 5, er: 17, w: 2, l: 1, sv: 2, fld: 69, rk: true },
      { id: 'grillja01', name: 'Jason Grilli', role: 'RP', throws: 'R', age: 32, g: 52, gs: 0, outs: 137, h: 47, hr: 3, bb: 24, so: 45, hbp: 2, er: 22, w: 2, l: 3, sv: 1, fld: 75 },
      { id: 'mathido01', name: 'Doug Mathis', role: 'RP', throws: 'R', age: 26, g: 24, gs: 2, outs: 128, h: 44, hr: 4, bb: 13, so: 22, hbp: 1, er: 18, w: 0, l: 1, sv: 1, fld: 66, rk: true },
    ],
    reservePitchers: [
      { id: 'mccarbr01', name: 'Brandon McCarthy', role: 'SP', throws: 'R', age: 25, g: 17, gs: 17, outs: 292, h: 97, hr: 12, bb: 38, so: 60, hbp: 3, er: 50, w: 7, l: 4, sv: 0, fld: 79 },
      { id: 'nippedu01', name: 'Dustin Nippert', role: 'SP', throws: 'R', age: 28, g: 20, gs: 10, outs: 209, h: 72, hr: 8, bb: 30, so: 52, hbp: 2, er: 37, w: 5, l: 3, sv: 0, fld: 69 },
      { id: 'harrima01', name: 'Matt Harrison', role: 'SP', throws: 'L', age: 23, g: 11, gs: 11, outs: 190, h: 79, hr: 9, bb: 23, so: 33, hbp: 2, er: 41, w: 4, l: 5, sv: 0, fld: 62 },
      { id: 'guarded01', name: 'Eddie Guardado', role: 'RP', throws: 'L', age: 38, g: 48, gs: 0, outs: 115, h: 38, hr: 6, bb: 14, so: 22, hbp: 1, er: 20, w: 1, l: 2, sv: 0, fld: 71 },
      { id: 'felizne01', name: 'Neftali Feliz', role: 'RP', throws: 'R', age: 21, g: 20, gs: 0, outs: 93, h: 13, hr: 2, bb: 8, so: 39, hbp: 3, er: 6, w: 1, l: 0, sv: 2, fld: 68, rk: true },
    ],
  },
  // ATL (ATL 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'hansoto01', name: 'Tommy Hanson', role: 'SP', throws: 'R', age: 22, g: 21, gs: 21, outs: 383, h: 105, hr: 10, bb: 46, so: 116, hbp: 5, er: 41, w: 11, l: 4, sv: 0, fld: 65, rk: true },
      { id: 'soriara01', name: 'Rafael Soriano', role: 'CL', throws: 'R', age: 29, g: 77, gs: 0, outs: 227, h: 51, hr: 7, bb: 27, so: 95, hbp: 2, er: 25, w: 1, l: 6, sv: 27, fld: 71 },
      { id: 'gonzami02', name: 'Mike Gonzalez', role: 'RP', throws: 'L', age: 31, g: 80, gs: 0, outs: 223, h: 57, hr: 8, bb: 33, so: 90, hbp: 6, er: 23, w: 5, l: 4, sv: 10, fld: 79 },
      { id: 'moylape01', name: 'Peter Moylan', role: 'RP', throws: 'R', age: 30, g: 87, gs: 0, outs: 219, h: 63, hr: 2, bb: 32, so: 59, hbp: 3, er: 21, w: 6, l: 2, sv: 0, fld: 59 },
      { id: 'medlekr01', name: 'Kris Medlen', role: 'RP', throws: 'R', age: 23, g: 37, gs: 4, outs: 203, h: 65, hr: 5, bb: 30, so: 72, hbp: 2, er: 32, w: 3, l: 5, sv: 0, fld: 84, rk: true },
      { id: 'oflaher01', name: 'Eric O\'Flaherty', role: 'RP', throws: 'L', age: 24, g: 78, gs: 0, outs: 169, h: 55, hr: 3, bb: 19, so: 38, hbp: 6, er: 26, w: 2, l: 1, sv: 0, fld: 77 },
      { id: 'benneje01', name: 'Jeff Bennett', role: 'RP', throws: 'R', age: 29, g: 44, gs: 0, outs: 140, h: 56, hr: 4, bb: 28, so: 34, hbp: 4, er: 24, w: 2, l: 4, sv: 0, fld: 70 },
    ],
    reservePitchers: [
      { id: 'hudsoti01', name: 'Tim Hudson', role: 'RP', throws: 'R', age: 33, g: 7, gs: 7, outs: 127, h: 43, hr: 3, bb: 12, so: 27, hbp: 1, er: 16, w: 2, l: 1, sv: 0, fld: 59 },
      { id: 'acostma01', name: 'Manny Acosta', role: 'RP', throws: 'R', age: 28, g: 36, gs: 0, outs: 112, h: 39, hr: 5, bb: 20, so: 29, hbp: 1, er: 17, w: 1, l: 1, sv: 0, fld: 76 },
      { id: 'reyesjo03', name: 'Jo-Jo Reyes', role: 'RP', throws: 'L', age: 24, g: 6, gs: 5, outs: 81, h: 30, hr: 4, bb: 13, so: 18, hbp: 1, er: 18, w: 0, l: 2, sv: 0, fld: 61 },
      { id: 'carlybu01', name: 'Buddy Carlyle', role: 'RP', throws: 'R', age: 31, g: 16, gs: 0, outs: 64, h: 27, hr: 4, bb: 10, so: 19, hbp: 0, er: 15, w: 0, l: 1, sv: 0, fld: 59 },
      { id: 'loganbo02', name: 'Boone Logan', role: 'RP', throws: 'L', age: 24, g: 20, gs: 0, outs: 52, h: 22, hr: 2, bb: 7, so: 14, hbp: 0, er: 11, w: 1, l: 1, sv: 0, fld: 73 },
    ],
  },
  // MIA (FLO 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'westse01', name: 'Sean West', role: 'SP', throws: 'L', age: 23, g: 20, gs: 20, outs: 310, h: 115, hr: 11, bb: 44, so: 70, hbp: 3, er: 55, w: 8, l: 6, sv: 0, fld: 79, rk: true },
      { id: 'sanchan01', name: 'Anibal Sanchez', role: 'SP', throws: 'R', age: 25, g: 16, gs: 16, outs: 258, h: 87, hr: 10, bb: 45, so: 70, hbp: 4, er: 41, w: 4, l: 8, sv: 0, fld: 69 },
      { id: 'nunezle01', name: 'Juan Carlos Oviedo', role: 'CL', throws: 'R', age: 27, g: 75, gs: 0, outs: 206, h: 62, hr: 10, bb: 24, so: 53, hbp: 4, er: 29, w: 4, l: 6, sv: 26, fld: 78 },
      { id: 'badenbu01', name: 'Burke Badenhop', role: 'RP', throws: 'R', age: 26, g: 35, gs: 2, outs: 216, h: 73, hr: 7, bb: 26, so: 55, hbp: 2, er: 35, w: 7, l: 4, sv: 0, fld: 84, rk: true },
      { id: 'pintore01', name: 'Renyel Pinto', role: 'RP', throws: 'L', age: 26, g: 73, gs: 0, outs: 184, h: 52, hr: 6, bb: 41, so: 58, hbp: 3, er: 26, w: 4, l: 1, sv: 0, fld: 81 },
      { id: 'calerki01', name: 'Kiko Calero', role: 'RP', throws: 'R', age: 34, g: 67, gs: 0, outs: 180, h: 41, hr: 2, bb: 30, so: 64, hbp: 1, er: 18, w: 2, l: 2, sv: 0, fld: 67 },
      { id: 'meyerda02', name: 'Dan Meyer', role: 'RP', throws: 'L', age: 27, g: 71, gs: 0, outs: 175, h: 52, hr: 8, bb: 23, so: 50, hbp: 1, er: 28, w: 3, l: 2, sv: 2, fld: 54, rk: true },
      { id: 'sanchbr01', name: 'Brian Sanches', role: 'RP', throws: 'R', age: 30, g: 47, gs: 0, outs: 169, h: 52, hr: 7, bb: 27, so: 49, hbp: 6, er: 20, w: 4, l: 2, sv: 0, fld: 69, rk: true },
    ],
    reservePitchers: [
      { id: 'millean01', name: 'Andrew Miller', role: 'SP', throws: 'L', age: 24, g: 20, gs: 14, outs: 240, h: 87, hr: 7, bb: 43, so: 63, hbp: 3, er: 47, w: 3, l: 5, sv: 0, fld: 64 },
      { id: 'vanderi01', name: 'Rick van den Hurk', role: 'SP', throws: 'R', age: 24, g: 11, gs: 11, outs: 176, h: 60, hr: 10, bb: 26, so: 53, hbp: 4, er: 33, w: 3, l: 2, sv: 0, fld: 69 },
      { id: 'lindsma01', name: 'Matt Lindstrom', role: 'RP', throws: 'R', age: 29, g: 54, gs: 0, outs: 142, h: 52, hr: 3, bb: 22, so: 40, hbp: 2, er: 24, w: 2, l: 1, sv: 15, fld: 69 },
      { id: 'marticr01', name: 'Cristhian Martinez', role: 'RP', throws: 'R', age: 27, g: 15, gs: 0, outs: 79, h: 27, hr: 2, bb: 8, so: 18, hbp: 0, er: 15, w: 1, l: 1, sv: 0, fld: 70, rk: true },
      { id: 'donnebr01', name: 'Brendan Donnelly', role: 'RP', throws: 'R', age: 37, g: 30, gs: 0, outs: 76, h: 24, hr: 1, bb: 10, so: 21, hbp: 1, er: 9, w: 3, l: 0, sv: 2, fld: 64 },
    ],
  },
  // NYM (NYN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'redditi01', name: 'Tim Redding', role: 'SP', throws: 'R', age: 31, g: 30, gs: 17, outs: 360, h: 124, hr: 17, bb: 47, so: 76, hbp: 4, er: 65, w: 3, l: 6, sv: 0, fld: 67 },
      { id: 'mainejo01', name: 'John Maine', role: 'SP', throws: 'R', age: 28, g: 15, gs: 15, outs: 244, h: 70, hr: 9, bb: 37, so: 67, hbp: 3, er: 38, w: 7, l: 6, sv: 0, fld: 64 },
      { id: 'rodrifr03', name: 'Francisco Rodriguez', role: 'CL', throws: 'R', age: 27, g: 70, gs: 0, outs: 204, h: 52, hr: 5, bb: 36, so: 77, hbp: 1, er: 23, w: 3, l: 6, sv: 35, fld: 66 },
      { id: 'parnebo01', name: 'Bobby Parnell', role: 'RP', throws: 'R', age: 24, g: 68, gs: 8, outs: 265, h: 100, hr: 8, bb: 46, so: 74, hbp: 4, er: 52, w: 4, l: 8, sv: 1, fld: 61, rk: true },
      { id: 'stokebr01', name: 'Brian Stokes', role: 'RP', throws: 'R', age: 29, g: 69, gs: 0, outs: 211, h: 78, hr: 8, bb: 32, so: 46, hbp: 2, er: 35, w: 2, l: 4, sv: 0, fld: 72 },
      { id: 'greense01', name: 'Sean Green', role: 'RP', throws: 'R', age: 30, g: 79, gs: 0, outs: 209, h: 69, hr: 4, bb: 34, so: 54, hbp: 7, er: 35, w: 1, l: 4, sv: 1, fld: 69 },
      { id: 'mischpa01', name: 'Pat Misch', role: 'RP', throws: 'L', age: 27, g: 26, gs: 7, outs: 187, h: 68, hr: 10, bb: 20, so: 32, hbp: 3, er: 34, w: 3, l: 4, sv: 0, fld: 77 },
      { id: 'felicpe01', name: 'Pedro Feliciano', role: 'RP', throws: 'L', age: 32, g: 88, gs: 0, outs: 178, h: 51, hr: 6, bb: 22, so: 55, hbp: 2, er: 21, w: 6, l: 4, sv: 0, fld: 47 },
    ],
    reservePitchers: [
      { id: 'figuene01', name: 'Nelson Figueroa', role: 'SP', throws: 'R', age: 35, g: 16, gs: 10, outs: 211, h: 78, hr: 7, bb: 29, so: 58, hbp: 7, er: 33, w: 3, l: 8, sv: 0, fld: 70 },
      { id: 'perezol01', name: 'Oliver Perez', role: 'SP', throws: 'L', age: 27, g: 14, gs: 14, outs: 198, h: 65, hr: 10, bb: 44, so: 68, hbp: 4, er: 38, w: 3, l: 4, sv: 0, fld: 60 },
      { id: 'nievefe01', name: 'Fernando Nieve', role: 'RP', throws: 'R', age: 26, g: 8, gs: 7, outs: 110, h: 39, hr: 4, bb: 17, so: 26, hbp: 1, er: 15, w: 3, l: 3, sv: 0, fld: 75 },
      { id: 'desseel01', name: 'Elmer Dessens', role: 'RP', throws: 'R', age: 38, g: 28, gs: 0, outs: 98, h: 30, hr: 5, bb: 11, so: 15, hbp: 1, er: 18, w: 0, l: 0, sv: 0, fld: 56 },
      { id: 'putzjj01', name: 'J. J. Putz', role: 'RP', throws: 'R', age: 32, g: 29, gs: 0, outs: 88, h: 27, hr: 2, bb: 16, so: 31, hbp: 1, er: 13, w: 1, l: 4, sv: 2, fld: 62 },
    ],
  },
  // PHI (PHI 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'myersbr01', name: 'Brett Myers', role: 'SP', throws: 'R', age: 28, g: 18, gs: 10, outs: 212, h: 73, hr: 13, bb: 24, so: 60, hbp: 3, er: 36, w: 4, l: 3, sv: 0, fld: 87 },
      { id: 'lidgebr01', name: 'Brad Lidge', role: 'CL', throws: 'R', age: 32, g: 67, gs: 0, outs: 176, h: 61, hr: 8, bb: 33, so: 75, hbp: 3, er: 32, w: 0, l: 8, sv: 31, fld: 76 },
      { id: 'parkch01', name: 'Chan Ho Park', role: 'RP', throws: 'R', age: 36, g: 45, gs: 7, outs: 250, h: 85, hr: 8, bb: 32, so: 72, hbp: 4, er: 38, w: 3, l: 3, sv: 0, fld: 60 },
      { id: 'madsory01', name: 'Ryan Madson', role: 'RP', throws: 'R', age: 28, g: 79, gs: 0, outs: 232, h: 73, hr: 6, bb: 23, so: 70, hbp: 2, er: 27, w: 5, l: 5, sv: 10, fld: 65 },
      { id: 'durbich01', name: 'Chad Durbin', role: 'RP', throws: 'R', age: 31, g: 59, gs: 0, outs: 209, h: 64, hr: 8, bb: 36, so: 53, hbp: 5, er: 31, w: 2, l: 2, sv: 2, fld: 67 },
      { id: 'martipe02', name: 'Pedro Martinez', role: 'RP', throws: 'R', age: 37, g: 9, gs: 9, outs: 134, h: 49, hr: 7, bb: 13, so: 36, hbp: 3, er: 22, w: 5, l: 1, sv: 0, fld: 77 },
      { id: 'condrcl01', name: 'Clay Condrey', role: 'RP', throws: 'R', age: 33, g: 45, gs: 0, outs: 126, h: 44, hr: 4, bb: 12, so: 22, hbp: 2, er: 15, w: 6, l: 2, sv: 1, fld: 67 },
    ],
    reservePitchers: [
      { id: 'walkety01', name: 'Tyler Walker', role: 'RP', throws: 'R', age: 33, g: 32, gs: 0, outs: 106, h: 31, hr: 4, bb: 11, so: 29, hbp: 2, er: 14, w: 2, l: 1, sv: 0, fld: 72 },
      { id: 'eyresc01', name: 'Scott Eyre', role: 'RP', throws: 'L', age: 37, g: 42, gs: 0, outs: 90, h: 26, hr: 2, bb: 15, so: 26, hbp: 1, er: 9, w: 2, l: 1, sv: 0, fld: 60 },
      { id: 'lopezro01', name: 'Rodrigo Lopez', role: 'RP', throws: 'R', age: 33, g: 7, gs: 5, outs: 90, h: 39, hr: 4, bb: 10, so: 19, hbp: 0, er: 18, w: 3, l: 1, sv: 0, fld: 68 },
      { id: 'taschja01', name: 'Jack Taschner', role: 'RP', throws: 'L', age: 31, g: 24, gs: 0, outs: 88, h: 36, hr: 3, bb: 18, so: 25, hbp: 1, er: 17, w: 1, l: 1, sv: 0, fld: 80 },
      { id: 'kendrky01', name: 'Kyle Kendrick', role: 'RP', throws: 'R', age: 24, g: 9, gs: 2, outs: 79, h: 30, hr: 3, bb: 8, so: 11, hbp: 2, er: 14, w: 3, l: 1, sv: 0, fld: 78 },
    ],
  },
  // WSH (WAS 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'stammcr01', name: 'Craig Stammen', role: 'SP', throws: 'R', age: 25, g: 19, gs: 19, outs: 317, h: 112, hr: 14, bb: 24, so: 48, hbp: 3, er: 60, w: 4, l: 7, sv: 0, fld: 68, rk: true },
      { id: 'mockga01', name: 'Garrett Mock', role: 'SP', throws: 'R', age: 26, g: 28, gs: 15, outs: 274, h: 108, hr: 9, bb: 46, so: 80, hbp: 1, er: 54, w: 3, l: 10, sv: 0, fld: 76, rk: true },
      { id: 'zimmejo02', name: 'Jordan Zimmermann', role: 'SP', throws: 'R', age: 23, g: 16, gs: 16, outs: 274, h: 95, hr: 10, bb: 29, so: 92, hbp: 4, er: 47, w: 3, l: 5, sv: 0, fld: 67, rk: true },
      { id: 'martish01', name: 'Shairon Martis', role: 'SP', throws: 'R', age: 22, g: 15, gs: 15, outs: 257, h: 82, hr: 12, bb: 41, so: 43, hbp: 3, er: 51, w: 5, l: 3, sv: 0, fld: 74, rk: true },
      { id: 'macdomi01', name: 'Mike MacDougal', role: 'CL', throws: 'R', age: 32, g: 57, gs: 0, outs: 163, h: 53, hr: 3, bb: 38, so: 37, hbp: 3, er: 26, w: 1, l: 1, sv: 20, fld: 71 },
      { id: 'hanrajo01', name: 'Joel Hanrahan', role: 'RP', throws: 'R', age: 27, g: 67, gs: 0, outs: 192, h: 68, hr: 6, bb: 36, so: 71, hbp: 2, er: 33, w: 1, l: 4, sv: 5, fld: 75 },
      { id: 'clippty01', name: 'Tyler Clippard', role: 'RP', throws: 'R', age: 24, g: 41, gs: 0, outs: 181, h: 41, hr: 9, bb: 32, so: 60, hbp: 1, er: 21, w: 4, l: 2, sv: 0, fld: 62, rk: true },
      { id: 'beimejo01', name: 'Joe Beimel', role: 'RP', throws: 'L', age: 32, g: 71, gs: 0, outs: 166, h: 56, hr: 3, bb: 20, so: 35, hbp: 2, er: 19, w: 1, l: 6, sv: 1, fld: 70 },
      { id: 'cabreda01', name: 'Daniel Cabrera', role: 'RP', throws: 'R', age: 28, g: 15, gs: 9, outs: 153, h: 59, hr: 6, bb: 31, so: 32, hbp: 5, er: 33, w: 0, l: 6, sv: 0, fld: 84 },
      { id: 'villoro01', name: 'Ron Villone', role: 'RP', throws: 'L', age: 39, g: 63, gs: 0, outs: 146, h: 49, hr: 5, bb: 31, so: 38, hbp: 2, er: 24, w: 5, l: 6, sv: 1, fld: 79 },
    ],
    reservePitchers: [
      { id: 'martijd01', name: 'J. D. Martin', role: 'SP', throws: 'R', age: 26, g: 15, gs: 15, outs: 231, h: 85, hr: 14, bb: 24, so: 37, hbp: 6, er: 38, w: 5, l: 4, sv: 0, fld: 54, rk: true },
      { id: 'detwiro01', name: 'Ross Detwiler', role: 'SP', throws: 'L', age: 23, g: 15, gs: 14, outs: 227, h: 87, hr: 3, bb: 33, so: 43, hbp: 2, er: 42, w: 1, l: 6, sv: 0, fld: 79, rk: true },
      { id: 'olsensc01', name: 'Scott Olsen', role: 'SP', throws: 'L', age: 25, g: 11, gs: 11, outs: 188, h: 74, hr: 10, bb: 25, so: 41, hbp: 1, er: 36, w: 2, l: 4, sv: 0, fld: 65 },
      { id: 'bergmja01', name: 'Jason Bergmann', role: 'RP', throws: 'R', age: 27, g: 56, gs: 0, outs: 144, h: 51, hr: 8, bb: 20, so: 37, hbp: 1, er: 27, w: 2, l: 4, sv: 0, fld: 70 },
      { id: 'riversa01', name: 'Saul Rivera', role: 'RP', throws: 'R', age: 31, g: 30, gs: 0, outs: 115, h: 43, hr: 3, bb: 16, so: 27, hbp: 2, er: 20, w: 1, l: 3, sv: 0, fld: 65 },
    ],
  },
  // CHC (CHN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'greggke01', name: 'Kevin Gregg', role: 'CL', throws: 'R', age: 31, g: 72, gs: 0, outs: 206, h: 56, hr: 8, bb: 33, so: 67, hbp: 4, er: 31, w: 5, l: 6, sv: 23, fld: 83 },
      { id: 'marshse01', name: 'Sean Marshall', role: 'RP', throws: 'L', age: 26, g: 55, gs: 9, outs: 256, h: 88, hr: 11, bb: 31, so: 68, hbp: 2, er: 39, w: 3, l: 7, sv: 0, fld: 78 },
      { id: 'marmoca01', name: 'Carlos Marmol', role: 'RP', throws: 'R', age: 26, g: 79, gs: 0, outs: 222, h: 42, hr: 5, bb: 53, so: 102, hbp: 9, er: 25, w: 2, l: 4, sv: 15, fld: 83 },
      { id: 'heilmaa01', name: 'Aaron Heilman', role: 'RP', throws: 'R', age: 30, g: 70, gs: 0, outs: 217, h: 67, hr: 9, bb: 34, so: 66, hbp: 4, er: 34, w: 4, l: 4, sv: 1, fld: 64 },
      { id: 'guzmaan01', name: 'Angel Guzman', role: 'RP', throws: 'R', age: 27, g: 55, gs: 0, outs: 183, h: 45, hr: 7, bb: 22, so: 48, hbp: 2, er: 22, w: 3, l: 3, sv: 1, fld: 83 },
      { id: 'gorzeto01', name: 'Tom Gorzelanny', role: 'RP', throws: 'L', age: 26, g: 22, gs: 7, outs: 141, h: 48, hr: 6, bb: 21, so: 33, hbp: 1, er: 27, w: 7, l: 3, sv: 0, fld: 69 },
    ],
    reservePitchers: [
      { id: 'samarje01', name: 'Jeff Samardzija', role: 'RP', throws: 'R', age: 24, g: 20, gs: 2, outs: 104, h: 42, hr: 5, bb: 17, so: 25, hbp: 1, er: 23, w: 1, l: 3, sv: 0, fld: 78, rk: true },
      { id: 'pattoda01', name: 'David Patton', role: 'RP', throws: 'R', age: 25, g: 20, gs: 0, outs: 83, h: 31, hr: 4, bb: 19, so: 23, hbp: 0, er: 21, w: 3, l: 1, sv: 0, fld: 75, rk: true },
      { id: 'carides01', name: 'Esmailin Caridad', role: 'RP', throws: 'R', age: 25, g: 14, gs: 0, outs: 58, h: 15, hr: 0, bb: 3, so: 17, hbp: 3, er: 3, w: 1, l: 0, sv: 0, fld: 64, rk: true },
      { id: 'ascanjo01', name: 'Jose Ascanio', role: 'RP', throws: 'R', age: 24, g: 16, gs: 0, outs: 54, h: 22, hr: 2, bb: 9, so: 18, hbp: 2, er: 10, w: 0, l: 2, sv: 0, fld: 80, rk: true },
      { id: 'steveje01', name: 'Jeff Stevens', role: 'RP', throws: 'R', age: 25, g: 11, gs: 0, outs: 38, h: 14, hr: 2, bb: 8, so: 9, hbp: 1, er: 10, w: 1, l: 0, sv: 0, fld: 64, rk: true },
    ],
  },
  // CIN (CIN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'owingmi01', name: 'Micah Owings', role: 'SP', throws: 'R', age: 26, g: 26, gs: 19, outs: 359, h: 124, hr: 17, bb: 55, so: 82, hbp: 9, er: 72, w: 7, l: 12, sv: 1, fld: 62 },
      { id: 'baileho02', name: 'Homer Bailey', role: 'SP', throws: 'R', age: 23, g: 20, gs: 20, outs: 340, h: 122, hr: 13, bb: 53, so: 78, hbp: 3, er: 64, w: 8, l: 5, sv: 0, fld: 73 },
      { id: 'cordefr01', name: 'Francisco Cordero', role: 'CL', throws: 'R', age: 34, g: 68, gs: 0, outs: 200, h: 57, hr: 4, bb: 30, so: 68, hbp: 1, er: 20, w: 2, l: 6, sv: 39, fld: 54 },
      { id: 'masseni01', name: 'Nick Masset', role: 'RP', throws: 'R', age: 27, g: 74, gs: 0, outs: 228, h: 65, hr: 6, bb: 27, so: 58, hbp: 1, er: 26, w: 5, l: 1, sv: 0, fld: 78 },
      { id: 'wellski01', name: 'Kip Wells', role: 'RP', throws: 'R', age: 32, g: 33, gs: 7, outs: 218, h: 68, hr: 7, bb: 40, so: 48, hbp: 4, er: 44, w: 2, l: 5, sv: 2, fld: 77 },
      { id: 'weathda01', name: 'David Weathers', role: 'RP', throws: 'R', age: 39, g: 68, gs: 0, outs: 186, h: 57, hr: 7, bb: 26, so: 38, hbp: 3, er: 25, w: 4, l: 6, sv: 1, fld: 84 },
      { id: 'herreda01', name: 'Danny Herrera', role: 'RP', throws: 'L', age: 24, g: 70, gs: 0, outs: 185, h: 64, hr: 5, bb: 24, so: 45, hbp: 3, er: 23, w: 4, l: 4, sv: 0, fld: 78, rk: true },
      { id: 'burtoja01', name: 'Jared Burton', role: 'RP', throws: 'R', age: 28, g: 53, gs: 0, outs: 178, h: 57, hr: 5, bb: 25, so: 51, hbp: 3, er: 25, w: 1, l: 0, sv: 0, fld: 70 },
    ],
    reservePitchers: [
      { id: 'lehrju01', name: 'Justin Lehr', role: 'SP', throws: 'R', age: 31, g: 11, gs: 11, outs: 196, h: 72, hr: 14, bb: 28, so: 33, hbp: 3, er: 39, w: 5, l: 3, sv: 0, fld: 74 },
      { id: 'rhodear01', name: 'Arthur Rhodes', role: 'RP', throws: 'L', age: 39, g: 66, gs: 0, outs: 160, h: 38, hr: 2, bb: 21, so: 51, hbp: 1, er: 14, w: 1, l: 1, sv: 0, fld: 76 },
      { id: 'fisheca01', name: 'Carlos Fisher', role: 'RP', throws: 'R', age: 26, g: 39, gs: 0, outs: 157, h: 50, hr: 4, bb: 31, so: 48, hbp: 1, er: 26, w: 1, l: 1, sv: 0, fld: 81, rk: true },
      { id: 'volqued01', name: 'Edinson Volquez', role: 'RP', throws: 'R', age: 25, g: 9, gs: 9, outs: 149, h: 41, hr: 4, bb: 26, so: 50, hbp: 4, er: 20, w: 4, l: 2, sv: 0, fld: 54 },
      { id: 'malonma02', name: 'Matt Maloney', role: 'RP', throws: 'L', age: 25, g: 7, gs: 7, outs: 122, h: 43, hr: 9, bb: 8, so: 28, hbp: 3, er: 22, w: 2, l: 4, sv: 0, fld: 62, rk: true },
    ],
  },
  // MIL (MIL 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'bushda01', name: 'Dave Bush', role: 'SP', throws: 'R', age: 29, g: 22, gs: 21, outs: 343, h: 124, hr: 19, bb: 33, so: 82, hbp: 10, er: 69, w: 5, l: 9, sv: 0, fld: 69 },
      { id: 'hoffmtr01', name: 'Trevor Hoffman', role: 'CL', throws: 'R', age: 41, g: 55, gs: 0, outs: 162, h: 39, hr: 4, bb: 13, so: 48, hbp: 1, er: 15, w: 3, l: 2, sv: 37, fld: 85 },
      { id: 'villaca01', name: 'Carlos Villanueva', role: 'RP', throws: 'R', age: 25, g: 64, gs: 6, outs: 288, h: 99, hr: 14, bb: 34, so: 84, hbp: 2, er: 50, w: 4, l: 10, sv: 3, fld: 72 },
      { id: 'coffeto01', name: 'Todd Coffey', role: 'RP', throws: 'R', age: 28, g: 78, gs: 0, outs: 251, h: 82, hr: 10, bb: 22, so: 61, hbp: 4, er: 32, w: 4, l: 4, sv: 2, fld: 61 },
      { id: 'mccluse01', name: 'Seth McClung', role: 'RP', throws: 'R', age: 28, g: 41, gs: 2, outs: 186, h: 59, hr: 8, bb: 36, so: 47, hbp: 3, er: 31, w: 3, l: 3, sv: 0, fld: 77 },
      { id: 'burnsmi01', name: 'Mike Burns', role: 'RP', throws: 'R', age: 30, g: 15, gs: 8, outs: 155, h: 60, hr: 10, bb: 17, so: 39, hbp: 1, er: 33, w: 3, l: 5, sv: 0, fld: 76 },
      { id: 'difelma01', name: 'Mark DiFelice', role: 'RP', throws: 'R', age: 32, g: 59, gs: 0, outs: 155, h: 49, hr: 7, bb: 14, so: 50, hbp: 1, er: 20, w: 4, l: 1, sv: 0, fld: 66, rk: true },
    ],
    reservePitchers: [
      { id: 'narvech01', name: 'Chris Narveson', role: 'RP', throws: 'L', age: 27, g: 21, gs: 4, outs: 141, h: 45, hr: 7, bb: 16, so: 46, hbp: 2, er: 20, w: 2, l: 0, sv: 0, fld: 71, rk: true },
      { id: 'smithch07', name: 'Chris Smith', role: 'RP', throws: 'R', age: 28, g: 35, gs: 0, outs: 138, h: 42, hr: 12, bb: 19, so: 35, hbp: 2, er: 25, w: 0, l: 0, sv: 0, fld: 54, rk: true },
      { id: 'stettmi01', name: 'Mitch Stetter', role: 'RP', throws: 'L', age: 28, g: 71, gs: 0, outs: 135, h: 33, hr: 4, bb: 29, so: 47, hbp: 6, er: 18, w: 4, l: 1, sv: 1, fld: 68, rk: true },
      { id: 'vargacl01', name: 'Claudio Vargas', role: 'RP', throws: 'R', age: 31, g: 36, gs: 0, outs: 124, h: 34, hr: 5, bb: 14, so: 28, hbp: 1, er: 16, w: 1, l: 0, sv: 0, fld: 69 },
      { id: 'juliojo01', name: 'Jorge Julio', role: 'RP', throws: 'R', age: 30, g: 15, gs: 0, outs: 52, h: 18, hr: 2, bb: 12, so: 17, hbp: 2, er: 11, w: 1, l: 1, sv: 0, fld: 74 },
    ],
  },
  // PIT (PIT 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'karstje01', name: 'Jeff Karstens', role: 'SP', throws: 'R', age: 26, g: 39, gs: 13, outs: 324, h: 119, hr: 13, bb: 42, so: 51, hbp: 1, er: 63, w: 4, l: 6, sv: 0, fld: 81 },
      { id: 'cappsma01', name: 'Matt Capps', role: 'CL', throws: 'R', age: 25, g: 57, gs: 0, outs: 163, h: 64, hr: 8, bb: 13, so: 47, hbp: 3, er: 27, w: 4, l: 8, sv: 27, fld: 69 },
      { id: 'grabojo02', name: 'John Grabow', role: 'RP', throws: 'L', age: 30, g: 75, gs: 0, outs: 217, h: 63, hr: 7, bb: 37, so: 59, hbp: 2, er: 27, w: 3, l: 0, sv: 0, fld: 72 },
      { id: 'chaveje01', name: 'Jesse Chavez', role: 'RP', throws: 'R', age: 25, g: 73, gs: 0, outs: 202, h: 71, hr: 11, bb: 24, so: 49, hbp: 1, er: 32, w: 1, l: 4, sv: 0, fld: 67, rk: true },
      { id: 'burnese01', name: 'Sean Burnett', role: 'RP', throws: 'L', age: 26, g: 71, gs: 0, outs: 173, h: 43, hr: 6, bb: 29, so: 41, hbp: 3, er: 23, w: 2, l: 3, sv: 1, fld: 61 },
      { id: 'meekev01', name: 'Evan Meek', role: 'RP', throws: 'R', age: 26, g: 41, gs: 0, outs: 141, h: 34, hr: 3, bb: 31, so: 39, hbp: 1, er: 20, w: 1, l: 1, sv: 0, fld: 78, rk: true },
      { id: 'vasquvi01', name: 'Virgil Vasquez', role: 'RP', throws: 'R', age: 27, g: 14, gs: 7, outs: 134, h: 59, hr: 7, bb: 17, so: 28, hbp: 3, er: 30, w: 2, l: 5, sv: 0, fld: 80, rk: true },
    ],
    reservePitchers: [
      { id: 'mortoch02', name: 'Charlie Morton', role: 'SP', throws: 'R', age: 25, g: 18, gs: 18, outs: 291, h: 102, hr: 9, bb: 44, so: 62, hbp: 4, er: 54, w: 5, l: 9, sv: 0, fld: 60 },
      { id: 'hartke01', name: 'Kevin Hart', role: 'SP', throws: 'R', age: 26, g: 18, gs: 14, outs: 243, h: 98, hr: 10, bb: 45, so: 56, hbp: 5, er: 49, w: 4, l: 9, sv: 0, fld: 64, rk: true },
      { id: 'jacksst01', name: 'Steven Jackson', role: 'RP', throws: 'R', age: 27, g: 40, gs: 0, outs: 129, h: 38, hr: 2, bb: 22, so: 21, hbp: 0, er: 15, w: 2, l: 3, sv: 0, fld: 64, rk: true },
      { id: 'mccutda01', name: 'Daniel McCutchen', role: 'RP', throws: 'R', age: 26, g: 6, gs: 6, outs: 109, h: 38, hr: 6, bb: 11, so: 19, hbp: 1, er: 17, w: 1, l: 2, sv: 0, fld: 68, rk: true },
      { id: 'vealdo01', name: 'Donnie Veal', role: 'RP', throws: 'L', age: 24, g: 19, gs: 0, outs: 49, h: 18, hr: 2, bb: 20, so: 16, hbp: 2, er: 13, w: 1, l: 0, sv: 0, fld: 73, rk: true },
    ],
  },
  // STL (SLN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'welleto01', name: 'Todd Wellemeyer', role: 'SP', throws: 'R', age: 30, g: 28, gs: 21, outs: 367, h: 142, hr: 18, bb: 52, so: 88, hbp: 4, er: 68, w: 7, l: 10, sv: 0, fld: 77 },
      { id: 'lohseky01', name: 'Kyle Lohse', role: 'SP', throws: 'R', age: 30, g: 23, gs: 22, outs: 353, h: 126, hr: 13, bb: 33, so: 74, hbp: 3, er: 57, w: 6, l: 10, sv: 0, fld: 73 },
      { id: 'frankry01', name: 'Ryan Franklin', role: 'CL', throws: 'R', age: 36, g: 62, gs: 0, outs: 183, h: 55, hr: 5, bb: 20, so: 40, hbp: 2, er: 18, w: 4, l: 3, sv: 38, fld: 60 },
      { id: 'thompbr01', name: 'Brad Thompson', role: 'RP', throws: 'R', age: 27, g: 32, gs: 8, outs: 240, h: 88, hr: 9, bb: 23, so: 35, hbp: 6, er: 43, w: 2, l: 6, sv: 0, fld: 59 },
      { id: 'mccleky01', name: 'Kyle McClellan', role: 'RP', throws: 'R', age: 25, g: 66, gs: 0, outs: 200, h: 61, hr: 5, bb: 29, so: 51, hbp: 3, er: 27, w: 4, l: 4, sv: 3, fld: 84 },
      { id: 'boggsmi01', name: 'Mitchell Boggs', role: 'RP', throws: 'R', age: 25, g: 16, gs: 9, outs: 174, h: 71, hr: 5, bb: 34, so: 39, hbp: 4, er: 33, w: 2, l: 3, sv: 0, fld: 81, rk: true },
      { id: 'motteja01', name: 'Jason Motte', role: 'RP', throws: 'R', age: 27, g: 69, gs: 0, outs: 170, h: 54, hr: 9, bb: 23, so: 58, hbp: 2, er: 28, w: 4, l: 4, sv: 0, fld: 60, rk: true },
      { id: 'milletr02', name: 'Trever Miller', role: 'RP', throws: 'L', age: 36, g: 70, gs: 0, outs: 131, h: 34, hr: 4, bb: 15, so: 42, hbp: 3, er: 15, w: 4, l: 1, sv: 0, fld: 67 },
    ],
    reservePitchers: [
      { id: 'reyesde01', name: 'Dennys Reyes', role: 'RP', throws: 'L', age: 32, g: 75, gs: 0, outs: 123, h: 37, hr: 3, bb: 19, so: 33, hbp: 3, er: 14, w: 0, l: 2, sv: 1, fld: 73 },
      { id: 'hawksbl01', name: 'Blake Hawksworth', role: 'RP', throws: 'R', age: 26, g: 30, gs: 0, outs: 120, h: 29, hr: 2, bb: 15, so: 20, hbp: 1, er: 9, w: 4, l: 0, sv: 0, fld: 74, rk: true },
      { id: 'waltepj01', name: 'P. J. Walters', role: 'RP', throws: 'R', age: 24, g: 8, gs: 1, outs: 48, h: 21, hr: 6, bb: 9, so: 14, hbp: 0, er: 17, w: 0, l: 0, sv: 0, fld: 75, rk: true },
      { id: 'kinnejo01', name: 'Josh Kinney', role: 'RP', throws: 'R', age: 30, g: 17, gs: 0, outs: 46, h: 21, hr: 2, bb: 10, so: 11, hbp: 2, er: 12, w: 1, l: 0, sv: 0, fld: 56, rk: true },
    ],
  },
  // ARI (ARI 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'petityu01', name: 'Yusmeiro Petit', role: 'SP', throws: 'R', age: 24, g: 23, gs: 17, outs: 269, h: 96, hr: 20, bb: 31, so: 73, hbp: 0, er: 54, w: 3, l: 10, sv: 0, fld: 66 },
      { id: 'quallch01', name: 'Chad Qualls', role: 'CL', throws: 'R', age: 30, g: 51, gs: 0, outs: 156, h: 49, hr: 4, bb: 11, so: 48, hbp: 2, er: 18, w: 2, l: 2, sv: 24, fld: 61 },
      { id: 'gutieju01', name: 'J. C. Gutierrez', role: 'RP', throws: 'R', age: 25, g: 65, gs: 0, outs: 213, h: 68, hr: 3, bb: 29, so: 65, hbp: 3, er: 33, w: 4, l: 3, sv: 9, fld: 71, rk: true },
      { id: 'rauchjo01', name: 'Jon Rauch', role: 'RP', throws: 'R', age: 30, g: 75, gs: 0, outs: 210, h: 69, hr: 8, bb: 20, so: 57, hbp: 1, er: 30, w: 7, l: 3, sv: 2, fld: 83 },
      { id: 'boyerbl01', name: 'Blaine Boyer', role: 'RP', throws: 'R', age: 27, g: 48, gs: 0, outs: 164, h: 57, hr: 4, bb: 20, so: 39, hbp: 3, er: 30, w: 0, l: 2, sv: 0, fld: 68 },
      { id: 'vasques01', name: 'Esmerling Vasquez', role: 'RP', throws: 'R', age: 25, g: 53, gs: 0, outs: 159, h: 52, hr: 4, bb: 29, so: 45, hbp: 3, er: 26, w: 3, l: 3, sv: 0, fld: 69, rk: true },
      { id: 'zavadcl01', name: 'Clay Zavada', role: 'RP', throws: 'L', age: 25, g: 49, gs: 0, outs: 153, h: 45, hr: 5, bb: 24, so: 52, hbp: 3, er: 19, w: 3, l: 3, sv: 0, fld: 61, rk: true },
    ],
    reservePitchers: [
      { id: 'bucknbi02', name: 'Billy Buckner', role: 'SP', throws: 'R', age: 25, g: 16, gs: 13, outs: 232, h: 93, hr: 12, bb: 29, so: 61, hbp: 3, er: 52, w: 4, l: 6, sv: 0, fld: 76, rk: true },
      { id: 'rosalle01', name: 'Leo Rosales', role: 'RP', throws: 'R', age: 28, g: 33, gs: 0, outs: 136, h: 41, hr: 4, bb: 15, so: 29, hbp: 0, er: 22, w: 2, l: 1, sv: 0, fld: 84, rk: true },
      { id: 'mulveke01', name: 'Kevin Mulvey', role: 'RP', throws: 'R', age: 24, g: 8, gs: 4, outs: 73, h: 29, hr: 5, bb: 12, so: 18, hbp: 2, er: 22, w: 0, l: 3, sv: 0, fld: 77, rk: true },
      { id: 'schoesc01', name: 'Scott Schoeneweis', role: 'RP', throws: 'L', age: 35, g: 45, gs: 0, outs: 72, h: 27, hr: 4, bb: 12, so: 16, hbp: 2, er: 14, w: 1, l: 2, sv: 0, fld: 62 },
      { id: 'schleda01', name: 'Daniel Schlereth', role: 'RP', throws: 'L', age: 23, g: 21, gs: 0, outs: 55, h: 15, hr: 1, bb: 15, so: 22, hbp: 1, er: 12, w: 1, l: 4, sv: 0, fld: 63, rk: true },
    ],
  },
  // COL (COL 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'streehu01', name: 'Huston Street', role: 'CL', throws: 'R', age: 25, g: 64, gs: 0, outs: 185, h: 45, hr: 6, bb: 17, so: 66, hbp: 0, er: 22, w: 4, l: 1, sv: 35, fld: 55 },
      { id: 'daleyma01', name: 'Matt Daley', role: 'RP', throws: 'R', age: 27, g: 57, gs: 0, outs: 153, h: 43, hr: 6, bb: 18, so: 55, hbp: 2, er: 24, w: 1, l: 1, sv: 0, fld: 71, rk: true },
      { id: 'foggjo01', name: 'Josh Fogg', role: 'RP', throws: 'R', age: 32, g: 24, gs: 1, outs: 137, h: 45, hr: 7, bb: 16, so: 24, hbp: 3, er: 26, w: 0, l: 2, sv: 0, fld: 60 },
      { id: 'moralfr01', name: 'Franklin Morales', role: 'RP', throws: 'L', age: 23, g: 40, gs: 2, outs: 120, h: 39, hr: 3, bb: 22, so: 32, hbp: 1, er: 21, w: 3, l: 2, sv: 7, fld: 76 },
      { id: 'rincoju01', name: 'Juan Rincon', role: 'RP', throws: 'R', age: 30, g: 33, gs: 0, outs: 110, h: 37, hr: 5, bb: 20, so: 30, hbp: 2, er: 24, w: 4, l: 2, sv: 0, fld: 72 },
      { id: 'corpama01', name: 'Manny Corpas', role: 'RP', throws: 'R', age: 26, g: 35, gs: 0, outs: 101, h: 39, hr: 3, bb: 9, so: 24, hbp: 1, er: 17, w: 1, l: 3, sv: 1, fld: 74 },
    ],
    reservePitchers: [
      { id: 'belisma01', name: 'Matt Belisle', role: 'RP', throws: 'R', age: 29, g: 24, gs: 0, outs: 93, h: 37, hr: 5, bb: 6, so: 20, hbp: 1, er: 19, w: 3, l: 1, sv: 0, fld: 50 },
      { id: 'embreal01', name: 'Alan Embree', role: 'RP', throws: 'L', age: 39, g: 36, gs: 0, outs: 74, h: 26, hr: 3, bb: 11, so: 19, hbp: 1, er: 14, w: 2, l: 2, sv: 0, fld: 79 },
      { id: 'peraljo01', name: 'Joel Peralta', role: 'RP', throws: 'R', age: 33, g: 27, gs: 0, outs: 74, h: 28, hr: 5, bb: 8, so: 20, hbp: 1, er: 15, w: 0, l: 3, sv: 0, fld: 56 },
      { id: 'ruschgl01', name: 'Glendon Rusch', role: 'RP', throws: 'L', age: 34, g: 11, gs: 0, outs: 56, h: 27, hr: 3, bb: 5, so: 14, hbp: 0, er: 13, w: 2, l: 0, sv: 0, fld: 70 },
      { id: 'florera01', name: 'Randy Flores', role: 'RP', throws: 'L', age: 33, g: 27, gs: 0, outs: 36, h: 14, hr: 1, bb: 5, so: 9, hbp: 0, er: 6, w: 0, l: 1, sv: 0, fld: 60 },
    ],
  },
  // LAD (LAN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'kurodhi01', name: 'Hiroki Kuroda', role: 'SP', throws: 'R', age: 34, g: 21, gs: 20, outs: 352, h: 112, hr: 10, bb: 25, so: 79, hbp: 3, er: 48, w: 8, l: 7, sv: 0, fld: 72 },
      { id: 'stulter01', name: 'Eric Stults', role: 'SP', throws: 'L', age: 29, g: 10, gs: 10, outs: 150, h: 53, hr: 5, bb: 23, so: 36, hbp: 3, er: 26, w: 4, l: 3, sv: 0, fld: 84 },
      { id: 'broxtjo01', name: 'Jonathan Broxton', role: 'CL', throws: 'R', age: 25, g: 73, gs: 0, outs: 228, h: 51, hr: 4, bb: 27, so: 102, hbp: 2, er: 23, w: 7, l: 2, sv: 36, fld: 68 },
      { id: 'troncra01', name: 'Ramon Troncoso', role: 'RP', throws: 'R', age: 26, g: 73, gs: 0, outs: 248, h: 83, hr: 3, bb: 32, so: 62, hbp: 4, er: 28, w: 5, l: 4, sv: 6, fld: 59, rk: true },
      { id: 'weaveje01', name: 'Jeff Weaver', role: 'RP', throws: 'R', age: 32, g: 28, gs: 7, outs: 237, h: 93, hr: 9, bb: 28, so: 56, hbp: 5, er: 41, w: 6, l: 4, sv: 0, fld: 83 },
      { id: 'belisro01', name: 'Ronald Belisario', role: 'RP', throws: 'R', age: 26, g: 69, gs: 0, outs: 212, h: 52, hr: 4, bb: 29, so: 64, hbp: 6, er: 16, w: 4, l: 3, sv: 0, fld: 71, rk: true },
      { id: 'motagu01', name: 'Guillermo Mota', role: 'RP', throws: 'R', age: 35, g: 61, gs: 0, outs: 196, h: 57, hr: 7, bb: 25, so: 46, hbp: 3, er: 29, w: 3, l: 4, sv: 0, fld: 77 },
      { id: 'mcdonja03', name: 'James McDonald', role: 'RP', throws: 'R', age: 24, g: 45, gs: 4, outs: 189, h: 60, hr: 6, bb: 33, so: 52, hbp: 5, er: 27, w: 5, l: 5, sv: 0, fld: 77, rk: true },
    ],
    reservePitchers: [
      { id: 'kuoho01', name: 'Hung-Chih Kuo', role: 'RP', throws: 'L', age: 27, g: 35, gs: 0, outs: 90, h: 24, hr: 2, bb: 10, so: 34, hbp: 1, er: 10, w: 2, l: 0, sv: 0, fld: 70 },
      { id: 'wadeco01', name: 'Cory Wade', role: 'RP', throws: 'R', age: 26, g: 27, gs: 0, outs: 83, h: 24, hr: 3, bb: 8, so: 20, hbp: 1, er: 11, w: 2, l: 3, sv: 0, fld: 61 },
      { id: 'miltoer01', name: 'Eric Milton', role: 'RP', throws: 'L', age: 33, g: 5, gs: 5, outs: 71, h: 30, hr: 2, bb: 6, so: 18, hbp: 1, er: 11, w: 2, l: 1, sv: 0, fld: 58 },
      { id: 'leachbr01', name: 'Brent Leach', role: 'RP', throws: 'L', age: 26, g: 38, gs: 0, outs: 61, h: 16, hr: 3, bb: 12, so: 19, hbp: 1, er: 13, w: 2, l: 0, sv: 0, fld: 65, rk: true },
      { id: 'elbersc01', name: 'Scott Elbert', role: 'RP', throws: 'L', age: 23, g: 19, gs: 0, outs: 59, h: 20, hr: 4, bb: 8, so: 21, hbp: 1, er: 13, w: 2, l: 0, sv: 0, fld: 70, rk: true },
    ],
  },
  // SDP (SDN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'geerjo01', name: 'Josh Geer', role: 'SP', throws: 'R', age: 26, g: 19, gs: 17, outs: 308, h: 115, hr: 24, bb: 25, so: 55, hbp: 3, er: 62, w: 1, l: 7, sv: 0, fld: 76, rk: true },
      { id: 'peavyja01', name: 'Jake Peavy', role: 'SP', throws: 'R', age: 28, g: 16, gs: 16, outs: 305, h: 81, hr: 8, bb: 33, so: 104, hbp: 2, er: 34, w: 9, l: 6, sv: 0, fld: 74 },
      { id: 'youngch03', name: 'Chris Young', role: 'SP', throws: 'R', age: 30, g: 14, gs: 14, outs: 228, h: 64, hr: 9, bb: 37, so: 65, hbp: 2, er: 37, w: 4, l: 6, sv: 0, fld: 71 },
      { id: 'bellhe01', name: 'Heath Bell', role: 'CL', throws: 'R', age: 31, g: 68, gs: 0, outs: 209, h: 54, hr: 3, bb: 24, so: 73, hbp: 1, er: 22, w: 6, l: 4, sv: 42, fld: 64 },
      { id: 'mujiced01', name: 'Edward Mujica', role: 'RP', throws: 'R', age: 25, g: 67, gs: 4, outs: 281, h: 103, hr: 14, bb: 20, so: 72, hbp: 0, er: 48, w: 3, l: 5, sv: 2, fld: 64 },
      { id: 'gregelu01', name: 'Luke Gregerson', role: 'RP', throws: 'R', age: 25, g: 72, gs: 0, outs: 225, h: 62, hr: 3, bb: 31, so: 93, hbp: 3, er: 27, w: 2, l: 4, sv: 1, fld: 71, rk: true },
      { id: 'meredcl01', name: 'Cla Meredith', role: 'RP', throws: 'R', age: 26, g: 64, gs: 0, outs: 196, h: 75, hr: 5, bb: 22, so: 43, hbp: 3, er: 29, w: 4, l: 2, sv: 0, fld: 58 },
      { id: 'perdolu01', name: 'Luis Perdomo', role: 'RP', throws: 'R', age: 25, g: 35, gs: 0, outs: 180, h: 57, hr: 11, bb: 34, so: 55, hbp: 0, er: 32, w: 1, l: 0, sv: 0, fld: 69, rk: true },
      { id: 'leblawa01', name: 'Wade LeBlanc', role: 'RP', throws: 'L', age: 24, g: 9, gs: 9, outs: 139, h: 40, hr: 8, bb: 21, so: 29, hbp: 3, er: 23, w: 3, l: 1, sv: 0, fld: 78, rk: true },
    ],
    reservePitchers: [
      { id: 'staufti01', name: 'Tim Stauffer', role: 'SP', throws: 'R', age: 27, g: 14, gs: 14, outs: 219, h: 73, hr: 9, bb: 34, so: 53, hbp: 5, er: 33, w: 4, l: 7, sv: 0, fld: 70 },
      { id: 'latosma01', name: 'Mat Latos', role: 'SP', throws: 'R', age: 21, g: 10, gs: 10, outs: 152, h: 43, hr: 7, bb: 23, so: 39, hbp: 0, er: 26, w: 4, l: 5, sv: 0, fld: 75, rk: true },
      { id: 'burkegr01', name: 'Greg Burke', role: 'RP', throws: 'R', age: 26, g: 48, gs: 0, outs: 137, h: 48, hr: 4, bb: 23, so: 33, hbp: 1, er: 21, w: 3, l: 3, sv: 0, fld: 66, rk: true },
      { id: 'thatcjo01', name: 'Joe Thatcher', role: 'RP', throws: 'L', age: 27, g: 52, gs: 0, outs: 135, h: 43, hr: 3, bb: 18, so: 45, hbp: 3, er: 19, w: 1, l: 0, sv: 0, fld: 80, rk: true },
      { id: 'adamsmi03', name: 'Mike Adams', role: 'RP', throws: 'R', age: 30, g: 37, gs: 0, outs: 111, h: 20, hr: 2, bb: 9, so: 41, hbp: 0, er: 6, w: 0, l: 0, sv: 0, fld: 71 },
    ],
  },
  // SFG (SFN 2009)
  {
    ...
    pitchers: [
      ...
      { id: 'johnsra05', name: 'Randy Johnson', role: 'SP', throws: 'L', age: 45, g: 22, gs: 17, outs: 288, h: 97, hr: 15, bb: 26, so: 92, hbp: 3, er: 46, w: 8, l: 6, sv: 0, fld: 63 },
      { id: 'wilsobr01', name: 'Brian Wilson', role: 'CL', throws: 'R', age: 27, g: 68, gs: 0, outs: 217, h: 62, hr: 5, bb: 28, so: 78, hbp: 2, er: 26, w: 5, l: 6, sv: 38, fld: 78 },
      { id: 'meddebr01', name: 'Brandon Medders', role: 'RP', throws: 'R', age: 29, g: 61, gs: 0, outs: 206, h: 63, hr: 8, bb: 33, so: 53, hbp: 3, er: 26, w: 5, l: 1, sv: 1, fld: 74 },
      { id: 'howrybo01', name: 'Bob Howry', role: 'RP', throws: 'R', age: 35, g: 63, gs: 0, outs: 191, h: 61, hr: 7, bb: 17, so: 49, hbp: 2, er: 28, w: 2, l: 6, sv: 0, fld: 48 },
      { id: 'affelje01', name: 'Jeremy Affeldt', role: 'RP', throws: 'L', age: 30, g: 74, gs: 0, outs: 187, h: 50, hr: 5, bb: 27, so: 56, hbp: 3, er: 18, w: 2, l: 2, sv: 0, fld: 62 },
      { id: 'milleju01', name: 'Justin Miller', role: 'RP', throws: 'R', age: 31, g: 44, gs: 0, outs: 170, h: 50, hr: 6, bb: 25, so: 46, hbp: 2, er: 22, w: 3, l: 3, sv: 0, fld: 74 },
      { id: 'valdeme01', name: 'Merkin Valdez', role: 'RP', throws: 'R', age: 27, g: 48, gs: 0, outs: 148, h: 55, hr: 5, bb: 27, so: 39, hbp: 1, er: 27, w: 2, l: 1, sv: 0, fld: 57, rk: true },
    ],
    reservePitchers: [
      { id: 'romose01', name: 'Sergio Romo', role: 'RP', throws: 'R', age: 26, g: 45, gs: 0, outs: 102, h: 25, hr: 2, bb: 10, so: 39, hbp: 2, er: 13, w: 5, l: 2, sv: 2, fld: 70, rk: true },
      { id: 'martijo07', name: 'Joe Martinez', role: 'RP', throws: 'R', age: 26, g: 9, gs: 5, outs: 90, h: 46, hr: 4, bb: 12, so: 19, hbp: 1, er: 25, w: 3, l: 2, sv: 0, fld: 59, rk: true },
      { id: 'sadowry01', name: 'Ryan Sadowski', role: 'RP', throws: 'R', age: 26, g: 6, gs: 6, outs: 85, h: 28, hr: 2, bb: 17, so: 17, hbp: 1, er: 14, w: 2, l: 4, sv: 0, fld: 64, rk: true },
      { id: 'joaquwa01', name: 'Waldis Joaquin', role: 'RP', throws: 'R', age: 22, g: 10, gs: 0, outs: 32, h: 10, hr: 1, bb: 7, so: 12, hbp: 2, er: 5, w: 0, l: 0, sv: 0, fld: 87, rk: true },
      { id: 'bumgama01', name: 'Madison Bumgarner', role: 'RP', throws: 'L', age: 19, g: 4, gs: 1, outs: 30, h: 8, hr: 2, bb: 3, so: 10, hbp: 0, er: 2, w: 0, l: 0, sv: 0, fld: 80, rk: true },
    ],
  },
];
