...
//
// Tabellini REALI (approssimati, fonte: record pubblici) di due rose iconiche
// del 1999: l'attacco monstre dei Cleveland Indians (primo >1000 punti dal 1950)
// e il pitching dei Boston Red Sox trainato dal Pedro Martinez 2.07/313K. Servono
// come primo banco di prova dell'import: coprono le tre fasce — campioni
// (Ramirez, Nomar, Pedro), medi (Fryman, Wakefield) e scarsi (Lewis, Portugal).
//
// I NUMERI sono la fonte: l'importatore ne ricava i rating 20-80 (inversione in
// engine/statsToRatings) e da quei rating ri-deriva/ri-simula. Nessun logo/foto
// (marchi protetti): solo dati statistici fattuali. Le cifre sono arrotondate e
// non pretendono l'esattezza al singolo evento: e' una prova di pipeline.
// ---------------------------------------------------------------------------
...
// --- Cleveland Indians 1999 (1009 punti segnati) --------------------------
const CLE_1999: HistTeam = {
  franchiseId: 'CLE',
  season: 1999,
  batters: [
...
// --- Boston Red Sox 1999 (Pedro 2.07 ERA / 313 K) -------------------------
const BOS_1999: HistTeam = {
  franchiseId: 'BOS',
  season: 1999,
  batters: [
...
export const SEASON_1999: HistTeam[] = [CLE_1999, BOS_1999];
