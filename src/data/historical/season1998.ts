...
export const SEASON_1998: HistTeam[] = [
  // BAL (BAL 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'drabedo01', name: 'Doug Drabek', role: 'SP', throws: 'R', age: 35, g: 23, gs: 21, outs: 326, h: 126, hr: 18, bb: 37, so: 62, hbp: 4, er: 75, w: 6, l: 11, sv: 0, fld: 75 },
      { id: 'smithpe02', name: 'Pete Smith', role: 'SP', throws: 'R', age: 32, g: 37, gs: 12, outs: 265, h: 97, hr: 12, bb: 37, so: 59, hbp: 2, er: 51, w: 5, l: 5, sv: 0, fld: 69 },
      { id: 'benitar01', name: 'Armando Benitez', role: 'CL', throws: 'R', age: 25, g: 71, gs: 0, outs: 205, h: 47, hr: 9, bb: 39, so: 93, hbp: 3, er: 25, w: 5, l: 6, sv: 22, fld: 61 },
      { id: 'millsal01', name: 'Alan Mills', role: 'RP', throws: 'R', age: 31, g: 72, gs: 0, outs: 231, h: 59, hr: 9, bb: 52, so: 59, hbp: 1, er: 34, w: 3, l: 4, sv: 2, fld: 61 },
      { id: 'rhodear01', name: 'Arthur Rhodes', role: 'RP', throws: 'L', age: 28, g: 45, gs: 0, outs: 231, h: 65, hr: 8, bb: 29, so: 85, hbp: 2, er: 29, w: 4, l: 4, sv: 4, fld: 76 },
      { id: 'oroscje01', name: 'Jesse Orosco', role: 'RP', throws: 'L', age: 41, g: 69, gs: 0, outs: 170, h: 42, hr: 6, bb: 30, so: 52, hbp: 1, er: 19, w: 4, l: 1, sv: 7, fld: 78 },
      { id: 'charlno01', name: 'Norm Charlton', role: 'RP', throws: 'L', age: 35, g: 49, gs: 0, outs: 144, h: 54, hr: 5, bb: 31, so: 43, hbp: 2, er: 31, w: 2, l: 1, sv: 1, fld: 84 },
      { id: 'rodrine01', name: 'Nerio Rodriguez', role: 'RP', throws: 'R', age: 27, g: 13, gs: 4, outs: 82, h: 33, hr: 2, bb: 15, so: 13, hbp: 1, er: 22, w: 2, l: 3, sv: 0, fld: 73, rk: true },
    ],
    reservePitchers: [
      { id: 'johnsdo04', name: 'Doug Johns', role: 'SP', throws: 'L', age: 30, g: 31, gs: 10, outs: 260, h: 106, hr: 10, bb: 34, so: 36, hbp: 4, er: 49, w: 3, l: 3, sv: 1, fld: 69 },
      { id: 'keyji01', name: 'Jimmy Key', role: 'SP', throws: 'L', age: 37, g: 25, gs: 11, outs: 238, h: 77, hr: 8, bb: 27, so: 52, hbp: 2, er: 34, w: 6, l: 3, sv: 0, fld: 67 },
      { id: 'kamiesc01', name: 'Scott Kamieniecki', role: 'SP', throws: 'R', age: 34, g: 12, gs: 11, outs: 164, h: 63, hr: 7, bb: 24, so: 32, hbp: 2, er: 33, w: 2, l: 6, sv: 0, fld: 79 },
      { id: 'mathete01', name: 'Terry Mathews', role: 'RP', throws: 'R', age: 33, g: 17, gs: 0, outs: 61, h: 22, hr: 3, bb: 10, so: 13, hbp: 0, er: 11, w: 0, l: 1, sv: 0, fld: 59 },
      { id: 'coppiro01', name: 'Rocky Coppinger', role: 'RP', throws: 'R', age: 24, g: 6, gs: 1, outs: 47, h: 16, hr: 3, bb: 8, so: 14, hbp: 0, er: 9, w: 0, l: 0, sv: 0, fld: 77 },
    ],
  },
  // BOS (BOS 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'averyst01', name: 'Steve Avery', role: 'SP', throws: 'L', age: 28, g: 34, gs: 23, outs: 371, h: 138, hr: 14, bb: 58, so: 63, hbp: 4, er: 72, w: 10, l: 7, sv: 0, fld: 67 },
      { id: 'lowede01', name: 'Derek Lowe', role: 'SP', throws: 'R', age: 25, g: 63, gs: 10, outs: 369, h: 127, hr: 9, bb: 42, so: 81, hbp: 5, er: 63, w: 3, l: 9, sv: 4, fld: 79 },
      { id: 'gordoto01', name: 'Tom Gordon', role: 'CL', throws: 'R', age: 30, g: 73, gs: 0, outs: 238, h: 65, hr: 5, bb: 30, so: 65, hbp: 1, er: 32, w: 7, l: 4, sv: 46, fld: 60 },
      { id: 'wasdijo01', name: 'John Wasdin', role: 'RP', throws: 'R', age: 25, g: 47, gs: 8, outs: 288, h: 104, hr: 15, bb: 30, so: 61, hbp: 2, er: 55, w: 6, l: 4, sv: 0, fld: 70 },
      { id: 'corsiji01', name: 'Jim Corsi', role: 'RP', throws: 'R', age: 36, g: 59, gs: 0, outs: 198, h: 60, hr: 4, bb: 24, so: 45, hbp: 2, er: 22, w: 3, l: 2, sv: 0, fld: 90 },
      { id: 'reyesca01', name: 'Carlos Reyes', role: 'RP', throws: 'R', age: 29, g: 46, gs: 0, outs: 198, h: 67, hr: 8, bb: 22, so: 40, hbp: 2, er: 32, w: 3, l: 3, sv: 1, fld: 78 },
      { id: 'garceri01', name: 'Rich Garces', role: 'RP', throws: 'R', age: 27, g: 30, gs: 0, outs: 138, h: 38, hr: 6, bb: 28, so: 39, hbp: 2, er: 19, w: 1, l: 1, sv: 1, fld: 71 },
      { id: 'eckerde01', name: 'Dennis Eckersley', role: 'RP', throws: 'R', age: 43, g: 50, gs: 0, outs: 119, h: 43, hr: 6, bb: 7, so: 30, hbp: 2, er: 19, w: 4, l: 1, sv: 1, fld: 76 },
    ],
    reservePitchers: [
      { id: 'rosebr01', name: 'Brian Rose', role: 'RP', throws: 'R', age: 22, g: 8, gs: 8, outs: 113, h: 44, hr: 8, bb: 14, so: 19, hbp: 2, er: 30, w: 1, l: 4, sv: 0, fld: 85, rk: true },
      { id: 'mahayro01', name: 'Ron Mahay', role: 'RP', throws: 'L', age: 27, g: 29, gs: 0, outs: 78, h: 24, hr: 3, bb: 14, so: 18, hbp: 1, er: 9, w: 1, l: 1, sv: 1, fld: 85, rk: true },
      { id: 'choji01', name: 'Jin Ho Cho', role: 'RP', throws: 'R', age: 22, g: 4, gs: 4, outs: 56, h: 28, hr: 4, bb: 3, so: 15, hbp: 1, er: 17, w: 0, l: 3, sv: 0, fld: 60, rk: true },
      { id: 'barklbr01', name: 'Brian Barkley', role: 'RP', throws: 'L', age: 22, g: 6, gs: 0, outs: 33, h: 16, hr: 2, bb: 9, so: 2, hbp: 1, er: 12, w: 0, l: 0, sv: 0, fld: 63, rk: true },
    ],
  },
  // NYY (NYA 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'riverma01', name: 'Mariano Rivera', role: 'CL', throws: 'R', age: 28, g: 54, gs: 0, outs: 184, h: 49, hr: 3, bb: 18, so: 52, hbp: 1, er: 13, w: 3, l: 0, sv: 36, fld: 62 },
      { id: 'stantmi02', name: 'Mike Stanton', role: 'RP', throws: 'L', age: 31, g: 67, gs: 0, outs: 237, h: 69, hr: 10, bb: 30, so: 71, hbp: 3, er: 37, w: 4, l: 1, sv: 6, fld: 60 },
      { id: 'holmeda01', name: 'Darren Holmes', role: 'RP', throws: 'R', age: 32, g: 34, gs: 0, outs: 154, h: 56, hr: 5, bb: 17, so: 37, hbp: 1, er: 24, w: 0, l: 3, sv: 2, fld: 73 },
      { id: 'buddimi01', name: 'Mike Buddie', role: 'RP', throws: 'R', age: 27, g: 24, gs: 2, outs: 125, h: 46, hr: 5, bb: 13, so: 20, hbp: 3, er: 26, w: 4, l: 1, sv: 0, fld: 66, rk: true },
      { id: 'nelsoje01', name: 'Jeff Nelson', role: 'RP', throws: 'R', age: 31, g: 45, gs: 0, outs: 121, h: 39, hr: 3, bb: 22, so: 44, hbp: 4, er: 17, w: 5, l: 3, sv: 3, fld: 72 },
      { id: 'lloydgr01', name: 'Graeme Lloyd', role: 'RP', throws: 'L', age: 31, g: 50, gs: 0, outs: 113, h: 32, hr: 3, bb: 10, so: 18, hbp: 1, er: 11, w: 3, l: 0, sv: 0, fld: 67 },
    ],
    reservePitchers: [
      { id: 'mendora01', name: 'Ramiro Mendoza', role: 'SP', throws: 'R', age: 26, g: 41, gs: 14, outs: 391, h: 142, hr: 11, bb: 28, so: 66, hbp: 7, er: 55, w: 10, l: 2, sv: 1, fld: 64 },
      { id: 'bradlry01', name: 'Ryan Bradley', role: 'RP', throws: 'R', age: 22, g: 5, gs: 1, outs: 38, h: 12, hr: 2, bb: 9, so: 13, hbp: 1, er: 8, w: 2, l: 1, sv: 0, fld: 78, rk: true },
    ],
  },
  // TBR (TBA 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'sprinde01', name: 'Dennis Springer', role: 'SP', throws: 'R', age: 33, g: 29, gs: 17, outs: 347, h: 121, hr: 22, bb: 53, so: 50, hbp: 9, er: 70, w: 3, l: 11, sv: 0, fld: 72 },
      { id: 'hernaro01', name: 'Roberto Hernandez', role: 'CL', throws: 'R', age: 33, g: 67, gs: 0, outs: 214, h: 57, hr: 5, bb: 37, so: 65, hbp: 3, er: 25, w: 2, l: 6, sv: 26, fld: 69 },
      { id: 'yanes01', name: 'Esteban Yan', role: 'RP', throws: 'R', age: 23, g: 64, gs: 0, outs: 266, h: 84, hr: 12, bb: 41, so: 72, hbp: 6, er: 45, w: 5, l: 4, sv: 1, fld: 76, rk: true },
      { id: 'mecirji01', name: 'Jim Mecir', role: 'RP', throws: 'R', age: 28, g: 68, gs: 0, outs: 252, h: 73, hr: 8, bb: 33, so: 73, hbp: 3, er: 35, w: 7, l: 2, sv: 0, fld: 76 },
      { id: 'lopezal02', name: 'Albie Lopez', role: 'RP', throws: 'R', age: 26, g: 54, gs: 0, outs: 239, h: 84, hr: 10, bb: 33, so: 60, hbp: 3, er: 39, w: 7, l: 4, sv: 1, fld: 62 },
      { id: 'whiteri01', name: 'Rick White', role: 'RP', throws: 'R', age: 29, g: 38, gs: 3, outs: 206, h: 66, hr: 8, bb: 23, so: 39, hbp: 2, er: 29, w: 2, l: 6, sv: 0, fld: 74 },
      { id: 'aldresc01', name: 'Scott Aldred', role: 'RP', throws: 'L', age: 30, g: 48, gs: 0, outs: 94, h: 37, hr: 5, bb: 12, so: 18, hbp: 1, er: 21, w: 0, l: 0, sv: 0, fld: 74 },
    ],
    reservePitchers: [
      { id: 'rekarbr01', name: 'Bryan Rekar', role: 'SP', throws: 'R', age: 26, g: 16, gs: 15, outs: 260, h: 98, hr: 16, bb: 25, so: 49, hbp: 3, er: 53, w: 2, l: 8, sv: 0, fld: 76 },
      { id: 'johnsja02', name: 'Jason Johnson', role: 'SP', throws: 'R', age: 24, g: 13, gs: 13, outs: 180, h: 76, hr: 10, bb: 26, so: 36, hbp: 3, er: 38, w: 2, l: 5, sv: 0, fld: 62, rk: true },
      { id: 'carlsda01', name: 'Dan Carlson', role: 'RP', throws: 'R', age: 28, g: 10, gs: 0, outs: 53, h: 25, hr: 4, bb: 8, so: 15, hbp: 2, er: 14, w: 0, l: 0, sv: 0, fld: 73, rk: true },
      { id: 'gorecri01', name: 'Rick Gorecki', role: 'RP', throws: 'R', age: 24, g: 3, gs: 3, outs: 50, h: 16, hr: 2, bb: 11, so: 9, hbp: 0, er: 12, w: 1, l: 2, sv: 0, fld: 72, rk: true },
      { id: 'tatisra01', name: 'Ramon Tatis', role: 'RP', throws: 'L', age: 25, g: 22, gs: 0, outs: 35, h: 20, hr: 3, bb: 11, so: 8, hbp: 1, er: 12, w: 0, l: 0, sv: 0, fld: 68 },
    ],
  },
  // TOR (TOR 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'myersra01', name: 'Randy Myers', role: 'CL', throws: 'L', age: 35, g: 62, gs: 0, outs: 170, h: 55, hr: 5, bb: 25, so: 52, hbp: 1, er: 23, w: 4, l: 7, sv: 28, fld: 61 },
      { id: 'quantpa01', name: 'Paul Quantrill', role: 'RP', throws: 'R', age: 29, g: 82, gs: 0, outs: 240, h: 92, hr: 7, bb: 22, so: 54, hbp: 2, er: 27, w: 3, l: 4, sv: 7, fld: 75 },
      { id: 'rislebi01', name: 'Bill Risley', role: 'RP', throws: 'R', age: 31, g: 44, gs: 0, outs: 164, h: 50, hr: 8, bb: 34, so: 41, hbp: 3, er: 32, w: 3, l: 4, sv: 0, fld: 76 },
      { id: 'stiebda01', name: 'Dave Stieb', role: 'RP', throws: 'R', age: 40, g: 19, gs: 3, outs: 151, h: 58, hr: 6, bb: 17, so: 27, hbp: 5, er: 27, w: 1, l: 2, sv: 2, fld: 80 },
      { id: 'plesada01', name: 'Dan Plesac', role: 'RP', throws: 'L', age: 36, g: 78, gs: 0, outs: 150, h: 43, hr: 5, bb: 17, so: 56, hbp: 0, er: 21, w: 4, l: 3, sv: 4, fld: 73 },
      { id: 'hansoer01', name: 'Erik Hanson', role: 'RP', throws: 'R', age: 33, g: 11, gs: 8, outs: 147, h: 66, hr: 8, bb: 27, so: 34, hbp: 1, er: 34, w: 0, l: 3, sv: 0, fld: 53 },
    ],
    reservePitchers: [
      { id: 'escobke01', name: 'Kelvim Escobar', role: 'SP', throws: 'R', age: 22, g: 22, gs: 10, outs: 239, h: 71, hr: 4, bb: 38, so: 76, hbp: 0, er: 31, w: 7, l: 3, sv: 0, fld: 59, rk: true },
      { id: 'persoro01', name: 'Robert Person', role: 'RP', throws: 'R', age: 28, g: 27, gs: 0, outs: 115, h: 41, hr: 7, bb: 19, so: 32, hbp: 2, er: 26, w: 3, l: 1, sv: 6, fld: 78 },
      { id: 'almanca01', name: 'Carlos Almanzar', role: 'RP', throws: 'R', age: 24, g: 25, gs: 0, outs: 86, h: 33, hr: 4, bb: 8, so: 21, hbp: 1, er: 17, w: 2, l: 2, sv: 0, fld: 72, rk: true },
      { id: 'sinclst01', name: 'Steve Sinclair', role: 'RP', throws: 'L', age: 26, g: 24, gs: 0, outs: 45, h: 13, hr: 0, bb: 5, so: 8, hbp: 0, er: 6, w: 0, l: 2, sv: 0, fld: 72, rk: true },
      { id: 'hallaro01', name: 'Roy Halladay', role: 'RP', throws: 'R', age: 21, g: 2, gs: 2, outs: 42, h: 9, hr: 2, bb: 2, so: 13, hbp: 0, er: 3, w: 1, l: 0, sv: 0, fld: 67, rk: true },
    ],
  },
  // CWS (CHA 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'bereja01', name: 'Jason Bere', role: 'SP', throws: 'R', age: 27, g: 27, gs: 22, outs: 382, h: 133, hr: 17, bb: 80, so: 88, hbp: 4, er: 81, w: 6, l: 9, sv: 0, fld: 72 },
      { id: 'parquji01', name: 'Jim Parque', role: 'SP', throws: 'L', age: 23, g: 21, gs: 21, outs: 339, h: 135, hr: 14, bb: 49, so: 77, hbp: 6, er: 64, w: 7, l: 5, sv: 0, fld: 69, rk: true },
      { id: 'simasbi01', name: 'Bill Simas', role: 'CL', throws: 'R', age: 26, g: 60, gs: 0, outs: 212, h: 60, hr: 10, bb: 28, so: 56, hbp: 2, er: 29, w: 4, l: 3, sv: 18, fld: 62 },
      { id: 'castica02', name: 'Carlos Castillo', role: 'RP', throws: 'R', age: 23, g: 54, gs: 2, outs: 301, h: 95, hr: 16, bb: 39, so: 63, hbp: 4, er: 54, w: 6, l: 4, sv: 0, fld: 80 },
      { id: 'foulkke01', name: 'Keith Foulke', role: 'RP', throws: 'R', age: 25, g: 54, gs: 0, outs: 196, h: 60, hr: 10, bb: 19, so: 51, hbp: 4, er: 35, w: 3, l: 2, sv: 1, fld: 65 },
      { id: 'karchma01', name: 'Matt Karchner', role: 'RP', throws: 'R', age: 31, g: 61, gs: 0, outs: 194, h: 63, hr: 8, bb: 35, so: 47, hbp: 4, er: 33, w: 5, l: 5, sv: 11, fld: 79 },
      { id: 'howrybo01', name: 'Bob Howry', role: 'RP', throws: 'R', age: 24, g: 44, gs: 0, outs: 163, h: 37, hr: 7, bb: 19, so: 51, hbp: 2, er: 19, w: 0, l: 3, sv: 9, fld: 48, rk: true },
      { id: 'fordhto01', name: 'Tom Fordham', role: 'RP', throws: 'L', age: 24, g: 29, gs: 5, outs: 144, h: 51, hr: 7, bb: 40, so: 24, hbp: 1, er: 36, w: 1, l: 2, sv: 0, fld: 73, rk: true },
    ],
    reservePitchers: [
      { id: 'eyresc01', name: 'Scott Eyre', role: 'SP', throws: 'L', age: 26, g: 33, gs: 17, outs: 321, h: 114, hr: 23, bb: 62, so: 71, hbp: 2, er: 63, w: 3, l: 8, sv: 0, fld: 60 },
      { id: 'snydejo02', name: 'John Snyder', role: 'SP', throws: 'R', age: 23, g: 15, gs: 14, outs: 259, h: 96, hr: 14, bb: 23, so: 52, hbp: 2, er: 46, w: 7, l: 2, sv: 0, fld: 71, rk: true },
      { id: 'abbotji01', name: 'Jim Abbott', role: 'RP', throws: 'L', age: 30, g: 5, gs: 5, outs: 95, h: 36, hr: 4, bb: 15, so: 13, hbp: 1, er: 21, w: 5, l: 0, sv: 0, fld: 71 },
      { id: 'bradfch01', name: 'Chad Bradford', role: 'RP', throws: 'R', age: 23, g: 29, gs: 0, outs: 92, h: 27, hr: 0, bb: 7, so: 11, hbp: 0, er: 11, w: 2, l: 1, sv: 1, fld: 82, rk: true },
      { id: 'castito02', name: 'Tony Castillo', role: 'RP', throws: 'L', age: 35, g: 25, gs: 0, outs: 81, h: 34, hr: 4, bb: 10, so: 18, hbp: 1, er: 17, w: 1, l: 2, sv: 0, fld: 67 },
    ],
  },
  // CLE (CLE 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'jacksmi02', name: 'Michael Jackson', role: 'CL', throws: 'R', age: 33, g: 69, gs: 0, outs: 192, h: 46, hr: 4, bb: 18, so: 57, hbp: 4, er: 17, w: 1, l: 1, sv: 40, fld: 65 },
      { id: 'mesajo01', name: 'Jose Mesa', role: 'RP', throws: 'R', age: 32, g: 76, gs: 0, outs: 254, h: 89, hr: 8, bb: 35, so: 69, hbp: 4, er: 36, w: 8, l: 7, sv: 1, fld: 64 },
      { id: 'plunker01', name: 'Eric Plunk', role: 'RP', throws: 'R', age: 34, g: 63, gs: 0, outs: 218, h: 71, hr: 10, bb: 34, so: 76, hbp: 3, er: 34, w: 4, l: 3, sv: 1, fld: 58 },
      { id: 'ogeach01', name: 'Chad Ogea', role: 'RP', throws: 'R', age: 27, g: 19, gs: 9, outs: 207, h: 75, hr: 9, bb: 24, so: 45, hbp: 4, er: 40, w: 5, l: 4, sv: 0, fld: 65 },
      { id: 'shueypa01', name: 'Paul Shuey', role: 'RP', throws: 'R', age: 27, g: 43, gs: 0, outs: 153, h: 47, hr: 6, bb: 26, so: 52, hbp: 2, er: 22, w: 5, l: 4, sv: 2, fld: 77 },
      { id: 'assenpa01', name: 'Paul Assenmacher', role: 'RP', throws: 'L', age: 37, g: 69, gs: 0, outs: 141, h: 50, hr: 4, bb: 17, so: 48, hbp: 2, er: 17, w: 2, l: 5, sv: 3, fld: 73 },
    ],
    reservePitchers: [
      { id: 'mormaal01', name: 'Alvin Morman', role: 'RP', throws: 'L', age: 29, g: 40, gs: 0, outs: 87, h: 31, hr: 5, bb: 16, so: 22, hbp: 0, er: 17, w: 0, l: 2, sv: 0, fld: 80 },
      { id: 'villoro01', name: 'Ron Villone', role: 'RP', throws: 'L', age: 28, g: 25, gs: 0, outs: 81, h: 28, hr: 3, bb: 20, so: 20, hbp: 2, er: 13, w: 0, l: 0, sv: 0, fld: 79 },
      { id: 'karsast01', name: 'Steve Karsay', role: 'RP', throws: 'R', age: 26, g: 11, gs: 1, outs: 73, h: 30, hr: 3, bb: 8, so: 16, hbp: 2, er: 15, w: 0, l: 2, sv: 0, fld: 61 },
      { id: 'martito02', name: 'Tom Martin', role: 'RP', throws: 'L', age: 28, g: 14, gs: 0, outs: 44, h: 22, hr: 1, bb: 9, so: 11, hbp: 0, er: 10, w: 1, l: 1, sv: 0, fld: 73 },
    ],
  },
  // DET (DET 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'floribr01', name: 'Bryce Florie', role: 'SP', throws: 'R', age: 28, g: 42, gs: 16, outs: 399, h: 136, hr: 13, bb: 65, so: 99, hbp: 5, er: 69, w: 8, l: 9, sv: 0, fld: 55 },
      { id: 'greisse01', name: 'Seth Greisinger', role: 'SP', throws: 'R', age: 22, g: 21, gs: 21, outs: 390, h: 142, hr: 17, bb: 48, so: 66, hbp: 4, er: 74, w: 6, l: 9, sv: 0, fld: 87, rk: true },
      { id: 'castifr01', name: 'Frank Castillo', role: 'SP', throws: 'R', age: 29, g: 27, gs: 19, outs: 348, h: 145, hr: 17, bb: 42, so: 84, hbp: 5, er: 78, w: 3, l: 9, sv: 1, fld: 63 },
      { id: 'jonesto02', name: 'Todd Jones', role: 'CL', throws: 'R', age: 30, g: 65, gs: 0, outs: 190, h: 58, hr: 5, bb: 35, so: 58, hbp: 2, er: 30, w: 1, l: 4, sv: 28, fld: 68 },
      { id: 'worreti01', name: 'Tim Worrell', role: 'RP', throws: 'R', age: 30, g: 43, gs: 9, outs: 309, h: 103, hr: 13, bb: 35, so: 80, hbp: 4, er: 54, w: 2, l: 7, sv: 0, fld: 75 },
      { id: 'bochtdo01', name: 'Doug Bochtler', role: 'RP', throws: 'R', age: 27, g: 51, gs: 0, outs: 202, h: 65, hr: 11, bb: 47, so: 52, hbp: 2, er: 40, w: 0, l: 2, sv: 0, fld: 68 },
      { id: 'brocado01', name: 'Doug Brocail', role: 'RP', throws: 'R', age: 31, g: 60, gs: 0, outs: 188, h: 52, hr: 5, bb: 22, so: 48, hbp: 2, er: 21, w: 5, l: 2, sv: 0, fld: 62 },
      { id: 'sageraj01', name: 'A. J. Sager', role: 'RP', throws: 'R', age: 33, g: 31, gs: 3, outs: 178, h: 72, hr: 7, bb: 21, so: 33, hbp: 1, er: 37, w: 4, l: 2, sv: 2, fld: 72 },
      { id: 'runyase01', name: 'Sean Runyan', role: 'RP', throws: 'L', age: 24, g: 88, gs: 0, outs: 151, h: 47, hr: 7, bb: 28, so: 39, hbp: 2, er: 20, w: 1, l: 4, sv: 1, fld: 52, rk: true },
    ],
    reservePitchers: [
      { id: 'powelbr01', name: 'Brian Powell', role: 'SP', throws: 'R', age: 24, g: 18, gs: 16, outs: 251, h: 101, hr: 17, bb: 36, so: 46, hbp: 2, er: 59, w: 3, l: 8, sv: 0, fld: 56, rk: true },
      { id: 'crowde01', name: 'Dean Crow', role: 'RP', throws: 'R', age: 25, g: 32, gs: 0, outs: 137, h: 55, hr: 6, bb: 16, so: 18, hbp: 2, er: 20, w: 2, l: 2, sv: 0, fld: 67, rk: true },
      { id: 'anderma01', name: 'Matt Anderson', role: 'RP', throws: 'R', age: 21, g: 42, gs: 0, outs: 132, h: 38, hr: 3, bb: 31, so: 44, hbp: 2, er: 16, w: 5, l: 1, sv: 0, fld: 79, rk: true },
      { id: 'keaglgr01', name: 'Greg Keagle', role: 'RP', throws: 'R', age: 27, g: 9, gs: 7, outs: 116, h: 46, hr: 6, bb: 21, so: 27, hbp: 4, er: 27, w: 0, l: 5, sv: 0, fld: 60 },
      { id: 'duranro01', name: 'Roberto Duran', role: 'RP', throws: 'L', age: 25, g: 18, gs: 0, outs: 46, h: 9, hr: 0, bb: 18, so: 13, hbp: 3, er: 11, w: 0, l: 1, sv: 0, fld: 73, rk: true },
    ],
  },
  // KCR (KCA 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'pichahi01', name: 'Hipolito Pichardo', role: 'SP', throws: 'R', age: 28, g: 27, gs: 18, outs: 337, h: 124, hr: 12, bb: 45, so: 62, hbp: 4, er: 62, w: 7, l: 8, sv: 1, fld: 70 },
      { id: 'montgje01', name: 'Jeff Montgomery', role: 'CL', throws: 'R', age: 36, g: 56, gs: 0, outs: 168, h: 56, hr: 9, bb: 20, so: 50, hbp: 1, er: 28, w: 2, l: 5, sv: 36, fld: 70 },
      { id: 'servisc01', name: 'Scott Service', role: 'RP', throws: 'R', age: 31, g: 73, gs: 0, outs: 248, h: 76, hr: 8, bb: 32, so: 90, hbp: 8, er: 36, w: 6, l: 4, sv: 4, fld: 80 },
      { id: 'pittsji01', name: 'Jim Pittsley', role: 'RP', throws: 'R', age: 24, g: 39, gs: 2, outs: 205, h: 83, hr: 11, bb: 36, so: 39, hbp: 3, er: 47, w: 1, l: 1, sv: 0, fld: 56 },
      { id: 'whisema01', name: 'Matt Whisenant', role: 'RP', throws: 'L', age: 27, g: 70, gs: 0, outs: 182, h: 59, hr: 2, bb: 36, so: 47, hbp: 4, er: 32, w: 2, l: 1, sv: 2, fld: 61, rk: true },
      { id: 'bonesri01', name: 'Ricky Bones', role: 'RP', throws: 'R', age: 29, g: 32, gs: 0, outs: 160, h: 59, hr: 7, bb: 21, so: 26, hbp: 3, er: 30, w: 2, l: 2, sv: 1, fld: 75 },
      { id: 'barbebr02', name: 'Brian Barber', role: 'RP', throws: 'R', age: 25, g: 8, gs: 8, outs: 126, h: 45, hr: 5, bb: 14, so: 23, hbp: 1, er: 29, w: 2, l: 4, sv: 0, fld: 62, rk: true },
    ],
    reservePitchers: [
      { id: 'haneych01', name: 'Chris Haney', role: 'SP', throws: 'L', age: 29, g: 38, gs: 12, outs: 307, h: 127, hr: 16, bb: 31, so: 56, hbp: 4, er: 69, w: 6, l: 6, sv: 0, fld: 71 },
      { id: 'bevilbr01', name: 'Brian Bevil', role: 'RP', throws: 'R', age: 26, g: 39, gs: 0, outs: 120, h: 45, hr: 4, bb: 22, so: 43, hbp: 3, er: 29, w: 3, l: 1, sv: 0, fld: 55, rk: true },
      { id: 'walkeja01', name: 'Jamie Walker', role: 'RP', throws: 'L', age: 26, g: 6, gs: 2, outs: 52, h: 24, hr: 4, bb: 6, so: 12, hbp: 2, er: 14, w: 0, l: 1, sv: 0, fld: 78, rk: true },
      { id: 'appieke01', name: 'Kevin Appier', role: 'RP', throws: 'R', age: 30, g: 3, gs: 3, outs: 45, h: 16, hr: 2, bb: 5, so: 14, hbp: 0, er: 7, w: 1, l: 2, sv: 0, fld: 60 },
    ],
  },
  // MIN (MIN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'morgami01', name: 'Mike Morgan', role: 'SP', throws: 'R', age: 38, g: 23, gs: 22, outs: 362, h: 134, hr: 16, bb: 39, so: 69, hbp: 6, er: 61, w: 4, l: 3, sv: 0, fld: 57 },
      { id: 'aguilri01', name: 'Rick Aguilera', role: 'CL', throws: 'R', age: 36, g: 68, gs: 0, outs: 223, h: 75, hr: 10, bb: 18, so: 61, hbp: 2, er: 36, w: 4, l: 9, sv: 38, fld: 80 },
      { id: 'trombmi01', name: 'Mike Trombley', role: 'RP', throws: 'R', age: 31, g: 77, gs: 1, outs: 290, h: 90, hr: 12, bb: 39, so: 88, hbp: 4, er: 41, w: 6, l: 5, sv: 1, fld: 62 },
      { id: 'swindgr01', name: 'Greg Swindell', role: 'RP', throws: 'L', age: 33, g: 81, gs: 0, outs: 271, h: 91, hr: 13, bb: 27, so: 62, hbp: 2, er: 40, w: 5, l: 6, sv: 2, fld: 64 },
      { id: 'serafda01', name: 'Dan Serafini', role: 'RP', throws: 'L', age: 24, g: 28, gs: 9, outs: 225, h: 93, hr: 9, bb: 30, so: 45, hbp: 1, er: 50, w: 7, l: 4, sv: 0, fld: 56, rk: true },
      { id: 'guarded01', name: 'Eddie Guardado', role: 'RP', throws: 'L', age: 27, g: 79, gs: 0, outs: 197, h: 64, hr: 10, bb: 28, so: 62, hbp: 1, er: 33, w: 3, l: 1, sv: 0, fld: 71 },
      { id: 'carrahe01', name: 'Hector Carrasco', role: 'RP', throws: 'R', age: 28, g: 63, gs: 0, outs: 185, h: 65, hr: 5, bb: 32, so: 52, hbp: 3, er: 30, w: 4, l: 2, sv: 1, fld: 59 },
    ],
    reservePitchers: [
      { id: 'rodrifr02', name: 'Frankie Rodriguez', role: 'SP', throws: 'R', age: 25, g: 20, gs: 11, outs: 210, h: 81, hr: 7, bb: 30, so: 44, hbp: 2, er: 43, w: 4, l: 6, sv: 0, fld: 70 },
      { id: 'baptitr01', name: 'Travis Baptist', role: 'RP', throws: 'L', age: 26, g: 13, gs: 0, outs: 81, h: 34, hr: 5, bb: 11, so: 11, hbp: 0, er: 17, w: 0, l: 1, sv: 0, fld: 62, rk: true },
      { id: 'ritchto01', name: 'Todd Ritchie', role: 'RP', throws: 'R', age: 26, g: 15, gs: 0, outs: 72, h: 29, hr: 3, bb: 9, so: 17, hbp: 0, er: 13, w: 0, l: 0, sv: 0, fld: 63 },
      { id: 'naultda01', name: 'Dan Naulty', role: 'RP', throws: 'R', age: 28, g: 19, gs: 0, outs: 71, h: 23, hr: 4, bb: 11, so: 19, hbp: 0, er: 13, w: 0, l: 2, sv: 0, fld: 64 },
      { id: 'milletr01', name: 'Travis Miller', role: 'RP', throws: 'L', age: 25, g: 14, gs: 0, outs: 70, h: 29, hr: 3, bb: 10, so: 16, hbp: 0, er: 16, w: 0, l: 2, sv: 0, fld: 81 },
    ],
  },
  // HOU (HOU 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'schoupe01', name: 'Pete Schourek', role: 'SP', throws: 'L', age: 29, g: 25, gs: 23, outs: 372, h: 126, hr: 19, bb: 51, so: 93, hbp: 5, er: 67, w: 8, l: 9, sv: 0, fld: 60 },
      { id: 'wagnebi02', name: 'Billy Wagner', role: 'CL', throws: 'L', age: 26, g: 58, gs: 0, outs: 180, h: 43, hr: 6, bb: 27, so: 93, hbp: 1, er: 18, w: 4, l: 3, sv: 30, fld: 79 },
      { id: 'henrydo01', name: 'Doug Henry', role: 'RP', throws: 'R', age: 34, g: 59, gs: 0, outs: 213, h: 62, hr: 7, bb: 36, so: 59, hbp: 0, er: 29, w: 8, l: 2, sv: 2, fld: 65 },
      { id: 'nitkocj01', name: 'C. J. Nitkowski', role: 'RP', throws: 'L', age: 25, g: 43, gs: 0, outs: 179, h: 53, hr: 5, bb: 27, so: 43, hbp: 6, er: 29, w: 3, l: 3, sv: 3, fld: 76 },
      { id: 'elartsc01', name: 'Scott Elarton', role: 'RP', throws: 'R', age: 22, g: 28, gs: 2, outs: 171, h: 40, hr: 5, bb: 20, so: 56, hbp: 1, er: 21, w: 2, l: 1, sv: 2, fld: 71, rk: true },
      { id: 'milletr02', name: 'Trever Miller', role: 'RP', throws: 'L', age: 25, g: 37, gs: 1, outs: 160, h: 59, hr: 4, bb: 20, so: 29, hbp: 1, er: 21, w: 2, l: 0, sv: 1, fld: 67, rk: true },
      { id: 'magnami01', name: 'Mike Magnante', role: 'RP', throws: 'L', age: 33, g: 48, gs: 0, outs: 155, h: 54, hr: 3, bb: 22, so: 42, hbp: 3, er: 25, w: 4, l: 7, sv: 2, fld: 66 },
    ],
    reservePitchers: [
      { id: 'halamjo01', name: 'John Halama', role: 'RP', throws: 'L', age: 26, g: 6, gs: 6, outs: 97, h: 37, hr: 0, bb: 13, so: 21, hbp: 2, er: 21, w: 1, l: 1, sv: 0, fld: 79, rk: true },
      { id: 'scanlbo01', name: 'Bob Scanlan', role: 'RP', throws: 'R', age: 31, g: 27, gs: 0, outs: 79, h: 26, hr: 4, bb: 13, so: 8, hbp: 1, er: 11, w: 0, l: 1, sv: 0, fld: 54 },
    ],
  },
  // LAA (ANA 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'sparkst01', name: 'Steve Sparks', role: 'SP', throws: 'R', age: 32, g: 22, gs: 20, outs: 386, h: 132, hr: 16, bb: 61, so: 78, hbp: 5, er: 67, w: 9, l: 4, sv: 0, fld: 68 },
      { id: 'dicksja01', name: 'Jason Dickson', role: 'SP', throws: 'R', age: 25, g: 27, gs: 18, outs: 366, h: 146, hr: 18, bb: 38, so: 66, hbp: 5, er: 70, w: 10, l: 10, sv: 0, fld: 76 },
      { id: 'hillke01', name: 'Ken Hill', role: 'SP', throws: 'R', age: 32, g: 19, gs: 19, outs: 309, h: 114, hr: 8, bb: 48, so: 62, hbp: 2, er: 52, w: 9, l: 6, sv: 0, fld: 59 },
      { id: 'percitr01', name: 'Troy Percival', role: 'CL', throws: 'R', age: 28, g: 67, gs: 0, outs: 200, h: 45, hr: 6, bb: 33, so: 90, hbp: 3, er: 25, w: 2, l: 7, sv: 42, fld: 76 },
      { id: 'hasegsh01', name: 'Shigetoshi Hasegawa', role: 'RP', throws: 'R', age: 29, g: 61, gs: 0, outs: 292, h: 90, hr: 13, bb: 34, so: 70, hbp: 2, er: 37, w: 8, l: 3, sv: 5, fld: 60 },
      { id: 'delucri01', name: 'Rich DeLucia', role: 'RP', throws: 'R', age: 33, g: 61, gs: 0, outs: 215, h: 59, hr: 9, bb: 44, so: 71, hbp: 3, er: 35, w: 2, l: 6, sv: 3, fld: 63 },
      { id: 'harripe01', name: 'Pep Harris', role: 'RP', throws: 'R', age: 25, g: 49, gs: 0, outs: 180, h: 56, hr: 6, bb: 25, so: 37, hbp: 1, er: 26, w: 3, l: 1, sv: 0, fld: 53 },
      { id: 'cadargr01', name: 'Greg Cadaret', role: 'RP', throws: 'L', age: 36, g: 50, gs: 0, outs: 134, h: 47, hr: 6, bb: 19, so: 41, hbp: 4, er: 20, w: 1, l: 2, sv: 1, fld: 70 },
      { id: 'holtzmi01', name: 'Mike Holtz', role: 'RP', throws: 'L', age: 25, g: 53, gs: 0, outs: 91, h: 33, hr: 2, bb: 15, so: 31, hbp: 2, er: 14, w: 2, l: 2, sv: 1, fld: 82 },
    ],
    reservePitchers: [
      { id: 'watsoal01', name: 'Allen Watson', role: 'SP', throws: 'L', age: 27, g: 28, gs: 14, outs: 277, h: 111, hr: 15, bb: 35, so: 67, hbp: 3, er: 55, w: 6, l: 7, sv: 0, fld: 73 },
      { id: 'mcdowja01', name: 'Jack McDowell', role: 'SP', throws: 'R', age: 32, g: 14, gs: 14, outs: 228, h: 90, hr: 10, bb: 24, so: 54, hbp: 1, er: 43, w: 5, l: 3, sv: 0, fld: 65 },
      { id: 'washbja01', name: 'Jarrod Washburn', role: 'SP', throws: 'L', age: 23, g: 15, gs: 11, outs: 222, h: 70, hr: 11, bb: 27, so: 48, hbp: 3, er: 38, w: 6, l: 3, sv: 0, fld: 77, rk: true },
      { id: 'jamesmi01', name: 'Mike James', role: 'RP', throws: 'R', age: 30, g: 11, gs: 0, outs: 42, h: 12, hr: 1, bb: 6, so: 11, hbp: 1, er: 5, w: 0, l: 0, sv: 0, fld: 77 },
    ],
  },
  // OAK (OAK 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'steinbl01', name: 'Blake Stein', role: 'SP', throws: 'R', age: 24, g: 24, gs: 20, outs: 352, h: 117, hr: 22, bb: 71, so: 89, hbp: 5, er: 83, w: 5, l: 9, sv: 0, fld: 65, rk: true },
      { id: 'taylobi04', name: 'Billy Taylor', role: 'CL', throws: 'R', age: 36, g: 70, gs: 0, outs: 219, h: 68, hr: 5, bb: 28, so: 63, hbp: 4, er: 30, w: 4, l: 9, sv: 33, fld: 69 },
      { id: 'mathetj01', name: 'T. J. Mathews', role: 'RP', throws: 'R', age: 28, g: 66, gs: 0, outs: 218, h: 69, hr: 7, bb: 29, so: 62, hbp: 3, er: 31, w: 7, l: 4, sv: 1, fld: 85 },
      { id: 'smallaa01', name: 'Aaron Small', role: 'RP', throws: 'R', age: 26, g: 47, gs: 0, outs: 203, h: 80, hr: 6, bb: 27, so: 37, hbp: 3, er: 39, w: 4, l: 2, sv: 0, fld: 62 },
      { id: 'mohlemi01', name: 'Mike Mohler', role: 'RP', throws: 'L', age: 29, g: 57, gs: 0, outs: 183, h: 68, hr: 6, bb: 30, so: 42, hbp: 4, er: 33, w: 3, l: 3, sv: 0, fld: 75 },
      { id: 'fettemi01', name: 'Mike Fetters', role: 'RP', throws: 'R', age: 33, g: 60, gs: 0, outs: 176, h: 59, hr: 4, bb: 26, so: 48, hbp: 1, er: 25, w: 2, l: 8, sv: 5, fld: 87 },
      { id: 'groombu01', name: 'Buddy Groom', role: 'RP', throws: 'L', age: 32, g: 75, gs: 0, outs: 172, h: 63, hr: 6, bb: 21, so: 38, hbp: 1, er: 28, w: 3, l: 1, sv: 0, fld: 61 },
    ],
    reservePitchers: [
      { id: 'heredgi01', name: 'Gil Heredia', role: 'RP', throws: 'R', age: 32, g: 8, gs: 6, outs: 128, h: 45, hr: 5, bb: 5, so: 26, hbp: 2, er: 18, w: 3, l: 3, sv: 0, fld: 55 },
      { id: 'witasja01', name: 'Jay Witasick', role: 'RP', throws: 'R', age: 25, g: 7, gs: 3, outs: 81, h: 35, hr: 9, bb: 15, so: 27, hbp: 0, er: 19, w: 1, l: 3, sv: 0, fld: 63, rk: true },
      { id: 'telghda01', name: 'Dave Telgheder', role: 'RP', throws: 'R', age: 31, g: 8, gs: 2, outs: 60, h: 23, hr: 3, bb: 6, so: 9, hbp: 1, er: 11, w: 0, l: 1, sv: 0, fld: 58 },
      { id: 'doughji01', name: 'Jim Dougherty', role: 'RP', throws: 'R', age: 30, g: 9, gs: 0, outs: 36, h: 16, hr: 2, bb: 8, so: 4, hbp: 1, er: 11, w: 0, l: 2, sv: 0, fld: 66 },
    ],
  },
  // SEA (SEA 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'timlimi01', name: 'Mike Timlin', role: 'CL', throws: 'R', age: 32, g: 70, gs: 0, outs: 238, h: 76, hr: 6, bb: 19, so: 58, hbp: 2, er: 28, w: 3, l: 3, sv: 19, fld: 71 },
      { id: 'spoljpa01', name: 'Paul Spoljaric', role: 'RP', throws: 'L', age: 27, g: 53, gs: 6, outs: 250, h: 81, hr: 11, bb: 51, so: 89, hbp: 2, er: 50, w: 4, l: 6, sv: 0, fld: 70 },
      { id: 'ayalabo01', name: 'Bobby Ayala', role: 'RP', throws: 'R', age: 28, g: 62, gs: 0, outs: 226, h: 88, hr: 10, bb: 30, so: 72, hbp: 2, er: 50, w: 1, l: 10, sv: 8, fld: 62 },
      { id: 'slocuhe01', name: 'Heathcliff Slocumb', role: 'RP', throws: 'R', age: 32, g: 57, gs: 0, outs: 203, h: 70, hr: 5, bb: 44, so: 57, hbp: 2, er: 36, w: 2, l: 5, sv: 3, fld: 59 },
      { id: 'wellsbo01', name: 'Bob Wells', role: 'RP', throws: 'R', age: 31, g: 30, gs: 0, outs: 155, h: 58, hr: 10, bb: 16, so: 34, hbp: 2, er: 32, w: 2, l: 2, sv: 0, fld: 63 },
      { id: 'suzukma01', name: 'Mac Suzuki', role: 'RP', throws: 'R', age: 23, g: 6, gs: 5, outs: 79, h: 34, hr: 3, bb: 15, so: 19, hbp: 0, er: 22, w: 1, l: 2, sv: 0, fld: 67, rk: true },
    ],
    reservePitchers: [
      { id: 'abbotpa01', name: 'Paul Abbott', role: 'RP', throws: 'R', age: 30, g: 4, gs: 4, outs: 74, h: 24, hr: 2, bb: 10, so: 22, hbp: 0, er: 11, w: 3, l: 1, sv: 0, fld: 61 },
      { id: 'mccargr01', name: 'Greg McCarthy', role: 'RP', throws: 'L', age: 29, g: 29, gs: 0, outs: 70, h: 19, hr: 4, bb: 15, so: 26, hbp: 3, er: 13, w: 1, l: 2, sv: 0, fld: 72, rk: true },
      { id: 'fossato01', name: 'Tony Fossas', role: 'RP', throws: 'L', age: 40, g: 41, gs: 0, outs: 68, h: 28, hr: 3, bb: 13, so: 21, hbp: 0, er: 11, w: 1, l: 3, sv: 0, fld: 70 },
      { id: 'paniajo01', name: 'Jose Paniagua', role: 'RP', throws: 'R', age: 24, g: 18, gs: 0, outs: 66, h: 20, hr: 3, bb: 9, so: 11, hbp: 3, er: 10, w: 2, l: 0, sv: 1, fld: 84 },
      { id: 'lirafe01', name: 'Felipe Lira', role: 'RP', throws: 'R', age: 26, g: 7, gs: 0, outs: 47, h: 19, hr: 3, bb: 7, so: 11, hbp: 1, er: 10, w: 1, l: 0, sv: 0, fld: 71 },
    ],
  },
  // TEX (TEX 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'wittbo01', name: 'Bobby Witt', role: 'SP', throws: 'R', age: 34, g: 31, gs: 18, outs: 350, h: 145, hr: 19, bb: 50, so: 71, hbp: 1, er: 74, w: 7, l: 9, sv: 0, fld: 50 },
      { id: 'wettejo01', name: 'John Wetteland', role: 'CL', throws: 'R', age: 31, g: 63, gs: 0, outs: 186, h: 46, hr: 6, bb: 17, so: 67, hbp: 0, er: 15, w: 3, l: 1, sv: 42, fld: 66 },
      { id: 'crabtti01', name: 'Tim Crabtree', role: 'RP', throws: 'R', age: 28, g: 64, gs: 0, outs: 256, h: 92, hr: 6, bb: 33, so: 60, hbp: 3, er: 38, w: 6, l: 1, sv: 0, fld: 56 },
      { id: 'gundeer01', name: 'Eric Gunderson', role: 'RP', throws: 'L', age: 32, g: 68, gs: 1, outs: 203, h: 81, hr: 12, bb: 21, so: 42, hbp: 2, er: 37, w: 0, l: 3, sv: 0, fld: 69 },
      { id: 'patteda04', name: 'Danny Patterson', role: 'RP', throws: 'R', age: 27, g: 56, gs: 0, outs: 182, h: 63, hr: 7, bb: 19, so: 45, hbp: 1, er: 26, w: 2, l: 5, sv: 2, fld: 63 },
      { id: 'hernaxa01', name: 'Xavier Hernandez', role: 'RP', throws: 'R', age: 32, g: 46, gs: 0, outs: 174, h: 50, hr: 7, bb: 26, so: 45, hbp: 1, er: 26, w: 6, l: 6, sv: 1, fld: 76 },
      { id: 'levinal01', name: 'Al Levine', role: 'RP', throws: 'R', age: 30, g: 30, gs: 0, outs: 174, h: 68, hr: 6, bb: 20, so: 26, hbp: 1, er: 32, w: 0, l: 1, sv: 0, fld: 84, rk: true },
    ],
    reservePitchers: [
      { id: 'bailesc01', name: 'Scott Bailes', role: 'RP', throws: 'L', age: 36, g: 46, gs: 0, outs: 121, h: 55, hr: 5, bb: 13, so: 30, hbp: 0, er: 25, w: 1, l: 0, sv: 0, fld: 69 },
      { id: 'pavliro01', name: 'Roger Pavlik', role: 'RP', throws: 'R', age: 30, g: 5, gs: 0, outs: 42, h: 15, hr: 2, bb: 6, so: 9, hbp: 0, er: 7, w: 1, l: 1, sv: 1, fld: 56 },
    ],
  },
  // ATL (ATL 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'ligteke01', name: 'Kerry Ligtenberg', role: 'CL', throws: 'R', age: 27, g: 75, gs: 0, outs: 219, h: 52, hr: 8, bb: 23, so: 81, hbp: 0, er: 22, w: 3, l: 2, sv: 30, fld: 80, rk: true },
      { id: 'martide01', name: 'Dennis Martinez', role: 'RP', throws: 'R', age: 44, g: 53, gs: 5, outs: 273, h: 106, hr: 10, bb: 28, so: 49, hbp: 5, er: 50, w: 4, l: 6, sv: 2, fld: 71 },
      { id: 'cathemi01', name: 'Mike Cather', role: 'RP', throws: 'R', age: 27, g: 36, gs: 0, outs: 124, h: 34, hr: 5, bb: 16, so: 33, hbp: 2, er: 16, w: 2, l: 2, sv: 0, fld: 82, rk: true },
      { id: 'rockejo01', name: 'John Rocker', role: 'RP', throws: 'L', age: 23, g: 47, gs: 0, outs: 114, h: 22, hr: 4, bb: 22, so: 42, hbp: 3, er: 9, w: 1, l: 3, sv: 2, fld: 69, rk: true },
      { id: 'seaneru01', name: 'Rudy Seanez', role: 'RP', throws: 'R', age: 29, g: 34, gs: 0, outs: 108, h: 25, hr: 2, bb: 16, so: 50, hbp: 1, er: 11, w: 4, l: 1, sv: 2, fld: 74 },
      { id: 'chenbr01', name: 'Bruce Chen', role: 'RP', throws: 'L', age: 21, g: 4, gs: 4, outs: 61, h: 23, hr: 3, bb: 9, so: 17, hbp: 1, er: 9, w: 2, l: 0, sv: 0, fld: 70, rk: true },
    ],
    reservePitchers: [
      { id: 'wohlema01', name: 'Mark Wohlers', role: 'RP', throws: 'R', age: 28, g: 27, gs: 0, outs: 61, h: 21, hr: 2, bb: 17, so: 31, hbp: 0, er: 13, w: 0, l: 1, sv: 8, fld: 67 },
      { id: 'perezod01', name: 'Odalis Perez', role: 'RP', throws: 'L', age: 20, g: 10, gs: 0, outs: 32, h: 10, hr: 1, bb: 4, so: 5, hbp: 0, er: 5, w: 0, l: 1, sv: 0, fld: 67, rk: true },
    ],
  },
  // MIA (FLO 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'ojalaki01', name: 'Kirt Ojala', role: 'SP', throws: 'L', age: 29, g: 41, gs: 13, outs: 375, h: 127, hr: 14, bb: 61, so: 76, hbp: 3, er: 57, w: 2, l: 7, sv: 0, fld: 82, rk: true },
      { id: 'larkian01', name: 'Andy Larkin', role: 'SP', throws: 'R', age: 24, g: 17, gs: 14, outs: 224, h: 100, hr: 12, bb: 55, so: 43, hbp: 4, er: 79, w: 3, l: 8, sv: 0, fld: 67, rk: true },
      { id: 'mantema01', name: 'Matt Mantei', role: 'CL', throws: 'R', age: 24, g: 42, gs: 0, outs: 164, h: 37, hr: 1, bb: 27, so: 63, hbp: 6, er: 20, w: 3, l: 4, sv: 9, fld: 77, rk: true },
      { id: 'edmonbr01', name: 'Brian Edmondson', role: 'RP', throws: 'R', age: 25, g: 53, gs: 0, outs: 228, h: 76, hr: 10, bb: 37, so: 40, hbp: 3, er: 33, w: 4, l: 4, sv: 0, fld: 62, rk: true },
      { id: 'darenvi01', name: 'Vic Darensbourg', role: 'RP', throws: 'L', age: 27, g: 59, gs: 0, outs: 213, h: 52, hr: 5, bb: 30, so: 74, hbp: 0, er: 29, w: 0, l: 7, sv: 1, fld: 78, rk: true },
      { id: 'alfonan01', name: 'Antonio Alfonseca', role: 'RP', throws: 'R', age: 26, g: 58, gs: 0, outs: 212, h: 79, hr: 10, bb: 32, so: 47, hbp: 3, er: 33, w: 4, l: 6, sv: 8, fld: 59, rk: true },
      { id: 'powelja04', name: 'Jay Powell', role: 'RP', throws: 'R', age: 26, g: 62, gs: 0, outs: 211, h: 62, hr: 5, bb: 33, so: 59, hbp: 3, er: 27, w: 7, l: 7, sv: 7, fld: 64 },
      { id: 'heredfe01', name: 'Felix Heredia', role: 'RP', throws: 'L', age: 23, g: 71, gs: 2, outs: 176, h: 57, hr: 3, bb: 35, so: 54, hbp: 3, er: 31, w: 3, l: 3, sv: 2, fld: 71 },
    ],
    reservePitchers: [
      { id: 'medinra01', name: 'Rafael Medina', role: 'SP', throws: 'R', age: 23, g: 12, gs: 12, outs: 202, h: 76, hr: 8, bb: 52, so: 49, hbp: 3, er: 45, w: 2, l: 6, sv: 0, fld: 62, rk: true },
      { id: 'dempsry01', name: 'Ryan Dempster', role: 'SP', throws: 'R', age: 21, g: 14, gs: 11, outs: 164, h: 72, hr: 6, bb: 38, so: 35, hbp: 9, er: 43, w: 1, l: 5, sv: 0, fld: 69, rk: true },
      { id: 'staniro01', name: 'Rob Stanifer', role: 'RP', throws: 'R', age: 26, g: 38, gs: 0, outs: 144, h: 52, hr: 7, bb: 20, so: 30, hbp: 1, er: 28, w: 2, l: 4, sv: 1, fld: 57, rk: true },
      { id: 'fontejo01', name: 'Joe Fontenot', role: 'RP', throws: 'R', age: 21, g: 8, gs: 8, outs: 128, h: 56, hr: 5, bb: 20, so: 24, hbp: 5, er: 30, w: 0, l: 7, sv: 0, fld: 65, rk: true },
      { id: 'palldo01', name: 'Donn Pall', role: 'RP', throws: 'R', age: 36, g: 23, gs: 0, outs: 100, h: 40, hr: 5, bb: 9, so: 24, hbp: 1, er: 19, w: 0, l: 1, sv: 0, fld: 70 },
    ],
  },
  // NYM (NYN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'francjo01', name: 'John Franco', role: 'CL', throws: 'L', age: 37, g: 61, gs: 0, outs: 194, h: 63, hr: 4, bb: 27, so: 60, hbp: 3, er: 22, w: 0, l: 8, sv: 38, fld: 76 },
      { id: 'wendetu01', name: 'Turk Wendell', role: 'RP', throws: 'R', age: 31, g: 66, gs: 0, outs: 230, h: 61, hr: 5, bb: 40, so: 61, hbp: 2, er: 28, w: 5, l: 1, sv: 4, fld: 66 },
      { id: 'cookde01', name: 'Dennis Cook', role: 'RP', throws: 'L', age: 35, g: 73, gs: 0, outs: 204, h: 61, hr: 4, bb: 29, so: 72, hbp: 3, er: 24, w: 8, l: 4, sv: 1, fld: 71 },
      { id: 'mcmicgr01', name: 'Greg McMichael', role: 'RP', throws: 'R', age: 31, g: 64, gs: 0, outs: 204, h: 74, hr: 7, bb: 29, so: 63, hbp: 3, er: 28, w: 5, l: 4, sv: 2, fld: 71 },
      { id: 'rojasme01', name: 'Mel Rojas', role: 'RP', throws: 'R', age: 31, g: 50, gs: 0, outs: 174, h: 60, hr: 9, bb: 27, so: 58, hbp: 4, er: 34, w: 5, l: 2, sv: 2, fld: 65 },
      { id: 'tamje01', name: 'Jeff Tam', role: 'RP', throws: 'R', age: 27, g: 15, gs: 0, outs: 43, h: 13, hr: 2, bb: 4, so: 8, hbp: 2, er: 10, w: 1, l: 1, sv: 0, fld: 60, rk: true },
    ],
    reservePitchers: [
      { id: 'reynoar02', name: 'Armando Reynoso', role: 'SP', throws: 'R', age: 32, g: 11, gs: 11, outs: 205, h: 71, hr: 7, bb: 25, so: 37, hbp: 4, er: 33, w: 7, l: 3, sv: 0, fld: 80 },
    ],
  },
  // PHI (PHI 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'loeweca01', name: 'Carlton Loewer', role: 'SP', throws: 'R', age: 24, g: 21, gs: 21, outs: 368, h: 154, hr: 18, bb: 39, so: 58, hbp: 3, er: 83, w: 7, l: 8, sv: 0, fld: 74, rk: true },
      { id: 'beechma01', name: 'Matt Beech', role: 'SP', throws: 'L', age: 26, g: 21, gs: 21, outs: 351, h: 128, hr: 20, bb: 56, so: 109, hbp: 4, er: 69, w: 3, l: 9, sv: 0, fld: 60 },
      { id: 'leitema01', name: 'Mark Leiter', role: 'CL', throws: 'R', age: 35, g: 69, gs: 0, outs: 266, h: 88, hr: 11, bb: 35, so: 74, hbp: 6, er: 46, w: 7, l: 5, sv: 23, fld: 64 },
      { id: 'gomeswa01', name: 'Wayne Gomes', role: 'RP', throws: 'R', age: 25, g: 71, gs: 0, outs: 280, h: 94, hr: 9, bb: 39, so: 77, hbp: 3, er: 46, w: 9, l: 6, sv: 1, fld: 63, rk: true },
      { id: 'spradje01', name: 'Jerry Spradlin', role: 'RP', throws: 'R', age: 31, g: 69, gs: 0, outs: 245, h: 70, hr: 9, bb: 22, so: 70, hbp: 2, er: 35, w: 4, l: 4, sv: 1, fld: 73 },
      { id: 'byrdpa01', name: 'Paul Byrd', role: 'RP', throws: 'R', age: 27, g: 9, gs: 8, outs: 171, h: 47, hr: 6, bb: 22, so: 37, hbp: 1, er: 23, w: 5, l: 2, sv: 0, fld: 77 },
      { id: 'perezyo01', name: 'Yorkis Perez', role: 'RP', throws: 'L', age: 30, g: 57, gs: 0, outs: 156, h: 45, hr: 3, bb: 26, so: 42, hbp: 0, er: 25, w: 0, l: 2, sv: 0, fld: 66 },
      { id: 'bottari01', name: 'Ricky Bottalico', role: 'RP', throws: 'R', age: 28, g: 39, gs: 0, outs: 130, h: 46, hr: 5, bb: 24, so: 44, hbp: 1, er: 24, w: 1, l: 5, sv: 6, fld: 79 },
    ],
    reservePitchers: [
      { id: 'gracemi02', name: 'Mike Grace', role: 'SP', throws: 'R', age: 28, g: 21, gs: 15, outs: 271, h: 107, hr: 10, bb: 28, so: 53, hbp: 6, er: 50, w: 4, l: 7, sv: 0, fld: 71 },
      { id: 'winstda01', name: 'Darrin Winston', role: 'RP', throws: 'L', age: 31, g: 27, gs: 0, outs: 75, h: 28, hr: 8, bb: 6, so: 13, hbp: 3, er: 17, w: 2, l: 2, sv: 1, fld: 79, rk: true },
      { id: 'stephga01', name: 'Garrett Stephenson', role: 'RP', throws: 'R', age: 26, g: 6, gs: 6, outs: 69, h: 27, hr: 3, bb: 12, so: 19, hbp: 1, er: 14, w: 0, l: 2, sv: 0, fld: 81 },
      { id: 'ryanke01', name: 'Ken Ryan', role: 'RP', throws: 'R', age: 29, g: 17, gs: 1, outs: 68, h: 23, hr: 2, bb: 15, so: 16, hbp: 1, er: 12, w: 0, l: 0, sv: 0, fld: 64 },
      { id: 'welchmi03', name: 'Mike Welch', role: 'RP', throws: 'R', age: 25, g: 10, gs: 2, outs: 62, h: 26, hr: 7, bb: 7, so: 15, hbp: 2, er: 19, w: 0, l: 2, sv: 0, fld: 69, rk: true },
    ],
  },
  // WSH (MON 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'urbinug01', name: 'Ugueth Urbina', role: 'CL', throws: 'R', age: 24, g: 64, gs: 0, outs: 208, h: 47, hr: 6, bb: 30, so: 83, hbp: 0, er: 19, w: 6, l: 3, sv: 34, fld: 58 },
      { id: 'bennesh01', name: 'Shayne Bennett', role: 'RP', throws: 'R', age: 26, g: 62, gs: 0, outs: 275, h: 96, hr: 8, bb: 44, so: 56, hbp: 5, er: 53, w: 5, l: 5, sv: 1, fld: 74, rk: true },
      { id: 'telfoan01', name: 'Anthony Telford', role: 'RP', throws: 'R', age: 32, g: 77, gs: 0, outs: 273, h: 83, hr: 10, bb: 35, so: 61, hbp: 4, er: 37, w: 3, l: 6, sv: 1, fld: 57 },
      { id: 'klinest02', name: 'Steve Kline', role: 'RP', throws: 'L', age: 25, g: 78, gs: 0, outs: 215, h: 72, hr: 7, bb: 37, so: 66, hbp: 3, er: 30, w: 3, l: 6, sv: 1, fld: 66 },
      { id: 'maddumi01', name: 'Mike Maddux', role: 'RP', throws: 'R', age: 36, g: 51, gs: 0, outs: 167, h: 55, hr: 5, bb: 18, so: 30, hbp: 2, er: 26, w: 3, l: 4, sv: 1, fld: 67 },
      { id: 'valdema01', name: 'Marc Valdes', role: 'RP', throws: 'R', age: 26, g: 20, gs: 4, outs: 109, h: 39, hr: 3, bb: 18, so: 22, hbp: 2, er: 20, w: 1, l: 3, sv: 0, fld: 65 },
    ],
    reservePitchers: [
      { id: 'thurmmi01', name: 'Mike Thurman', role: 'SP', throws: 'R', age: 24, g: 14, gs: 13, outs: 201, h: 59, hr: 8, bb: 26, so: 34, hbp: 3, er: 36, w: 4, l: 5, sv: 0, fld: 67, rk: true },
      { id: 'mooretr01', name: 'Trey Moore', role: 'SP', throws: 'L', age: 25, g: 13, gs: 11, outs: 183, h: 78, hr: 5, bb: 17, so: 35, hbp: 1, er: 34, w: 2, l: 5, sv: 0, fld: 67, rk: true },
      { id: 'deharri01', name: 'Rick DeHart', role: 'RP', throws: 'L', age: 28, g: 26, gs: 0, outs: 84, h: 33, hr: 5, bb: 13, so: 20, hbp: 0, er: 16, w: 0, l: 0, sv: 1, fld: 71, rk: true },
      { id: 'powelje01', name: 'Jeremy Powell', role: 'RP', throws: 'R', age: 22, g: 7, gs: 6, outs: 75, h: 27, hr: 5, bb: 11, so: 14, hbp: 4, er: 22, w: 1, l: 5, sv: 0, fld: 90, rk: true },
      { id: 'boskish01', name: 'Shawn Boskie', role: 'RP', throws: 'R', age: 31, g: 5, gs: 5, outs: 53, h: 26, hr: 4, bb: 7, so: 13, hbp: 1, er: 14, w: 1, l: 3, sv: 0, fld: 69 },
    ],
  },
  // CHC (CHN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'gonzaje01', name: 'Geremi Gonzalez', role: 'SP', throws: 'R', age: 23, g: 20, gs: 20, outs: 330, h: 113, hr: 13, bb: 47, so: 72, hbp: 2, er: 60, w: 7, l: 7, sv: 0, fld: 70 },
      { id: 'beckro01', name: 'Rod Beck', role: 'CL', throws: 'R', age: 29, g: 81, gs: 0, outs: 241, h: 83, hr: 10, bb: 16, so: 74, hbp: 2, er: 29, w: 3, l: 4, sv: 51, fld: 58 },
      { id: 'mulhote01', name: 'Terry Mulholland', role: 'RP', throws: 'L', age: 35, g: 70, gs: 6, outs: 336, h: 110, hr: 11, bb: 32, so: 61, hbp: 5, er: 47, w: 6, l: 5, sv: 3, fld: 76 },
      { id: 'adamste01', name: 'Terry Adams', role: 'RP', throws: 'R', age: 25, g: 63, gs: 0, outs: 218, h: 75, hr: 5, bb: 39, so: 66, hbp: 1, er: 33, w: 7, l: 7, sv: 1, fld: 73 },
      { id: 'wengedo01', name: 'Don Wengert', role: 'RP', throws: 'R', age: 28, g: 31, gs: 6, outs: 190, h: 80, hr: 10, bb: 23, so: 36, hbp: 3, er: 40, w: 1, l: 5, sv: 1, fld: 82 },
      { id: 'piscima01', name: 'Marc Pisciotta', role: 'RP', throws: 'R', age: 27, g: 43, gs: 0, outs: 132, h: 41, hr: 3, bb: 31, so: 32, hbp: 2, er: 19, w: 1, l: 2, sv: 0, fld: 72, rk: true },
      { id: 'steveda01', name: 'Dave Stevens', role: 'RP', throws: 'R', age: 28, g: 31, gs: 0, outs: 114, h: 45, hr: 7, bb: 20, so: 28, hbp: 1, er: 24, w: 1, l: 2, sv: 0, fld: 94 },
    ],
    reservePitchers: [
      { id: 'pattebo01', name: 'Bob Patterson', role: 'RP', throws: 'L', age: 39, g: 33, gs: 0, outs: 61, h: 26, hr: 3, bb: 8, so: 23, hbp: 0, er: 12, w: 1, l: 1, sv: 1, fld: 81 },
      { id: 'myersro01', name: 'Rodney Myers', role: 'RP', throws: 'R', age: 29, g: 12, gs: 0, outs: 54, h: 21, hr: 2, bb: 9, so: 14, hbp: 1, er: 12, w: 0, l: 0, sv: 0, fld: 65 },
      { id: 'vanrybe01', name: 'Ben VanRyn', role: 'RP', throws: 'L', age: 26, g: 25, gs: 0, outs: 44, h: 18, hr: 0, bb: 12, so: 10, hbp: 2, er: 10, w: 0, l: 2, sv: 0, fld: 46, rk: true },
    ],
  },
  // CIN (CIN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'parrist01', name: 'Steve Parris', role: 'SP', throws: 'R', age: 30, g: 18, gs: 16, outs: 297, h: 92, hr: 9, bb: 32, so: 78, hbp: 4, er: 44, w: 6, l: 5, sv: 0, fld: 76 },
      { id: 'winchsc01', name: 'Scott Winchester', role: 'SP', throws: 'R', age: 25, g: 16, gs: 16, outs: 237, h: 101, hr: 12, bb: 27, so: 40, hbp: 4, er: 51, w: 3, l: 6, sv: 0, fld: 57, rk: true },
      { id: 'shawje01', name: 'Jeff Shaw', role: 'CL', throws: 'R', age: 31, g: 73, gs: 0, outs: 255, h: 75, hr: 7, bb: 17, so: 60, hbp: 1, er: 22, w: 3, l: 8, sv: 48, fld: 58 },
      { id: 'weathda01', name: 'David Weathers', role: 'RP', throws: 'R', age: 28, g: 44, gs: 9, outs: 330, h: 132, hr: 7, bb: 45, so: 85, hbp: 4, er: 65, w: 6, l: 5, sv: 0, fld: 84 },
      { id: 'sullisc01', name: 'Scott Sullivan', role: 'RP', throws: 'R', age: 27, g: 67, gs: 0, outs: 306, h: 94, hr: 13, bb: 35, so: 92, hbp: 9, er: 51, w: 5, l: 5, sv: 1, fld: 80 },
      { id: 'whitega01', name: 'Gabe White', role: 'RP', throws: 'L', age: 26, g: 69, gs: 3, outs: 296, h: 88, hr: 16, bb: 25, so: 78, hbp: 1, er: 45, w: 5, l: 5, sv: 9, fld: 83 },
      { id: 'graveda01', name: 'Danny Graves', role: 'RP', throws: 'R', age: 24, g: 62, gs: 0, outs: 244, h: 81, hr: 6, bb: 32, so: 42, hbp: 1, er: 33, w: 2, l: 1, sv: 8, fld: 75 },
      { id: 'hudekjo01', name: 'John Hudek', role: 'RP', throws: 'R', age: 31, g: 58, gs: 0, outs: 192, h: 52, hr: 9, bb: 46, so: 64, hbp: 4, er: 27, w: 5, l: 6, sv: 0, fld: 73 },
    ],
    reservePitchers: [
      { id: 'reyesde01', name: 'Dennys Reyes', role: 'SP', throws: 'L', age: 21, g: 19, gs: 10, outs: 202, h: 66, hr: 4, bb: 41, so: 70, hbp: 1, er: 33, w: 3, l: 5, sv: 0, fld: 73, rk: true },
      { id: 'belinst01', name: 'Stan Belinda', role: 'RP', throws: 'R', age: 31, g: 40, gs: 0, outs: 184, h: 49, hr: 7, bb: 25, so: 61, hbp: 4, er: 25, w: 4, l: 8, sv: 1, fld: 87 },
      { id: 'krivdri01', name: 'Rick Krivda', role: 'RP', throws: 'L', age: 28, g: 27, gs: 2, outs: 154, h: 67, hr: 9, bb: 29, so: 32, hbp: 2, er: 38, w: 2, l: 2, sv: 0, fld: 78 },
      { id: 'klingsc01', name: 'Scott Klingenbeck', role: 'RP', throws: 'R', age: 27, g: 4, gs: 4, outs: 68, h: 28, hr: 5, bb: 7, so: 12, hbp: 1, er: 16, w: 1, l: 3, sv: 0, fld: 66 },
      { id: 'huttoma01', name: 'Mark Hutton', role: 'RP', throws: 'R', age: 28, g: 10, gs: 2, outs: 51, h: 22, hr: 3, bb: 11, so: 11, hbp: 1, er: 11, w: 0, l: 1, sv: 0, fld: 65 },
    ],
  },
  // MIL (MIL 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'eldreca01', name: 'Cal Eldred', role: 'SP', throws: 'R', age: 30, g: 23, gs: 23, outs: 399, h: 148, hr: 17, bb: 61, so: 84, hbp: 5, er: 73, w: 4, l: 8, sv: 0, fld: 74 },
      { id: 'wickmbo01', name: 'Bob Wickman', role: 'CL', throws: 'R', age: 29, g: 72, gs: 0, outs: 247, h: 80, hr: 6, bb: 38, so: 69, hbp: 4, er: 32, w: 6, l: 9, sv: 25, fld: 79 },
      { id: 'jonesdo01', name: 'Doug Jones', role: 'RP', throws: 'R', age: 41, g: 69, gs: 0, outs: 256, h: 91, hr: 12, bb: 16, so: 80, hbp: 4, er: 36, w: 4, l: 6, sv: 13, fld: 64 },
      { id: 'patribr01', name: 'Bronswell Patrick', role: 'RP', throws: 'R', age: 27, g: 32, gs: 3, outs: 236, h: 83, hr: 9, bb: 29, so: 49, hbp: 0, er: 41, w: 4, l: 1, sv: 0, fld: 67, rk: true },
      { id: 'foxch02', name: 'Chad Fox', role: 'RP', throws: 'R', age: 27, g: 49, gs: 0, outs: 171, h: 54, hr: 5, bb: 23, so: 62, hbp: 1, er: 24, w: 1, l: 4, sv: 0, fld: 71, rk: true },
      { id: 'reyesal01', name: 'Alberto Reyes', role: 'RP', throws: 'R', age: 28, g: 50, gs: 0, outs: 171, h: 57, hr: 9, bb: 27, so: 56, hbp: 3, er: 28, w: 5, l: 1, sv: 0, fld: 60 },
      { id: 'wagnepa01', name: 'Paul Wagner', role: 'RP', throws: 'R', age: 30, g: 13, gs: 9, outs: 167, h: 65, hr: 9, bb: 31, so: 42, hbp: 1, er: 39, w: 1, l: 5, sv: 0, fld: 54 },
    ],
    reservePitchers: [
      { id: 'pulsibi01', name: 'Bill Pulsipher', role: 'SP', throws: 'L', age: 24, g: 26, gs: 11, outs: 217, h: 86, hr: 8, bb: 31, so: 51, hbp: 1, er: 41, w: 3, l: 4, sv: 0, fld: 58 },
      { id: 'myersmi01', name: 'Mike Myers', role: 'RP', throws: 'L', age: 29, g: 70, gs: 0, outs: 150, h: 48, hr: 7, bb: 23, so: 44, hbp: 4, er: 23, w: 2, l: 2, sv: 1, fld: 63 },
      { id: 'roquera01', name: 'Rafael Roque', role: 'RP', throws: 'L', age: 26, g: 9, gs: 9, outs: 144, h: 42, hr: 9, bb: 24, so: 34, hbp: 1, er: 26, w: 4, l: 2, sv: 0, fld: 57, rk: true },
      { id: 'mercejo02', name: 'Jose Mercedes', role: 'RP', throws: 'R', age: 27, g: 7, gs: 5, outs: 96, h: 34, hr: 5, bb: 11, so: 16, hbp: 1, er: 18, w: 2, l: 2, sv: 0, fld: 83 },
      { id: 'delosva01', name: 'Valerio De Los Santos', role: 'RP', throws: 'L', age: 25, g: 13, gs: 0, outs: 65, h: 11, hr: 4, bb: 2, so: 18, hbp: 0, er: 7, w: 0, l: 0, sv: 0, fld: 68, rk: true },
    ],
  },
  // PIT (PIT 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'loiseri01', name: 'Rich Loiselle', role: 'CL', throws: 'R', age: 26, g: 54, gs: 0, outs: 165, h: 59, hr: 4, bb: 28, so: 49, hbp: 1, er: 21, w: 2, l: 7, sv: 19, fld: 66 },
      { id: 'desseel01', name: 'Elmer Dessens', role: 'RP', throws: 'R', age: 27, g: 43, gs: 5, outs: 224, h: 92, hr: 9, bb: 23, so: 43, hbp: 1, er: 48, w: 2, l: 6, sv: 0, fld: 56, rk: true },
      { id: 'rincori01', name: 'Ricardo Rincon', role: 'RP', throws: 'L', age: 28, g: 60, gs: 0, outs: 195, h: 52, hr: 6, bb: 28, so: 69, hbp: 1, er: 22, w: 0, l: 2, sv: 14, fld: 72 },
      { id: 'chrisja01', name: 'Jason Christiansen', role: 'RP', throws: 'L', age: 28, g: 60, gs: 0, outs: 194, h: 57, hr: 3, bb: 27, so: 66, hbp: 1, er: 22, w: 3, l: 3, sv: 6, fld: 61 },
      { id: 'willimi03', name: 'Mike Williams', role: 'RP', throws: 'R', age: 29, g: 37, gs: 1, outs: 153, h: 47, hr: 4, bb: 18, so: 41, hbp: 1, er: 21, w: 4, l: 2, sv: 0, fld: 68 },
      { id: 'tabakje01', name: 'Jeff Tabaka', role: 'RP', throws: 'L', age: 34, g: 37, gs: 0, outs: 152, h: 39, hr: 7, bb: 23, so: 39, hbp: 6, er: 19, w: 2, l: 2, sv: 0, fld: 73 },
    ],
    reservePitchers: [
      { id: 'silvajo01', name: 'Jose Silva', role: 'SP', throws: 'R', age: 24, g: 18, gs: 18, outs: 301, h: 110, hr: 8, bb: 32, so: 66, hbp: 1, er: 52, w: 6, l: 7, sv: 0, fld: 61, rk: true },
      { id: 'vanpoto01', name: 'Todd Van Poppel', role: 'SP', throws: 'R', age: 26, g: 22, gs: 11, outs: 199, h: 81, hr: 11, bb: 31, so: 39, hbp: 1, er: 52, w: 2, l: 4, sv: 0, fld: 71 },
      { id: 'martija02', name: 'Javier Martinez', role: 'RP', throws: 'R', age: 21, g: 37, gs: 0, outs: 123, h: 39, hr: 5, bb: 34, so: 42, hbp: 4, er: 22, w: 0, l: 1, sv: 0, fld: 64, rk: true },
      { id: 'lawrese01', name: 'Sean Lawrence', role: 'RP', throws: 'L', age: 27, g: 7, gs: 3, outs: 59, h: 25, hr: 4, bb: 10, so: 12, hbp: 0, er: 16, w: 2, l: 1, sv: 0, fld: 90, rk: true },
      { id: 'mccurje01', name: 'Jeff McCurry', role: 'RP', throws: 'R', age: 28, g: 16, gs: 0, outs: 58, h: 23, hr: 4, bb: 10, so: 10, hbp: 0, er: 13, w: 1, l: 3, sv: 0, fld: 78 },
    ],
  },
  // STL (SLN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'morrima01', name: 'Matt Morris', role: 'SP', throws: 'R', age: 23, g: 17, gs: 17, outs: 341, h: 105, hr: 7, bb: 39, so: 78, hbp: 3, er: 37, w: 7, l: 5, sv: 0, fld: 67 },
      { id: 'petkoma01', name: 'Mark Petkovsek', role: 'SP', throws: 'R', age: 32, g: 48, gs: 10, outs: 317, h: 125, hr: 12, bb: 37, so: 56, hbp: 7, er: 56, w: 7, l: 4, sv: 0, fld: 66 },
      { id: 'aceveju01', name: 'Juan Acevedo', role: 'CL', throws: 'R', age: 28, g: 50, gs: 9, outs: 295, h: 87, hr: 8, bb: 32, so: 57, hbp: 5, er: 30, w: 8, l: 3, sv: 15, fld: 58 },
      { id: 'frascjo01', name: 'John Frascatore', role: 'RP', throws: 'R', age: 28, g: 69, gs: 0, outs: 287, h: 93, hr: 9, bb: 37, so: 56, hbp: 4, er: 38, w: 3, l: 4, sv: 0, fld: 87 },
      { id: 'crousri01', name: 'Rich Croushore', role: 'RP', throws: 'R', age: 27, g: 41, gs: 0, outs: 163, h: 44, hr: 6, bb: 29, so: 47, hbp: 4, er: 30, w: 0, l: 3, sv: 8, fld: 68, rk: true },
      { id: 'kingcu01', name: 'Curtis King', role: 'RP', throws: 'R', age: 27, g: 36, gs: 0, outs: 153, h: 54, hr: 4, bb: 19, so: 26, hbp: 3, er: 18, w: 2, l: 0, sv: 2, fld: 53, rk: true },
      { id: 'brantje01', name: 'Jeff Brantley', role: 'RP', throws: 'R', age: 34, g: 48, gs: 0, outs: 152, h: 39, hr: 10, bb: 20, so: 51, hbp: 1, er: 21, w: 0, l: 5, sv: 14, fld: 78 },
      { id: 'paintla01', name: 'Lance Painter', role: 'RP', throws: 'L', age: 30, g: 65, gs: 0, outs: 142, h: 44, hr: 6, bb: 26, so: 39, hbp: 3, er: 24, w: 4, l: 0, sv: 1, fld: 56 },
    ],
    reservePitchers: [
      { id: 'osbordo01', name: 'Donovan Osborne', role: 'SP', throws: 'L', age: 29, g: 14, gs: 14, outs: 251, h: 84, hr: 10, bb: 23, so: 57, hbp: 1, er: 38, w: 5, l: 4, sv: 0, fld: 65 },
      { id: 'aybarma01', name: 'Manny Aybar', role: 'SP', throws: 'R', age: 26, g: 20, gs: 14, outs: 244, h: 87, hr: 7, bb: 40, so: 55, hbp: 3, er: 49, w: 6, l: 6, sv: 0, fld: 52 },
      { id: 'busbymi01', name: 'Mike Busby', role: 'RP', throws: 'R', age: 25, g: 26, gs: 2, outs: 138, h: 50, hr: 4, bb: 15, so: 30, hbp: 4, er: 27, w: 5, l: 2, sv: 0, fld: 67, rk: true },
      { id: 'politcl01', name: 'Cliff Politte', role: 'RP', throws: 'R', age: 24, g: 8, gs: 8, outs: 111, h: 45, hr: 6, bb: 18, so: 22, hbp: 1, er: 26, w: 2, l: 3, sv: 0, fld: 66, rk: true },
      { id: 'jimenjo01', name: 'Jose Jimenez', role: 'RP', throws: 'R', age: 24, g: 4, gs: 3, outs: 64, h: 22, hr: 0, bb: 8, so: 12, hbp: 0, er: 7, w: 3, l: 0, sv: 0, fld: 55, rk: true },
    ],
  },
  // ARI (ARI 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'olsongr01', name: 'Gregg Olson', role: 'CL', throws: 'R', age: 31, g: 64, gs: 0, outs: 206, h: 62, hr: 5, bb: 30, so: 49, hbp: 1, er: 29, w: 3, l: 4, sv: 30, fld: 74 },
      { id: 'sodowcl01', name: 'Clint Sodowsky', role: 'RP', throws: 'R', age: 25, g: 45, gs: 6, outs: 233, h: 84, hr: 7, bb: 44, so: 50, hbp: 6, er: 47, w: 3, l: 6, sv: 0, fld: 82 },
      { id: 'bankswi01', name: 'Willie Banks', role: 'RP', throws: 'R', age: 29, g: 42, gs: 0, outs: 174, h: 52, hr: 5, bb: 36, so: 40, hbp: 2, er: 29, w: 2, l: 3, sv: 1, fld: 68 },
      { id: 'embreal01', name: 'Alan Embree', role: 'RP', throws: 'L', age: 28, g: 55, gs: 0, outs: 161, h: 52, hr: 6, bb: 25, so: 48, hbp: 1, er: 24, w: 4, l: 2, sv: 1, fld: 79 },
      { id: 'sprinru01', name: 'Russ Springer', role: 'RP', throws: 'R', age: 29, g: 48, gs: 0, outs: 158, h: 52, hr: 5, bb: 27, so: 60, hbp: 2, er: 25, w: 5, l: 4, sv: 0, fld: 62 },
      { id: 'rodrife01', name: 'Felix Rodriguez', role: 'RP', throws: 'R', age: 25, g: 43, gs: 0, outs: 132, h: 44, hr: 4, bb: 28, so: 34, hbp: 3, er: 26, w: 0, l: 2, sv: 5, fld: 69 },
    ],
    reservePitchers: [
      { id: 'suppaje01', name: 'Jeff Suppan', role: 'SP', throws: 'R', age: 23, g: 17, gs: 14, outs: 236, h: 93, hr: 11, bb: 24, so: 48, hbp: 2, er: 50, w: 1, l: 7, sv: 0, fld: 69 },
      { id: 'chouibo01', name: 'Bobby Chouinard', role: 'RP', throws: 'R', age: 26, g: 27, gs: 2, outs: 124, h: 46, hr: 5, bb: 14, so: 25, hbp: 1, er: 21, w: 0, l: 2, sv: 0, fld: 65 },
      { id: 'wolcobo01', name: 'Bob Wolcott', role: 'RP', throws: 'R', age: 24, g: 6, gs: 6, outs: 99, h: 38, hr: 6, bb: 11, so: 18, hbp: 1, er: 22, w: 1, l: 3, sv: 0, fld: 77 },
      { id: 'adamsjo02', name: 'Joel Adamson', role: 'RP', throws: 'L', age: 26, g: 5, gs: 5, outs: 69, h: 26, hr: 4, bb: 8, so: 17, hbp: 2, er: 14, w: 0, l: 3, sv: 0, fld: 62 },
      { id: 'browsc01', name: 'Scott Brow', role: 'RP', throws: 'R', age: 29, g: 17, gs: 0, outs: 64, h: 23, hr: 2, bb: 14, so: 13, hbp: 0, er: 15, w: 1, l: 0, sv: 0, fld: 72 },
    ],
  },
  // COL (COL 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'dipotje01', name: 'Jerry Dipoto', role: 'CL', throws: 'R', age: 30, g: 68, gs: 0, outs: 214, h: 69, hr: 6, bb: 26, so: 49, hbp: 3, er: 31, w: 3, l: 4, sv: 19, fld: 69 },
      { id: 'veresda01', name: 'Dave Veres', role: 'RP', throws: 'R', age: 31, g: 63, gs: 0, outs: 229, h: 72, hr: 7, bb: 29, so: 68, hbp: 3, er: 27, w: 3, l: 1, sv: 8, fld: 71 },
      { id: 'leskacu01', name: 'Curt Leskanic', role: 'RP', throws: 'R', age: 30, g: 66, gs: 0, outs: 227, h: 77, hr: 10, bb: 37, so: 63, hbp: 1, er: 43, w: 6, l: 4, sv: 2, fld: 57 },
      { id: 'dejeami01', name: 'Mike DeJean', role: 'RP', throws: 'R', age: 27, g: 59, gs: 1, outs: 223, h: 79, hr: 4, bb: 25, so: 32, hbp: 2, er: 28, w: 3, l: 1, sv: 2, fld: 56 },
      { id: 'mcelrch01', name: 'Chuck McElroy', role: 'RP', throws: 'L', age: 30, g: 78, gs: 0, outs: 205, h: 67, hr: 4, bb: 24, so: 60, hbp: 1, er: 26, w: 6, l: 4, sv: 2, fld: 80 },
      { id: 'munozmi01', name: 'Mike Munoz', role: 'RP', throws: 'L', age: 32, g: 40, gs: 0, outs: 124, h: 52, hr: 3, bb: 15, so: 28, hbp: 1, er: 26, w: 2, l: 2, sv: 3, fld: 83 },
    ],
    reservePitchers: [
      { id: 'thompma01', name: 'Mark Thompson', role: 'RP', throws: 'R', age: 27, g: 6, gs: 6, outs: 70, h: 32, hr: 6, bb: 12, so: 14, hbp: 3, er: 18, w: 1, l: 2, sv: 0, fld: 60 },
      { id: 'brownma04', name: 'Mark Brownson', role: 'RP', throws: 'R', age: 23, g: 2, gs: 2, outs: 40, h: 16, hr: 2, bb: 2, so: 8, hbp: 1, er: 7, w: 1, l: 0, sv: 0, fld: 67, rk: true },
      { id: 'wainhda01', name: 'Dave Wainhouse', role: 'RP', throws: 'R', age: 30, g: 10, gs: 0, outs: 33, h: 14, hr: 1, bb: 6, so: 7, hbp: 1, er: 8, w: 1, l: 0, sv: 0, fld: 74 },
      { id: 'saipemi01', name: 'Mike Saipe', role: 'RP', throws: 'R', age: 24, g: 2, gs: 2, outs: 30, h: 22, hr: 5, bb: 0, so: 2, hbp: 2, er: 12, w: 0, l: 1, sv: 0, fld: 79, rk: true },
    ],
  },
  // LAD (LAN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'radinsc01', name: 'Scott Radinsky', role: 'CL', throws: 'L', age: 30, g: 62, gs: 0, outs: 185, h: 61, hr: 4, bb: 21, so: 47, hbp: 2, er: 19, w: 6, l: 6, sv: 13, fld: 56 },
      { id: 'osunaan01', name: 'Antonio Osuna', role: 'RP', throws: 'R', age: 25, g: 54, gs: 0, outs: 194, h: 51, hr: 7, bb: 27, so: 72, hbp: 2, er: 20, w: 7, l: 1, sv: 6, fld: 70 },
      { id: 'bruskji01', name: 'Jim Bruske', role: 'RP', throws: 'R', age: 33, g: 42, gs: 1, outs: 180, h: 62, hr: 5, bb: 27, so: 41, hbp: 3, er: 24, w: 4, l: 0, sv: 1, fld: 84 },
      { id: 'guthrma01', name: 'Mark Guthrie', role: 'RP', throws: 'L', age: 32, g: 53, gs: 0, outs: 162, h: 55, hr: 5, bb: 23, so: 40, hbp: 1, er: 24, w: 2, l: 1, sv: 0, fld: 62 },
      { id: 'clontbr01', name: 'Brad Clontz', role: 'RP', throws: 'R', age: 27, g: 20, gs: 0, outs: 71, h: 23, hr: 3, bb: 10, so: 17, hbp: 1, er: 13, w: 2, l: 0, sv: 0, fld: 71 },
      { id: 'lankffr01', name: 'Frank Lankford', role: 'RP', throws: 'R', age: 27, g: 12, gs: 0, outs: 59, h: 23, hr: 2, bb: 7, so: 7, hbp: 2, er: 13, w: 0, l: 2, sv: 1, fld: 69, rk: true },
    ],
    reservePitchers: [
      { id: 'martira02', name: 'Ramon Martinez', role: 'SP', throws: 'R', age: 30, g: 15, gs: 15, outs: 305, h: 83, hr: 8, bb: 45, so: 85, hbp: 4, er: 35, w: 7, l: 3, sv: 0, fld: 81 },
      { id: 'malonse01', name: 'Sean Maloney', role: 'RP', throws: 'R', age: 27, g: 11, gs: 0, outs: 38, h: 13, hr: 2, bb: 5, so: 10, hbp: 2, er: 7, w: 0, l: 1, sv: 0, fld: 76, rk: true },
      { id: 'hallda01', name: 'Darren Hall', role: 'RP', throws: 'R', age: 33, g: 11, gs: 0, outs: 34, h: 14, hr: 1, bb: 6, so: 9, hbp: 0, er: 6, w: 0, l: 3, sv: 0, fld: 73 },
      { id: 'juddmi01', name: 'Mike Judd', role: 'RP', throws: 'R', age: 23, g: 7, gs: 0, outs: 34, h: 19, hr: 4, bb: 8, so: 15, hbp: 1, er: 17, w: 0, l: 0, sv: 0, fld: 65, rk: true },
    ],
  },
  // SDP (SDN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'langsma01', name: 'Mark Langston', role: 'SP', throws: 'L', age: 37, g: 22, gs: 16, outs: 244, h: 101, hr: 12, bb: 41, so: 56, hbp: 1, er: 52, w: 4, l: 6, sv: 0, fld: 75 },
      { id: 'hoffmtr01', name: 'Trevor Hoffman', role: 'CL', throws: 'R', age: 30, g: 66, gs: 0, outs: 219, h: 44, hr: 5, bb: 22, so: 90, hbp: 1, er: 16, w: 4, l: 2, sv: 53, fld: 85 },
      { id: 'boehrbr01', name: 'Brian Boehringer', role: 'RP', throws: 'R', age: 29, g: 56, gs: 1, outs: 229, h: 73, hr: 9, bb: 46, so: 72, hbp: 3, er: 35, w: 5, l: 2, sv: 0, fld: 69 },
      { id: 'micelda01', name: 'Dan Miceli', role: 'RP', throws: 'R', age: 27, g: 67, gs: 0, outs: 218, h: 67, hr: 9, bb: 30, so: 65, hbp: 1, er: 34, w: 10, l: 5, sv: 2, fld: 73 },
      { id: 'walldo01', name: 'Donne Wall', role: 'RP', throws: 'R', age: 30, g: 46, gs: 1, outs: 211, h: 65, hr: 8, bb: 25, so: 48, hbp: 2, er: 29, w: 5, l: 4, sv: 1, fld: 74 },
      { id: 'sandesc02', name: 'Scott Sanders', role: 'RP', throws: 'R', age: 29, g: 26, gs: 2, outs: 121, h: 46, hr: 7, bb: 16, so: 38, hbp: 1, er: 26, w: 3, l: 3, sv: 0, fld: 58 },
      { id: 'spencst02', name: 'Stan Spencer', role: 'RP', throws: 'R', age: 28, g: 6, gs: 5, outs: 92, h: 29, hr: 5, bb: 4, so: 31, hbp: 1, er: 16, w: 1, l: 0, sv: 0, fld: 77, rk: true },
    ],
    reservePitchers: [
      { id: 'ramirro01', name: 'Roberto Ramirez', role: 'RP', throws: 'L', age: 26, g: 21, gs: 0, outs: 44, h: 12, hr: 4, bb: 12, so: 17, hbp: 0, er: 10, w: 1, l: 0, sv: 0, fld: 70, rk: true },
      { id: 'clemema01', name: 'Matt Clement', role: 'RP', throws: 'R', age: 23, g: 4, gs: 2, outs: 41, h: 15, hr: 0, bb: 7, so: 13, hbp: 0, er: 7, w: 2, l: 0, sv: 0, fld: 68, rk: true },
    ],
  },
  // SFG (SFN 1998)
  {
    ...
    pitchers: [
      ...
      { id: 'nenro01', name: 'Robb Nen', role: 'CL', throws: 'R', age: 28, g: 78, gs: 0, outs: 266, h: 66, hr: 5, bb: 30, so: 100, hbp: 1, er: 22, w: 7, l: 7, sv: 40, fld: 68 },
      { id: 'johnsjo07', name: 'John Johnstone', role: 'RP', throws: 'R', age: 29, g: 70, gs: 0, outs: 264, h: 73, hr: 9, bb: 39, so: 80, hbp: 3, er: 31, w: 6, l: 5, sv: 0, fld: 57 },
      { id: 'tavarju01', name: 'Julian Tavarez', role: 'RP', throws: 'R', age: 25, g: 60, gs: 0, outs: 256, h: 97, hr: 6, bb: 33, so: 47, hbp: 6, er: 39, w: 5, l: 3, sv: 1, fld: 64 },
      { id: 'reedst01', name: 'Steve Reed', role: 'RP', throws: 'R', age: 33, g: 70, gs: 0, outs: 241, h: 59, hr: 10, bb: 28, so: 64, hbp: 6, er: 31, w: 4, l: 3, sv: 1, fld: 62 },
      { id: 'rodriri02', name: 'Rich Rodriguez', role: 'RP', throws: 'L', age: 35, g: 68, gs: 0, outs: 197, h: 68, hr: 7, bb: 20, so: 39, hbp: 0, er: 26, w: 4, l: 0, sv: 2, fld: 85 },
      { id: 'pooleji02', name: 'Jim Poole', role: 'RP', throws: 'L', age: 32, g: 38, gs: 0, outs: 118, h: 47, hr: 5, bb: 16, so: 24, hbp: 2, er: 23, w: 1, l: 3, sv: 0, fld: 72 },
    ],
    reservePitchers: [
      { id: 'ortizru01', name: 'Russ Ortiz', role: 'SP', throws: 'R', age: 24, g: 22, gs: 13, outs: 265, h: 90, hr: 11, bb: 46, so: 75, hbp: 4, er: 49, w: 4, l: 4, sv: 0, fld: 67, rk: true },
      { id: 'brockch01', name: 'Chris Brock', role: 'RP', throws: 'R', age: 28, g: 13, gs: 0, outs: 83, h: 30, hr: 2, bb: 11, so: 16, hbp: 0, er: 14, w: 0, l: 0, sv: 0, fld: 76, rk: true },
    ],
  },
];
