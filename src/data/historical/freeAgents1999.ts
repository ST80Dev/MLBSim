...
export const FREE_AGENT_PITCHERS_1999: HistPitLine[] = [
  { id: 'radinsc01', name: 'Scott Radinsky', role: 'RP', throws: 'L', age: 31, g: 43, gs: 0, outs: 83, h: 28, hr: 2, bb: 12, so: 20, hbp: 1, er: 11, w: 2, l: 1, sv: 3 },
  { id: 'wengedo01', name: 'Don Wengert', role: 'RP', throws: 'R', age: 29, g: 11, gs: 1, outs: 73, h: 34, hr: 4, bb: 8, so: 14, hbp: 1, er: 18, w: 0, l: 1, sv: 0 },
  { id: 'shumaan01', name: 'Anthony Shumaker', role: 'RP', throws: 'L', age: 26, g: 8, gs: 4, outs: 68, h: 23, hr: 3, bb: 14, so: 17, hbp: 1, er: 15, w: 0, l: 3, sv: 0, rk: true },
  { id: 'holtzmi01', name: 'Mike Holtz', role: 'RP', throws: 'L', age: 26, g: 28, gs: 0, outs: 67, h: 26, hr: 2, bb: 12, so: 20, hbp: 1, er: 15, w: 2, l: 3, sv: 0 },
  { id: 'callami01', name: 'Mickey Callaway', role: 'RP', throws: 'R', age: 24, g: 5, gs: 4, outs: 58, h: 30, hr: 2, bb: 14, so: 11, hbp: 0, er: 16, w: 1, l: 2, sv: 0, rk: true },
  { id: 'mcdowja01', name: 'Jack McDowell', role: 'RP', throws: 'R', age: 33, g: 4, gs: 4, outs: 57, h: 27, hr: 3, bb: 6, so: 13, hbp: 1, er: 13, w: 0, l: 4, sv: 0 },
  { id: 'barbebr02', name: 'Brian Barber', role: 'RP', throws: 'R', age: 26, g: 8, gs: 3, outs: 56, h: 27, hr: 4, bb: 8, so: 10, hbp: 1, er: 17, w: 1, l: 3, sv: 1 },
  { id: 'politcl01', name: 'Cliff Politte', role: 'RP', throws: 'R', age: 25, g: 13, gs: 0, outs: 53, h: 21, hr: 3, bb: 12, so: 13, hbp: 0, er: 13, w: 1, l: 0, sv: 0, rk: true },
  { id: 'busbymi01', name: 'Mike Busby', role: 'RP', throws: 'R', age: 26, g: 15, gs: 0, outs: 53, h: 21, hr: 2, bb: 9, so: 11, hbp: 2, er: 12, w: 0, l: 1, sv: 0 },
  { id: 'bennejo02', name: 'Joel Bennett', role: 'RP', throws: 'R', age: 29, g: 5, gs: 3, outs: 51, h: 25, hr: 9, bb: 8, so: 12, hbp: 0, er: 16, w: 2, l: 1, sv: 0, rk: true },
  { id: 'newmaal02', name: 'Alan Newman', role: 'RP', throws: 'L', age: 29, g: 18, gs: 0, outs: 47, h: 22, hr: 2, bb: 9, so: 20, hbp: 1, er: 12, w: 2, l: 2, sv: 0, rk: true },
  { id: 'almanar01', name: 'Armando Almanza', role: 'RP', throws: 'L', age: 26, g: 14, gs: 0, outs: 47, h: 8, hr: 1, bb: 9, so: 20, hbp: 1, er: 3, w: 0, l: 1, sv: 0, rk: true },
  { id: 'ryanke01', name: 'Ken Ryan', role: 'RP', throws: 'R', age: 30, g: 15, gs: 0, outs: 47, h: 16, hr: 2, bb: 12, so: 9, hbp: 1, er: 10, w: 1, l: 2, sv: 0 },
  { id: 'danekpa01', name: 'Pat Daneker', role: 'RP', throws: 'R', age: 23, g: 3, gs: 2, outs: 45, h: 14, hr: 1, bb: 6, so: 5, hbp: 0, er: 7, w: 0, l: 0, sv: 0, rk: true },
  { id: 'almonhe01', name: 'Hector Almonte', role: 'RP', throws: 'R', age: 23, g: 15, gs: 0, outs: 45, h: 20, hr: 1, bb: 6, so: 8, hbp: 0, er: 7, w: 0, l: 2, sv: 0, rk: true },
  { id: 'rainst01', name: 'Steve Rain', role: 'RP', throws: 'R', age: 24, g: 16, gs: 0, outs: 44, h: 28, hr: 1, bb: 7, so: 12, hbp: 1, er: 15, w: 0, l: 1, sv: 0, rk: true },
  { id: 'porzimi01', name: 'Mike Porzio', role: 'RP', throws: 'L', age: 26, g: 16, gs: 0, outs: 44, h: 21, hr: 5, bb: 10, so: 10, hbp: 0, er: 14, w: 0, l: 0, sv: 0, rk: true },
  { id: 'ohkato01', name: 'Tomo Ohka', role: 'RP', throws: 'R', age: 23, g: 8, gs: 2, outs: 39, h: 21, hr: 2, bb: 6, so: 8, hbp: 0, er: 9, w: 1, l: 2, sv: 0, rk: true },
  { id: 'penaju01', name: 'Juan Pena', role: 'RP', throws: 'R', age: 22, g: 2, gs: 2, outs: 39, h: 9, hr: 0, bb: 3, so: 15, hbp: 0, er: 1, w: 2, l: 0, sv: 0, rk: true },
  { id: 'bochtdo01', name: 'Doug Bochtler', role: 'RP', throws: 'R', age: 28, g: 12, gs: 0, outs: 39, h: 12, hr: 2, bb: 8, so: 8, hbp: 1, er: 8, w: 0, l: 0, sv: 0 },
  { id: 'grosski01', name: 'Kip Gross', role: 'RP', throws: 'R', age: 34, g: 11, gs: 1, outs: 38, h: 15, hr: 3, bb: 8, so: 9, hbp: 3, er: 11, w: 0, l: 2, sv: 0 },
  { id: 'harrire01', name: 'Reggie Harris', role: 'RP', throws: 'R', age: 30, g: 8, gs: 0, outs: 36, h: 10, hr: 1, bb: 8, so: 9, hbp: 1, er: 6, w: 0, l: 0, sv: 0 },
  { id: 'tamje01', name: 'Jeff Tam', role: 'RP', throws: 'R', age: 28, g: 10, gs: 0, outs: 35, h: 9, hr: 2, bb: 4, so: 7, hbp: 1, er: 7, w: 0, l: 0, sv: 0, rk: true },
  { id: 'rayke01', name: 'Ken Ray', role: 'RP', throws: 'R', age: 24, g: 13, gs: 0, outs: 34, h: 23, hr: 2, bb: 6, so: 0, hbp: 1, er: 11, w: 1, l: 0, sv: 0, rk: true },
  { id: 'runyase01', name: 'Sean Runyan', role: 'RP', throws: 'L', age: 25, g: 12, gs: 0, outs: 32, h: 9, hr: 2, bb: 5, so: 7, hbp: 1, er: 4, w: 0, l: 1, sv: 0 },
  { id: 'ojalaki01', name: 'Kirt Ojala', role: 'RP', throws: 'L', age: 30, g: 8, gs: 1, outs: 32, h: 14, hr: 1, bb: 6, so: 8, hbp: 0, er: 7, w: 0, l: 1, sv: 0 },
  { id: 'kingra01', name: 'Ray King', role: 'RP', throws: 'L', age: 25, g: 10, gs: 0, outs: 32, h: 11, hr: 2, bb: 10, so: 5, hbp: 1, er: 7, w: 0, l: 0, sv: 0, rk: true },
  { id: 'mcnicbr01', name: 'Brian McNichol', role: 'RP', throws: 'L', age: 25, g: 4, gs: 2, outs: 32, h: 15, hr: 4, bb: 7, so: 12, hbp: 1, er: 8, w: 0, l: 2, sv: 0, rk: true },
  { id: 'murrada02', name: 'Dan Murray', role: 'RP', throws: 'R', age: 25, g: 5, gs: 0, outs: 31, h: 13, hr: 4, bb: 6, so: 9, hbp: 1, er: 9, w: 0, l: 0, sv: 0, rk: true },
  { id: 'sparkje01', name: 'Jeff Sparks', role: 'RP', throws: 'R', age: 27, g: 8, gs: 0, outs: 30, h: 6, hr: 1, bb: 12, so: 17, hbp: 1, er: 6, w: 0, l: 0, sv: 1, rk: true },
  { id: 'bunchme01', name: 'Melvin Bunch', role: 'RP', throws: 'R', age: 27, g: 5, gs: 1, outs: 30, h: 20, hr: 3, bb: 7, so: 4, hbp: 0, er: 13, w: 0, l: 0, sv: 0, rk: true },
];
