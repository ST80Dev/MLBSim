...
export const FREE_AGENT_BATTERS_1999: HistBatLine[] = [
  ...
  { id: 'pritcch01', name: 'Chris Pritchett', pos: '1B', bats: 'L', age: 29, pa: 49, h: 10, double: 1, triple: 0, hr: 1, bb: 2, so: 9, hbp: 0, sb: 1, cs: 0, sec: '3B' },
  { id: 'vitiejo01', name: 'Joe Vitiello', pos: '1B', bats: 'R', age: 29, pa: 45, h: 8, double: 1, triple: 0, hr: 1, bb: 3, so: 10, hbp: 1, sb: 0, cs: 0, sec: 'LF' },
  { id: 'matthga02', name: 'Gary Matthews', pos: 'RF', bats: 'S', age: 24, pa: 45, h: 8, double: 0, triple: 0, hr: 0, bb: 9, so: 9, hbp: 0, sb: 2, cs: 0, sec: 'LF' },
  { id: 'newhada01', name: 'David Newhan', pos: '2B', bats: 'L', age: 25, pa: 44, h: 6, double: 1, triple: 0, hr: 2, bb: 1, so: 11, hbp: 0, sb: 2, cs: 1, sec: 'SS' },
  { id: 'cabrejo02', name: 'Jolbert Cabrera', pos: 'CF', bats: 'R', age: 26, pa: 39, h: 7, double: 1, triple: 0, hr: 0, bb: 1, so: 8, hbp: 1, sb: 3, cs: 0, sec: 'LF' },
  ...
  { id: 'melusmi01', name: 'Mitch Meluskey', pos: 'C', bats: 'S', age: 25, pa: 38, h: 7, double: 1, triple: 0, hr: 1, bb: 5, so: 7, hbp: 0, sb: 1, cs: 0, sec: '1B' },
  { id: 'wittke01', name: 'Kevin Witt', pos: 'DH', bats: 'L', age: 23, pa: 37, h: 7, double: 1, triple: 0, hr: 1, bb: 2, so: 10, hbp: 0, sb: 0, cs: 0, sec: '1B' },
  { id: 'tarasto01', name: 'Tony Tarasco', pos: 'LF', bats: 'L', age: 28, pa: 35, h: 6, double: 2, triple: 0, hr: 1, bb: 4, so: 6, hbp: 0, sb: 0, cs: 0, sec: 'RF' },
  { id: 'dellaja01', name: 'Jason Dellaero', pos: 'SS', bats: 'S', age: 22, pa: 35, h: 3, double: 0, triple: 0, hr: 0, bb: 1, so: 13, hbp: 0, sb: 0, cs: 0, sec: '2B' },
  ...
  { id: 'garcije01', name: 'Jesse Garcia', pos: 'SS', bats: 'R', age: 25, pa: 34, h: 6, double: 0, triple: 0, hr: 2, bb: 2, so: 3, hbp: 0, sb: 0, cs: 0, sec: '2B' },
  ...
  { id: 'coraal01', name: 'Alex Cora', pos: 'SS', bats: 'L', age: 23, pa: 31, h: 4, double: 1, triple: 0, hr: 0, bb: 1, so: 5, hbp: 1, sb: 0, cs: 0, sec: '2B' },
  { id: 'liniaco01', name: 'Cole Liniak', pos: '3B', bats: 'R', age: 22, pa: 30, h: 7, double: 2, triple: 0, hr: 0, bb: 1, so: 4, hbp: 0, sb: 0, cs: 1, sec: '1B' },
  { id: 'martisa01', name: 'Sandy Martinez', pos: 'C', bats: 'L', age: 28, pa: 30, h: 6, double: 2, triple: 0, hr: 0, bb: 3, so: 8, hbp: 0, sb: 0, cs: 0, sec: '1B' },
  { id: 'ryanro02', name: 'Rob Ryan', pos: 'RF', bats: 'L', age: 26, pa: 30, h: 7, double: 1, triple: 0, hr: 2, bb: 1, so: 8, hbp: 0, sb: 0, cs: 0, sec: 'LF' },
  { id: 'dalesma01', name: 'Mark Dalesandro', pos: 'C', bats: 'R', age: 31, pa: 29, h: 7, double: 1, triple: 0, hr: 1, bb: 0, so: 2, hbp: 0, sb: 0, cs: 0, sec: '1B' },
  { id: 'woodwch01', name: 'Chris Woodward', pos: 'SS', bats: 'R', age: 23, pa: 29, h: 6, double: 1, triple: 0, hr: 0, bb: 2, so: 6, hbp: 0, sb: 0, cs: 0, sec: '2B' },
  { id: 'levisje01', name: 'Jesse Levis', pos: 'C', bats: 'L', age: 31, pa: 29, h: 7, double: 0, triple: 0, hr: 0, bb: 3, so: 3, hbp: 1, sb: 0, cs: 0, sec: '1B' },
  { id: 'portebo03', name: 'Bo Porter', pos: 'LF', bats: 'R', age: 26, pa: 29, h: 5, double: 1, triple: 0, hr: 0, bb: 2, so: 13, hbp: 0, sb: 0, cs: 0, sec: 'RF' },
  { id: 'gibsode01', name: 'Derrick Gibson', pos: 'RF', bats: 'R', age: 24, pa: 29, h: 7, double: 1, triple: 0, hr: 1, bb: 0, so: 6, hbp: 1, sb: 0, cs: 0, sec: 'LF' },
  { id: 'whitema01', name: 'Mark Whiten', pos: 'LF', bats: 'S', age: 32, pa: 28, h: 6, double: 1, triple: 0, hr: 1, bb: 3, so: 6, hbp: 0, sb: 0, cs: 0, sec: 'RF' },
  { id: 'powelda01', name: 'Dante Powell', pos: 'CF', bats: 'R', age: 25, pa: 28, h: 6, double: 2, triple: 0, hr: 1, bb: 3, so: 6, hbp: 0, sb: 1, cs: 1, sec: 'LF' },
  { id: 'brownde02', name: 'Dee Brown', pos: 'LF', bats: 'L', age: 21, pa: 27, h: 2, double: 0, triple: 0, hr: 0, bb: 2, so: 7, hbp: 0, sb: 0, cs: 0, sec: 'RF' },
  { id: 'hemphbr01', name: 'Bret Hemphill', pos: 'C', bats: 'S', age: 27, pa: 27, h: 3, double: 0, triple: 0, hr: 0, bb: 4, so: 4, hbp: 0, sb: 0, cs: 0, sec: '1B' },
  { id: 'garciam01', name: 'Amaury Garcia', pos: '2B', bats: 'R', age: 24, pa: 27, h: 6, double: 0, triple: 1, hr: 2, bb: 3, so: 11, hbp: 0, sb: 0, cs: 0, sec: 'SS' },
  { id: 'coxda02', name: 'Darron Cox', pos: 'C', bats: 'R', age: 31, pa: 27, h: 6, double: 1, triple: 0, hr: 1, bb: 0, so: 5, hbp: 2, sb: 0, cs: 0, sec: '1B' },
  { id: 'ortizda01', name: 'David Ortiz', pos: 'DH', bats: 'L', age: 23, pa: 25, h: 5, double: 1, triple: 0, hr: 1, bb: 3, so: 6, hbp: 0, sb: 0, cs: 0, sec: '1B' },
  { id: 'fernajo01', name: 'Jose Fernandez', pos: '3B', bats: 'R', age: 24, pa: 25, h: 5, double: 2, triple: 0, hr: 0, bb: 1, so: 7, hbp: 0, sb: 0, cs: 0, sec: '1B' },
];
