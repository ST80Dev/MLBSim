...
export const FREE_AGENT_PITCHERS_1998: HistPitLine[] = [
  { id: 'ludwier01', name: 'Eric Ludwick', role: 'RP', throws: 'R', age: 26, gs: 6, outs: 98, h: 45, hr: 8, bb: 19, so: 26, hbp: 1, er: 28, w: 1, l: 4, sv: 0, rk: true },
  { id: 'wardbr01', name: 'Bryan Ward', role: 'RP', throws: 'L', age: 26, gs: 0, outs: 81, h: 30, hr: 4, bb: 7, so: 17, hbp: 0, er: 10, w: 1, l: 2, sv: 1, rk: true },
  { id: 'speieju01', name: 'Justin Speier', role: 'RP', throws: 'R', age: 24, gs: 0, outs: 62, h: 27, hr: 7, bb: 13, so: 17, hbp: 0, er: 20, w: 0, l: 3, sv: 0, rk: true },
  { id: 'henrios01', name: 'Oscar Henriquez', role: 'RP', throws: 'R', age: 24, gs: 0, outs: 60, h: 24, hr: 4, bb: 12, so: 19, hbp: 1, er: 18, w: 0, l: 0, sv: 0, rk: true },
  { id: 'whitema02', name: 'Matt Whiteside', role: 'RP', throws: 'R', age: 30, gs: 0, outs: 54, h: 24, hr: 3, bb: 6, so: 12, hbp: 0, er: 13, w: 1, l: 1, sv: 0 },
  { id: 'sampsbe01', name: 'Benj Sampson', role: 'RP', throws: 'L', age: 23, gs: 2, outs: 52, h: 10, hr: 0, bb: 6, so: 16, hbp: 1, er: 3, w: 1, l: 0, sv: 0, rk: true },
  ...
  { id: 'harride01', name: 'Denny Harriger', role: 'RP', throws: 'R', age: 28, gs: 2, outs: 36, h: 17, hr: 1, bb: 8, so: 3, hbp: 0, er: 9, w: 0, l: 3, sv: 0, rk: true },
  { id: 'wadete01', name: 'Terrell Wade', role: 'RP', throws: 'L', age: 25, gs: 2, outs: 32, h: 12, hr: 2, bb: 5, so: 10, hbp: 0, er: 5, w: 1, l: 1, sv: 0 },
  { id: 'fordbe01', name: 'Ben Ford', role: 'RP', throws: 'R', age: 22, gs: 0, outs: 30, h: 13, hr: 2, bb: 3, so: 5, hbp: 2, er: 11, w: 0, l: 0, sv: 0, rk: true },
];
