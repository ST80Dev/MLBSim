...
export const SEASON_2003: HistTeam[] = [
  // BAL (BAL 2003)
  {
    ...
    batters: [
      ...
      { id: 'coninje01', name: 'Jeff Conine', pos: '1B', bats: 'R', age: 37, pa: 646, h: 165, double: 34, triple: 3, hr: 19, bb: 49, so: 77, hbp: 4, sb: 8, cs: 1, sec: 'LF', fld: 74 },
      ...
      { id: 'batisto01', name: 'Tony Batista', pos: '3B', bats: 'R', age: 29, pa: 670, h: 148, double: 27, triple: 2, hr: 28, bb: 36, so: 106, hbp: 7, sb: 5, cs: 3, sec: 'SS', fld: 66 },
      ...
      { id: 'bigbila01', name: 'Larry Bigbie', pos: 'LF', bats: 'L', age: 25, pa: 319, h: 82, double: 14, triple: 1, hr: 8, bb: 29, so: 66, hbp: 0, sb: 7, cs: 1, sec: 'RF', fld: 77, arm: 70 },
      { id: 'matoslu01', name: 'Luis Matos', pos: 'CF', bats: 'R', age: 24, pa: 486, h: 127, double: 23, triple: 3, hr: 13, bb: 29, so: 93, hbp: 7, sb: 16, cs: 6, sec: 'RF', fld: 77, arm: 68 },
    ...
    bench: [
      { id: 'morame01', name: 'Melvin Mora', pos: 'LF', bats: 'R', age: 31, pa: 413, h: 94, double: 19, triple: 1, hr: 12, bb: 44, so: 71, hbp: 12, sb: 8, cs: 4, sec: 'CF', fld: 80, arm: 83 },
  ...
  // BOS (BOS 2003)
  {
    ...
    batters: [
      ...
      { id: 'millake01', name: 'Kevin Millar', pos: '1B', bats: 'R', age: 31, pa: 618, h: 160, double: 39, triple: 1, hr: 24, bb: 56, so: 101, hbp: 6, sb: 2, cs: 2, sec: 'LF', fld: 76 },
      ...
      { id: 'muellbi02', name: 'Bill Mueller', pos: '3B', bats: 'S', age: 32, pa: 600, h: 158, double: 38, triple: 5, hr: 16, bb: 66, so: 69, hbp: 5, sb: 1, cs: 3, sec: '2B', fld: 65 },
      ...
      { id: 'nixontr01', name: 'Trot Nixon', pos: 'RF', bats: 'L', age: 29, pa: 513, h: 125, double: 26, triple: 4, hr: 24, bb: 61, so: 94, hbp: 4, sb: 4, cs: 2, sec: 'CF', fld: 66, arm: 64 },
    ...
    bench: [
      { id: 'kaplega01', name: 'Gabe Kapler', pos: 'RF', bats: 'R', age: 27, pa: 247, h: 61, double: 12, triple: 1, hr: 4, bb: 20, so: 37, hbp: 1, sb: 8, cs: 2, sec: 'CF', fld: 57, arm: 81 },
      { id: 'mirabdo01', name: 'Doug Mirabelli', pos: 'C', bats: 'R', age: 32, pa: 176, h: 38, double: 10, triple: 0, hr: 7, bb: 15, so: 37, hbp: 2, sb: 0, cs: 0, sec: '1B', fld: 58, arm: 64 },
      { id: 'jacksda04', name: 'Damian Jackson', pos: '2B', bats: 'R', age: 29, pa: 172, h: 39, double: 9, triple: 1, hr: 1, bb: 12, so: 31, hbp: 1, sb: 10, cs: 4, sec: 'SS', fld: 51 },
  ...
  // NYY (NYA 2003)
  {
    ...
    batters: [
      ...
      { id: 'giambja01', name: 'Jason Giambi', pos: '1B', bats: 'L', age: 32, pa: 690, h: 156, double: 32, triple: 1, hr: 41, bb: 123, so: 122, hbp: 18, sb: 2, cs: 1, sec: 'LF', fld: 68 },
      ...
      { id: 'venturo01', name: 'Robin Ventura', pos: '3B', bats: 'L', age: 35, pa: 453, h: 93, double: 16, triple: 0, hr: 17, bb: 66, so: 84, hbp: 1, sb: 1, cs: 1, sec: '1B', fld: 67 },
      { id: 'jeterde01', name: 'Derek Jeter', pos: 'SS', bats: 'R', age: 29, pa: 542, h: 150, double: 23, triple: 2, hr: 13, bb: 48, so: 85, hbp: 9, sb: 18, cs: 3, sec: '2B', fld: 55 },
      { id: 'matsuhi01', name: 'Hideki Matsui', pos: 'LF', bats: 'L', age: 29, pa: 695, h: 179, double: 42, triple: 1, hr: 16, bb: 63, so: 86, hbp: 3, sb: 2, cs: 2, sec: 'CF', fld: 71, arm: 74, rk: true },
      ...
      { id: 'mondera01', name: 'Raul Mondesi', pos: 'RF', bats: 'R', age: 32, pa: 586, h: 133, double: 30, triple: 3, hr: 24, bb: 57, so: 99, hbp: 4, sb: 20, cs: 9, sec: 'CF', fld: 69, arm: 69 },
      { id: 'johnsni01', name: 'Nick Johnson', pos: 'DH', bats: 'L', age: 24, pa: 406, h: 88, double: 17, triple: 0, hr: 14, bb: 58, so: 71, hbp: 10, sb: 3, cs: 2, sec: '1B', fld: 65 },
    ],
    bench: [
      ...
      { id: 'wilsoen01', name: 'Enrique Wilson', pos: 'SS', bats: 'S', age: 29, pa: 147, h: 29, double: 6, triple: 1, hr: 2, bb: 7, so: 20, hbp: 1, sb: 2, cs: 2, sec: '3B', fld: 62 },
    ],
    reserveBatters: [
      ...
      { id: 'almoner01', name: 'Erick Almonte', pos: 'SS', bats: 'R', age: 25, pa: 111, h: 26, double: 6, triple: 0, hr: 1, bb: 8, so: 24, hbp: 1, sb: 2, cs: 0, sec: '2B', fld: 55, rk: true },
  ...
  // TBR (TBA 2003)
  {
    ...
    batters: [
      ...
      { id: 'leetr01', name: 'Travis Lee', pos: '1B', bats: 'L', age: 28, pa: 613, h: 146, double: 33, triple: 3, hr: 17, bb: 62, so: 102, hbp: 1, sb: 5, cs: 3, sec: 'LF', fld: 74 },
      { id: 'anderma02', name: 'Marlon Anderson', pos: '2B', bats: 'L', age: 29, pa: 535, h: 131, double: 27, triple: 4, hr: 7, bb: 38, so: 63, hbp: 3, sb: 12, cs: 3, sec: 'SS', fld: 61 },
      { id: 'rollsda01', name: 'Damian Rolls', pos: '3B', bats: 'R', age: 25, pa: 404, h: 98, double: 20, triple: 1, hr: 6, bb: 18, so: 81, hbp: 6, sb: 12, cs: 6, sec: '2B', fld: 81 },
      ...
      { id: 'crawfca02', name: 'Carl Crawford', pos: 'LF', bats: 'L', age: 21, pa: 661, h: 173, double: 20, triple: 10, hr: 5, bb: 25, so: 101, hbp: 2, sb: 48, cs: 10, sec: 'CF', fld: 85, arm: 71 },
      { id: 'baldero01', name: 'Rocco Baldelli', pos: 'CF', bats: 'R', age: 21, pa: 684, h: 184, double: 32, triple: 8, hr: 11, bb: 30, so: 128, hbp: 8, sb: 27, cs: 10, sec: 'LF', fld: 79, arm: 77, rk: true },
    ...
    bench: [
      ...
      { id: 'perezan01', name: 'Antonio Perez', pos: '2B', bats: 'R', age: 23, pa: 147, h: 31, double: 6, triple: 1, hr: 2, bb: 18, so: 34, hbp: 1, sb: 4, cs: 1, sec: 'SS', fld: 53, rk: true },
      ...
      { id: 'ordonre01', name: 'Rey Ordonez', pos: 'SS', bats: 'R', age: 32, pa: 124, h: 30, double: 7, triple: 1, hr: 1, bb: 6, so: 11, hbp: 1, sb: 0, cs: 1, sec: '2B', fld: 80 },
    ],
    reserveBatters: [
      { id: 'easleda01', name: 'Damion Easley', pos: '3B', bats: 'R', age: 33, pa: 110, h: 22, double: 4, triple: 1, hr: 2, bb: 7, so: 15, hbp: 2, sb: 1, cs: 1, sec: '2B', fld: 54 },
  ...
  // TOR (TOR 2003)
  {
    ...
    batters: [
      ...
      { id: 'delgaca01', name: 'Carlos Delgado', pos: '1B', bats: 'L', age: 31, pa: 705, h: 165, double: 37, triple: 1, hr: 40, bb: 111, so: 138, hbp: 17, sb: 1, cs: 0, sec: 'LF', fld: 80 },
      { id: 'hudsoor01', name: 'Orlando Hudson', pos: '2B', bats: 'S', age: 25, pa: 521, h: 128, double: 22, triple: 7, hr: 9, bb: 37, so: 83, hbp: 5, sb: 4, cs: 4, sec: 'SS', fld: 84 },
      { id: 'hinsker01', name: 'Eric Hinske', pos: '3B', bats: 'L', age: 25, pa: 514, h: 116, double: 38, triple: 2, hr: 15, bb: 60, so: 106, hbp: 1, sb: 11, cs: 1, sec: '1B', fld: 61 },
      { id: 'woodwch01', name: 'Chris Woodward', pos: 'SS', bats: 'R', age: 27, pa: 386, h: 92, double: 19, triple: 3, hr: 10, bb: 27, so: 75, hbp: 3, sb: 2, cs: 1, sec: '2B', fld: 73 },
      { id: 'stewash01', name: 'Shannon Stewart', pos: 'LF', bats: 'R', age: 29, pa: 644, h: 178, double: 41, triple: 4, hr: 12, bb: 51, so: 64, hbp: 8, sb: 11, cs: 5, sec: 'CF', fld: 77, arm: 68 },
      ...
      { id: 'johnsre02', name: 'Reed Johnson', pos: 'RF', bats: 'R', age: 26, pa: 457, h: 121, double: 21, triple: 2, hr: 10, bb: 20, so: 67, hbp: 20, sb: 5, cs: 3, sec: 'LF', fld: 59, arm: 69, rk: true },
      { id: 'catalfr01', name: 'Frank Catalanotto', pos: 'DH', bats: 'L', age: 29, pa: 535, h: 144, double: 34, triple: 7, hr: 11, bb: 40, so: 60, hbp: 9, sb: 8, cs: 4, sec: 'LF', fld: 65, arm: 66 },
    ],
    bench: [
      ...
      { id: 'bergda01', name: 'Dave Berg', pos: '2B', bats: 'R', age: 32, pa: 174, h: 41, double: 9, triple: 1, hr: 3, bb: 11, so: 28, hbp: 1, sb: 0, cs: 1, sec: 'SS', fld: 63 },
  ...
  // CWS (CHA 2003)
  {
    ...
    batters: [
      ...
      { id: 'konerpa01', name: 'Paul Konerko', pos: '1B', bats: 'R', age: 27, pa: 495, h: 120, double: 22, triple: 0, hr: 20, bb: 40, so: 56, hbp: 6, sb: 0, cs: 0, sec: '3B', fld: 72 },
      ...
      { id: 'credejo01', name: 'Joe Crede', pos: '3B', bats: 'R', age: 25, pa: 580, h: 143, double: 30, triple: 2, hr: 21, bb: 30, so: 83, hbp: 5, sb: 1, cs: 2, sec: '1B', fld: 68 },
    ...
    bench: [
      ...
      { id: 'daubabr01', name: 'Brian Daubach', pos: '1B', bats: 'L', age: 31, pa: 219, h: 48, double: 11, triple: 1, hr: 8, bb: 26, so: 53, hbp: 2, sb: 1, cs: 0, sec: 'LF', fld: 60 },
      ...
      { id: 'harriwi01', name: 'Willie Harris', pos: 'CF', bats: 'L', age: 25, pa: 150, h: 29, double: 3, triple: 1, hr: 1, bb: 9, so: 24, hbp: 0, sb: 9, cs: 1, sec: 'LF', fld: 75, arm: 79 },
      { id: 'riosar01', name: 'Armando Rios', pos: 'CF', bats: 'L', age: 31, pa: 112, h: 25, double: 5, triple: 0, hr: 2, bb: 8, so: 19, hbp: 0, sb: 0, cs: 1, sec: 'RF', fld: 64, arm: 68 },
    ],
    reserveBatters: [
  ...
  // CLE (CLE 2003)
  {
    ...
    batters: [
      ...
      { id: 'brousbe01', name: 'Ben Broussard', pos: '1B', bats: 'L', age: 26, pa: 429, h: 96, double: 20, triple: 3, hr: 16, bb: 31, so: 77, hbp: 5, sb: 4, cs: 2, sec: 'LF', fld: 73, rk: true },
      { id: 'phillbr01', name: 'Brandon Phillips', pos: '2B', bats: 'R', age: 22, pa: 393, h: 78, double: 19, triple: 2, hr: 6, bb: 15, so: 76, hbp: 3, sb: 4, cs: 5, sec: 'SS', fld: 76, rk: true },
      ...
      { id: 'vizquom01', name: 'Omar Vizquel', pos: 'SS', bats: 'S', age: 36, pa: 285, h: 65, double: 13, triple: 2, hr: 4, bb: 26, so: 26, hbp: 2, sb: 7, cs: 4, fld: 85 },
      ...
      { id: 'bradlmi01', name: 'Milton Bradley', pos: 'CF', bats: 'S', age: 25, pa: 451, h: 112, double: 30, triple: 3, hr: 9, bb: 54, so: 77, hbp: 3, sb: 14, cs: 6, sec: 'LF', fld: 73, arm: 72 },
      { id: 'gerutjo01', name: 'Jody Gerut', pos: 'RF', bats: 'L', age: 25, pa: 525, h: 134, double: 33, triple: 2, hr: 22, bb: 35, so: 70, hbp: 7, sb: 4, cs: 5, sec: 'LF', fld: 73, arm: 73, rk: true },
    ...
    bench: [
      { id: 'lawtoma02', name: 'Matt Lawton', pos: 'LF', bats: 'L', age: 31, pa: 429, h: 93, double: 19, triple: 1, hr: 13, bb: 51, so: 43, hbp: 7, sb: 11, cs: 5, sec: 'RF', fld: 70, arm: 68 },
      ...
      { id: 'mcdonjo03', name: 'John McDonald', pos: '2B', bats: 'R', age: 28, pa: 233, h: 49, double: 9, triple: 2, hr: 1, bb: 10, so: 36, hbp: 3, sb: 3, cs: 2, sec: 'SS', fld: 66 },
    ...
    reserveBatters: [
      ...
      { id: 'escobal01', name: 'Alex Escobar', pos: 'RF', bats: 'R', age: 24, pa: 108, h: 26, double: 2, triple: 0, hr: 5, bb: 7, so: 34, hbp: 1, sb: 1, cs: 0, sec: 'LF', fld: 77, arm: 79, rk: true },
  ...
  // DET (DET 2003)
  {
    ...
    batters: [
      ...
      { id: 'penaca01', name: 'Carlos Pena', pos: '1B', bats: 'L', age: 25, pa: 516, h: 112, double: 21, triple: 6, hr: 20, bb: 52, so: 125, hbp: 5, sb: 3, cs: 4, sec: '3B', fld: 76 },
      { id: 'morriwa02', name: 'Warren Morris', pos: '2B', bats: 'L', age: 29, pa: 377, h: 91, double: 14, triple: 2, hr: 6, bb: 22, so: 41, hbp: 2, sb: 4, cs: 3, sec: 'SS', fld: 82 },
      { id: 'haltesh01', name: 'Shane Halter', pos: '3B', bats: 'R', age: 33, pa: 393, h: 84, double: 14, triple: 4, hr: 10, bb: 30, so: 78, hbp: 2, sb: 1, cs: 3, sec: 'SS', fld: 87 },
      { id: 'santira01', name: 'Ramon Santiago', pos: 'SS', bats: 'S', age: 23, pa: 507, h: 102, double: 16, triple: 3, hr: 4, bb: 31, so: 74, hbp: 12, sb: 12, cs: 6, sec: '2B', fld: 78 },
      { id: 'monrocr01', name: 'Craig Monroe', pos: 'LF', bats: 'R', age: 26, pa: 458, h: 100, double: 18, triple: 1, hr: 23, bb: 27, so: 91, hbp: 2, sb: 4, cs: 3, sec: 'RF', fld: 73, arm: 73, rk: true },
      { id: 'sanchal03', name: 'Alex Sanchez', pos: 'CF', bats: 'L', age: 26, pa: 599, h: 158, double: 20, triple: 9, hr: 1, bb: 31, so: 78, hbp: 3, sb: 52, cs: 22, sec: 'LF', fld: 78, arm: 65 },
      { id: 'higgibo02', name: 'Bobby Higginson', pos: 'RF', bats: 'L', age: 32, pa: 538, h: 121, double: 19, triple: 4, hr: 13, bb: 56, so: 62, hbp: 4, sb: 11, cs: 8, sec: 'LF', fld: 73, arm: 65 },
    ...
    bench: [
      { id: 'munsoer01', name: 'Eric Munson', pos: '3B', bats: 'L', age: 25, pa: 357, h: 72, double: 8, triple: 0, hr: 17, bb: 34, so: 63, hbp: 1, sb: 3, cs: 0, sec: '1B', fld: 61 },
      ...
      { id: 'infanom01', name: 'Omar Infante', pos: 'SS', bats: 'R', age: 21, pa: 244, h: 54, double: 7, triple: 1, hr: 1, bb: 17, so: 36, hbp: 0, sb: 5, cs: 3, sec: '2B', fld: 88, rk: true },
    ...
    reserveBatters: [
      { id: 'kingsge01', name: 'Gene Kingsale', pos: 'CF', bats: 'S', age: 26, pa: 140, h: 31, double: 4, triple: 1, hr: 1, bb: 11, so: 22, hbp: 1, sb: 4, cs: 2, sec: 'RF', fld: 64, arm: 59 },
      { id: 'petribe01', name: 'Ben Petrick', pos: 'LF', bats: 'R', age: 26, pa: 131, h: 26, double: 6, triple: 1, hr: 5, bb: 11, so: 33, hbp: 1, sb: 0, cs: 1, sec: 'CF', fld: 77, arm: 80 },
  ...
  // KCR (KCA 2003)
  {
    ...
    batters: [
      ...
      { id: 'harveke01', name: 'Ken Harvey', pos: '1B', bats: 'R', age: 25, pa: 524, h: 129, double: 30, triple: 0, hr: 13, bb: 29, so: 95, hbp: 5, sb: 2, cs: 3, sec: '3B', fld: 70, rk: true },
      { id: 'relafde01', name: 'Desi Relaford', pos: '2B', bats: 'S', age: 29, pa: 557, h: 131, double: 27, triple: 4, hr: 9, bb: 43, so: 76, hbp: 7, sb: 19, cs: 5, sec: 'SS', fld: 71 },
      ...
      { id: 'beltrca01', name: 'Carlos Beltran', pos: 'CF', bats: 'S', age: 26, pa: 602, h: 156, double: 25, triple: 9, hr: 25, bb: 63, so: 97, hbp: 3, sb: 34, cs: 4, sec: 'LF', fld: 79, arm: 75 },
      { id: 'guielaa01', name: 'Aaron Guiel', pos: 'RF', bats: 'L', age: 30, pa: 401, h: 94, double: 27, triple: 0, hr: 12, bb: 27, so: 72, hbp: 11, sb: 3, cs: 6, sec: 'LF', fld: 77, arm: 77 },
    ...
    bench: [
      ...
      { id: 'febleca01', name: 'Carlos Febles', pos: '2B', bats: 'R', age: 27, pa: 219, h: 47, double: 7, triple: 1, hr: 2, bb: 18, so: 34, hbp: 4, sb: 7, cs: 2, sec: 'SS', fld: 64 },
      ...
      { id: 'brownde02', name: 'Dee Brown', pos: 'LF', bats: 'L', age: 25, pa: 143, h: 31, double: 7, triple: 0, hr: 2, bb: 8, so: 35, hbp: 1, sb: 1, cs: 1, sec: 'RF', fld: 85, arm: 74 },
  ...
  // MIN (MIN 2003)
  {
    ...
    batters: [
      ...
      { id: 'mientdo01', name: 'Doug Mientkiewicz', pos: '1B', bats: 'L', age: 29, pa: 574, h: 141, double: 35, triple: 1, hr: 11, bb: 73, so: 66, hbp: 6, sb: 3, cs: 2, sec: '3B', fld: 65 },
      { id: 'rivaslu01', name: 'Luis Rivas', pos: '2B', bats: 'R', age: 23, pa: 521, h: 123, double: 21, triple: 7, hr: 7, bb: 30, so: 72, hbp: 5, sb: 18, cs: 7, sec: 'SS', fld: 57 },
      { id: 'koskico01', name: 'Corey Koskie', pos: '3B', bats: 'L', age: 30, pa: 562, h: 133, double: 32, triple: 2, hr: 16, bb: 71, so: 115, hbp: 8, sb: 13, cs: 7, sec: '1B', fld: 69 },
      { id: 'guzmacr01', name: 'Cristian Guzman', pos: 'SS', bats: 'S', age: 25, pa: 585, h: 149, double: 22, triple: 11, hr: 6, bb: 24, so: 77, hbp: 4, sb: 17, cs: 10, sec: '2B', fld: 62 },
      { id: 'jonesja04', name: 'Jacque Jones', pos: 'LF', bats: 'L', age: 28, pa: 548, h: 152, double: 32, triple: 1, hr: 19, bb: 28, so: 107, hbp: 3, sb: 10, cs: 4, sec: 'CF', fld: 75, arm: 60 },
      { id: 'hunteto01', name: 'Torii Hunter', pos: 'CF', bats: 'R', age: 27, pa: 642, h: 156, double: 34, triple: 4, hr: 28, bb: 43, so: 117, hbp: 6, sb: 13, cs: 7, sec: 'LF', fld: 78, arm: 66 },
      { id: 'kieltbo01', name: 'Bobby Kielty', pos: 'RF', bats: 'S', age: 26, pa: 509, h: 110, double: 25, triple: 2, hr: 14, bb: 71, so: 94, hbp: 7, sb: 8, cs: 2, sec: 'CF', fld: 64, arm: 65 },
      { id: 'mohrdu01', name: 'Dustan Mohr', pos: 'DH', bats: 'R', age: 27, pa: 387, h: 90, double: 22, triple: 1, hr: 10, bb: 31, so: 96, hbp: 1, sb: 5, cs: 2, sec: 'RF', fld: 79, arm: 62 },
    ],
    bench: [
      ...
      { id: 'hockide01', name: 'Denny Hocking', pos: '2B', bats: 'S', age: 33, pa: 209, h: 46, double: 10, triple: 1, hr: 2, bb: 16, so: 35, hbp: 1, sb: 1, cs: 1, sec: 'SS', fld: 66 },
      { id: 'gomezch02', name: 'Chris Gomez', pos: '2B', bats: 'R', age: 32, pa: 185, h: 45, double: 11, triple: 1, hr: 3, bb: 8, so: 19, hbp: 2, sb: 1, cs: 1, sec: 'SS', fld: 70 },
      ...
      { id: 'cuddymi01', name: 'Michael Cuddyer', pos: 'RF', bats: 'R', age: 24, pa: 114, h: 26, double: 4, triple: 2, hr: 4, bb: 10, so: 23, hbp: 0, sb: 2, cs: 1, sec: '1B', fld: 61, arm: 70 },
    ],
    reserveBatters: [
      { id: 'fordle01', name: 'Lew Ford', pos: 'CF', bats: 'R', age: 26, pa: 83, h: 24, double: 7, triple: 1, hr: 3, bb: 8, so: 9, hbp: 1, sb: 2, cs: 0, sec: 'LF', fld: 54, arm: 71, rk: true },
      ...
      { id: 'princto01', name: 'Tom Prince', pos: 'C', bats: 'R', age: 38, pa: 57, h: 11, double: 2, triple: 0, hr: 2, bb: 5, so: 9, hbp: 2, sb: 1, cs: 1, fld: 65, arm: 81 },
    ],
    pitchers: [
      ...
      { id: 'santajo01', name: 'Johan Santana', role: 'SP', throws: 'L', age: 24, g: 45, gs: 18, outs: 475, h: 127, hr: 15, bb: 54, so: 172, hbp: 3, er: 55, w: 12, l: 3, sv: 0, fld: 51 },
  ...
  // HOU (HOU 2003)
  {
    ...
    batters: [
      ...
      { id: 'bagweje01', name: 'Jeff Bagwell', pos: '1B', bats: 'R', age: 35, pa: 702, h: 168, double: 32, triple: 2, hr: 36, bb: 95, so: 126, hbp: 7, sb: 10, cs: 4, fld: 66 },
      { id: 'kentje01', name: 'Jeff Kent', pos: '2B', bats: 'R', age: 35, pa: 552, h: 152, double: 37, triple: 2, hr: 24, bb: 42, so: 82, hbp: 5, sb: 5, cs: 2, sec: '3B', fld: 71 },
      { id: 'blumge01', name: 'Geoff Blum', pos: '3B', bats: 'S', age: 30, pa: 449, h: 107, double: 20, triple: 1, hr: 10, bb: 33, so: 64, hbp: 3, sb: 2, cs: 1, sec: 'SS', fld: 67 },
      { id: 'everead01', name: 'Adam Everett', pos: 'SS', bats: 'R', age: 26, pa: 436, h: 95, double: 17, triple: 3, hr: 7, bb: 31, so: 68, hbp: 8, sb: 9, cs: 1, sec: '2B', fld: 77, rk: true },
      { id: 'berkmla01', name: 'Lance Berkman', pos: 'LF', bats: 'S', age: 27, pa: 658, h: 162, double: 37, triple: 4, hr: 31, bb: 102, so: 111, hbp: 8, sb: 6, cs: 4, sec: 'CF', fld: 65, arm: 70 },
      { id: 'biggicr01', name: 'Craig Biggio', pos: 'CF', bats: 'R', age: 37, pa: 717, h: 166, double: 41, triple: 3, hr: 16, bb: 58, so: 115, hbp: 25, sb: 11, cs: 3, sec: 'LF', fld: 67, arm: 71 },
    ...
    bench: [
      { id: 'merceor01', name: 'Orlando Merced', pos: 'RF', bats: 'S', age: 36, pa: 230, h: 54, double: 14, triple: 2, hr: 4, bb: 18, so: 38, hbp: 1, sb: 4, cs: 1, sec: '1B', fld: 68, arm: 88 },
      ...
      { id: 'zaungr01', name: 'Gregg Zaun', pos: 'C', bats: 'S', age: 32, pa: 189, h: 40, double: 8, triple: 0, hr: 4, bb: 16, so: 26, hbp: 1, sb: 1, cs: 1, sec: '1B', fld: 64, arm: 72 },
      { id: 'huntebr02', name: 'Brian Hunter', pos: 'RF', bats: 'R', age: 32, pa: 108, h: 25, double: 7, triple: 1, hr: 1, bb: 8, so: 19, hbp: 1, sb: 3, cs: 0, sec: 'CF', fld: 53, arm: 67 },
  ...
  // LAA (ANA 2003)
  {
    ...
    batters: [
      ...
      { id: 'spiezsc01', name: 'Scott Spiezio', pos: '1B', bats: 'S', age: 30, pa: 581, h: 140, double: 35, triple: 5, hr: 15, bb: 52, so: 63, hbp: 5, sb: 6, cs: 4, sec: '3B', fld: 61 },
      ...
      { id: 'glaustr01', name: 'Troy Glaus', pos: '3B', bats: 'R', age: 26, pa: 367, h: 78, double: 16, triple: 1, hr: 17, bb: 49, so: 77, hbp: 2, sb: 6, cs: 2, sec: 'SS', fld: 58 },
      ...
      { id: 'anderga01', name: 'Garret Anderson', pos: 'LF', bats: 'L', age: 31, pa: 673, h: 196, double: 49, triple: 3, hr: 29, bb: 30, so: 84, hbp: 0, sb: 7, cs: 4, sec: 'CF', fld: 83, arm: 77 },
      { id: 'erstada01', name: 'Darin Erstad', pos: 'CF', bats: 'L', age: 29, pa: 284, h: 70, double: 11, triple: 1, hr: 4, bb: 17, so: 36, hbp: 3, sb: 10, cs: 2, sec: 'LF', fld: 82, arm: 65 },
      { id: 'davanje02', name: 'Jeff DaVanon', pos: 'RF', bats: 'S', age: 29, pa: 382, h: 89, double: 16, triple: 1, hr: 13, bb: 41, so: 63, hbp: 1, sb: 16, cs: 5, sec: 'CF', fld: 83, arm: 63 },
      { id: 'salmoti01', name: 'Tim Salmon', pos: 'DH', bats: 'R', age: 34, pa: 621, h: 142, double: 35, triple: 3, hr: 20, bb: 81, so: 105, hbp: 9, sb: 5, cs: 2, sec: 'RF', fld: 63, arm: 69 },
    ],
    bench: [
    ...
    reserveBatters: [
      ...
      { id: 'quinlro01', name: 'Robb Quinlan', pos: '1B', bats: 'R', age: 26, pa: 101, h: 27, double: 4, triple: 2, hr: 0, bb: 6, so: 16, hbp: 0, sb: 1, cs: 2, sec: '3B', fld: 48, rk: true },
  ...
  // OAK (OAK 2003)
  {
    ...
    batters: [
      ...
      { id: 'hattesc01', name: 'Scott Hatteberg', pos: '1B', bats: 'L', age: 33, pa: 622, h: 142, double: 31, triple: 1, hr: 13, bb: 69, so: 56, hbp: 8, sb: 0, cs: 1, sec: '3B', fld: 77 },
      ...
      { id: 'chaveer01', name: 'Eric Chavez', pos: '3B', bats: 'L', age: 25, pa: 654, h: 165, double: 37, triple: 4, hr: 32, bb: 60, so: 102, hbp: 2, sb: 8, cs: 3, sec: '1B', fld: 82 },
      ...
      { id: 'singlch01', name: 'Chris Singleton', pos: 'CF', bats: 'L', age: 30, pa: 341, h: 81, double: 21, triple: 3, hr: 4, bb: 19, so: 54, hbp: 2, sb: 10, cs: 3, sec: 'LF', fld: 58, arm: 61 },
      { id: 'dyeje01', name: 'Jermaine Dye', pos: 'RF', bats: 'R', age: 29, pa: 253, h: 53, double: 10, triple: 0, hr: 9, bb: 23, so: 45, hbp: 4, sb: 2, cs: 0, sec: 'LF', fld: 67, arm: 62 },
    ...
    bench: [
      { id: 'byrneer01', name: 'Eric Byrnes', pos: 'CF', bats: 'R', age: 27, pa: 460, h: 108, double: 25, triple: 9, hr: 13, bb: 39, so: 71, hbp: 4, sb: 10, cs: 2, sec: 'LF', fld: 61, arm: 68 },
      ...
      { id: 'piattad01', name: 'Adam Piatt', pos: 'LF', bats: 'R', age: 27, pa: 143, h: 29, double: 10, triple: 0, hr: 5, bb: 11, so: 39, hbp: 1, sb: 1, cs: 1, sec: 'RF', fld: 59, arm: 69 },
  ...
  // SEA (SEA 2003)
  {
    ...
    batters: [
      ...
      { id: 'olerujo01', name: 'John Olerud', pos: '1B', bats: 'L', age: 34, pa: 634, h: 152, double: 35, triple: 0, hr: 15, bb: 88, so: 65, hbp: 5, sb: 0, cs: 1, fld: 62 },
      { id: 'boonebr01', name: 'Bret Boone', pos: '2B', bats: 'R', age: 34, pa: 705, h: 185, double: 36, triple: 4, hr: 32, bb: 59, so: 117, hbp: 7, sb: 13, cs: 4, fld: 66 },
      { id: 'cirilje01', name: 'Jeff Cirillo', pos: '3B', bats: 'R', age: 33, pa: 293, h: 65, double: 11, triple: 0, hr: 4, bb: 20, so: 34, hbp: 4, sb: 4, cs: 1, sec: '2B', fld: 63 },
      { id: 'guillca01', name: 'Carlos Guillen', pos: 'SS', bats: 'S', age: 27, pa: 451, h: 106, double: 19, triple: 4, hr: 7, bb: 46, so: 71, hbp: 1, sb: 4, cs: 4, sec: '3B', fld: 63 },
      { id: 'winnra01', name: 'Randy Winn', pos: 'LF', bats: 'S', age: 29, pa: 660, h: 175, double: 37, triple: 6, hr: 12, bb: 47, so: 108, hbp: 7, sb: 23, cs: 7, sec: 'CF', fld: 81, arm: 60 },
      { id: 'camermi01', name: 'Mike Cameron', pos: 'CF', bats: 'R', age: 30, pa: 612, h: 132, double: 29, triple: 5, hr: 21, bb: 71, so: 150, hbp: 6, sb: 24, cs: 7, sec: 'RF', fld: 87, arm: 63 },
    ...
    bench: [
      ...
      { id: 'mclemma01', name: 'Mark McLemore', pos: 'SS', bats: 'S', age: 38, pa: 352, h: 77, double: 14, triple: 3, hr: 4, bb: 46, so: 63, hbp: 1, sb: 13, cs: 6, sec: '2B', fld: 66 },
      ...
      { id: 'bloomwi01', name: 'Willie Bloomquist', pos: '3B', bats: 'R', age: 25, pa: 220, h: 53, double: 9, triple: 2, hr: 1, bb: 20, so: 36, hbp: 1, sb: 5, cs: 1, sec: 'SS', fld: 59, rk: true },
  ...
  // TEX (TEX 2003)
  {
    ...
    batters: [
      ...
      { id: 'menchke01', name: 'Kevin Mench', pos: 'LF', bats: 'R', age: 25, pa: 139, h: 35, double: 9, triple: 0, hr: 4, bb: 10, so: 24, hbp: 3, sb: 1, cs: 1, sec: 'RF', fld: 67, arm: 63 },
      { id: 'evereca01', name: 'Carl Everett', pos: 'CF', bats: 'S', age: 32, pa: 602, h: 148, double: 27, triple: 3, hr: 25, bb: 49, so: 99, hbp: 14, sb: 7, cs: 4, sec: 'RF', fld: 66, arm: 73 },
      { id: 'gonzaju03', name: 'Juan Gonzalez', pos: 'RF', bats: 'R', age: 33, pa: 346, h: 96, double: 20, triple: 1, hr: 19, bb: 18, so: 66, hbp: 3, sb: 1, cs: 0, sec: 'LF', fld: 72, arm: 88 },
    ...
    bench: [
      ...
      { id: 'nixla01', name: 'Laynce Nix', pos: 'RF', bats: 'L', age: 22, pa: 195, h: 47, double: 10, triple: 0, hr: 8, bb: 9, so: 53, hbp: 0, sb: 3, cs: 0, sec: 'CF', fld: 82, arm: 62, rk: true },
      { id: 'chrisry01', name: 'Ryan Christenson', pos: 'CF', bats: 'R', age: 29, pa: 186, h: 28, double: 8, triple: 0, hr: 2, bb: 15, so: 43, hbp: 2, sb: 2, cs: 2, sec: 'LF', fld: 78, arm: 59 },
    ...
    reserveBatters: [
      { id: 'jonesja05', name: 'Jason Jones', pos: 'LF', bats: 'S', age: 26, pa: 121, h: 23, double: 6, triple: 0, hr: 3, bb: 10, so: 21, hbp: 3, sb: 0, cs: 1, sec: 'RF', fld: 71, arm: 88, rk: true },
      { id: 'nivarra01', name: 'Ramon Nivar', pos: 'CF', bats: 'R', age: 23, pa: 97, h: 19, double: 1, triple: 2, hr: 0, bb: 4, so: 10, hbp: 1, sb: 4, cs: 2, sec: 'LF', fld: 72, arm: 83, rk: true },
      { id: 'thamema01', name: 'Marcus Thames', pos: 'RF', bats: 'R', age: 26, pa: 84, h: 15, double: 2, triple: 0, hr: 2, bb: 7, so: 19, hbp: 2, sb: 0, cs: 1, sec: 'LF', fld: 68, arm: 67, rk: true },
  ...
  // ATL (ATL 2003)
  {
    ...
    batters: [
      ...
      { id: 'fickro01', name: 'Robert Fick', pos: '1B', bats: 'L', age: 29, pa: 460, h: 111, double: 26, triple: 1, hr: 13, bb: 39, so: 58, hbp: 4, sb: 0, cs: 1, sec: '3B', fld: 76 },
      { id: 'gilesma01', name: 'Marcus Giles', pos: '2B', bats: 'R', age: 25, pa: 635, h: 163, double: 42, triple: 2, hr: 21, bb: 61, so: 86, hbp: 9, sb: 11, cs: 5, sec: 'SS', fld: 77 },
      { id: 'castivi02', name: 'Vinny Castilla', pos: '3B', bats: 'R', age: 35, pa: 578, h: 140, double: 27, triple: 2, hr: 19, bb: 26, so: 84, hbp: 4, sb: 2, cs: 2, sec: 'SS', fld: 73 },
      ...
      { id: 'jonesch06', name: 'Chipper Jones', pos: 'LF', bats: 'S', age: 31, pa: 656, h: 174, double: 33, triple: 2, hr: 28, bb: 98, so: 84, hbp: 1, sb: 5, cs: 3, sec: 'RF', fld: 54, arm: 70 },
      { id: 'jonesan01', name: 'Andruw Jones', pos: 'CF', bats: 'R', age: 26, pa: 659, h: 157, double: 29, triple: 1, hr: 35, bb: 63, so: 130, hbp: 6, sb: 6, cs: 3, sec: 'RF', fld: 73, arm: 70 },
    ...
    bench: [
      { id: 'francju01', name: 'Julio Franco', pos: '1B', bats: 'R', age: 44, pa: 223, h: 57, double: 10, triple: 1, hr: 4, bb: 24, so: 43, hbp: 0, sb: 1, cs: 1, fld: 82 },
      { id: 'braggda01', name: 'Darren Bragg', pos: 'RF', bats: 'L', age: 33, pa: 181, h: 41, double: 9, triple: 1, hr: 1, bb: 15, so: 40, hbp: 2, sb: 3, cs: 1, sec: 'CF', fld: 65, arm: 63 },
    ...
    pitchers: [
      ...
      { id: 'hamptmi01', name: 'Mike Hampton', role: 'SP', throws: 'L', age: 30, g: 31, gs: 31, outs: 570, h: 202, hr: 20, bb: 81, so: 97, hbp: 4, er: 98, w: 14, l: 8, sv: 0, fld: 87 },
  ...
  // MIA (FLO 2003)
  {
    ...
    batters: [
      ...
      { id: 'leede02', name: 'Derrek Lee', pos: '1B', bats: 'R', age: 27, pa: 643, h: 149, double: 33, triple: 4, hr: 27, bb: 83, so: 139, hbp: 8, sb: 17, cs: 7, sec: '3B', fld: 68 },
      ...
      { id: 'encarju01', name: 'Juan Encarnacion', pos: 'RF', bats: 'R', age: 27, pa: 653, h: 159, double: 31, triple: 6, hr: 21, bb: 40, so: 100, hbp: 5, sb: 19, cs: 8, sec: 'CF', fld: 76, arm: 67 },
      { id: 'banksbr01', name: 'Brian Banks', pos: 'DH', bats: 'S', age: 32, pa: 180, h: 37, double: 6, triple: 2, hr: 4, bb: 23, so: 38, hbp: 2, sb: 2, cs: 1, sec: '1B', fld: 61, arm: 65 },
    ],
    bench: [
    ...
    pitchers: [
      ...
      { id: 'willido03', name: 'Dontrelle Willis', role: 'SP', throws: 'L', age: 21, g: 27, gs: 27, outs: 482, h: 148, hr: 13, bb: 58, so: 142, hbp: 3, er: 59, w: 14, l: 6, sv: 0, fld: 55, rk: true },
  ...
  // NYM (NYN 2003)
  {
    ...
    batters: [
      ...
      { id: 'phillja04', name: 'Jason Phillips', pos: '1B', bats: 'R', age: 26, pa: 453, h: 120, double: 24, triple: 0, hr: 11, bb: 38, so: 49, hbp: 10, sb: 0, cs: 1, sec: '3B', fld: 67, rk: true },
      ...
      { id: 'reyesjo01', name: 'Jose Reyes', pos: 'SS', bats: 'S', age: 20, pa: 292, h: 84, double: 12, triple: 4, hr: 5, bb: 13, so: 36, hbp: 0, sb: 13, cs: 3, sec: '2B', fld: 76, rk: true },
      ...
      { id: 'duncaje01', name: 'Jeff Duncan', pos: 'CF', bats: 'L', age: 24, pa: 166, h: 27, double: 0, triple: 2, hr: 1, bb: 17, so: 41, hbp: 2, sb: 4, cs: 2, sec: 'LF', fld: 87, arm: 59, rk: true },
    ...
    bench: [
      ...
      { id: 'clarkto02', name: 'Tony Clark', pos: '1B', bats: 'S', age: 31, pa: 280, h: 60, double: 13, triple: 1, hr: 10, bb: 25, so: 64, hbp: 1, sb: 0, cs: 0, sec: '3B', fld: 60 },
    ...
    reserveBatters: [
      { id: 'gonzara01', name: 'Raul Gonzalez', pos: 'LF', bats: 'R', age: 29, pa: 246, h: 52, double: 11, triple: 2, hr: 3, bb: 24, so: 38, hbp: 1, sb: 4, cs: 1, sec: 'RF', fld: 85, arm: 72, rk: true },
      { id: 'shinjts01', name: 'Tsuyoshi Shinjo', pos: 'CF', bats: 'R', age: 31, pa: 124, h: 27, double: 5, triple: 1, hr: 2, bb: 7, so: 15, hbp: 2, sb: 1, cs: 1, sec: 'LF', fld: 80, arm: 88 },
      { id: 'vaughmo01', name: 'Mo Vaughn', pos: '1B', bats: 'L', age: 35, pa: 96, h: 20, double: 3, triple: 0, hr: 4, bb: 11, so: 24, hbp: 2, sb: 0, cs: 0, fld: 65 },
      ...
      { id: 'velanjo01', name: 'Jorge Velandia', pos: 'SS', bats: 'R', age: 28, pa: 72, h: 10, double: 3, triple: 1, hr: 0, bb: 10, so: 15, hbp: 0, sb: 0, cs: 0, sec: '2B', fld: 84 },
    ],
    pitchers: [
  ...
  // PHI (PHI 2003)
  {
    ...
    batters: [
      ...
      { id: 'thomeji01', name: 'Jim Thome', pos: '1B', bats: 'L', age: 32, pa: 698, h: 160, double: 27, triple: 2, hr: 52, bb: 121, so: 178, hbp: 5, sb: 0, cs: 2, sec: '3B', fld: 74 },
      { id: 'polanpl01', name: 'Placido Polanco', pos: '2B', bats: 'R', age: 27, pa: 554, h: 146, double: 29, triple: 3, hr: 10, bb: 32, so: 38, hbp: 7, sb: 10, cs: 2, sec: '3B', fld: 78 },
      { id: 'bellda01', name: 'David Bell', pos: '3B', bats: 'R', age: 30, pa: 348, h: 72, double: 16, triple: 0, hr: 8, bb: 32, so: 42, hbp: 4, sb: 0, cs: 1, sec: '2B', fld: 76 },
      ...
      { id: 'burrepa01', name: 'Pat Burrell', pos: 'LF', bats: 'R', age: 26, pa: 599, h: 126, double: 32, triple: 3, hr: 26, bb: 73, so: 142, hbp: 4, sb: 1, cs: 0, sec: '1B', fld: 64, arm: 67 },
      ...
      { id: 'ledeeri01', name: 'Ricky Ledee', pos: 'DH', bats: 'L', age: 29, pa: 291, h: 60, double: 16, triple: 2, hr: 10, bb: 35, so: 60, hbp: 1, sb: 1, cs: 1, sec: 'LF', fld: 60, arm: 77 },
    ],
    bench: [
      ...
      { id: 'michaja01', name: 'Jason Michaels', pos: 'LF', bats: 'R', age: 27, pa: 125, h: 33, double: 11, triple: 1, hr: 4, bb: 14, so: 27, hbp: 1, sb: 0, cs: 0, sec: 'RF', fld: 68, arm: 88, rk: true },
  ...
  // WSH (MON 2003)
  {
    ...
    season: 2003,
    batters: [
      { id: 'schnebr01', name: 'Brian Schneider', pos: 'C', bats: 'L', age: 26, pa: 377, h: 82, double: 27, triple: 2, hr: 9, bb: 36, so: 71, hbp: 1, sb: 0, cs: 2, sec: '1B', fld: 76, arm: 88 },
      { id: 'cordewi01', name: 'Wil Cordero', pos: '1B', bats: 'R', age: 31, pa: 492, h: 118, double: 25, triple: 0, hr: 15, bb: 47, so: 87, hbp: 5, sb: 2, cs: 1, sec: 'LF', fld: 79 },
      { id: 'vidrojo01', name: 'Jose Vidro', pos: '2B', bats: 'S', age: 28, pa: 592, h: 163, double: 37, triple: 1, hr: 16, bb: 58, so: 55, hbp: 6, sb: 3, cs: 1, sec: '3B', fld: 64 },
      { id: 'carroja01', name: 'Jamey Carroll', pos: '3B', bats: 'R', age: 29, pa: 260, h: 61, double: 11, triple: 2, hr: 1, bb: 18, so: 39, hbp: 2, sb: 5, cs: 2, sec: 'SS', fld: 85, rk: true },
    ...
    bench: [
      ...
      { id: 'guzmaed01', name: 'Edwards Guzman', pos: '3B', bats: 'L', age: 26, pa: 155, h: 35, double: 6, triple: 0, hr: 2, bb: 5, so: 18, hbp: 0, sb: 0, cs: 0, sec: '1B', fld: 57 },
    ],
    reserveBatters: [
      { id: 'liefeje01', name: 'Jeff Liefer', pos: '1B', bats: 'L', age: 28, pa: 120, h: 24, double: 5, triple: 0, hr: 5, bb: 8, so: 34, hbp: 0, sb: 0, cs: 0, sec: 'LF', fld: 54 },
  ...
  // CHC (CHN 2003)
  {
    ...
    batters: [
      ...
      { id: 'karroer01', name: 'Eric Karros', pos: '1B', bats: 'R', age: 35, pa: 365, h: 90, double: 16, triple: 1, hr: 10, bb: 27, so: 52, hbp: 2, sb: 2, cs: 1, fld: 63 },
      ...
      { id: 'bellhma01', name: 'Mark Bellhorn', pos: '3B', bats: 'S', age: 28, pa: 307, h: 60, double: 12, triple: 2, hr: 9, bb: 46, so: 83, hbp: 3, sb: 4, cs: 4, sec: '2B', fld: 62 },
      ...
      { id: 'aloumo01', name: 'Moises Alou', pos: 'LF', bats: 'R', age: 36, pa: 638, h: 163, double: 33, triple: 1, hr: 22, bb: 61, so: 68, hbp: 4, sb: 5, cs: 1, sec: 'RF', fld: 56, arm: 62 },
      { id: 'patteco01', name: 'Corey Patterson', pos: 'CF', bats: 'L', age: 23, pa: 347, h: 89, double: 16, triple: 4, hr: 10, bb: 13, so: 78, hbp: 3, sb: 13, cs: 3, sec: 'LF', fld: 56, arm: 67 },
      { id: 'sosasa01', name: 'Sammy Sosa', pos: 'RF', bats: 'R', age: 34, pa: 589, h: 145, double: 21, triple: 1, hr: 44, bb: 79, so: 134, hbp: 4, sb: 1, cs: 1, sec: 'CF', fld: 56, arm: 61 },
      { id: 'martira03', name: 'Ramon Martinez', pos: 'DH', bats: 'R', age: 30, pa: 333, h: 80, double: 16, triple: 2, hr: 4, bb: 25, so: 46, hbp: 3, sb: 1, cs: 1, sec: '3B', fld: 54 },
    ],
    bench: [
      { id: 'choihe01', name: 'Hee-Seop Choi', pos: '1B', bats: 'L', age: 24, pa: 245, h: 43, double: 15, triple: 0, hr: 8, bb: 36, so: 70, hbp: 3, sb: 1, cs: 1, sec: '3B', fld: 75, rk: true },
      ...
      { id: 'oleartr01', name: 'Troy O\'Leary', pos: 'LF', bats: 'L', age: 33, pa: 194, h: 43, double: 8, triple: 1, hr: 4, bb: 17, so: 32, hbp: 2, sb: 1, cs: 1, sec: 'RF', fld: 66, arm: 74 },
      { id: 'goodwto01', name: 'Tom Goodwin', pos: 'CF', bats: 'L', age: 34, pa: 184, h: 45, double: 7, triple: 1, hr: 1, bb: 13, so: 32, hbp: 0, sb: 17, cs: 4, sec: 'LF', fld: 59, arm: 59 },
      { id: 'harrile01', name: 'Lenny Harris', pos: '3B', bats: 'L', age: 38, pa: 163, h: 36, double: 5, triple: 1, hr: 1, bb: 13, so: 16, hbp: 1, sb: 2, cs: 1, sec: '2B', fld: 57 },
    ],
    pitchers: [
  ...
  // CIN (CIN 2003)
  {
    ...
    batters: [
      ...
      { id: 'caseyse01', name: 'Sean Casey', pos: '1B', bats: 'L', age: 28, pa: 629, h: 163, double: 27, triple: 2, hr: 12, bb: 52, so: 61, hbp: 5, sb: 3, cs: 1, sec: '3B', fld: 72 },
      ...
      { id: 'booneaa01', name: 'Aaron Boone', pos: '3B', bats: 'R', age: 30, pa: 654, h: 153, double: 34, triple: 3, hr: 24, bb: 49, so: 105, hbp: 9, sb: 24, cs: 5, sec: 'SS', fld: 75 },
      ...
      { id: 'dunnad01', name: 'Adam Dunn', pos: 'LF', bats: 'L', age: 23, pa: 469, h: 89, double: 17, triple: 1, hr: 23, bb: 79, so: 122, hbp: 8, sb: 10, cs: 4, sec: '1B', fld: 69, arm: 67 },
      { id: 'taylore01', name: 'Reggie Taylor', pos: 'CF', bats: 'L', age: 26, pa: 194, h: 42, double: 7, triple: 2, hr: 5, bb: 10, so: 58, hbp: 1, sb: 7, cs: 3, sec: 'LF', fld: 72, arm: 69 },
      ...
      { id: 'branyru01', name: 'Russell Branyan', pos: 'DH', bats: 'L', age: 27, pa: 205, h: 40, double: 9, triple: 0, hr: 11, bb: 25, so: 71, hbp: 1, sb: 1, cs: 1, sec: 'LF', fld: 91 },
    ],
    bench: [
      { id: 'castrju01', name: 'Juan Castro', pos: '2B', bats: 'R', age: 31, pa: 348, h: 78, double: 14, triple: 1, hr: 8, bb: 19, so: 61, hbp: 0, sb: 1, cs: 2, sec: 'SS', fld: 77 },
      { id: 'kearnau01', name: 'Austin Kearns', pos: 'RF', bats: 'R', age: 23, pa: 338, h: 83, double: 15, triple: 1, hr: 13, bb: 41, so: 66, hbp: 5, sb: 5, cs: 2, sec: 'CF', fld: 85, arm: 70 },
      { id: 'olmedra01', name: 'Ray Olmedo', pos: 'SS', bats: 'S', age: 22, pa: 250, h: 55, double: 6, triple: 1, hr: 0, bb: 13, so: 46, hbp: 0, sb: 1, cs: 1, sec: '2B', fld: 57, rk: true },
      { id: 'lopezfe01', name: 'Felipe Lopez', pos: 'SS', bats: 'S', age: 23, pa: 229, h: 46, double: 9, triple: 2, hr: 4, bb: 22, so: 61, hbp: 1, sb: 6, cs: 4, sec: '3B', fld: 58 },
    ...
    reserveBatters: [
      ...
      { id: 'griffke02', name: 'Ken Griffey', pos: 'CF', bats: 'L', age: 33, pa: 201, h: 45, double: 10, triple: 1, hr: 10, bb: 25, so: 38, hbp: 4, sb: 1, cs: 1, sec: 'LF', fld: 66, arm: 74 },
      { id: 'penawi01', name: 'Wily Mo Pena', pos: 'CF', bats: 'R', age: 21, pa: 181, h: 36, double: 6, triple: 1, hr: 5, bb: 11, so: 57, hbp: 3, sb: 3, cs: 2, sec: 'RF', fld: 61, arm: 64, rk: true },
      { id: 'freelry01', name: 'Ryan Freel', pos: 'CF', bats: 'R', age: 27, pa: 153, h: 39, double: 6, triple: 1, hr: 4, bb: 9, so: 14, hbp: 4, sb: 9, cs: 4, sec: 'LF', fld: 77, arm: 77, rk: true },
      { id: 'larsobr01', name: 'Brandon Larson', pos: '3B', bats: 'R', age: 27, pa: 104, h: 13, double: 2, triple: 0, hr: 2, bb: 12, so: 28, hbp: 0, sb: 2, cs: 1, sec: '1B', fld: 81, rk: true },
    ],
    pitchers: [
  ...
  // MIL (MIL 2003)
  {
    ...
    batters: [
      ...
      { id: 'sexsori01', name: 'Richie Sexson', pos: '1B', bats: 'R', age: 28, pa: 718, h: 170, double: 32, triple: 2, hr: 41, bb: 86, so: 157, hbp: 9, sb: 1, cs: 2, sec: 'LF', fld: 66 },
      ...
      { id: 'helmswe01', name: 'Wes Helms', pos: '3B', bats: 'R', age: 27, pa: 536, h: 121, double: 24, triple: 1, hr: 21, bb: 40, so: 131, hbp: 9, sb: 1, cs: 1, sec: '1B', fld: 65 },
      { id: 'claytro01', name: 'Royce Clayton', pos: 'SS', bats: 'R', age: 33, pa: 543, h: 117, double: 18, triple: 2, hr: 11, bb: 42, so: 91, hbp: 3, sb: 7, cs: 3, sec: '2B', fld: 68 },
      { id: 'jenkige01', name: 'Geoff Jenkins', pos: 'LF', bats: 'L', age: 28, pa: 554, h: 137, double: 30, triple: 2, hr: 26, bb: 53, so: 125, hbp: 8, sb: 1, cs: 1, sec: 'RF', fld: 72, arm: 76 },
      ...
      { id: 'vandejo02', name: 'John Vander Wal', pos: 'RF', bats: 'L', age: 37, pa: 374, h: 85, double: 24, triple: 2, hr: 12, bb: 44, so: 96, hbp: 1, sb: 2, cs: 2, sec: 'LF', fld: 74, arm: 67 },
      { id: 'ginteke01', name: 'Keith Ginter', pos: 'DH', bats: 'R', age: 27, pa: 415, h: 90, double: 18, triple: 2, hr: 13, bb: 42, so: 84, hbp: 15, sb: 1, cs: 1, sec: '3B', fld: 68, rk: true },
    ],
    bench: [
      { id: 'clarkbr02', name: 'Brady Clark', pos: 'RF', bats: 'R', age: 30, pa: 354, h: 82, double: 19, triple: 1, hr: 6, bb: 25, so: 40, hbp: 8, sb: 11, cs: 3, sec: 'LF', fld: 75, arm: 70 },
  ...
  // PIT (PIT 2003)
  {
    ...
    batters: [
      ...
      { id: 'simonra01', name: 'Randall Simon', pos: '1B', bats: 'L', age: 28, pa: 431, h: 118, double: 17, triple: 1, hr: 15, bb: 15, so: 33, hbp: 3, sb: 0, cs: 1, sec: '3B', fld: 78 },
      { id: 'nunezab01', name: 'Abraham Nunez', pos: '2B', bats: 'S', age: 27, pa: 351, h: 77, double: 11, triple: 5, hr: 3, bb: 29, so: 54, hbp: 3, sb: 7, cs: 3, sec: 'SS', fld: 76 },
      ...
      { id: 'wilsoja02', name: 'Jack Wilson', pos: 'SS', bats: 'R', age: 25, pa: 615, h: 140, double: 22, triple: 3, hr: 7, bb: 35, so: 79, hbp: 4, sb: 5, cs: 4, sec: '2B', fld: 74 },
      ...
      { id: 'wilsocr03', name: 'Craig Wilson', pos: 'DH', bats: 'R', age: 26, pa: 358, h: 83, double: 14, triple: 3, hr: 17, bb: 31, so: 94, hbp: 15, sb: 3, cs: 2, sec: 'RF', fld: 82, arm: 73 },
    ],
    bench: [
      { id: 'stairma01', name: 'Matt Stairs', pos: 'RF', bats: 'L', age: 35, pa: 357, h: 82, double: 19, triple: 1, hr: 18, bb: 44, so: 62, hbp: 6, sb: 1, cs: 1, sec: 'LF', fld: 62, arm: 74 },
      { id: 'rebouje01', name: 'Jeff Reboulet', pos: '2B', bats: 'R', age: 39, pa: 299, h: 63, double: 12, triple: 2, hr: 3, bb: 30, so: 51, hbp: 3, sb: 1, cs: 1, sec: 'SS', fld: 81 },
      ...
      { id: 'reesepo01', name: 'Pokey Reese', pos: '2B', bats: 'R', age: 30, pa: 120, h: 26, double: 5, triple: 0, hr: 1, bb: 10, so: 23, hbp: 1, sb: 5, cs: 0, sec: 'SS', fld: 83 },
    ],
    reserveBatters: [
      ...
      { id: 'riverca01', name: 'Carlos Rivera', pos: '1B', bats: 'L', age: 25, pa: 107, h: 21, double: 5, triple: 0, hr: 3, bb: 8, so: 28, hbp: 1, sb: 0, cs: 0, sec: '3B', fld: 79, rk: true },
      { id: 'youngke01', name: 'Kevin Young', pos: '1B', bats: 'R', age: 34, pa: 96, h: 20, double: 5, triple: 0, hr: 3, bb: 9, so: 21, hbp: 1, sb: 1, cs: 1, sec: '3B', fld: 79 },
      { id: 'hyzduad01', name: 'Adam Hyzdu', pos: 'CF', bats: 'R', age: 31, pa: 75, h: 14, double: 3, triple: 0, hr: 3, bb: 9, so: 19, hbp: 1, sb: 0, cs: 0, sec: 'RF', fld: 70, arm: 71 },
    ],
    pitchers: [
  ...
  // STL (SLN 2003)
  {
    ...
    batters: [
      ...
      { id: 'martiti02', name: 'Tino Martinez', pos: '1B', bats: 'L', age: 35, pa: 547, h: 131, double: 24, triple: 2, hr: 19, bb: 51, so: 71, hbp: 5, sb: 2, cs: 1, fld: 71 },
      { id: 'hartbo01', name: 'Bo Hart', pos: '2B', bats: 'R', age: 26, pa: 321, h: 82, double: 13, triple: 5, hr: 4, bb: 12, so: 64, hbp: 6, sb: 3, cs: 1, sec: 'SS', fld: 76, rk: true },
      ...
      { id: 'renteed01', name: 'Edgar Renteria', pos: 'SS', bats: 'R', age: 26, pa: 663, h: 184, double: 41, triple: 2, hr: 13, bb: 59, so: 62, hbp: 2, sb: 29, cs: 7, sec: '2B', fld: 64 },
      ...
      { id: 'edmonji01', name: 'Jim Edmonds', pos: 'CF', bats: 'L', age: 33, pa: 531, h: 129, double: 31, triple: 2, hr: 32, bb: 79, so: 124, hbp: 5, sb: 3, cs: 3, sec: 'LF', fld: 78, arm: 79 },
      { id: 'perezed01', name: 'Eduardo Perez', pos: 'RF', bats: 'R', age: 33, pa: 289, h: 66, double: 16, triple: 0, hr: 13, bb: 29, so: 55, hbp: 4, sb: 4, cs: 1, sec: '1B', fld: 73, arm: 62 },
      { id: 'palmeor01', name: 'Orlando Palmeiro', pos: 'DH', bats: 'L', age: 34, pa: 364, h: 88, double: 14, triple: 1, hr: 2, bb: 34, so: 30, hbp: 2, sb: 5, cs: 4, sec: 'LF', fld: 82, arm: 73 },
    ],
    bench: [
      { id: 'drewjd01', name: 'J. D. Drew', pos: 'RF', bats: 'L', age: 27, pa: 328, h: 79, double: 13, triple: 2, hr: 15, bb: 38, so: 58, hbp: 4, sb: 5, cs: 2, sec: 'CF', fld: 81, arm: 77 },
      { id: 'cairomi01', name: 'Miguel Cairo', pos: '2B', bats: 'R', age: 29, pa: 290, h: 65, double: 14, triple: 2, hr: 4, bb: 16, so: 37, hbp: 5, sb: 3, cs: 1, sec: '3B', fld: 62 },
      ...
      { id: 'robinke02', name: 'Kerry Robinson', pos: 'RF', bats: 'L', age: 29, pa: 221, h: 53, double: 7, triple: 3, hr: 1, bb: 10, so: 28, hbp: 1, sb: 8, cs: 2, sec: 'LF', fld: 75, arm: 59 },
    ...
    reserveBatters: [
      { id: 'marreel01', name: 'Eli Marrero', pos: 'RF', bats: 'R', age: 29, pa: 116, h: 26, double: 5, triple: 1, hr: 4, bb: 9, so: 19, hbp: 0, sb: 3, cs: 1, sec: 'LF', fld: 78, arm: 67 },
  ...
  // ARI (ARI 2003)
  {
    ...
    batters: [
      ...
      { id: 'hillesh02', name: 'Shea Hillenbrand', pos: '1B', bats: 'R', age: 27, pa: 554, h: 146, double: 33, triple: 2, hr: 17, bb: 21, so: 73, hbp: 8, sb: 2, cs: 1, sec: '3B', fld: 70 },
      ...
      { id: 'counscr01', name: 'Craig Counsell', pos: '3B', bats: 'L', age: 32, pa: 351, h: 80, double: 11, triple: 2, hr: 2, bb: 38, so: 38, hbp: 1, sb: 7, cs: 4, sec: '2B', fld: 77 },
      { id: 'cintral01', name: 'Alex Cintron', pos: 'SS', bats: 'S', age: 24, pa: 487, h: 136, double: 27, triple: 6, hr: 12, bb: 33, so: 37, hbp: 2, sb: 2, cs: 3, sec: '2B', fld: 67, rk: true },
      { id: 'gonzalu01', name: 'Luis Gonzalez', pos: 'LF', bats: 'L', age: 35, pa: 679, h: 173, double: 36, triple: 4, hr: 32, bb: 97, so: 73, hbp: 6, sb: 6, cs: 2, fld: 64, arm: 69 },
      { id: 'finlest01', name: 'Steve Finley', pos: 'CF', bats: 'L', age: 38, pa: 582, h: 147, double: 25, triple: 7, hr: 22, bb: 59, so: 84, hbp: 4, sb: 15, cs: 7, sec: 'RF', fld: 59, arm: 72 },
      { id: 'bautida01', name: 'Danny Bautista', pos: 'RF', bats: 'R', age: 31, pa: 314, h: 83, double: 14, triple: 3, hr: 6, bb: 21, so: 46, hbp: 3, sb: 4, cs: 2, sec: 'LF', fld: 56, arm: 61 },
      { id: 'delluda01', name: 'David Dellucci', pos: 'DH', bats: 'L', age: 29, pa: 248, h: 52, double: 11, triple: 2, hr: 5, bb: 24, so: 55, hbp: 3, sb: 7, cs: 1, sec: 'RF', fld: 68, arm: 65 },
    ],
    bench: [
      { id: 'womacto01', name: 'Tony Womack', pos: 'SS', bats: 'L', age: 33, pa: 364, h: 86, double: 13, triple: 3, hr: 2, bb: 18, so: 44, hbp: 3, sb: 16, cs: 6, sec: '2B', fld: 59 },
      ...
      { id: 'overbly01', name: 'Lyle Overbay', pos: '1B', bats: 'L', age: 26, pa: 293, h: 69, double: 20, triple: 0, hr: 4, bb: 34, so: 69, hbp: 2, sb: 1, cs: 0, sec: '3B', fld: 82, rk: true },
    ...
    reserveBatters: [
      { id: 'mccraqu01', name: 'Quinton McCracken', pos: 'RF', bats: 'S', age: 32, pa: 226, h: 54, double: 10, triple: 4, hr: 1, bb: 17, so: 37, hbp: 1, sb: 4, cs: 2, sec: 'CF', fld: 54, arm: 63 },
      ...
      { id: 'gracema01', name: 'Mark Grace', pos: '1B', bats: 'L', age: 39, pa: 155, h: 34, double: 8, triple: 0, hr: 3, bb: 19, so: 13, hbp: 1, sb: 0, cs: 0, fld: 67 },
    ],
    pitchers: [
  ...
  // COL (COL 2003)
  {
    ...
    batters: [
      ...
      { id: 'heltoto01', name: 'Todd Helton', pos: '1B', bats: 'L', age: 29, pa: 703, h: 202, double: 47, triple: 4, hr: 35, bb: 107, so: 85, hbp: 4, sb: 3, cs: 3, sec: 'LF', fld: 81 },
      { id: 'belliro01', name: 'Ronnie Belliard', pos: '2B', bats: 'R', age: 28, pa: 505, h: 116, double: 29, triple: 2, hr: 8, bb: 43, so: 73, hbp: 3, sb: 6, cs: 3, sec: '3B', fld: 71 },
      { id: 'hernajo01', name: 'Jose Hernandez', pos: '3B', bats: 'R', age: 33, pa: 571, h: 130, double: 21, triple: 2, hr: 18, bb: 46, so: 180, hbp: 2, sb: 3, cs: 3, sec: 'SS', fld: 81 },
      { id: 'uribeju01', name: 'Juan Uribe', pos: 'SS', bats: 'R', age: 24, pa: 343, h: 80, double: 16, triple: 5, hr: 7, bb: 17, so: 64, hbp: 3, sb: 6, cs: 1, sec: '2B', fld: 90 },
      ...
      { id: 'wilsopr01', name: 'Preston Wilson', pos: 'CF', bats: 'R', age: 28, pa: 661, h: 159, double: 37, triple: 2, hr: 32, bb: 57, so: 145, hbp: 7, sb: 18, cs: 9, sec: 'LF', fld: 64, arm: 70 },
    ...
    bench: [
      { id: 'stynech01', name: 'Chris Stynes', pos: '3B', bats: 'R', age: 30, pa: 502, h: 114, double: 28, triple: 3, hr: 11, bb: 44, so: 73, hbp: 5, sb: 3, cs: 2, sec: '2B', fld: 78 },
      ...
      { id: 'butlebr02', name: 'Brent Butler', pos: '2B', bats: 'R', age: 25, pa: 99, h: 22, double: 4, triple: 1, hr: 2, bb: 4, so: 11, hbp: 1, sb: 1, cs: 1, sec: '3B', fld: 68 },
    ],
    reserveBatters: [
      { id: 'atkinga01', name: 'Garrett Atkins', pos: '3B', bats: 'R', age: 23, pa: 73, h: 11, double: 2, triple: 0, hr: 0, bb: 3, so: 14, hbp: 1, sb: 0, cs: 0, sec: '1B', fld: 51, rk: true },
  ...
  // LAD (LAN 2003)
  {
    ...
    batters: [
      ...
      { id: 'mcgrifr01', name: 'Fred McGriff', pos: '1B', bats: 'L', age: 39, pa: 329, h: 79, double: 14, triple: 1, hr: 15, bb: 34, so: 60, hbp: 2, sb: 0, cs: 1, fld: 67 },
      { id: 'coraal01', name: 'Alex Cora', pos: '2B', bats: 'L', age: 27, pa: 514, h: 119, double: 24, triple: 4, hr: 5, bb: 26, so: 62, hbp: 10, sb: 5, cs: 2, sec: 'SS', fld: 76 },
      ...
      { id: 'jordabr01', name: 'Brian Jordan', pos: 'LF', bats: 'R', age: 36, pa: 253, h: 67, double: 12, triple: 1, hr: 8, bb: 18, so: 37, hbp: 3, sb: 1, cs: 1, sec: 'RF', fld: 65, arm: 63 },
      { id: 'roberda07', name: 'Dave Roberts', pos: 'CF', bats: 'L', age: 31, pa: 440, h: 102, double: 9, triple: 6, hr: 2, bb: 43, so: 42, hbp: 3, sb: 40, cs: 12, sec: 'LF', fld: 59, arm: 67 },
      { id: 'greensh01', name: 'Shawn Green', pos: 'RF', bats: 'L', age: 30, pa: 691, h: 172, double: 40, triple: 2, hr: 32, bb: 77, so: 111, hbp: 6, sb: 9, cs: 3, sec: 'LF', fld: 60, arm: 68 },
      { id: 'kinkami01', name: 'Mike Kinkade', pos: 'DH', bats: 'R', age: 30, pa: 191, h: 41, double: 8, triple: 0, hr: 5, bb: 13, so: 36, hbp: 14, sb: 2, cs: 2, sec: 'LF', fld: 45, arm: 56 },
    ],
    bench: [
      ...
      { id: 'henderi01', name: 'Rickey Henderson', pos: 'LF', bats: 'R', age: 44, pa: 84, h: 15, double: 2, triple: 0, hr: 2, bb: 14, so: 16, hbp: 1, sb: 4, cs: 1, sec: 'CF', fld: 48, arm: 70 },
    ],
    reserveBatters: [
  ...
  // SDP (SDN 2003)
  {
    ...
    batters: [
      ...
      { id: 'kleskry01', name: 'Ryan Klesko', pos: '1B', bats: 'L', age: 32, pa: 474, h: 111, double: 24, triple: 1, hr: 22, bb: 62, so: 73, hbp: 3, sb: 6, cs: 3, sec: 'LF', fld: 66 },
      ...
      { id: 'vazqura01', name: 'Ramon Vazquez', pos: 'SS', bats: 'L', age: 26, pa: 484, h: 113, double: 18, triple: 4, hr: 3, bb: 49, so: 84, hbp: 2, sb: 9, cs: 3, sec: '2B', fld: 61 },
      { id: 'whitero02', name: 'Rondell White', pos: 'LF', bats: 'R', age: 31, pa: 534, h: 134, double: 24, triple: 2, hr: 20, bb: 31, so: 84, hbp: 10, sb: 1, cs: 3, sec: 'CF', fld: 70, arm: 68 },
      { id: 'kotsama01', name: 'Mark Kotsay', pos: 'CF', bats: 'L', age: 27, pa: 541, h: 135, double: 27, triple: 4, hr: 10, bb: 54, so: 77, hbp: 2, sb: 8, cs: 5, sec: 'RF', fld: 76, arm: 80 },
      { id: 'nadyxa01', name: 'Xavier Nady', pos: 'RF', bats: 'R', age: 24, pa: 404, h: 99, double: 17, triple: 1, hr: 9, bb: 24, so: 74, hbp: 6, sb: 6, cs: 2, sec: 'LF', fld: 62, arm: 80, rk: true },
      { id: 'matthga02', name: 'Gary Matthews', pos: 'DH', bats: 'S', age: 28, pa: 513, h: 115, double: 29, triple: 3, hr: 8, bb: 50, so: 96, hbp: 2, sb: 14, cs: 7, sec: 'RF', fld: 66, arm: 66 },
    ],
    bench: [
      { id: 'nevinph01', name: 'Phil Nevin', pos: '1B', bats: 'R', age: 32, pa: 248, h: 64, double: 10, triple: 0, hr: 11, bb: 23, so: 50, hbp: 1, sb: 2, cs: 0, sec: '3B', fld: 66 },
      ...
      { id: 'merlolo01', name: 'Lou Merloni', pos: '3B', bats: 'R', age: 32, pa: 213, h: 48, double: 10, triple: 2, hr: 2, bb: 21, so: 38, hbp: 3, sb: 2, cs: 2, sec: '2B', fld: 74 },
    ...
    reserveBatters: [
      ...
      { id: 'mendedo01', name: 'Donaldo Mendez', pos: 'SS', bats: 'R', age: 25, pa: 94, h: 17, double: 5, triple: 0, hr: 2, bb: 6, so: 31, hbp: 2, sb: 1, cs: 0, sec: '2B', fld: 54, rk: true },
      { id: 'victosh01', name: 'Shane Victorino', pos: 'CF', bats: 'R', age: 22, pa: 83, h: 11, double: 2, triple: 0, hr: 0, bb: 7, so: 17, hbp: 1, sb: 7, cs: 2, sec: 'LF', fld: 64, arm: 86, rk: true },
  ...
  // SFG (SFN 2003)
  {
    ...
    batters: [
      ...
      { id: 'snowjt01', name: 'J. T. Snow', pos: '1B', bats: 'L', age: 35, pa: 396, h: 86, double: 19, triple: 2, hr: 7, bb: 53, so: 67, hbp: 7, sb: 0, cs: 1, fld: 75 },
      { id: 'durhara01', name: 'Ray Durham', pos: '2B', bats: 'S', age: 31, pa: 469, h: 115, double: 27, triple: 5, hr: 10, bb: 49, so: 74, hbp: 4, sb: 13, cs: 6, sec: 'SS', fld: 74 },
      { id: 'alfoned01', name: 'Edgardo Alfonzo', pos: '3B', bats: 'R', age: 29, pa: 586, h: 140, double: 26, triple: 1, hr: 15, bb: 60, so: 51, hbp: 5, sb: 6, cs: 1, sec: '2B', fld: 65 },
      { id: 'aurilri01', name: 'Rich Aurilia', pos: 'SS', bats: 'R', age: 31, pa: 545, h: 140, double: 29, triple: 2, hr: 16, bb: 36, so: 79, hbp: 2, sb: 1, cs: 2, sec: '2B', fld: 65 },
      ...
      { id: 'grissma02', name: 'Marquis Grissom', pos: 'CF', bats: 'R', age: 36, pa: 618, h: 165, double: 32, triple: 4, hr: 23, bb: 24, so: 99, hbp: 2, sb: 10, cs: 3, sec: 'LF', fld: 67, arm: 63 },
      { id: 'cruzjo02', name: 'Jose Cruz', pos: 'RF', bats: 'S', age: 29, pa: 650, h: 142, double: 30, triple: 3, hr: 23, bb: 81, so: 128, hbp: 0, sb: 11, cs: 6, sec: 'CF', fld: 79, arm: 79 },
      { id: 'galaran01', name: 'Andres Galarraga', pos: 'DH', bats: 'R', age: 42, pa: 293, h: 74, double: 14, triple: 0, hr: 10, bb: 22, so: 68, hbp: 5, sb: 1, cs: 2, sec: '1B', fld: 67 },
    ],
    bench: [
      { id: 'perezne01', name: 'Neifi Perez', pos: '2B', bats: 'S', age: 30, pa: 353, h: 84, double: 15, triple: 4, hr: 2, bb: 13, so: 30, hbp: 0, sb: 4, cs: 4, sec: 'SS', fld: 82 },
      { id: 'felizpe01', name: 'Pedro Feliz', pos: '3B', bats: 'R', age: 28, pa: 249, h: 57, double: 8, triple: 2, hr: 11, bb: 10, so: 51, hbp: 1, sb: 2, cs: 1, sec: '1B', fld: 84 },
